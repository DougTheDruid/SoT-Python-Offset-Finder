...
ENGINESTRUCT = "SDK\\Engine_Structs.h"
ATHENASTRUCT = "SDK\\Athena_structs.h"
...
if __name__ == '__main__':
    ...
    output = {
        ...
        "FCameraCacheEntry.FMinimalViewInfo": get_offset(ENGINESTRUCT, "// ScriptStruct Engine.CameraCacheEntry", "POV"),
    }
