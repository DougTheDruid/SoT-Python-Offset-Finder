...
public:
	...
	TArray<Assetclass >                                          SelectedCreatureType;                              // 0x4a8(0x10)
	TArray<Assetclass UMulticastInlineDelegateProperty>          Seagull;                                           // 0x4b8(0x10)
	float                                                        Size;                                              // 0x4c8(0x4)
	float                                                        SizeVariance;                                      // 0x4cc(0x4)
	float                                                        SimSpeed;                                          // 0x4d0(0x4)
	Struct Vector                                                BBox;                                              // 0x4d4(0xc)
	TArray<Assetclass >                                          Skellygull_01;                                     // 0x4e0(0x10)
	TArray<Assetclass >                                          Bats_01;                                           // 0x4f0(0x10)
	TArray<Assetclass None>                                      Parrot_01;                                         // 0x500(0x10)
