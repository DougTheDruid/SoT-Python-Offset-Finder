...
public:
	...
	TArray<Int ReplicateViewDataCounters>                        ReplicateViewDataCounters;                         // 0x5c8(0x10)
	...
	TArray<Byte BlackboardRepData>                               BlackboardRepData;                                 // 0x6d8(0x10)
	TArray<Struct Vector>                                        PathPoints;                                        // 0x6f8(0x10)
	TArray<Byte PathCorridorData>                                PathCorridorData;                                  // 0x708(0x10)
	TArray<Byte NavmeshRepData>                                  NavmeshRepData;                                    // 0x728(0x10)
	TArray<Byte EQSRepData>                                      EQSRepData;                                        // 0x738(0x10)
