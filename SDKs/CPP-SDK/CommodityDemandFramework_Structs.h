...
{
public:
	char                                                         pad0x18_ZMOUS[0x18];                               // 0x0(0x18)
...
public:
	...
	char                                                         pad0x7_MT3T2[0x7];                                 // 0x11(0x7)
...
{
public:
	char                                                         pad0x18_FGDS9[0x18];                               // 0x0(0x18)
...
{
public:
	char                                                         pad0x2_1XRCH[0x2];                                 // 0x0(0x2)
	char                                                         NPCName;                                           // 0x2(0x1)
	bool                                                         EntitlementOwnershipConfirmed;                     // 0x3(0x1)
	char                                                         pad0x4_UPN1P[0x4];                                 // 0x4(0x4)
	char                                                         pad0x8_5YYWM[0x8];                                 // 0x8(0x8)
};
...
public:
	...
	char                                                         pad0x7_EQNGX[0x7];                                 // 0x11(0x7)
	char                                                         pad0x8_89PYI[0x8];                                 // 0x18(0x8)
};
...
{
public:
	char                                                         pad0x18_KGQCR[0x18];                               // 0x0(0x18)
};
