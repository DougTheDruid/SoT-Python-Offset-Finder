...
public:
	...
	char                                                         pad0x7_7U5PM[0x7];                                 // 0x1(0x7)
	TArray<char>                                                 AllowedTextureFormats;                             // 0x8(0x10)
	char                                                         pad0x8_CP14Z[0x8];                                 // 0x18(0x8)
};
...
public:
	...
	int                                                          Value;                                             // 0x10(0x4)
	char                                                         pad0x4_BTX2F[0x4];                                 // 0x14(0x4)
};
...
public:
	...
	char                                                         pad0x2_YJDKA[0x2];                                 // 0x32(0x2)
};
