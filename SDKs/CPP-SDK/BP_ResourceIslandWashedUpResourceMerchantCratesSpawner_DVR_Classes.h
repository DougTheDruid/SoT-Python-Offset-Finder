...
class BP_ResourceIslandWashedUpResourceMerchantCratesSpawner_DVR_C: public OffTopSplineComponent
{
public:
	char                                                         pad0x440_3L3DW[0x440];                             // 0x0(0x440)
	...
	char                                                         pad0x4_L5WFA[0x4];                                 // 0x474(0x4)
