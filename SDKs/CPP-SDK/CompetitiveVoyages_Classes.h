...
public:
	...
	char                                                         pad0x228_BEFOB[0x228];                             // 0x3d8(0x228)
	TArray<uintptr_t>                                            TreasureItemProxies;                               // 0x6f0(0x10)
	char                                                         pad0x50_RTW67[0x50];                               // 0x700(0x50)
...
{
public:
	char                                                         pad0x58_LUU5C[0x58];                               // 0x98(0x58)
};
...
{
public:
	char                                                         pad0x120_UJLF7[0x120];                             // 0x3a0(0x120)
	TArray<struct Guid>                                          MainVoyageCrews;                                   // 0x4c0(0x10)
	char                                                         pad0x10_N8A1K[0x10];                               // 0x4d0(0x10)
...
public:
	...
	char                                                         pad0x4_EAOWW[0x4];                                 // 0x3c(0x4)
	...
	char                                                         pad0x3_NZSQD[0x3];                                 // 0x17d(0x3)
};
...
{
public:
	char                                                         pad0x8_5OXOL[0x8];                                 // 0x3a0(0x8)
	...
	char                                                         pad0x25f_1UG4T[0x25f];                             // 0x3c9(0x25f)
};
...
{
public:
	char                                                         pad0x10_IE35F[0x10];                               // 0x30(0x10)
	class CompetitiveVoyageVoteValidatorBase*                    Validator;                                         // 0x40(0x8)
	char                                                         pad0x48_2DHBN[0x48];                               // 0x48(0x48)
	...
	char                                                         pad0x18_EW73E[0x18];                               // 0xb0(0x18)
};
...
public:
	...
	char                                                         pad0x7_N3290[0x7];                                 // 0xb9(0x7)
};
