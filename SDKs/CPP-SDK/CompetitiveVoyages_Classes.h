...
{
public:
	char                                                         pad0x10_YADO8[0x10];                               // 0x30(0x10)
	class CompetitiveVoyageVoteValidatorBase*                    Validator;                                         // 0x40(0x8)
	char                                                         pad0x48_PQNL8[0x48];                               // 0x48(0x48)
	...
	char                                                         pad0x18_IPS8I[0x18];                               // 0xb0(0x18)
};
...
{
public:
	char                                                         pad0x120_2V66U[0x120];                             // 0x3a0(0x120)
	TArray<struct Guid>                                          MainVoyageCrews;                                   // 0x4c0(0x10)
	char                                                         pad0x10_EKNLM[0x10];                               // 0x4d0(0x10)
	...
	char                                                         pad0x68_RBWVF[0x68];                               // 0x4f8(0x68)
	TArray<struct Guid>                                          ActiveEventIDs;                                    // 0x560(0x10)
	char                                                         pad0x288_DC13Y[0x288];                             // 0x570(0x288)
	TArray<struct CompetitiveVoyageEventItem>                    VoyageEventItems;                                  // 0x7f8(0x10)
	char                                                         pad0x108_KSSJL[0x108];                             // 0x808(0x108)
};
...
{
public:
	char                                                         pad0x8_UNWET[0x8];                                 // 0x3a0(0x8)
	...
	char                                                         pad0x25f_TBJIH[0x25f];                             // 0x3c9(0x25f)
};
...
public:
	...
	char                                                         pad0x4_H1UG2[0x4];                                 // 0x3c(0x4)
	...
	char                                                         pad0x3_B9E0Z[0x3];                                 // 0x17d(0x3)
};
...
public:
	...
	char                                                         pad0x228_S09UT[0x228];                             // 0x3d8(0x228)
	TArray<uintptr_t>                                            TreasureItemProxies;                               // 0x6f0(0x10)
	char                                                         pad0x50_O5369[0x50];                               // 0x700(0x50)
...
{
public:
	char                                                         pad0x58_KTVJT[0x58];                               // 0x98(0x58)
};
...
public:
	...
	char                                                         pad0x7_07KPI[0x7];                                 // 0xb9(0x7)
};
