...
{
public:
	char                                                         pad0x18_PH25X[0x18];                               // 0x0(0x18)
...
{
public:
	char                                                         pad0x18_Z8IP8[0x18];                               // 0x0(0x18)
	struct FString                                               MatchID;                                           // 0x18(0x10)
};
...
{
public:
	char                                                         pad0x18_HLAIZ[0x18];                               // 0x0(0x18)
	struct FString                                               MatchID;                                           // 0x18(0x10)
};
...
{
public:
	char                                                         pad0x18_20CGX[0x18];                               // 0x0(0x18)
	struct FString                                               MatchID;                                           // 0x18(0x10)
};
...
public:
	...
	char                                                         pad0x7_WO7AL[0x7];                                 // 0x21(0x7)
};
...
public:
	...
	char                                                         pad0x3_SUOMA[0x3];                                 // 0x11(0x3)
};
...
public:
	...
	char                                                         pad0x6_DEFNL[0x6];                                 // 0x52(0x6)
...
{
public:
	char                                                         pad0x18_OX11H[0x18];                               // 0x0(0x18)
	struct FString                                               MatchID;                                           // 0x18(0x10)
...
public:
	...
	char                                                         pad0x58_RTKTB[0x58];                               // 0x20(0x58)
};
...
{
public:
	char                                                         pad0x18_9N9BP[0x18];                               // 0x0(0x18)
	struct FString                                               MatchID;                                           // 0x18(0x10)
	struct PlayerData                                            PlayerData;                                        // 0x28(0x28)
	struct Guid                                                  CrewId;                                            // 0x50(0x10)
};
