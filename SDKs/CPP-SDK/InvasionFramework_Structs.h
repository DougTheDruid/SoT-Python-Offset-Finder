...
{
public:
	char                                                         pad0x18_1971U[0x18];                               // 0x0(0x18)
...
public:
	...
	char                                                         pad0x7_VDXVR[0x7];                                 // 0x21(0x7)
};
...
{
public:
	char                                                         pad0x18_LX28Y[0x18];                               // 0x0(0x18)
	struct FString                                               MatchID;                                           // 0x18(0x10)
};
...
{
public:
	char                                                         pad0x18_LA38N[0x18];                               // 0x0(0x18)
	struct FString                                               MatchID;                                           // 0x18(0x10)
};
...
public:
	...
	char                                                         pad0x3_0M5YL[0x3];                                 // 0x11(0x3)
};
...
{
public:
	char                                                         pad0x18_HM0XE[0x18];                               // 0x0(0x18)
	struct FString                                               MatchID;                                           // 0x18(0x10)
...
public:
	...
	char                                                         pad0x6_FLYOZ[0x6];                                 // 0x52(0x6)
...
public:
	...
	char                                                         pad0x58_PRO1T[0x58];                               // 0x20(0x58)
};
...
{
public:
	char                                                         pad0x18_WWD74[0x18];                               // 0x0(0x18)
	struct FString                                               MatchID;                                           // 0x18(0x10)
...
{
public:
	char                                                         pad0x18_RTKWR[0x18];                               // 0x0(0x18)
	struct FString                                               MatchID;                                           // 0x18(0x10)
	struct PlayerData                                            PlayerData;                                        // 0x28(0x28)
};
