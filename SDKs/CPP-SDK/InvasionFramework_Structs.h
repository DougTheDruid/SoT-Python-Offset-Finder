...
public:
	...
	char                                                         pad0x3_80BD9[0x3];                                 // 0x11(0x3)
};
...
{
public:
	char                                                         pad0x18_VZIMY[0x18];                               // 0x0(0x18)
...
{
public:
	char                                                         pad0x18_MMYDI[0x18];                               // 0x0(0x18)
	struct FString                                               MatchID;                                           // 0x18(0x10)
};
...
{
public:
	char                                                         pad0x18_SRV2X[0x18];                               // 0x0(0x18)
	struct FString                                               MatchID;                                           // 0x18(0x10)
};
...
public:
	...
	char                                                         pad0x7_XTVIL[0x7];                                 // 0x21(0x7)
};
...
{
public:
	char                                                         pad0x18_YXNFS[0x18];                               // 0x0(0x18)
	struct FString                                               MatchID;                                           // 0x18(0x10)
...
public:
	...
	char                                                         pad0x6_NBASH[0x6];                                 // 0x52(0x6)
...
public:
	...
	char                                                         pad0x58_ZIAPN[0x58];                               // 0x20(0x58)
};
...
{
public:
	char                                                         pad0x18_Y8A2E[0x18];                               // 0x0(0x18)
	struct FString                                               MatchID;                                           // 0x18(0x10)
...
{
public:
	char                                                         pad0x18_B48HK[0x18];                               // 0x0(0x18)
	struct FString                                               MatchID;                                           // 0x18(0x10)
	struct PlayerData                                            PlayerData;                                        // 0x28(0x28)
};
