...
{
public:
	char                                                         pad0x18_3O6XZ[0x18];                               // 0x0(0x18)
...
{
public:
	char                                                         pad0x18_MI345[0x18];                               // 0x0(0x18)
	struct FString                                               MatchID;                                           // 0x18(0x10)
...
{
public:
	char                                                         pad0x18_8WDN1[0x18];                               // 0x0(0x18)
	struct FString                                               MatchID;                                           // 0x18(0x10)
};
...
public:
	...
	char                                                         pad0x3_8GEJ3[0x3];                                 // 0x11(0x3)
};
...
public:
	...
	char                                                         pad0x7_2QO75[0x7];                                 // 0x21(0x7)
};
...
{
public:
	char                                                         pad0x18_UWA58[0x18];                               // 0x0(0x18)
	struct FString                                               MatchID;                                           // 0x18(0x10)
};
...
public:
	...
	char                                                         pad0x6_YY0DW[0x6];                                 // 0x52(0x6)
...
public:
	...
	char                                                         pad0x58_MJVZ8[0x58];                               // 0x20(0x58)
};
...
{
public:
	char                                                         pad0x18_BEE27[0x18];                               // 0x0(0x18)
	struct FString                                               MatchID;                                           // 0x18(0x10)
...
{
public:
	char                                                         pad0x18_WRT5I[0x18];                               // 0x0(0x18)
	struct FString                                               MatchID;                                           // 0x18(0x10)
	struct PlayerData                                            PlayerData;                                        // 0x28(0x28)
};
