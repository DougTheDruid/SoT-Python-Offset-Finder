...
public:
	...
	char                                                         pad0x38_8PT5Z[0x38];                               // 0x2e(0x38)
};
...
{
public:
	char                                                         pad0x38_SPZQ9[0x38];                               // 0x58(0x38)
...
public:
	...
	char                                                         pad0x4_IJLO2[0x4];                                 // 0x2c(0x4)
	bool                                                         bManuallySetID;                                    // 0x30(0x1)
	char                                                         pad0x9_7ZCS7[0x9];                                 // 0x2f(0x9)
};
