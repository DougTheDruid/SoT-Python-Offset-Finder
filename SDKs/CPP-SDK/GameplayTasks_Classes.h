...
public:
	...
	char                                                         pad0x28_CDT5X[0x28];                               // 0x30(0x28)
};
...
{
public:
	char                                                         pad0x38_XY7W9[0x38];                               // 0x58(0x38)
...
public:
	...
	char                                                         pad0x4_QMEHN[0x4];                                 // 0x2c(0x4)
	bool                                                         bManuallySetID;                                    // 0x30(0x1)
	char                                                         pad0x7_L2VUY[0x7];                                 // 0x31(0x7)
};
