...
public:
	...
	char                                                         pad0x28_5N5O9[0x28];                               // 0x30(0x28)
};
...
public:
	...
	char                                                         pad0x4_1ISBW[0x4];                                 // 0x2c(0x4)
	bool                                                         bManuallySetID;                                    // 0x30(0x1)
	char                                                         pad0x7_F1LWF[0x7];                                 // 0x31(0x7)
};
...
{
public:
	char                                                         pad0x38_8QKB1[0x38];                               // 0x58(0x38)
...
{
public:
	char                                                         pad0x18_FB705[0x18];                               // 0x58(0x18)
};
