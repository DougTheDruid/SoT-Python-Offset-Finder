...
public:
	...
	char                                                         pad0x28_C7Z43[0x28];                               // 0x30(0x28)
};
...
{
public:
	char                                                         pad0x38_FG9B2[0x38];                               // 0x58(0x38)
...
public:
	...
	char                                                         pad0x4_9VNOE[0x4];                                 // 0x2c(0x4)
	bool                                                         bManuallySetID;                                    // 0x30(0x1)
	char                                                         pad0x7_06MA9[0x7];                                 // 0x31(0x7)
};
