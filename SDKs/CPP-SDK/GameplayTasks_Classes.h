...
public:
	...
	char                                                         pad0x28_RU9IC[0x28];                               // 0x30(0x28)
};
...
public:
	...
	char                                                         pad0x4_OITN1[0x4];                                 // 0x2c(0x4)
	bool                                                         bManuallySetID;                                    // 0x30(0x1)
	char                                                         pad0x7_R01ZW[0x7];                                 // 0x31(0x7)
};
...
{
public:
	char                                                         pad0x38_1A8OJ[0x38];                               // 0x58(0x38)
...
{
public:
	char                                                         pad0x18_NDS94[0x18];                               // 0x58(0x18)
};
