...
public:
	...
	char                                                         pad0x28_635IX[0x28];                               // 0x30(0x28)
};
...
{
public:
	char                                                         pad0x38_FUJ8D[0x38];                               // 0x58(0x38)
...
{
public:
	char                                                         pad0x18_8ZHGC[0x18];                               // 0x58(0x18)
};
...
public:
	...
	char                                                         pad0x4_151WK[0x4];                                 // 0x2c(0x4)
	bool                                                         bManuallySetID;                                    // 0x30(0x1)
	char                                                         pad0x7_KF0I9[0x7];                                 // 0x31(0x7)
};
