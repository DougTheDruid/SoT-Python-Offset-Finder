...
{
public:
	char                                                         pad0x8_SWPJV[0x8];                                 // 0xc8(0x8)
	...
	char                                                         pad0xd7_V7EIV[0xd7];                               // 0xf9(0xd7)
};
...
public:
	...
	char                                                         pad0x4_1XNIJ[0x4];                                 // 0x34(0x4)
};
...
{
public:
	char                                                         pad0x10_7S2DP[0x10];                               // 0x78(0x10)
	class Actor*                                                 HealAreaOfEffectActor;                             // 0x88(0x8)
	char                                                         pad0x10_GZLZI[0x10];                               // 0x90(0x10)
};
...
public:
	...
	char                                                         pad0x18_GC42T[0x18];                               // 0xa0(0x18)
};
...
{
public:
	char                                                         pad0x8_DT7LC[0x8];                                 // 0x78(0x8)
};
...
{
public:
	char                                                         pad0x38_CK3C2[0x38];                               // 0xc8(0x38)
};
