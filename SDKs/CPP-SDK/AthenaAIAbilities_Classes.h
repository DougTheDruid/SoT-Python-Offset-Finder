...
{
public:
	char                                                         pad0x10_ID740[0x10];                               // 0x78(0x10)
	class Actor*                                                 HealAreaOfEffectActor;                             // 0x88(0x8)
	char                                                         pad0x10_YUS9P[0x10];                               // 0x90(0x10)
};
...
{
public:
	char                                                         pad0x8_04QX5[0x8];                                 // 0xc8(0x8)
	...
	char                                                         pad0xd7_XVVA1[0xd7];                               // 0xf9(0xd7)
};
...
{
public:
	char                                                         pad0x8_4F9PV[0x8];                                 // 0x78(0x8)
};
...
public:
	...
	char                                                         pad0x18_F1MAW[0x18];                               // 0xa0(0x18)
};
...
{
public:
	char                                                         pad0x38_4RHKJ[0x38];                               // 0xc8(0x38)
};
...
public:
	...
	char                                                         pad0x4_0IMYN[0x4];                                 // 0x34(0x4)
};
