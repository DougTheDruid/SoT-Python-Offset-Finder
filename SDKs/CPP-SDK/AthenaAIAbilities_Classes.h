...
{
public:
	char                                                         pad0x10_7I3F3[0x10];                               // 0x78(0x10)
	class Actor*                                                 HealAreaOfEffectActor;                             // 0x88(0x8)
	char                                                         pad0x10_AL04Q[0x10];                               // 0x90(0x10)
};
...
{
public:
	char                                                         pad0x8_TGBHY[0x8];                                 // 0xc8(0x8)
	...
	char                                                         pad0xd7_R6T7P[0xd7];                               // 0xf9(0xd7)
};
...
{
public:
	char                                                         pad0x8_8X9QN[0x8];                                 // 0x78(0x8)
};
...
public:
	...
	char                                                         pad0x18_SW5TG[0x18];                               // 0xa0(0x18)
};
...
{
public:
	char                                                         pad0x38_CYC9F[0x38];                               // 0xc8(0x38)
};
...
public:
	...
	char                                                         pad0x4_UKYS3[0x4];                                 // 0x34(0x4)
};
