...
{
public:
	char                                                         pad0x10_VDODQ[0x10];                               // 0x0(0x10)
};
...
public:
	...
	char                                                         pad0x1fc_NMN54[0x1fc];                             // 0xc(0x1fc)
};
...
public:
	...
	char                                                         pad0x3_1WTBG[0x3];                                 // 0x11(0x3)
};
...
public:
	...
	char                                                         pad0x3_6YIFJ[0x3];                                 // 0x15(0x3)
};
...
public:
	struct FName                                                 IslandName;                                        // 0x0(0x8)
	char                                                         pad0x1f8_HB61C[0x1f8];                             // 0x8(0x1f8)
};
...
public:
	...
	char                                                         pad0x8_Z9B0N[0x8];                                 // 0x18(0x8)
};
