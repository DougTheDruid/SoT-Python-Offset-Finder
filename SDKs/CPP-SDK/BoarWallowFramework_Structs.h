...
public:
	...
	char                                                         pad0x1f8_USD17[0x1f8];                             // 0x8(0x1f8)
};
...
public:
	...
	char                                                         pad0x8_J8FJW[0x8];                                 // 0x18(0x8)
};
...
{
public:
	char                                                         pad0x10_LHOHV[0x10];                               // 0x0(0x10)
};
...
public:
	...
	char                                                         pad0x3_Z3IQE[0x3];                                 // 0x11(0x3)
};
...
public:
	...
	char                                                         pad0x3_5F6J9[0x3];                                 // 0x15(0x3)
};
...
public:
	struct Vector                                                Location;                                          // 0x0(0xc)
	char                                                         pad0x1fc_ZOC66[0x1fc];                             // 0xc(0x1fc)
};
