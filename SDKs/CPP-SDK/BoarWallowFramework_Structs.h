...
{
public:
	char                                                         pad0x10_9IL17[0x10];                               // 0x0(0x10)
};
...
public:
	struct FName                                                 IslandName;                                        // 0x0(0x8)
	char                                                         pad0x1f8_1YILX[0x1f8];                             // 0x8(0x1f8)
};
...
public:
	...
	char                                                         pad0x8_0R7TY[0x8];                                 // 0x18(0x8)
};
...
public:
	...
	char                                                         pad0x3_OOSSS[0x3];                                 // 0x15(0x3)
};
...
public:
	struct Vector                                                Location;                                          // 0x0(0xc)
	char                                                         pad0x1fc_AXEF9[0x1fc];                             // 0xc(0x1fc)
};
...
public:
	...
	char                                                         pad0x3_B5JHD[0x3];                                 // 0x11(0x3)
};
