...
public:
	...
	char                                                         pad0x3_TB5GJ[0x3];                                 // 0x11(0x3)
};
...
public:
	...
	char                                                         pad0x1fc_MQZ3S[0x1fc];                             // 0xc(0x1fc)
};
...
public:
	...
	char                                                         pad0x3_L0WIM[0x3];                                 // 0x15(0x3)
};
...
{
public:
	char                                                         pad0x10_UFTZ0[0x10];                               // 0x0(0x10)
};
...
public:
	struct FName                                                 IslandName;                                        // 0x0(0x8)
	char                                                         pad0x1f8_HLF13[0x1f8];                             // 0x8(0x1f8)
};
...
public:
	...
	char                                                         pad0x8_2GGLM[0x8];                                 // 0x18(0x8)
};
