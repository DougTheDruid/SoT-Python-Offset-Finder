...
public:
	struct Vector                                                Location;                                          // 0x0(0xc)
	char                                                         pad0x1fc_R4A6U[0x1fc];                             // 0xc(0x1fc)
};
...
public:
	...
	char                                                         pad0x3_M7U32[0x3];                                 // 0x11(0x3)
};
...
public:
	...
	char                                                         pad0x3_EMK4W[0x3];                                 // 0x15(0x3)
};
...
public:
	...
	char                                                         pad0x8_IZBEG[0x8];                                 // 0x18(0x8)
};
...
{
public:
	char                                                         pad0x10_L8WKI[0x10];                               // 0x0(0x10)
};
...
public:
	struct FName                                                 IslandName;                                        // 0x0(0x8)
	char                                                         pad0x1f8_ZO8JX[0x1f8];                             // 0x8(0x1f8)
};
