...
public:
	...
	char                                                         pad0x4c_0NJ62[0x4c];                               // 0x140(0x4c)
	Struct ObjectMessagingHandle                                 Handle_EmissaryDiscoveredLoot;                     // 0x140(0x58)
	struct FName                                                 CompnayName;                                       // 0x198(0x8)
	bool                                                         SurfacedThisSession;                               // 0x1a0(0x1)
	char                                                         pad0x3_S3R2Y[0x3];                                 // 0x1a1(0x3)
	struct FName                                                 ExpectedCompanyName;                               // 0x1a4(0x8)
	char                                                         pad0x4_XVH7Y[0x4];                                 // 0x1ac(0x4)
