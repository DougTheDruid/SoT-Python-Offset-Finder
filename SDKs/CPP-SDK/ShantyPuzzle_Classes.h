...
public:
	...
	char                                                         pad0x4_ZKE8E[0x4];                                 // 0xcc(0x4)
...
{
public:
	char                                                         pad0x20_671TX[0x20];                               // 0x5e0(0x20)
};
...
{
public:
	char                                                         pad0x8_ONIS8[0x8];                                 // 0x2e0(0x8)
	...
	char                                                         pad0x6_BK5VW[0x6];                                 // 0x302(0x6)
	...
	char                                                         pad0xc0_FOQE5[0xc0];                               // 0x330(0xc0)
};
