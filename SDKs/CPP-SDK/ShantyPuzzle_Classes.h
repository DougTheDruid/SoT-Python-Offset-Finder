...
public:
	...
	char                                                         pad0x4_CHDJL[0x4];                                 // 0xcc(0x4)
...
{
public:
	char                                                         pad0x8_GTDGQ[0x8];                                 // 0x2e0(0x8)
	...
	char                                                         pad0x6_UFIVD[0x6];                                 // 0x302(0x6)
	...
	char                                                         pad0xc0_EGPTQ[0xc0];                               // 0x330(0xc0)
};
...
{
public:
	char                                                         pad0x20_VV1SW[0x20];                               // 0x5e0(0x20)
};
