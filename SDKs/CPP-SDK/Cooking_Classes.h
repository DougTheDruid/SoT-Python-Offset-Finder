...
{
public:
	char                                                         pad0x20_BOA2F[0x20];                               // 0xc8(0x20)
	class                                                        NextCookState;                                     // 0xe8(0x8)
	float                                                        TimeToNextCookState;                               // 0xf0(0x4)
	char                                                         pad0x4_0GY12[0x4];                                 // 0xf4(0x4)
...
{
public:
	char                                                         pad0x8_RLW3F[0x8];                                 // 0xc8(0x8)
	...
	char                                                         pad0x9e_Y5IDR[0x9e];                               // 0x1aa(0x9e)
};
...
public:
	...
	char                                                         pad0x4_X0VXK[0x4];                                 // 0x3c(0x4)
	...
	char                                                         pad0x4_YZGMQ[0x4];                                 // 0x9c(0x4)
};
...
{
public:
	char                                                         pad0x8_F690V[0x8];                                 // 0x400(0x8)
	...
	char                                                         pad0x4_3RT3M[0x4];                                 // 0x424(0x4)
	...
	char                                                         pad0xa0_KX95S[0xa0];                               // 0x540(0xa0)
};
...
public:
	...
	char                                                         pad0x7_4BUXD[0x7];                                 // 0x31(0x7)
};
...
{
public:
	char                                                         pad0x8_PREWX[0x8];                                 // 0xc8(0x8)
	bool                                                         CanBePutInPot;                                     // 0xd0(0x1)
	char                                                         pad0x7_ZK51E[0x7];                                 // 0xd1(0x7)
};
