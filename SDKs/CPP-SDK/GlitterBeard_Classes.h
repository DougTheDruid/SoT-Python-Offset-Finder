...
public:
	...
	char                                                         pad0x90_9P125[0x90];                               // 0xe0(0x90)
};
...
{
public:
	char                                                         pad0x48_3BE5G[0x48];                               // 0xc8(0x48)
};
...
{
public:
	char                                                         pad0x28_O43TY[0x28];                               // 0x3c8(0x28)
	...
	char                                                         pad0x4_N3VW8[0x4];                                 // 0x404(0x4)
...
public:
	...
	char                                                         pad0x10_O1QJD[0x10];                               // 0xd8(0x10)
	TArray<Byte CurrentStates>                                   CurrentStates;                                     // 0xe8(0x10)
	char                                                         pad0x20_L183Y[0x20];                               // 0xf8(0x20)
};
...
public:
	...
	char                                                         pad0xc_XR2LT[0xc];                                 // 0xe4(0xc)
};
