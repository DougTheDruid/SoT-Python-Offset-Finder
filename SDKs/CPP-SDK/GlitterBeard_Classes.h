...
public:
	...
	char                                                         pad0xc_KBNJV[0xc];                                 // 0xd4(0xc)
};
...
{
public:
	class EffectBlendControllerComponent*                        DecalBlendComponent;                               // 0x518(0x8)
};
...
{
public:
	char                                                         pad0x28_QLNSB[0x28];                               // 0x3a0(0x28)
	...
	char                                                         pad0x4_HS0F8[0x4];                                 // 0x3dc(0x4)
...
{
public:
	char                                                         pad0x48_2KCIB[0x48];                               // 0xb8(0x48)
};
...
public:
	...
	char                                                         pad0x90_T3R5P[0x90];                               // 0xd0(0x90)
};
...
public:
	...
	char                                                         pad0x10_A6NYB[0x10];                               // 0xc8(0x10)
	TArray<char>                                                 CurrentStates;                                     // 0xd8(0x10)
	char                                                         pad0x20_LC8FO[0x20];                               // 0xe8(0x20)
};
