...
public:
	...
	char                                                         pad0x90_GNRZ7[0x90];                               // 0xe0(0x90)
};
...
{
public:
	char                                                         pad0x28_R9J8C[0x28];                               // 0x3c8(0x28)
	...
	char                                                         pad0x4_Z7M3D[0x4];                                 // 0x404(0x4)
...
public:
	...
	char                                                         pad0x10_QT1R3[0x10];                               // 0xd8(0x10)
	TArray<Byte CurrentStates>                                   CurrentStates;                                     // 0xe8(0x10)
	char                                                         pad0x20_R75B2[0x20];                               // 0xf8(0x20)
};
...
public:
	...
	char                                                         pad0xc_A3SXV[0xc];                                 // 0xe4(0xc)
};
