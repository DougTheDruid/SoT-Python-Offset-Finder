...
public:
	...
	char                                                         pad0xc_TJD0P[0xc];                                 // 0xd4(0xc)
};
...
{
public:
	char                                                         pad0x28_V2AEH[0x28];                               // 0x3a0(0x28)
	...
	char                                                         pad0x4_2HK98[0x4];                                 // 0x3dc(0x4)
...
public:
	...
	char                                                         pad0x10_HO0JU[0x10];                               // 0xc8(0x10)
	TArray<char>                                                 CurrentStates;                                     // 0xd8(0x10)
	char                                                         pad0x20_XT9PI[0x20];                               // 0xe8(0x20)
};
...
public:
	...
	char                                                         pad0x90_7N6KD[0x90];                               // 0xd0(0x90)
};
...
{
public:
	char                                                         pad0x48_WRM41[0x48];                               // 0xb8(0x48)
};
