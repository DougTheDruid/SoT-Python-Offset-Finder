...
{
public:
	char                                                         pad0x10_TGK4I[0x10];                               // 0x28(0x10)
};
...
{
public:
	char                                                         pad0x8_KPNFZ[0x8];                                 // 0x3a0(0x8)
	...
	char                                                         pad0xa0_9CXNZ[0xa0];                               // 0x3c0(0xa0)
};
...
{
public:
	char                                                         pad0x8_J97PI[0x8];                                 // 0xb8(0x8)
};
...
public:
	...
	char                                                         pad0x7_Q0R2M[0x7];                                 // 0x2d1(0x7)
	TArray<struct Status>                                        StatusEffectsToMaintain;                           // 0x2d8(0x10)
	char                                                         pad0x8_V3W1C[0x8];                                 // 0x2e8(0x8)
};
...
public:
	...
	char                                                         pad0x10_2IV3A[0x10];                               // 0x488(0x10)
};
...
{
public:
	char                                                         pad0x20_A4RKT[0x20];                               // 0xb8(0x20)
...
{
public:
	char                                                         pad0x28_ZM10F[0x28];                               // 0xb8(0x28)
...
{
public:
	char                                                         pad0x8_E7E22[0x8];                                 // 0xb8(0x8)
	class PhysicalMaterial*                                      CurrentSurfaceMaterial;                            // 0xc0(0x8)
	char                                                         pad0x20_QJSHC[0x20];                               // 0xc8(0x20)
};
...
public:
	...
	char                                                         pad0x7_B8GLO[0x7];                                 // 0x41(0x7)
};
...
{
public:
	char                                                         pad0x8_8RTVX[0x8];                                 // 0x28(0x8)
};
...
{
public:
	char                                                         pad0x8_NWQZ9[0x8];                                 // 0xb8(0x8)
	bool                                                         CanReceiveBuff;                                    // 0xc0(0x1)
	char                                                         pad0x7_B5YYN[0x7];                                 // 0xc1(0x7)
};
...
public:
	...
	char                                                         pad0x6_0BJTY[0x6];                                 // 0x3a(0x6)
};
