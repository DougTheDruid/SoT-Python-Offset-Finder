...
{
public:
	char                                                         pad0x8_BJ8OP[0x8];                                 // 0x28(0x8)
};
...
{
public:
	char                                                         pad0x8_YLVEA[0x8];                                 // 0x28(0x8)
};
...
public:
	...
	char                                                         pad0x7_MN20E[0x7];                                 // 0x41(0x7)
};
...
{
public:
	char                                                         pad0x8_ZS004[0x8];                                 // 0xc8(0x8)
	bool                                                         CanReceiveBuff;                                    // 0xd0(0x1)
	char                                                         pad0x7_UDPPX[0x7];                                 // 0xd1(0x7)
};
...
{
public:
	char                                                         pad0x20_R8XY8[0x20];                               // 0xc8(0x20)
...
{
public:
	char                                                         pad0x8_4UVK6[0x8];                                 // 0xc8(0x8)
	class PhysicalMaterial*                                      CurrentSurfaceMaterial;                            // 0xd0(0x8)
	char                                                         pad0x20_21ZBQ[0x20];                               // 0xd8(0x20)
};
...
{
public:
	char                                                         pad0x8_PIP36[0x8];                                 // 0x3c8(0x8)
	...
	char                                                         pad0xa0_84DY4[0xa0];                               // 0x3e8(0xa0)
};
...
{
public:
	char                                                         pad0x28_APICS[0x28];                               // 0xc8(0x28)
...
public:
	...
	char                                                         pad0x10_QASXF[0x10];                               // 0x4b0(0x10)
};
...
{
public:
	char                                                         pad0x8_LZYG6[0x8];                                 // 0xc8(0x8)
};
...
public:
	...
	char                                                         pad0x7_U9J9K[0x7];                                 // 0x2e1(0x7)
	TArray<struct Status>                                        StatusEffectsToMaintain;                           // 0x2e8(0x10)
	char                                                         pad0x8_QQQMT[0x8];                                 // 0x2f8(0x8)
};
...
public:
	...
	char                                                         pad0x6_B7JRW[0x6];                                 // 0x32(0x6)
};
