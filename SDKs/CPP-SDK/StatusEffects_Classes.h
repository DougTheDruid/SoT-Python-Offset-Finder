...
{
public:
	char                                                         pad0x10_L7PBM[0x10];                               // 0x28(0x10)
};
...
{
public:
	char                                                         pad0x8_ZOODA[0x8];                                 // 0xb8(0x8)
	bool                                                         CanReceiveBuff;                                    // 0xc0(0x1)
	char                                                         pad0x7_4PD4O[0x7];                                 // 0xc1(0x7)
};
...
public:
	...
	char                                                         pad0x7_FY6IJ[0x7];                                 // 0x41(0x7)
};
...
{
public:
	char                                                         pad0x8_1LOJ7[0x8];                                 // 0xb8(0x8)
	class PhysicalMaterial*                                      CurrentSurfaceMaterial;                            // 0xc0(0x8)
	char                                                         pad0x20_1Z43U[0x20];                               // 0xc8(0x20)
};
...
{
public:
	char                                                         pad0x28_IPMV9[0x28];                               // 0xb8(0x28)
...
{
public:
	char                                                         pad0x8_1SK60[0x8];                                 // 0x28(0x8)
};
...
{
public:
	char                                                         pad0x20_8DF98[0x20];                               // 0xb8(0x20)
...
{
public:
	char                                                         pad0x8_TQ9RN[0x8];                                 // 0x3a0(0x8)
	...
	char                                                         pad0xa0_G7M1Y[0xa0];                               // 0x3c0(0xa0)
};
...
// Size 0x80 (Full Size[0x350] - InheritedSize[0x2d0]
class StatusEffectVolumeComponent: public SceneComponent
{
public:
	bool                                                         UseOverlapEventsFromParentComponent;               // 0x2d0(0x1)
	char                                                         pad0x7_WSP6H[0x7];                                 // 0x2d1(0x7)
	TArray<struct Status>                                        StatusEffectsToMaintain;                           // 0x2d8(0x10)
	bool                                                         ApplyFriendlyFireStatus;                           // 0x2e8(0x1)
	char                                                         StatusHealthChangeReason;                          // 0x2e9(0x1)
	char                                                         pad0x66_OPJW8[0x66];                               // 0x2ea(0x66)
};
...
{
public:
	char                                                         pad0x8_SGN7K[0x8];                                 // 0xb8(0x8)
};
...
public:
	...
	char                                                         pad0x10_BTZLL[0x10];                               // 0x488(0x10)
};
...
public:
	...
	char                                                         pad0x6_9CSY5[0x6];                                 // 0x3a(0x6)
};
