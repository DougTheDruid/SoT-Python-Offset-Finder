...
{
public:
	char                                                         pad0x8_T710Z[0x8];                                 // 0x3a0(0x8)
	...
	char                                                         pad0xa0_QK9AR[0xa0];                               // 0x3c0(0xa0)
};
...
{
public:
	char                                                         pad0x20_RPVZT[0x20];                               // 0xb8(0x20)
...
{
public:
	char                                                         pad0x8_9KIQS[0x8];                                 // 0xb8(0x8)
	bool                                                         CanReceiveBuff;                                    // 0xc0(0x1)
	char                                                         pad0x7_XNBW9[0x7];                                 // 0xc1(0x7)
};
...
public:
	...
	char                                                         pad0x7_KQH9R[0x7];                                 // 0x41(0x7)
};
...
{
public:
	char                                                         pad0x8_YY12D[0x8];                                 // 0xb8(0x8)
};
...
{
public:
	char                                                         pad0x8_XIW82[0x8];                                 // 0xb8(0x8)
	class PhysicalMaterial*                                      CurrentSurfaceMaterial;                            // 0xc0(0x8)
	char                                                         pad0x20_BQ409[0x20];                               // 0xc8(0x20)
};
...
{
public:
	char                                                         pad0x10_AVLGV[0x10];                               // 0x28(0x10)
};
...
public:
	...
	char                                                         pad0x7_XM7S0[0x7];                                 // 0x2d1(0x7)
	...
	char                                                         pad0x66_4YZFU[0x66];                               // 0x2ea(0x66)
};
...
{
public:
	char                                                         pad0x28_NSKK8[0x28];                               // 0xb8(0x28)
...
{
public:
	char                                                         pad0x8_F5ZJ5[0x8];                                 // 0x28(0x8)
};
...
public:
	...
	char                                                         pad0x10_UPAN6[0x10];                               // 0x488(0x10)
};
...
public:
	...
	char                                                         pad0x6_KBMNG[0x6];                                 // 0x3a(0x6)
};
