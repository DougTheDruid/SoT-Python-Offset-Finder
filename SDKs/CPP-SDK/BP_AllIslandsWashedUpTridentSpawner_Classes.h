...
class BP_AllIslandsWashedUpTridentSpawner_C: public HarpoonRenderComponent
{
public:
	char                                                         pad0x6d8_1HVDD[0x6d8];                             // 0x0(0x6d8)
	Class HarpoonRenderComponent*                                HarpoonRenderComponent;                            // 0x6d8(0x8)
	Class SceneComponent*                                        MovementBase;                                      // 0x6e0(0x8)
	char                                                         pad0x18_ANMJ1[0x18];                               // 0x6e8(0x18)
	struct FName                                                 TetherAttachSocketName;                            // 0x700(0x8)
	char                                                         pad0x8_BDKGO[0x8];                                 // 0x708(0x8)
