...
{
public:
	struct                                                       ShipInBattleBounds;                                // 0x80(0x30)
};
...
{
public:
	struct                                                       AggressiveShip;                                    // 0x80(0x30)
	struct                                                       AggressiveShip;                                    // 0xb0(0x30)
	struct                                                       PassiveShip;                                       // 0xe0(0x30)
	struct                                                       AggressiveCrewId;                                  // 0x110(0x30)
	struct                                                       AggressiveCrewId;                                  // 0x140(0x30)
	struct                                                       PassiveCrewId;                                     // 0x170(0x30)
	struct                                                       AggressiveFaction;                                 // 0x1a0(0x30)
	struct                                                       AggressiveFaction;                                 // 0x1d0(0x30)
	struct                                                       PassiveFaction;                                    // 0x200(0x30)
};
...
{
public:
	struct                                                       Ship1;                                             // 0x80(0x30)
	struct                                                       Ship2;                                             // 0xb0(0x30)
};
...
public:
	...
	struct                                                       DisplayShipsNameForCrewId;                         // 0xc0(0x30)
	struct                                                       DisplayBannersForFaction;                          // 0xf0(0x30)
};
...
{
public:
	struct                                                       InvasionServiceDataAsset;                          // 0x38(0x10)
};
...
{
public:
	struct                                                       WinningShip;                                       // 0x80(0x30)
	struct                                                       DefeatedShip;                                      // 0xb0(0x30)
	struct                                                       WinningCrewId;                                     // 0xe0(0x30)
	struct                                                       DefeatedCrewId;                                    // 0x110(0x30)
	struct                                                       WinningFaction;                                    // 0x140(0x30)
	struct                                                       DefeatedFaction;                                   // 0x170(0x30)
...
public:
	...
	map                                                          TimeAsSubmarine;                                   // 0x410(0x50)
};
