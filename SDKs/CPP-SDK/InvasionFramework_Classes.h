...
public:
	...
	char                                                         pad0x4_9K1XK[0x4];                                 // 0x1a4(0x4)
...
public:
	...
	char                                                         pad0x30_W7XOO[0x30];                               // 0x3c0(0x30)
	class Actor*                                                 ShipThatWasDestroyed;                              // 0x3f0(0x8)
	TArray<class Actor*>                                         HasLeftBattleBounds;                               // 0x3f8(0x10)
	char                                                         pad0x10_1JMN7[0x10];                               // 0x408(0x10)
	TArray<struct PhaseData>                                     PhasesData;                                        // 0x418(0x10)
	char                                                         pad0x50_Q2SR7[0x50];                               // 0x428(0x50)
};
...
public:
	...
	char                                                         pad0x7_K0XVK[0x7];                                 // 0x81(0x7)
};
...
// Size 0x278 (Full Size[0x618] - InheritedSize[0x3a0]
class InvasionService: public Actor
{
public:
	char                                                         pad0x40_8ZVBG[0x40];                               // 0x3a0(0x40)
	...
	char                                                         pad0x130_6GZLW[0x130];                             // 0x400(0x130)
	TArray<struct InvasionParticipatingCrewData>                 MatchmakingCrews;                                  // 0x530(0x10)
	TArray<struct InvasionParticipatingCrewData>                 InvadingCrews;                                     // 0x540(0x10)
	TArray<struct ReplicatedInvasionCrewMusicState>              ReplicatedInvasionCrewMusicStates;                 // 0x550(0x10)
	TArray<struct InvasionServiceMatchmakingCrewInfo>            MatchmakingCrewsReplicated;                        // 0x560(0x10)
	TArray<struct Guid>                                          InvadingCrewsReplicated;                           // 0x570(0x10)
	TArray<class InvasionBattleBounds*>                          InvasionBattleBoundsList;                          // 0x580(0x10)
	char                                                         pad0x88_IJDQD[0x88];                               // 0x590(0x88)
};
...
{
public:
	char                                                         pad0x8_VH0VL[0x8];                                 // 0x98(0x8)
};
...
public:
	...
	char                                                         pad0x4_808FU[0x4];                                 // 0x3c(0x4)
};
...
public:
	...
	char                                                         pad0x7_OWA7W[0x7];                                 // 0xb9(0x7)
...
public:
	...
	char                                                         pad0x4_AUHM6[0x4];                                 // 0x44(0x4)
	...
	char                                                         pad0x4_MJOW1[0x4];                                 // 0xb4(0x4)
};
...
public:
	...
	char                                                         pad0x1a0_AC41D[0x1a0];                             // 0x68(0x1a0)
};
...
public:
	...
	char                                                         pad0x1c0_K0YCF[0x1c0];                             // 0x68(0x1c0)
};
...
{
public:
	char                                                         pad0x18_0GOM9[0x18];                               // 0x98(0x18)
};
