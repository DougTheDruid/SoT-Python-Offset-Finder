...
public:
	...
	char                                                         pad0x1c0_1DW5T[0x1c0];                             // 0x68(0x1c0)
};
...
public:
	...
	char                                                         pad0x7_2RUVP[0x7];                                 // 0xb9(0x7)
...
{
public:
	char                                                         pad0x8_85E07[0x8];                                 // 0x98(0x8)
};
...
public:
	...
	char                                                         pad0x7_0Q7BY[0x7];                                 // 0x81(0x7)
};
...
public:
	...
	char                                                         pad0x4_VD3G9[0x4];                                 // 0x44(0x4)
	...
	char                                                         pad0x4_0DGNV[0x4];                                 // 0xac(0x4)
};
...
public:
	...
	char                                                         pad0x4_SZ322[0x4];                                 // 0x1a4(0x4)
...
public:
	...
	char                                                         pad0x1a0_026CD[0x1a0];                             // 0x68(0x1a0)
};
...
public:
	...
	char                                                         pad0x8_VQVY4[0x8];                                 // 0x3c0(0x8)
	class Actor*                                                 ShipThatWasDestroyed;                              // 0x3c8(0x8)
	TArray<class Actor*>                                         HasLeftBattleBounds;                               // 0x3d0(0x10)
	char                                                         pad0x8_ZGFWR[0x8];                                 // 0x3e0(0x8)
	char                                                         pad0x50_389LU[0x50];                               // 0x3e8(0x50)
};
...
{
public:
	char                                                         pad0x18_G2NEJ[0x18];                               // 0x98(0x18)
};
...
{
public:
	char                                                         pad0x40_0F2SH[0x40];                               // 0x3a0(0x40)
	...
	char                                                         pad0x130_Y6PKJ[0x130];                             // 0x3f8(0x130)
	...
	char                                                         pad0x80_S13CK[0x80];                               // 0x588(0x80)
};
