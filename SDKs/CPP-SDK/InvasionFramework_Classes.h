...
public:
	...
	char                                                         pad0x7_PSJGH[0x7];                                 // 0x81(0x7)
};
...
{
public:
	char                                                         pad0x18_SX106[0x18];                               // 0x98(0x18)
};
...
public:
	...
	char                                                         pad0x4_TLKZJ[0x4];                                 // 0x1a4(0x4)
...
public:
	...
	char                                                         pad0x8_H2LI4[0x8];                                 // 0x3e8(0x8)
	class Actor*                                                 ShipThatWasDestroyed;                              // 0x3f0(0x8)
	TArray<class Actor*>                                         HasLeftBattleBounds;                               // 0x3f8(0x10)
	char                                                         pad0x8_2EY5M[0x8];                                 // 0x408(0x8)
	char                                                         pad0x50_MYBZQ[0x50];                               // 0x410(0x50)
};
...
public:
	...
	char                                                         pad0x1c0_C6FTJ[0x1c0];                             // 0x68(0x1c0)
};
...
{
public:
	char                                                         pad0x40_OWY4B[0x40];                               // 0x3c8(0x40)
	...
	char                                                         pad0x178_YHY55[0x178];                             // 0x420(0x178)
	...
	char                                                         pad0x68_4O4PE[0x68];                               // 0x5f8(0x68)
};
...
public:
	...
	char                                                         pad0x1a0_WGPET[0x1a0];                             // 0x68(0x1a0)
};
...
public:
	...
	char                                                         pad0x4_Z8OY5[0x4];                                 // 0x44(0x4)
...
public:
	...
	char                                                         pad0x7_F0K9E[0x7];                                 // 0xb9(0x7)
