...
{
public:
	char                                                         pad0xa8_IVZ42[0xa8];                               // 0xb8(0xa8)
	...
	char                                                         pad0x176_C6BV0[0x176];                             // 0x18a(0x176)
};
...
{
public:
	char                                                         pad0x80_Y1H2K[0x80];                               // 0x28(0x80)
...
{
public:
	char                                                         pad0x50_V05OE[0x50];                               // 0x3a0(0x50)
};
...
{
public:
	char                                                         pad0x60_D3T1I[0x60];                               // 0x3a0(0x60)
};
...
public:
	...
	char                                                         pad0x18_L47TL[0x18];                               // 0xd0(0x18)
};
...
public:
	...
	char                                                         pad0x3_OR744[0x3];                                 // 0x29(0x3)
...
{
public:
	char                                                         pad0x20_UQBNA[0x20];                               // 0x138(0x20)
	...
	char                                                         pad0x3_1WSG6[0x3];                                 // 0x1fd(0x3)
...
public:
	...
	char                                                         pad0x90_HZWAJ[0x90];                               // 0x4a0(0x90)
};
...
public:
	...
	char                                                         pad0x8_MMDBA[0x8];                                 // 0x38(0x8)
};
...
public:
	...
	char                                                         pad0x8_RJNSG[0x8];                                 // 0x320(0x8)
};
...
{
public:
	char                                                         pad0x8_YRASF[0x8];                                 // 0xe8(0x8)
};
