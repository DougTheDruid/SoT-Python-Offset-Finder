...
{
public:
	char                                                         pad0xa8_CHTVK[0xa8];                               // 0xc8(0xa8)
	...
	char                                                         pad0x176_22FQ1[0x176];                             // 0x19a(0x176)
};
...
public:
	...
	char                                                         pad0x18_0BHRZ[0x18];                               // 0xe0(0x18)
};
...
{
public:
	char                                                         pad0x8_86PM3[0x8];                                 // 0xf8(0x8)
};
...
{
public:
	char                                                         pad0x50_4MU58[0x50];                               // 0x3c8(0x50)
};
...
{
public:
	char                                                         pad0x80_0NT4C[0x80];                               // 0x28(0x80)
...
public:
	...
	char                                                         pad0x8_GLNW1[0x8];                                 // 0x38(0x8)
};
...
public:
	...
	char                                                         pad0x8_78QT8[0x8];                                 // 0x330(0x8)
};
...
public:
	...
	char                                                         pad0x90_GQD2P[0x90];                               // 0x4c8(0x90)
};
...
{
public:
	char                                                         pad0x60_80LBT[0x60];                               // 0x3c8(0x60)
};
...
public:
	...
	char                                                         pad0x3_SNF5R[0x3];                                 // 0x29(0x3)
...
{
public:
	char                                                         pad0x20_B6I7T[0x20];                               // 0x138(0x20)
	...
	char                                                         pad0x3_NCR2D[0x3];                                 // 0x1fd(0x3)
