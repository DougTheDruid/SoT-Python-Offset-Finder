...
public:
	...
	char                                                         pad0x2_62WWA[0x2];                                 // 0x4a(0x2)
	float                                                        StaticWaterHeightValue;                            // 0x4c(0x4)
	char                                                         pad0x88_9FQLR[0x88];                               // 0x50(0x88)
};
...
public:
	...
	char                                                         pad0x3_T1XA4[0x3];                                 // 0x19(0x3)
};
...
public:
	...
	char                                                         pad0x4_DW9KN[0x4];                                 // 0x64(0x4)
	...
	char                                                         pad0x4_UAWKR[0x4];                                 // 0xac(0x4)
};
...
public:
	...
	char                                                         pad0x2_32RKY[0x2];                                 // 0x12(0x2)
	float                                                        Scalar;                                            // 0x14(0x4)
	float                                                        DampingScalar;                                     // 0x18(0x4)
	char                                                         pad0x4_Y0LUD[0x4];                                 // 0x1c(0x4)
	...
	char                                                         pad0x10_1DQ0F[0x10];                               // 0x48(0x10)
};
...
public:
	...
	char                                                         pad0x4_9US5F[0x4];                                 // 0x64(0x4)
	TArray<struct Vector2D>                                      CalmWaterPosition;                                 // 0x68(0x10)
	TArray<float>                                                CalmWaterRadius;                                   // 0x78(0x10)
	TArray<float>                                                CalmWaterDampeningFactor;                          // 0x88(0x10)
	TArray<float>                                                CalmWaterPercentageToStartLerp;                    // 0x98(0x10)
...
public:
	...
	char                                                         pad0x30_WPOPV[0x30];                               // 0x40(0x30)
};
...
public:
	...
	char                                                         Type;                                              // 0x2c(0x1)
	char                                                         pad0x63_MGHMK[0x63];                               // 0x2d(0x63)
};
...
public:
	...
	char                                                         pad0x4_VFYZR[0x4];                                 // 0x1c(0x4)
	...
	char                                                         pad0x4_GCEC9[0x4];                                 // 0x34(0x4)
};
...
public:
	...
	char                                                         pad0x4_W4THJ[0x4];                                 // 0x14(0x4)
	...
	char                                                         pad0xfc_6ZPJD[0xfc];                               // 0x44(0xfc)
};
...
public:
	...
	char                                                         pad0x4_DI2S8[0x4];                                 // 0x14(0x4)
};
...
public:
	...
	char                                                         pad0x7_1LM6L[0x7];                                 // 0x101(0x7)
	class ParticleSystemComponent*                               CurrentlyPlayingVFX;                               // 0x108(0x8)
	char                                                         pad0x18_T39XS[0x18];                               // 0x110(0x18)
};
