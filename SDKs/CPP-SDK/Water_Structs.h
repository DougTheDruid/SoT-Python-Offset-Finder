...
public:
	...
	char                                                         pad0x2_1KJG8[0x2];                                 // 0x4a(0x2)
	float                                                        StaticWaterHeightValue;                            // 0x4c(0x4)
	char                                                         pad0x88_JJDZ1[0x88];                               // 0x50(0x88)
};
...
public:
	...
	char                                                         pad0x30_P5612[0x30];                               // 0x40(0x30)
};
...
public:
	...
	char                                                         pad0x3_C6F26[0x3];                                 // 0x19(0x3)
};
...
public:
	...
	char                                                         pad0x2_IFIEM[0x2];                                 // 0x12(0x2)
	float                                                        Scalar;                                            // 0x14(0x4)
	float                                                        DampingScalar;                                     // 0x18(0x4)
	char                                                         pad0x4_VE9CM[0x4];                                 // 0x1c(0x4)
	...
	char                                                         pad0x10_VXY1K[0x10];                               // 0x48(0x10)
};
...
public:
	...
	char                                                         Type;                                              // 0x2c(0x1)
	char                                                         pad0x63_KLM31[0x63];                               // 0x2d(0x63)
};
...
public:
	...
	char                                                         pad0x4_RLABI[0x4];                                 // 0x14(0x4)
	...
	char                                                         pad0xec_V1R0U[0xec];                               // 0x44(0xec)
};
...
public:
	...
	char                                                         pad0x4_8JEHW[0x4];                                 // 0x1c(0x4)
	...
	char                                                         pad0x4_V7VWB[0x4];                                 // 0x34(0x4)
};
...
public:
	...
	char                                                         pad0x4_YMIKN[0x4];                                 // 0x14(0x4)
};
...
public:
	...
	char                                                         pad0x7_PW8UX[0x7];                                 // 0x101(0x7)
	class ParticleSystemComponent*                               CurrentlyPlayingVFX;                               // 0x108(0x8)
	char                                                         pad0x18_6JP75[0x18];                               // 0x110(0x18)
};
