...
public:
	...
	char                                                         pad0x2_6MIL9[0x2];                                 // 0x12(0x2)
	float                                                        Scalar;                                            // 0x14(0x4)
	float                                                        DampingScalar;                                     // 0x18(0x4)
	char                                                         pad0x4_V9CO7[0x4];                                 // 0x1c(0x4)
	...
	char                                                         pad0x10_DAMI5[0x10];                               // 0x48(0x10)
};
...
public:
	...
	char                                                         pad0x4_JW755[0x4];                                 // 0x64(0x4)
	...
	char                                                         pad0x4_AT9TJ[0x4];                                 // 0xac(0x4)
};
...
public:
	...
	char                                                         pad0x4_QKWVB[0x4];                                 // 0x64(0x4)
	TArray<struct Vector2D>                                      CalmWaterPosition;                                 // 0x68(0x10)
	TArray<float>                                                CalmWaterRadius;                                   // 0x78(0x10)
	TArray<float>                                                CalmWaterDampeningFactor;                          // 0x88(0x10)
	TArray<float>                                                CalmWaterPercentageToStartLerp;                    // 0x98(0x10)
...
public:
	...
	char                                                         pad0x3_0C3Y4[0x3];                                 // 0x19(0x3)
};
...
public:
	...
	char                                                         pad0x2_I8FWT[0x2];                                 // 0x4a(0x2)
	float                                                        StaticWaterHeightValue;                            // 0x4c(0x4)
	char                                                         pad0x88_F3M6L[0x88];                               // 0x50(0x88)
};
...
public:
	...
	char                                                         pad0x30_BP5TU[0x30];                               // 0x40(0x30)
};
...
public:
	...
	char                                                         Type;                                              // 0x2c(0x1)
	char                                                         pad0x63_LPIWT[0x63];                               // 0x2d(0x63)
};
...
public:
	...
	char                                                         pad0x4_KFW3K[0x4];                                 // 0x14(0x4)
	...
	char                                                         pad0xfc_PJX0L[0xfc];                               // 0x44(0xfc)
};
...
public:
	...
	char                                                         pad0x4_UDW4Z[0x4];                                 // 0x1c(0x4)
	...
	char                                                         pad0x4_NLMX4[0x4];                                 // 0x34(0x4)
};
...
public:
	...
	char                                                         pad0x4_Y99HV[0x4];                                 // 0x14(0x4)
};
...
public:
	...
	char                                                         pad0x7_D8YTD[0x7];                                 // 0x101(0x7)
	class ParticleSystemComponent*                               CurrentlyPlayingVFX;                               // 0x108(0x8)
	char                                                         pad0x18_OS4GJ[0x18];                               // 0x110(0x18)
};
