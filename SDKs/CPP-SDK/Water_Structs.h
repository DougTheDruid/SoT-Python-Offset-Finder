...
public:
	...
	char                                                         pad0x30_Q7MIJ[0x30];                               // 0x40(0x30)
};
...
public:
	...
	char                                                         Type;                                              // 0x2c(0x1)
	char                                                         pad0x63_76SOU[0x63];                               // 0x2d(0x63)
};
...
public:
	...
	char                                                         pad0x2_6ZXEQ[0x2];                                 // 0x12(0x2)
	float                                                        Scalar;                                            // 0x14(0x4)
	float                                                        DampingScalar;                                     // 0x18(0x4)
	char                                                         pad0x4_B3GDY[0x4];                                 // 0x1c(0x4)
	...
	char                                                         pad0x10_SR8RT[0x10];                               // 0x48(0x10)
};
...
public:
	...
	char                                                         pad0x4_UFLU6[0x4];                                 // 0x3c(0x4)
};
...
public:
	...
	char                                                         pad0x3_5JW2X[0x3];                                 // 0x19(0x3)
};
...
public:
	...
	char                                                         pad0x2_I95IR[0x2];                                 // 0x4a(0x2)
	float                                                        StaticWaterHeightValue;                            // 0x4c(0x4)
	char                                                         pad0x88_AEQIE[0x88];                               // 0x50(0x88)
};
...
public:
	...
	char                                                         pad0x4_FQ7PA[0x4];                                 // 0x14(0x4)
};
...
public:
	...
	char                                                         pad0x4_RA7F6[0x4];                                 // 0x14(0x4)
	...
	char                                                         pad0xfc_YK0MW[0xfc];                               // 0x44(0xfc)
};
...
public:
	...
	char                                                         pad0x7_3YSDB[0x7];                                 // 0x101(0x7)
	class ParticleSystemComponent*                               CurrentlyPlayingVFX;                               // 0x108(0x8)
	char                                                         pad0x18_IN87W[0x18];                               // 0x110(0x18)
};
...
public:
	...
	char                                                         pad0x4_KB2DW[0x4];                                 // 0x1c(0x4)
	...
	char                                                         pad0x4_5BW4Y[0x4];                                 // 0x34(0x4)
};
