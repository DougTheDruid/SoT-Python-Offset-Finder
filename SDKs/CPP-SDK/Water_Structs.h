...
// Size 0xc
struct LocalizedHeightOverride
{
public:
	char                                                         pad0xc_S1M17[0xc];                                 // 0x0(0xc)
};
...
public:
	...
	char                                                         pad0x2_TO4D0[0x2];                                 // 0x4a(0x2)
	float                                                        StaticWaterHeightValue;                            // 0x4c(0x4)
	char                                                         pad0x88_A1WKM[0x88];                               // 0x50(0x88)
};
...
public:
	...
	char                                                         pad0x4_YQQXF[0x4];                                 // 0x64(0x4)
...
public:
	...
	char                                                         pad0x3_L7TME[0x3];                                 // 0x19(0x3)
};
...
public:
	...
	char                                                         pad0x4_ZJVJI[0x4];                                 // 0x64(0x4)
	TArray<struct Vector2D>                                      CalmWaterPosition;                                 // 0x68(0x10)
	TArray<float>                                                CalmWaterRadius;                                   // 0x78(0x10)
	TArray<float>                                                CalmWaterDampeningFactor;                          // 0x88(0x10)
	TArray<float>                                                CalmWaterPercentageToStartLerp;                    // 0x98(0x10)
	float                                                        ShorelineScale;                                    // 0xa8(0x4)
	char                                                         pad0x4_J1OBL[0x4];                                 // 0xac(0x4)
};
...
public:
	...
	char                                                         pad0x30_85T8Q[0x30];                               // 0x40(0x30)
};
...
public:
	...
	char                                                         Type;                                              // 0x2c(0x1)
	char                                                         pad0x63_GGQV2[0x63];                               // 0x2d(0x63)
};
...
public:
	...
	char                                                         pad0x2_ZOYZF[0x2];                                 // 0x12(0x2)
	float                                                        Scalar;                                            // 0x14(0x4)
	float                                                        DampingScalar;                                     // 0x18(0x4)
	char                                                         pad0x4_70ON1[0x4];                                 // 0x1c(0x4)
	...
	char                                                         pad0x10_72KDD[0x10];                               // 0x48(0x10)
};
...
public:
	...
	char                                                         pad0x4_9MKKX[0x4];                                 // 0x1c(0x4)
	...
	char                                                         pad0x4_AZLD9[0x4];                                 // 0x34(0x4)
};
...
public:
	...
	char                                                         pad0x7_EB2HL[0x7];                                 // 0x101(0x7)
	class ParticleSystemComponent*                               CurrentlyPlayingVFX;                               // 0x108(0x8)
	char                                                         pad0x18_1VPWX[0x18];                               // 0x110(0x18)
};
...
public:
	...
	char                                                         pad0x4_4SXC5[0x4];                                 // 0x14(0x4)
};
...
public:
	...
	char                                                         pad0x4_6R72Q[0x4];                                 // 0x14(0x4)
	...
	char                                                         pad0xfc_9T7OE[0xfc];                               // 0x44(0xfc)
};
