...
public:
	...
	char                                                         pad0x4_B7UYU[0x4];                                 // 0x34(0x4)
...
public:
	...
	float                                                        Max;                                               // 0xc(0x4)
	float                                                        Env;                                               // 0x10(0x4)
	char                                                         pad0x4_JJ2XJ[0x4];                                 // 0x14(0x4)
