...
public:
	...
	char                                                         pad0x6_F1FS6[0x6];                                 // 0x32a(0x6)
	char                                                         pad0x70_OCZ3P[0x70];                               // 0x330(0x70)
};
...
public:
	...
	char                                                         pad0xf_CWQD8[0xf];                                 // 0x3c1(0xf)
};
...
public:
	...
	char                                                         pad0x28_K9V0U[0x28];                               // 0x3a8(0x28)
};
