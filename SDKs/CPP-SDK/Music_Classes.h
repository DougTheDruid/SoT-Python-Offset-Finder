...
{
public:
	char                                                         pad0x8_ZMM6L[0x8];                                 // 0x2d0(0x8)
	...
	char                                                         pad0x7_X5Q1C[0x7];                                 // 0x2f1(0x7)
	...
	char                                                         pad0x6_EQXSJ[0x6];                                 // 0x322(0x6)
	struct MusicZoneRemoteValues                                 EmitterRemoteValues;                               // 0x360(0x20)
	char                                                         pad0x40_N7RTL[0x40];                               // 0x380(0x40)
};
...
{
public:
	char                                                         pad0xc8_0WL2L[0xc8];                               // 0x3a0(0xc8)
};
...
public:
	...
	char                                                         pad0x7_D36H6[0x7];                                 // 0x3d9(0x7)
};
...
public:
	...
	char                                                         pad0x30_1FMXD[0x30];                               // 0x3c0(0x30)
};
