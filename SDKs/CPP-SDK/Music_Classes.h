...
{
public:
	char                                                         pad0xc8_0QVQF[0xc8];                               // 0x3a0(0xc8)
};
...
{
public:
	char                                                         pad0x8_HAANG[0x8];                                 // 0x2d0(0x8)
	...
	char                                                         pad0x7_OJFS5[0x7];                                 // 0x2f1(0x7)
	...
	char                                                         pad0x6_CTYN2[0x6];                                 // 0x322(0x6)
	struct MusicZoneRemoteValues                                 EmitterRemoteValues;                               // 0x360(0x20)
	char                                                         pad0x40_T84JK[0x40];                               // 0x380(0x40)
};
...
public:
	...
	char                                                         pad0x7_FNH22[0x7];                                 // 0x3d9(0x7)
};
...
public:
	...
	char                                                         pad0x30_74TGV[0x30];                               // 0x3c0(0x30)
};
