...
public:
	...
	struct                                                       BackgroundImageUrl;                                // 0xf8(0x10)
	struct                                                       PreviewTileIconImageUrl;                           // 0x108(0x10)
	struct                                                       BladeFrameImageURL;                                // 0x118(0x10)
	struct                                                       WatermarkImageUrl;                                 // 0x128(0x10)
};
...
{
public:
	struct                                                       TunnelInstanceId;                                  // 0x0(0x10)
...
{
public:
	struct                                                       BackgroundImageUrl;                                // 0x0(0x10)
	struct                                                       SmallBackgroundImageUrl;                           // 0x10(0x10)
