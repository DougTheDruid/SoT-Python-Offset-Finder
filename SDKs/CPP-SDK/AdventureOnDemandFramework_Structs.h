...
{
public:
	char                                                         pad0x138_N31HK[0x138];                             // 0x0(0x138)
	class UClass*                                                Proposal;                                          // 0x138(0x8)
};


// Size 0x18
struct QuestTypeTutorialOverride
{
public:
	char                                                         QuestType;                                         // 0x0(0x1)
	char                                                         pad0x7_KDEMR[0x7];                                 // 0x1(0x7)
	class UClass*                                                QuestCompany;                                      // 0x8(0x8)
	char                                                         OverrideTutorialType;                              // 0x10(0x1)
	char                                                         pad0x7_2SYBZ[0x7];                                 // 0x11(0x7)
};
...
public:
	...
	char                                                         pad0x1_0X797[0x1];                                 // 0x27(0x1)
...
public:
	...
	char                                                         pad0x7_6FZEV[0x7];                                 // 0xf1(0x7)
...
public:
	...
	char                                                         pad0x7_PXYMI[0x7];                                 // 0x21(0x7)
};
...
{
public:
	char                                                         pad0x30_ZKDYI[0x30];                               // 0x0(0x30)
};
...
{
public:
	char                                                         pad0x138_ZTSWO[0x138];                             // 0x0(0x138)
...
public:
	...
	char                                                         pad0x3_50CBF[0x3];                                 // 0x25(0x3)
...
public:
	...
	char                                                         pad0x2_HGK78[0x2];                                 // 0x56(0x2)
