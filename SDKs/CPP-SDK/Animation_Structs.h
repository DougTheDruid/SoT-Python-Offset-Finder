...
public:
	...
	char                                                         pad0x4_CIGDT[0x4];                                 // 0x1c(0x4)
...
public:
	...
	char                                                         pad0x7_M2ADJ[0x7];                                 // 0x11(0x7)
};
...
{
public:
	char                                                         pad0x90_RPKQX[0x90];                               // 0x0(0x90)
};
...
{
public:
	char                                                         pad0x60_E34T6[0x60];                               // 0x0(0x60)
};
...
public:
	...
	float                                                        Weighting;                                         // 0x10(0x4)
	char                                                         pad0x4_ANSUL[0x4];                                 // 0x14(0x4)
};
...
{
public:
	char                                                         pad0x18_B7IRT[0x18];                               // 0x0(0x18)
};
...
public:
	class UClass*                                                AnimDataId;                                        // 0x0(0x8)
	char                                                         pad0x20_3NDYB[0x20];                               // 0x8(0x20)
};
...
public:
	...
	char                                                         pad0x1e_V7KLX[0x1e];                               // 0xa(0x1e)
};
...
public:
	...
	char                                                         pad0xc0_QKQV7[0xc0];                               // 0x18(0xc0)
};
...
public:
	...
	char                                                         pad0x3_V3GND[0x3];                                 // 0x19(0x3)
};
...
public:
	...
	char                                                         pad0x3_D3H2G[0x3];                                 // 0x11(0x3)
...
{
public:
	char                                                         pad0x38_LF44V[0x38];                               // 0x0(0x38)
...
{
public:
	char                                                         pad0x40_RG1ES[0x40];                               // 0x0(0x40)
	float                                                        PlayRate;                                          // 0x40(0x4)
	char                                                         pad0x4_QW06B[0x4];                                 // 0x44(0x4)
...
public:
	...
	char                                                         pad0x7_6K7AT[0x7];                                 // 0x31(0x7)
};
