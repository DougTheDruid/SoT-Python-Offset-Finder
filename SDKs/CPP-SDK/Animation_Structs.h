...
{
public:
	char                                                         pad0x40_0QWI2[0x40];                               // 0x0(0x40)
	float                                                        PlayRate;                                          // 0x40(0x4)
	char                                                         pad0x4_Z5H6V[0x4];                                 // 0x44(0x4)
...
public:
	...
	char                                                         pad0x1e_MI43I[0x1e];                               // 0xa(0x1e)
};
...
{
public:
	char                                                         pad0x18_RROK6[0x18];                               // 0x0(0x18)
};
...
{
public:
	char                                                         pad0x90_F2B16[0x90];                               // 0x0(0x90)
};
...
public:
	...
	char                                                         pad0xc0_B8YDF[0xc0];                               // 0x18(0xc0)
};
...
{
public:
	char                                                         pad0x38_ZKAQW[0x38];                               // 0x0(0x38)
...
public:
	...
	char                                                         pad0x7_ASEGG[0x7];                                 // 0x11(0x7)
};
...
{
public:
	char                                                         pad0x60_791AR[0x60];                               // 0x0(0x60)
};
...
public:
	...
	char                                                         pad0x3_QC2O9[0x3];                                 // 0x19(0x3)
};
...
public:
	class UClass*                                                AnimDataId;                                        // 0x0(0x8)
	char                                                         pad0x20_R3ILL[0x20];                               // 0x8(0x20)
};
...
public:
	...
	char                                                         pad0x4_CR3WQ[0x4];                                 // 0x14(0x4)
};
...
public:
	...
	char                                                         pad0x3_44EC4[0x3];                                 // 0x11(0x3)
...
public:
	...
	char                                                         pad0x7_3Y47B[0x7];                                 // 0x31(0x7)
};
