...
{
public:
	char                                                         pad0x90_B179N[0x90];                               // 0x0(0x90)
};
...
{
public:
	char                                                         pad0x38_9DLLW[0x38];                               // 0x0(0x38)
...
public:
	...
	char                                                         pad0x7_2TZGH[0x7];                                 // 0x11(0x7)
};
...
public:
	class UClass*                                                AnimDataId;                                        // 0x0(0x8)
	char                                                         pad0x20_CQB57[0x20];                               // 0x8(0x20)
};
...
{
public:
	char                                                         pad0x60_AVH8P[0x60];                               // 0x0(0x60)
};
...
{
public:
	char                                                         pad0x40_C147J[0x40];                               // 0x0(0x40)
	float                                                        PlayRate;                                          // 0x40(0x4)
	char                                                         pad0x4_9215D[0x4];                                 // 0x44(0x4)
...
public:
	...
	char                                                         pad0x3_K1PZQ[0x3];                                 // 0x11(0x3)
...
public:
	...
	char                                                         pad0x4_GJ05U[0x4];                                 // 0x14(0x4)
};
...
public:
	...
	char                                                         pad0x1e_D2TF5[0x1e];                               // 0xa(0x1e)
};
...
{
public:
	char                                                         pad0x18_8DN2K[0x18];                               // 0x0(0x18)
};
...
public:
	...
	char                                                         pad0xc0_WS70L[0xc0];                               // 0x18(0xc0)
};
...
// Size 0x14
struct MaterialCurveUpdateValues
{
public:
	struct FName                                                 CurveName;                                         // 0x0(0x8)
	struct FName                                                 MaterialParameterName;                             // 0x8(0x8)
	float                                                        FinalValue;                                        // 0x10(0x4)
};
...
public:
	...
	char                                                         pad0x3_UCS4H[0x3];                                 // 0x19(0x3)
};
...
public:
	...
	char                                                         pad0x7_5AEJA[0x7];                                 // 0x1(0x7)
	class UClass*                                                DisguiseTypeId;                                    // 0x8(0x8)
	struct DisguiseProxyMeshData                                 MeshData;                                          // 0x10(0x40)
};
...
public:
	...
	char                                                         pad0x7_95LFZ[0x7];                                 // 0x31(0x7)
};
