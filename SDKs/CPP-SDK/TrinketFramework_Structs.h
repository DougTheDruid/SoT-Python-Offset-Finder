...
{
public:
	TArray<struct TrinketEntries>                                TrinketEntries;                                    // 0x0(0x10)
	TArray<struct TrinketOwnerXUIDs>                             TrinketOwnerXUIDs;                                 // 0x10(0x10)
};
...
{
public:
	TArray<struct Trinkets>                                      Trinkets;                                          // 0x0(0x10)
};
