...
public:
	...
	char                                                         pad0x4_1SZZQ[0x4];                                 // 0xbc(0x4)
};
...
{
public:
	char                                                         pad0x8_3F1H7[0x8];                                 // 0x3a0(0x8)
	class ShipDamageableComponent*                               ShipDamageableComponent;                           // 0x3a8(0x8)
	char                                                         pad0x18_YL99Y[0x18];                               // 0x3b0(0x18)
};
...
public:
	...
	char                                                         pad0x4_0F4OE[0x4];                                 // 0x3c(0x4)
	char                                                         pad0x8_QHHX3[0x8];                                 // 0x40(0x8)
};
