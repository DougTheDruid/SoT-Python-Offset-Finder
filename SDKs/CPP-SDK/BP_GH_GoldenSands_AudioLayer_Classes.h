...
class BP_GH_GoldenSands_AudioLayer_C: public Actor
{
public:
	Struct PointerToUberGraphFrame                               UberGraphFrame;                                    // 0x3c8(0x8)
	Class TritonComponent*                                       Triton;                                            // 0x3d0(0x8)
	Class AudioSpaceComponent*                                   GH_AudioSpace_LargeSection;                        // 0x3d8(0x8)
	Class AudioPortalComponent*                                  Tavern_AudioPortal;                                // 0x3e0(0x8)
