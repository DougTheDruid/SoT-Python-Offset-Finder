...
{
public:
	char                                                         pad0x10_F2DCV[0x10];                               // 0x0(0x10)
};
...
public:
	...
	char                                                         pad0x6_9IKEL[0x6];                                 // 0x12(0x6)
};
...
public:
	...
	char                                                         pad0x3_IZU9A[0x3];                                 // 0x11(0x3)
...
public:
	struct FString                                               ItemName;                                          // 0x0(0x10)
	char                                                         CookState;                                         // 0x10(0x1)
	char                                                         pad0x3_ZZJLL[0x3];                                 // 0x11(0x3)
	struct Vector                                                Location;                                          // 0x14(0xc)
	struct Guid                                                  CookId;                                            // 0x20(0x10)
};
