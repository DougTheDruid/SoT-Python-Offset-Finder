...
public:
	...
	char                                                         pad0x48_A7K53[0x48];                               // 0x38(0x48)
};
...
public:
	...
	char                                                         pad0x3_DNZLL[0x3];                                 // 0xe9(0x3)
...
{
public:
	char                                                         pad0x8_B2DRI[0x8];                                 // 0x28(0x8)
	TArray<struct BindingData>                                   BindingData;                                       // 0x30(0x10)
	char                                                         pad0x58_ARLFS[0x58];                               // 0x40(0x58)
};
...
public:
	...
	char                                                         pad0x10_4R39O[0x10];                               // 0x60(0x10)
};
...
public:
	...
	char                                                         pad0x2_3PCV1[0x2];                                 // 0x82(0x2)
	...
	char                                                         pad0x3_9R0US[0x3];                                 // 0x95(0x3)
};
...
public:
	...
	char                                                         pad0x4_F8B6N[0x4];                                 // 0x84(0x4)
};
...
public:
	...
	char                                                         pad0x6_NS0TJ[0x6];                                 // 0x2a2(0x6)
};
