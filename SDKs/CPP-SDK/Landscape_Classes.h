...
{
public:
	struct                                                       LandscapeGuid;                                     // 0x630(0x10)
...
public:
	...
	struct                                                       HeightfieldGuid;                                   // 0x5f8(0x10)
	struct                                                       CachedLocalBox;                                    // 0x608(0x1c)
...
public:
	...
	struct                                                       ExpressionGUID;                                    // 0x80(0x10)
};
...
{
public:
	struct                                                       Connections;                                       // 0x28(0x18)
	struct                                                       SplineInfo;                                        // 0x58(0x18)
	TArray<struct LandscapeSplineInterpPoint>                    Points;                                            // 0x70(0x10)
	struct                                                       Bounds;                                            // 0x80(0x1c)
...
public:
	...
	struct                                                       LandscapeGuid;                                     // 0x3d8(0x10)
	struct                                                       LandscapeSectionOffset;                            // 0x3e8(0x8)
	...
	struct                                                       LightmassSettings;                                 // 0x4f0(0x18)
	int                                                          CollisionMipLevel;                                 // 0x508(0x4)
	float                                                        CollisionThickness;                                // 0x50c(0x4)
	struct                                                       BodyInstance;                                      // 0x510(0x180)
...
{
public:
	struct                                                       LayerUsed;                                         // 0x70(0x38)
	struct                                                       LayerNotUsed;                                      // 0xa8(0x38)
	struct FName                                                 ParameterName;                                     // 0xe0(0x8)
	bool                                                         PreviewUsed;                                       // 0xe8(0x1)
	struct                                                       ExpressionGUID;                                    // 0xec(0x10)
};
...
{
public:
	struct                                                       ExpressionGUID;                                    // 0x70(0x10)
};
...
public:
	...
	struct                                                       ExpressionGUID;                                    // 0x7c(0x10)
};
...
public:
	...
	struct                                                       WeightmapScaleBias;                                // 0x620(0x10)
	float                                                        WeightmapSubsectionOffset;                         // 0x630(0x4)
	struct                                                       HeightmapScaleBias;                                // 0x640(0x10)
	class Texture2D*                                             HeightmapTexture;                                  // 0x650(0x8)
	struct                                                       CachedLocalBox;                                    // 0x658(0x1c)
	...
	struct                                                       StateId;                                           // 0x6c0(0x10)
	struct                                                       BakedTextureMaterialGuid;                          // 0x6d0(0x10)
...
public:
	...
	struct                                                       Layer;                                             // 0xa8(0x38)
	struct FName                                                 ParameterName;                                     // 0xe0(0x8)
	float                                                        PreviewWeight;                                     // 0xe8(0x4)
	struct                                                       ConstBase;                                         // 0xec(0xc)
	struct                                                       ExpressionGUID;                                    // 0xf8(0x10)
};
