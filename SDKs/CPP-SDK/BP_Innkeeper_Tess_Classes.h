...
class BP_Innkeeper_Tess_C: public WaterOcclusionVolume
{
public:
	char                                                         pad0x4f0_52SA3[0x4f0];                             // 0x0(0x4f0)
	...
	char                                                         pad0x4_U6SC5[0x4];                                 // 0x514(0x4)
	...
	char                                                         pad0x4_RLEMA[0x4];                                 // 0x534(0x4)
	Struct Status                                                SuperheatedWaterStatusToApply;                     // 0x538(0x18)
	char                                                         pad0x28_B5DGS[0x28];                               // 0x550(0x28)
