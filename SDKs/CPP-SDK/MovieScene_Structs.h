...
{
public:
	char                                                         pad0x38_AK333[0x38];                               // 0x0(0x38)
};
...
{
public:
	char                                                         pad0x38_P2Z5D[0x38];                               // 0x0(0x38)
};
...
{
public:
	char                                                         pad0xa8_G9LBC[0xa8];                               // 0x0(0xa8)
};
...
{
public:
	char                                                         pad0x10_OV6BU[0x10];                               // 0x0(0x10)
};
...
{
public:
	char                                                         pad0x220_0RS8A[0x220];                             // 0x0(0x220)
};
...
public:
	...
	char                                                         pad0x3_37NV4[0x3];                                 // 0x9(0x3)
	float                                                        StartTime;                                         // 0xc(0x4)
	bool                                                         bRestoreState;                                     // 0x10(0x1)
	char                                                         pad0x7_4YJCN[0x7];                                 // 0x11(0x7)
	char                                                         pad0x10_8N36V[0x10];                               // 0x18(0x10)
};
...
{
public:
	char                                                         pad0x18_LCSLZ[0x18];                               // 0x0(0x18)
...
public:
	...
	char                                                         pad0x3_KHRV8[0x3];                                 // 0x1(0x3)
	struct Guid                                                  Guid;                                              // 0x4(0x10)
	char                                                         pad0x4_T4542[0x4];                                 // 0x14(0x4)
	...
	char                                                         pad0x7_Q63MH[0x7];                                 // 0x41(0x7)
};
...
{
public:
	char                                                         pad0x10_H9UUA[0x10];                               // 0x0(0x10)
	char                                                         CompletionMode;                                    // 0x10(0x1)
	char                                                         pad0x7_R34SM[0x7];                                 // 0x11(0x7)
};
...
{
public:
	char                                                         pad0x40_LNSQE[0x40];                               // 0x0(0x40)
};
...
{
public:
	char                                                         pad0x10_D3GBG[0x10];                               // 0x0(0x10)
};
...
{
public:
	char                                                         pad0x50_99H8S[0x50];                               // 0x0(0x50)
...
{
public:
	char                                                         pad0xa0_7JX9K[0xa0];                               // 0x0(0xa0)
};
...
public:
	...
	char                                                         pad0x3_IMP4W[0x3];                                 // 0x19(0x3)
};
...
public:
	...
	char                                                         pad0x4_QSAIE[0x4];                                 // 0x24(0x4)
};
...
public:
	...
	char                                                         pad0x5_0A4X6[0x5];                                 // 0x13(0x5)
	...
	char                                                         pad0x7_7HCJ5[0x7];                                 // 0x79(0x7)
};
...
{
public:
	char                                                         pad0xa0_K0ZFQ[0xa0];                               // 0x0(0xa0)
	...
	char                                                         pad0x7_B0B05[0x7];                                 // 0x219(0x7)
};
