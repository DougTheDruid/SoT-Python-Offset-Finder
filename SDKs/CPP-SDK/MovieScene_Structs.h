...
{
public:
	char                                                         pad0x10_ZCRRC[0x10];                               // 0x0(0x10)
};
...
{
public:
	char                                                         pad0x18_NTMZG[0x18];                               // 0x0(0x18)
...
{
public:
	char                                                         pad0x38_C23JX[0x38];                               // 0x0(0x38)
};
...
{
public:
	char                                                         pad0x220_NRZP3[0x220];                             // 0x0(0x220)
};
...
{
public:
	char                                                         pad0x10_UF89U[0x10];                               // 0x0(0x10)
};
...
{
public:
	char                                                         pad0xa8_OAO6L[0xa8];                               // 0x0(0xa8)
};
...
public:
	...
	char                                                         pad0x3_QF4RX[0x3];                                 // 0x1(0x3)
	struct Guid                                                  Guid;                                              // 0x4(0x10)
	char                                                         pad0x4_H3VY5[0x4];                                 // 0x14(0x4)
	...
	char                                                         pad0x7_DI1Z6[0x7];                                 // 0x41(0x7)
};
...
public:
	...
	char                                                         pad0x3_V124W[0x3];                                 // 0x9(0x3)
	float                                                        StartTime;                                         // 0xc(0x4)
	bool                                                         bRestoreState;                                     // 0x10(0x1)
	char                                                         pad0x7_NB8BX[0x7];                                 // 0x11(0x7)
	char                                                         pad0x10_Z9M2L[0x10];                               // 0x18(0x10)
};
...
{
public:
	char                                                         pad0x38_DNJBO[0x38];                               // 0x0(0x38)
};
...
{
public:
	char                                                         pad0x40_1533M[0x40];                               // 0x0(0x40)
};
...
{
public:
	char                                                         pad0xa0_WYVJ5[0xa0];                               // 0x0(0xa0)
};
...
{
public:
	char                                                         pad0x10_TD8OF[0x10];                               // 0x0(0x10)
	char                                                         CompletionMode;                                    // 0x10(0x1)
	char                                                         pad0x7_AQ668[0x7];                                 // 0x11(0x7)
};
...
{
public:
	char                                                         pad0x50_UHQRB[0x50];                               // 0x0(0x50)
...
public:
	...
	char                                                         pad0x3_CXYXZ[0x3];                                 // 0x19(0x3)
};
...
public:
	...
	char                                                         pad0x5_MK99W[0x5];                                 // 0x13(0x5)
	...
	char                                                         pad0x7_24FX4[0x7];                                 // 0x79(0x7)
};
...
public:
	...
	char                                                         pad0x4_ZFTQF[0x4];                                 // 0x24(0x4)
};
...
{
public:
	char                                                         pad0xa0_18KEK[0xa0];                               // 0x0(0xa0)
	...
	char                                                         pad0x7_S2UD2[0x7];                                 // 0x219(0x7)
};
