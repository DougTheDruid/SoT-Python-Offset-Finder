...
public:
	...
	char                                                         pad0x3_6329E[0x3];                                 // 0x1(0x3)
	Struct Guid                                                  Guid;                                              // 0x4(0x10)
	char                                                         pad0x4_KBVDJ[0x4];                                 // 0x14(0x4)
...
public:
	...
	char                                                         pad0x3_P10UM[0x3];                                 // 0x9(0x3)
	float                                                        StartTime;                                         // 0xc(0x4)
	bool                                                         bRestoreState;                                     // 0x10(0x1)
	char                                                         pad0x7_MXSS0[0x7];                                 // 0x11(0x7)
};
...
public:
	...
	char                                                         pad0x5_ZVW8C[0x5];                                 // 0x13(0x5)
