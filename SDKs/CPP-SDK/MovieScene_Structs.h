...
public:
	...
	char                                                         pad0x3_JBI05[0x3];                                 // 0x1(0x3)
	Struct Guid                                                  Guid;                                              // 0x4(0x10)
	char                                                         pad0x4_JXJ59[0x4];                                 // 0x14(0x4)
...
public:
	...
	char                                                         pad0x3_HK6C4[0x3];                                 // 0x9(0x3)
	float                                                        StartTime;                                         // 0xc(0x4)
	bool                                                         bRestoreState;                                     // 0x10(0x1)
	char                                                         pad0x7_R1DX8[0x7];                                 // 0x11(0x7)
};
...
public:
	...
	char                                                         pad0x5_6K0F9[0x5];                                 // 0x13(0x5)
