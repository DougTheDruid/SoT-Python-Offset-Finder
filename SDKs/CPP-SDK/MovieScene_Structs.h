...
{
public:
	char                                                         pad0x40_ZJ8XV[0x40];                               // 0x0(0x40)
};
...
{
public:
	char                                                         pad0x10_8PJGQ[0x10];                               // 0x0(0x10)
	char                                                         CompletionMode;                                    // 0x10(0x1)
	char                                                         pad0x7_SZ2SJ[0x7];                                 // 0x11(0x7)
};
...
{
public:
	char                                                         pad0x10_O2718[0x10];                               // 0x0(0x10)
};
...
{
public:
	char                                                         pad0xa8_64M94[0xa8];                               // 0x0(0xa8)
};
...
{
public:
	char                                                         pad0x38_R6HAN[0x38];                               // 0x0(0x38)
};
...
public:
	...
	char                                                         pad0x3_KG8T4[0x3];                                 // 0x9(0x3)
	float                                                        StartTime;                                         // 0xc(0x4)
	bool                                                         bRestoreState;                                     // 0x10(0x1)
	char                                                         pad0x7_V6X16[0x7];                                 // 0x11(0x7)
	char                                                         pad0x10_0YPUC[0x10];                               // 0x18(0x10)
};
...
public:
	...
	char                                                         pad0x3_YYO4V[0x3];                                 // 0x1(0x3)
	struct Guid                                                  Guid;                                              // 0x4(0x10)
	char                                                         pad0x4_BMZ8N[0x4];                                 // 0x14(0x4)
	...
	char                                                         pad0x7_W9BM7[0x7];                                 // 0x41(0x7)
};
...
{
public:
	char                                                         pad0x50_VJ4BJ[0x50];                               // 0x0(0x50)
...
{
public:
	char                                                         pad0xa0_PMWEO[0xa0];                               // 0x0(0xa0)
};
...
{
public:
	char                                                         pad0x220_IHF3W[0x220];                             // 0x0(0x220)
};
...
{
public:
	char                                                         pad0x38_EBX59[0x38];                               // 0x0(0x38)
};
...
{
public:
	char                                                         pad0x10_JUW2A[0x10];                               // 0x0(0x10)
};
...
{
public:
	char                                                         pad0x18_ORVOC[0x18];                               // 0x0(0x18)
...
public:
	...
	char                                                         pad0x4_IAO1J[0x4];                                 // 0x24(0x4)
};
...
public:
	...
	char                                                         pad0x3_ILR3Y[0x3];                                 // 0x19(0x3)
};
...
public:
	...
	char                                                         pad0x5_ZFGB1[0x5];                                 // 0x13(0x5)
	...
	char                                                         pad0x7_N19D1[0x7];                                 // 0x79(0x7)
};
...
{
public:
	char                                                         pad0xa0_QKAE0[0xa0];                               // 0x0(0xa0)
	...
	char                                                         pad0x7_WCZ0N[0x7];                                 // 0x219(0x7)
};
