...
{
public:
	char                                                         pad0x10_IQNUM[0x10];                               // 0x0(0x10)
};
...
{
public:
	char                                                         pad0xa8_0NWMI[0xa8];                               // 0x0(0xa8)
};
...
{
public:
	char                                                         pad0x10_UWBJX[0x10];                               // 0x0(0x10)
	char                                                         CompletionMode;                                    // 0x10(0x1)
	char                                                         pad0x7_O2406[0x7];                                 // 0x11(0x7)
};
...
public:
	...
	char                                                         pad0x3_RODFV[0x3];                                 // 0x9(0x3)
	float                                                        StartTime;                                         // 0xc(0x4)
	bool                                                         bRestoreState;                                     // 0x10(0x1)
	char                                                         pad0x7_O6Y51[0x7];                                 // 0x11(0x7)
	char                                                         pad0x10_2VKUM[0x10];                               // 0x18(0x10)
};
...
{
public:
	char                                                         pad0x220_1UNV1[0x220];                             // 0x0(0x220)
};
...
{
public:
	char                                                         pad0xa0_Z8OOY[0xa0];                               // 0x0(0xa0)
};
...
{
public:
	char                                                         pad0x40_QTAHO[0x40];                               // 0x0(0x40)
};
...
{
public:
	char                                                         pad0x18_R9DLU[0x18];                               // 0x0(0x18)
...
{
public:
	char                                                         pad0x38_CBEC7[0x38];                               // 0x0(0x38)
};
...
{
public:
	char                                                         pad0x50_8CZ13[0x50];                               // 0x0(0x50)
...
{
public:
	char                                                         pad0x10_1XR4R[0x10];                               // 0x0(0x10)
};
...
public:
	...
	char                                                         pad0x3_6SG9K[0x3];                                 // 0x1(0x3)
	struct Guid                                                  Guid;                                              // 0x4(0x10)
	char                                                         pad0x4_JKQL0[0x4];                                 // 0x14(0x4)
	...
	char                                                         pad0x7_6NIWE[0x7];                                 // 0x41(0x7)
};
...
{
public:
	char                                                         pad0x38_25WAE[0x38];                               // 0x0(0x38)
};
...
public:
	...
	char                                                         pad0x3_ZFX7R[0x3];                                 // 0x19(0x3)
};
...
public:
	...
	char                                                         pad0x4_XQB2S[0x4];                                 // 0x24(0x4)
};
...
public:
	...
	char                                                         pad0x5_9FIB4[0x5];                                 // 0x13(0x5)
	...
	char                                                         pad0x7_T88E9[0x7];                                 // 0x79(0x7)
};
...
{
public:
	char                                                         pad0xa0_GJ1GB[0xa0];                               // 0x0(0xa0)
	...
	char                                                         pad0x7_B7GBM[0x7];                                 // 0x219(0x7)
};
