...
{
public:
	char                                                         pad0x10_Q9AGJ[0x10];                               // 0x0(0x10)
};
...
public:
	...
	char                                                         pad0x3_S1VZ6[0x3];                                 // 0x1(0x3)
	struct Guid                                                  Guid;                                              // 0x4(0x10)
	char                                                         pad0x4_8VKYR[0x4];                                 // 0x14(0x4)
	...
	char                                                         pad0x7_BV20G[0x7];                                 // 0x41(0x7)
};
...
{
public:
	char                                                         pad0x50_6EQDW[0x50];                               // 0x0(0x50)
...
{
public:
	char                                                         pad0x38_ANY4M[0x38];                               // 0x0(0x38)
};
...
{
public:
	char                                                         pad0x220_V9XV1[0x220];                             // 0x0(0x220)
};
...
{
public:
	char                                                         pad0x18_S6QMZ[0x18];                               // 0x0(0x18)
...
{
public:
	char                                                         pad0xa8_KNXN2[0xa8];                               // 0x0(0xa8)
};
...
{
public:
	char                                                         pad0x40_OF659[0x40];                               // 0x0(0x40)
};
...
{
public:
	char                                                         pad0xa0_VUIL5[0xa0];                               // 0x0(0xa0)
};
...
{
public:
	char                                                         pad0x10_DMM58[0x10];                               // 0x0(0x10)
	char                                                         CompletionMode;                                    // 0x10(0x1)
	char                                                         pad0x7_TTEBW[0x7];                                 // 0x11(0x7)
};
...
{
public:
	char                                                         pad0x38_LLY25[0x38];                               // 0x0(0x38)
};
...
public:
	...
	char                                                         pad0x3_D0VAE[0x3];                                 // 0x9(0x3)
	float                                                        StartTime;                                         // 0xc(0x4)
	bool                                                         bRestoreState;                                     // 0x10(0x1)
	char                                                         pad0x7_FFTQZ[0x7];                                 // 0x11(0x7)
	char                                                         pad0x10_YCS8P[0x10];                               // 0x18(0x10)
};
...
{
public:
	char                                                         pad0x10_CRD8I[0x10];                               // 0x0(0x10)
};
...
public:
	...
	char                                                         pad0x4_5WZXP[0x4];                                 // 0x24(0x4)
};
...
public:
	...
	char                                                         pad0x3_G051I[0x3];                                 // 0x19(0x3)
};
...
public:
	...
	char                                                         pad0x5_W4XWL[0x5];                                 // 0x13(0x5)
	...
	char                                                         pad0x7_BGX1Q[0x7];                                 // 0x79(0x7)
};
...
{
public:
	char                                                         pad0xa0_05WKF[0xa0];                               // 0x0(0xa0)
	...
	char                                                         pad0x7_YLXIO[0x7];                                 // 0x219(0x7)
};
