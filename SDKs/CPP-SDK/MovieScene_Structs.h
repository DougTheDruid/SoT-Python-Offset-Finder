...
{
public:
	char                                                         pad0x18_CUVQR[0x18];                               // 0x0(0x18)
...
public:
	...
	char                                                         pad0x3_JMQHG[0x3];                                 // 0x9(0x3)
	float                                                        StartTime;                                         // 0xc(0x4)
	bool                                                         bRestoreState;                                     // 0x10(0x1)
	char                                                         pad0x7_RNNJL[0x7];                                 // 0x11(0x7)
	char                                                         pad0x10_BG10E[0x10];                               // 0x18(0x10)
};
...
{
public:
	char                                                         pad0xa0_EZLQL[0xa0];                               // 0x0(0xa0)
};
...
{
public:
	char                                                         pad0x10_PDORX[0x10];                               // 0x0(0x10)
};
...
{
public:
	char                                                         pad0x10_W2H8U[0x10];                               // 0x0(0x10)
	char                                                         CompletionMode;                                    // 0x10(0x1)
	char                                                         pad0x7_TOA61[0x7];                                 // 0x11(0x7)
};
...
{
public:
	char                                                         pad0x38_35RSY[0x38];                               // 0x0(0x38)
};
...
{
public:
	char                                                         pad0x10_P1FD4[0x10];                               // 0x0(0x10)
};
...
public:
	...
	char                                                         pad0x3_IC298[0x3];                                 // 0x1(0x3)
	struct Guid                                                  Guid;                                              // 0x4(0x10)
	char                                                         pad0x4_09PDK[0x4];                                 // 0x14(0x4)
	...
	char                                                         pad0x7_QBG7Y[0x7];                                 // 0x41(0x7)
};
...
{
public:
	char                                                         pad0x40_0OMLC[0x40];                               // 0x0(0x40)
};
...
{
public:
	char                                                         pad0x50_BS3V7[0x50];                               // 0x0(0x50)
...
{
public:
	char                                                         pad0xa8_29DXX[0xa8];                               // 0x0(0xa8)
};
...
{
public:
	char                                                         pad0x220_AYHLA[0x220];                             // 0x0(0x220)
};
...
{
public:
	char                                                         pad0x38_0NSI8[0x38];                               // 0x0(0x38)
};
...
public:
	...
	char                                                         pad0x5_QGF7T[0x5];                                 // 0x13(0x5)
	...
	char                                                         pad0x7_RZ4KQ[0x7];                                 // 0x79(0x7)
};
...
public:
	...
	char                                                         pad0x4_0LV1V[0x4];                                 // 0x24(0x4)
};
...
public:
	...
	char                                                         pad0x3_6LLI9[0x3];                                 // 0x19(0x3)
};
...
{
public:
	char                                                         pad0xa0_ZTHAS[0xa0];                               // 0x0(0xa0)
	...
	char                                                         pad0x7_PI3IX[0x7];                                 // 0x219(0x7)
};
