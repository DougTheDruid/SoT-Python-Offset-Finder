...
{
public:
	struct                                                       ObjectBindingId;                                   // 0x0(0x10)
...
public:
	map                                                          Tracks;                                            // 0x0(0x50)
	struct                                                       EvaluationField;                                   // 0xa0(0x30)
	struct                                                       Hierarchy;                                         // 0xd0(0xa0)
	struct                                                       Ledger;                                            // 0x170(0xa8)
...
public:
	...
	struct                                                       WorkingRange;                                      // 0x50(0x10)
	struct                                                       ViewRange;                                         // 0x60(0x10)
};
...
public:
	...
	struct                                                       TrackTemplate;                                     // 0x38(0x38)
...
public:
	...
	struct                                                       CachedSignature;                                   // 0x8(0x10)
};
...
public:
	class MovieSceneSequence*                                    Sequence;                                          // 0x0(0x8)
	struct                                                       RootToSequenceTransform;                           // 0x8(0x8)
	struct                                                       SourceSequenceSignature;                           // 0x10(0x10)
	struct                                                       DeterministicSequenceID;                           // 0x20(0x4)
};
...
{
public:
	struct                                                       SequenceID;                                        // 0x0(0x4)
	struct                                                       TrackIdentifier;                                   // 0x4(0x4)
};
