...
{
public:
	char                                                         pad0x8_I8CZG[0x8];                                 // 0xb8(0x8)
	...
	char                                                         pad0x28_IBGD1[0x28];                               // 0xf0(0x28)
};
...
{
public:
	char                                                         pad0x8_I76P3[0x8];                                 // 0xb8(0x8)
	bool                                                         UseAreaOfOperationOnSpawn;                         // 0xc0(0x1)
	char                                                         pad0x3_29HS8[0x3];                                 // 0xc1(0x3)
...
public:
	...
	char                                                         pad0x8_49NY2[0x8];                                 // 0x38(0x8)
};
