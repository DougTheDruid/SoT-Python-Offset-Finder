...
{
public:
	char                                                         pad0x8_P4JBU[0x8];                                 // 0xb8(0x8)
	...
	char                                                         pad0x28_XWOKC[0x28];                               // 0xf0(0x28)
};
...
public:
	...
	char                                                         pad0x8_OQLOW[0x8];                                 // 0x38(0x8)
};
...
{
public:
	char                                                         pad0x8_8RNOF[0x8];                                 // 0xb8(0x8)
	bool                                                         UseAreaOfOperationOnSpawn;                         // 0xc0(0x1)
	char                                                         pad0x3_3UNST[0x3];                                 // 0xc1(0x3)
