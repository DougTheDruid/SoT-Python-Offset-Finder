...
{
public:
	char                                                         pad0x8_KJ4NJ[0x8];                                 // 0xc8(0x8)
	...
	char                                                         pad0x28_10GMM[0x28];                               // 0x100(0x28)
};
...
{
public:
	char                                                         pad0x8_H6DKV[0x8];                                 // 0xc8(0x8)
	bool                                                         UseAreaOfOperationOnSpawn;                         // 0xd0(0x1)
	char                                                         pad0x3_KILY5[0x3];                                 // 0xd1(0x3)
...
public:
	...
	char                                                         pad0x8_G3ZF4[0x8];                                 // 0x38(0x8)
};
