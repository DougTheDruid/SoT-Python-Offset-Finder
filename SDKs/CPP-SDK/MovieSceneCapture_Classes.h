...
{
public:
	char                                                         pad0x10_QRWH6[0x10];                               // 0x28(0x10)
...
public:
	...
	char                                                         pad0x3_6JAME[0x3];                                 // 0x39(0x3)
	int                                                          HDRCompressionQuality;                             // 0x3c(0x4)
	char                                                         CaptureGamut;                                      // 0x40(0x1)
	char                                                         pad0x7_47WDQ[0x7];                                 // 0x41(0x7)
...
{
public:
	char                                                         pad0x8_GW81Q[0x8];                                 // 0x28(0x8)
};
...
public:
	...
	char                                                         pad0xb_QQ971[0xb];                                 // 0x1e1(0xb)
	struct Guid                                                  PrerequisiteActorId;                               // 0x1ec(0x10)
	char                                                         pad0x4_1ACNE[0x4];                                 // 0x1fc(0x4)
};
...
public:
	...
	char                                                         pad0x4_8Q9A7[0x4];                                 // 0x34(0x4)
};
...
public:
	...
	char                                                         pad0x3_8MCLL[0x3];                                 // 0x31(0x3)
