...
{
public:
	char                                                         pad0x10_G7CZU[0x10];                               // 0x28(0x10)
...
public:
	...
	char                                                         pad0x3_TR8HI[0x3];                                 // 0x39(0x3)
	int                                                          HDRCompressionQuality;                             // 0x3c(0x4)
	char                                                         CaptureGamut;                                      // 0x40(0x1)
	char                                                         pad0x7_H0L8U[0x7];                                 // 0x41(0x7)
...
{
public:
	char                                                         pad0x8_A7YWJ[0x8];                                 // 0x28(0x8)
};
...
public:
	...
	char                                                         pad0xb_0X7V3[0xb];                                 // 0x1e1(0xb)
	struct Guid                                                  PrerequisiteActorId;                               // 0x1ec(0x10)
	char                                                         pad0x4_FDKIJ[0x4];                                 // 0x1fc(0x4)
};
...
public:
	...
	char                                                         pad0x4_ZUZAJ[0x4];                                 // 0x34(0x4)
};
...
public:
	...
	char                                                         pad0x3_APZOD[0x3];                                 // 0x31(0x3)
