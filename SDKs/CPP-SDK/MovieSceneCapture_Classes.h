...
{
public:
	char                                                         pad0x10_7X1LH[0x10];                               // 0x28(0x10)
...
public:
	...
	char                                                         pad0xb_W21P6[0xb];                                 // 0x1e1(0xb)
	struct Guid                                                  PrerequisiteActorId;                               // 0x1ec(0x10)
	char                                                         pad0x4_Q7CH4[0x4];                                 // 0x1fc(0x4)
};
...
{
public:
	char                                                         pad0x8_7LPEA[0x8];                                 // 0x28(0x8)
};
...
public:
	...
	char                                                         pad0x4_KO7PP[0x4];                                 // 0x34(0x4)
};
...
public:
	...
	char                                                         pad0x3_4KFXB[0x3];                                 // 0x39(0x3)
	int                                                          HDRCompressionQuality;                             // 0x3c(0x4)
	byte                                                         CaptureGamut;                                      // 0x40(0x1)
	char                                                         pad0x7_NVXCC[0x7];                                 // 0x41(0x7)
...
public:
	...
	char                                                         pad0x3_2V5ZE[0x3];                                 // 0x31(0x3)
