...
{
public:
	char                                                         pad0x10_GFP3S[0x10];                               // 0x28(0x10)
...
public:
	...
	char                                                         pad0xb_0VLBR[0xb];                                 // 0x1e1(0xb)
	Struct Guid                                                  PrerequisiteActorId;                               // 0x1ec(0x10)
	char                                                         pad0x4_KGN94[0x4];                                 // 0x1fc(0x4)
};
...
public:
	...
	char                                                         pad0x4_BD8U9[0x4];                                 // 0x34(0x4)
};
...
public:
	...
	char                                                         pad0x3_RQ2D7[0x3];                                 // 0x39(0x3)
	int                                                          HDRCompressionQuality;                             // 0x3c(0x4)
	byte                                                         CaptureGamut;                                      // 0x40(0x1)
	char                                                         pad0x7_Z1746[0x7];                                 // 0x41(0x7)
...
public:
	...
	char                                                         pad0x3_TCGDW[0x3];                                 // 0x31(0x3)
