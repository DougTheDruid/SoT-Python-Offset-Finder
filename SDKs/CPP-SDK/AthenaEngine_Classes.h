...
{
public:
	char                                                         pad0x8_VLHZ9[0x8];                                 // 0xc8(0x8)
};
...
public:
	...
	char                                                         pad0x38_1UMWJ[0x38];                               // 0x5a8(0x38)
};
...
{
public:
	char                                                         pad0x10_CG3OU[0x10];                               // 0x28(0x10)
};
...
public:
	...
	char                                                         pad0x2c_5VFSV[0x2c];                               // 0xcc(0x2c)
	class World*                                                 CachedWorld;                                       // 0xf8(0x8)
	char                                                         pad0x8_0RZB6[0x8];                                 // 0x100(0x8)
};
...
public:
	...
	char                                                         pad0x28_JC12G[0x28];                               // 0xd0(0x28)
};
...
public:
	...
	char                                                         pad0x18_FZAFB[0x18];                               // 0x38(0x18)
};
