...
public:
	...
	char                                                         pad0x28_JKACF[0x28];                               // 0xc0(0x28)
};
...
{
public:
	char                                                         pad0x8_V6LHO[0x8];                                 // 0xb8(0x8)
};
...
public:
	...
	char                                                         pad0x34_4BBWS[0x34];                               // 0xc4(0x34)
};
...
{
public:
	char                                                         pad0x10_FJ71E[0x10];                               // 0x28(0x10)
};
...
{
public:
	char                                                         pad0x8_HLUNM[0x8];                                 // 0xb8(0x8)
...
public:
	...
	char                                                         pad0x2c_9G2JY[0x2c];                               // 0xbc(0x2c)
	class World*                                                 CachedWorld;                                       // 0xe8(0x8)
	char                                                         pad0x8_BE683[0x8];                                 // 0xf0(0x8)
};
...
public:
	...
	char                                                         pad0x18_QZJNT[0x18];                               // 0x38(0x18)
};
...
public:
	...
	char                                                         pad0x38_D33TL[0x38];                               // 0x598(0x38)
};
