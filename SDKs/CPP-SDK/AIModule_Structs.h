...
public:
	...
	char                                                         pad0x10_OXHCF[0x10];                               // 0x8(0x10)
};
...
public:
	...
	char                                                         pad0x4_EWNIX[0x4];                                 // 0x1c(0x4)
...
{
public:
	char                                                         pad0x28_6M03R[0x28];                               // 0x0(0x28)
	float                                                        DefaultValue;                                      // 0x28(0x4)
	char                                                         pad0x4_EP8V6[0x4];                                 // 0x2c(0x4)
};
...
{
public:
	char                                                         pad0x10_XN96D[0x10];                               // 0x0(0x10)
...
{
public:
	char                                                         pad0x20_TO1CI[0x20];                               // 0x0(0x20)
...
public:
	...
	char                                                         pad0x38_NIK4V[0x38];                               // 0x8(0x38)
};
...
public:
	...
	char                                                         pad0x2d8_3SBYX[0x2d8];                             // 0x8(0x2d8)
};
...
public:
	...
	char                                                         pad0xc_JX1A5[0xc];                                 // 0x2c(0xc)
	bool                                                         bSuccessfullySensed;                               // 0x38(0x1)
	char                                                         pad0x3_ZBO3V[0x3];                                 // 0x39(0x3)
};
...
{
public:
	char                                                         pad0x28_Q88EK[0x28];                               // 0x0(0x28)
...
{
public:
	char                                                         pad0x10_GXVGE[0x10];                               // 0x0(0x10)
	class UClass*                                                ItemType;                                          // 0x10(0x8)
	char                                                         pad0x14_QYT55[0x14];                               // 0x18(0x14)
	int                                                          OptionIndex;                                       // 0x2c(0x4)
	int                                                          QueryID;                                           // 0x30(0x4)
	char                                                         pad0xc_8GBN8[0xc];                                 // 0x34(0xc)
};
...
{
public:
	char                                                         pad0x30_F7TWC[0x30];                               // 0x0(0x30)
};
...
public:
	...
	char                                                         pad0x158_150RG[0x158];                             // 0x18(0x158)
};
...
{
public:
	char                                                         pad0x28_I9QCV[0x28];                               // 0x0(0x28)
	bool                                                         DefaultValue;                                      // 0x28(0x1)
	char                                                         pad0x7_L40MU[0x7];                                 // 0x29(0x7)
};
...
public:
	...
	char                                                         pad0x7_ZV2OG[0x7];                                 // 0x19(0x7)
};
...
public:
	...
	char                                                         pad0x3_I5A8T[0x3];                                 // 0x21(0x3)
	bool                                                         bNoneIsAllowedValue;                               // 0x24(0x1)
	char                                                         pad0x3_0ZDW8[0x3];                                 // 0x25(0x3)
};
...
public:
	...
	char                                                         pad0x8_J8EBM[0x8];                                 // 0x10(0x8)
};
...
{
public:
	char                                                         pad0x28_J5Y8N[0x28];                               // 0x0(0x28)
	int                                                          DefaultValue;                                      // 0x28(0x4)
	char                                                         pad0x4_ZCGJ4[0x4];                                 // 0x2c(0x4)
};
...
public:
	...
	char                                                         pad0x8_TA84D[0x8];                                 // 0x10(0x8)
};
...
public:
	...
	char                                                         pad0x7_8BO40[0x7];                                 // 0x11(0x7)
};
...
public:
	...
	char                                                         pad0x8_SEW01[0x8];                                 // 0x28(0x8)
};
...
public:
	...
	char                                                         pad0x1_LM58R[0x1];                                 // 0x1(0x1)
	char                                                         pad0x2_BO3L6[0x2];                                 // 0x2(0x2)
};
...
public:
	...
	char                                                         pad0x7_DRMOK[0x7];                                 // 0x19(0x7)
};
