...
public:
	...
	char                                                         pad0xc_9D43Q[0xc];                                 // 0x2c(0xc)
	bool                                                         bSuccessfullySensed;                               // 0x38(0x1)
	char                                                         pad0x3_J5GUF[0x3];                                 // 0x39(0x3)
};
...
public:
	...
	char                                                         pad0x7_MUZVT[0x7];                                 // 0x11(0x7)
};
...
public:
	...
	char                                                         pad0x3_T21UB[0x3];                                 // 0x21(0x3)
	bool                                                         bNoneIsAllowedValue;                               // 0x24(0x1)
	char                                                         pad0x3_VOWMN[0x3];                                 // 0x25(0x3)
};
...
public:
	...
	char                                                         pad0x4_5IBR5[0x4];                                 // 0x1c(0x4)
...
public:
	...
	char                                                         pad0x38_S7U5J[0x38];                               // 0x8(0x38)
};
...
public:
	...
	char                                                         pad0x8_DLNTB[0x8];                                 // 0x10(0x8)
};
...
public:
	...
	char                                                         pad0x2d8_15ZAE[0x2d8];                             // 0x8(0x2d8)
};
...
public:
	...
	char                                                         pad0x8_QG5LF[0x8];                                 // 0x10(0x8)
};
...
public:
	...
	char                                                         pad0x1_99X3V[0x1];                                 // 0x1(0x1)
	char                                                         pad0x2_DXZB9[0x2];                                 // 0x2(0x2)
};
...
{
public:
	char                                                         pad0x10_36GJM[0x10];                               // 0x0(0x10)
	class UClass*                                                ItemType;                                          // 0x10(0x8)
	char                                                         pad0x14_38P25[0x14];                               // 0x18(0x14)
	int                                                          OptionIndex;                                       // 0x2c(0x4)
	int                                                          QueryID;                                           // 0x30(0x4)
	char                                                         pad0xc_IVDNI[0xc];                                 // 0x34(0xc)
};
...
public:
	...
	char                                                         pad0x8_X2SD3[0x8];                                 // 0x28(0x8)
};
...
{
public:
	char                                                         pad0x20_EVOKY[0x20];                               // 0x0(0x20)
...
public:
	...
	char                                                         pad0x10_7QRUY[0x10];                               // 0x8(0x10)
};
...
{
public:
	char                                                         pad0x30_698Z9[0x30];                               // 0x0(0x30)
};
...
{
public:
	char                                                         pad0x28_CMGQL[0x28];                               // 0x0(0x28)
	bool                                                         DefaultValue;                                      // 0x28(0x1)
	char                                                         pad0x7_T8K6N[0x7];                                 // 0x29(0x7)
};
...
{
public:
	char                                                         pad0x28_XAQ4J[0x28];                               // 0x0(0x28)
	int                                                          DefaultValue;                                      // 0x28(0x4)
	char                                                         pad0x4_DHHW4[0x4];                                 // 0x2c(0x4)
};
...
public:
	...
	char                                                         pad0x7_ULQWD[0x7];                                 // 0x19(0x7)
};
...
public:
	...
	char                                                         pad0x158_M912N[0x158];                             // 0x18(0x158)
};
...
{
public:
	char                                                         pad0x28_06Y1C[0x28];                               // 0x0(0x28)
	float                                                        DefaultValue;                                      // 0x28(0x4)
	char                                                         pad0x4_TEC5Y[0x4];                                 // 0x2c(0x4)
};
...
{
public:
	char                                                         pad0x10_M2ELT[0x10];                               // 0x0(0x10)
...
{
public:
	char                                                         pad0x28_7O778[0x28];                               // 0x0(0x28)
...
public:
	...
	char                                                         pad0x7_GCTNH[0x7];                                 // 0x19(0x7)
};
