...
{
public:
	char                                                         pad0x30_A6R3R[0x30];                               // 0x0(0x30)
};
...
public:
	...
	char                                                         pad0x10_3BO7R[0x10];                               // 0x8(0x10)
};
...
public:
	...
	char                                                         pad0x7_ZEJWA[0x7];                                 // 0x11(0x7)
};
...
public:
	...
	char                                                         pad0x7_64MCR[0x7];                                 // 0x19(0x7)
};
...
{
public:
	char                                                         pad0x10_1V3RA[0x10];                               // 0x0(0x10)
...
{
public:
	char                                                         pad0x28_ZL6RL[0x28];                               // 0x0(0x28)
	bool                                                         DefaultValue;                                      // 0x28(0x1)
	char                                                         pad0x7_1MW5S[0x7];                                 // 0x29(0x7)
};
...
public:
	...
	char                                                         pad0x8_N5YCD[0x8];                                 // 0x28(0x8)
};
...
{
public:
	char                                                         pad0x28_0AV9V[0x28];                               // 0x0(0x28)
	int                                                          DefaultValue;                                      // 0x28(0x4)
	char                                                         pad0x4_JZM5U[0x4];                                 // 0x2c(0x4)
};
...
public:
	...
	char                                                         pad0x8_6A6D6[0x8];                                 // 0x10(0x8)
};
...
public:
	...
	char                                                         pad0x38_3PR51[0x38];                               // 0x8(0x38)
};
...
public:
	...
	char                                                         pad0xc_HI8WU[0xc];                                 // 0x2c(0xc)
	bool                                                         bSuccessfullySensed;                               // 0x38(0x1)
	char                                                         pad0x3_LGHPA[0x3];                                 // 0x39(0x3)
};
...
public:
	...
	char                                                         pad0x4_QZZ1T[0x4];                                 // 0x1c(0x4)
...
{
public:
	char                                                         pad0x28_7DCJG[0x28];                               // 0x0(0x28)
	float                                                        DefaultValue;                                      // 0x28(0x4)
	char                                                         pad0x4_IIQPO[0x4];                                 // 0x2c(0x4)
};
...
public:
	...
	char                                                         pad0x1_I5HNJ[0x1];                                 // 0x1(0x1)
	char                                                         pad0x2_V7FIF[0x2];                                 // 0x2(0x2)
};
...
{
public:
	char                                                         pad0x28_WMMNE[0x28];                               // 0x0(0x28)
...
public:
	...
	char                                                         pad0x158_6D7DT[0x158];                             // 0x18(0x158)
};
...
{
public:
	char                                                         pad0x10_CMK3V[0x10];                               // 0x0(0x10)
	class UClass*                                                ItemType;                                          // 0x10(0x8)
	char                                                         pad0x14_9FLPA[0x14];                               // 0x18(0x14)
	int                                                          OptionIndex;                                       // 0x2c(0x4)
	int                                                          QueryID;                                           // 0x30(0x4)
	char                                                         pad0xc_YOVR5[0xc];                                 // 0x34(0xc)
};
...
public:
	...
	char                                                         pad0x3_KL9UJ[0x3];                                 // 0x21(0x3)
	bool                                                         bNoneIsAllowedValue;                               // 0x24(0x1)
	char                                                         pad0x3_HGM5C[0x3];                                 // 0x25(0x3)
};
...
{
public:
	char                                                         pad0x20_3WXV8[0x20];                               // 0x0(0x20)
...
public:
	...
	char                                                         pad0x8_3JCEN[0x8];                                 // 0x10(0x8)
};
...
public:
	...
	char                                                         pad0x2d8_L04BC[0x2d8];                             // 0x8(0x2d8)
};
...
public:
	...
	char                                                         pad0x7_OLQ9K[0x7];                                 // 0x19(0x7)
};
