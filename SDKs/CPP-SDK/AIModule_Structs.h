...
public:
	...
	char                                                         pad0x158_LG5CC[0x158];                             // 0x18(0x158)
};
...
public:
	...
	char                                                         pad0x8_XKG4L[0x8];                                 // 0x28(0x8)
};
...
{
public:
	char                                                         pad0x28_H44H8[0x28];                               // 0x0(0x28)
	bool                                                         DefaultValue;                                      // 0x28(0x1)
	char                                                         pad0x7_M0XXP[0x7];                                 // 0x29(0x7)
};
...
public:
	...
	char                                                         pad0xc_871YK[0xc];                                 // 0x2c(0xc)
	bool                                                         bSuccessfullySensed;                               // 0x38(0x1)
	char                                                         pad0x3_F4H64[0x3];                                 // 0x39(0x3)
};
...
{
public:
	char                                                         pad0x30_QF0BR[0x30];                               // 0x0(0x30)
};
...
public:
	...
	char                                                         pad0x2d8_SKCIQ[0x2d8];                             // 0x8(0x2d8)
};
...
public:
	...
	char                                                         pad0x10_QTQVX[0x10];                               // 0x8(0x10)
};
...
{
public:
	char                                                         pad0x10_Y1D94[0x10];                               // 0x0(0x10)
...
public:
	...
	char                                                         pad0x38_RH3NE[0x38];                               // 0x8(0x38)
};
...
public:
	...
	char                                                         pad0x8_ULK67[0x8];                                 // 0x10(0x8)
};
...
{
public:
	char                                                         pad0x28_RW4WC[0x28];                               // 0x0(0x28)
	float                                                        DefaultValue;                                      // 0x28(0x4)
	char                                                         pad0x4_MUXUM[0x4];                                 // 0x2c(0x4)
};
...
public:
	...
	char                                                         pad0x7_1SCIH[0x7];                                 // 0x11(0x7)
};
...
{
public:
	char                                                         pad0x28_2RPUS[0x28];                               // 0x0(0x28)
...
public:
	...
	char                                                         pad0x1_Q73MY[0x1];                                 // 0x1(0x1)
	char                                                         pad0x2_J1IL4[0x2];                                 // 0x2(0x2)
};
...
public:
	...
	char                                                         pad0x4_VRWJU[0x4];                                 // 0x1c(0x4)
...
{
public:
	char                                                         pad0x20_CKPMY[0x20];                               // 0x0(0x20)
...
public:
	...
	char                                                         pad0x3_W2004[0x3];                                 // 0x21(0x3)
	bool                                                         bNoneIsAllowedValue;                               // 0x24(0x1)
	char                                                         pad0x3_DU8F3[0x3];                                 // 0x25(0x3)
};
...
{
public:
	char                                                         pad0x28_7LW4I[0x28];                               // 0x0(0x28)
	int                                                          DefaultValue;                                      // 0x28(0x4)
	char                                                         pad0x4_UTG0G[0x4];                                 // 0x2c(0x4)
};
...
public:
	...
	char                                                         pad0x8_02W48[0x8];                                 // 0x10(0x8)
};
...
{
public:
	char                                                         pad0x10_D4V1M[0x10];                               // 0x0(0x10)
	class UClass*                                                ItemType;                                          // 0x10(0x8)
	char                                                         pad0x14_8ZKTW[0x14];                               // 0x18(0x14)
	int                                                          OptionIndex;                                       // 0x2c(0x4)
	int                                                          QueryID;                                           // 0x30(0x4)
	char                                                         pad0xc_592OD[0xc];                                 // 0x34(0xc)
};
...
public:
	...
	char                                                         pad0x7_LG7JN[0x7];                                 // 0x19(0x7)
};
...
public:
	...
	char                                                         pad0x7_N9NSR[0x7];                                 // 0x19(0x7)
};
