...
public:
	...
	char                                                         pad0x3_7FOI9[0x3];                                 // 0x21(0x3)
...
{
public:
	char                                                         pad0x18_YU94K[0x18];                               // 0x0(0x18)
};
...
public:
	...
	char                                                         pad0x2_HHNN3[0x2];                                 // 0x22(0x2)
};
...
public:
	...
	char                                                         pad0x2_V5HQJ[0x2];                                 // 0xd2(0x2)
	int                                                          Value;                                             // 0xd4(0x4)
...
public:
	...
	char                                                         PlayMode;                                          // 0xd0(0x1)
	char                                                         PlayModeVariant;                                   // 0xd1(0x1)
	char                                                         pad0x6_MLCH2[0x6];                                 // 0xd2(0x6)
	double                                                       CreatedAt;                                         // 0xd8(0x8)
};
...
public:
	...
	char                                                         pad0x3_7ZLF0[0x3];                                 // 0x2d(0x3)
...
public:
	...
	char                                                         pad0x10_X41K2[0x10];                               // 0x10(0x10)
};
...
public:
	...
	char                                                         pad0x7_O5BVQ[0x7];                                 // 0x11(0x7)
