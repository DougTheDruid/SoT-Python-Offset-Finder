...
{
public:
	char                                                         pad0x18_ES38I[0x18];                               // 0x0(0x18)
};
...
public:
	...
	char                                                         pad0x3_HGCJM[0x3];                                 // 0x21(0x3)
...
public:
	...
	char                                                         pad0x2_IEASL[0x2];                                 // 0x22(0x2)
};
...
public:
	...
	char                                                         pad0x2_DXL9H[0x2];                                 // 0xd2(0x2)
	int                                                          Value;                                             // 0xd4(0x4)
...
public:
	...
	char                                                         pad0x10_CV5FS[0x10];                               // 0x10(0x10)
};
...
public:
	...
	char                                                         PlayMode;                                          // 0xd0(0x1)
	char                                                         PlayModeVariant;                                   // 0xd1(0x1)
	char                                                         pad0x6_WCXZ3[0x6];                                 // 0xd2(0x6)
	double                                                       CreatedAt;                                         // 0xd8(0x8)
};
...
public:
	...
	char                                                         pad0x3_L60EP[0x3];                                 // 0x2d(0x3)
...
public:
	...
	char                                                         pad0x7_SXRDF[0x7];                                 // 0x11(0x7)
