...
{
public:
	struct                                                       SeasonId;                                          // 0x0(0x10)
	struct                                                       GoalId;                                            // 0x10(0x10)
	char                                                         GoalType;                                          // 0x20(0x1)
	struct                                                       GoalGroupId;                                       // 0x24(0x10)
};
...
public:
	...
	struct                                                       SeasonId;                                          // 0xc(0x10)
	struct                                                       GoalId;                                            // 0x1c(0x10)
	char                                                         GoalType;                                          // 0x2c(0x1)
	struct                                                       GoalGroupId;                                       // 0x30(0x10)
};
...
public:
	struct                                                       ObjectiveId;                                       // 0x0(0x10)
	struct                                                       PirateIdentity;                                    // 0x10(0x78)
	struct                                                       PlayerInfo;                                        // 0x88(0x48)
