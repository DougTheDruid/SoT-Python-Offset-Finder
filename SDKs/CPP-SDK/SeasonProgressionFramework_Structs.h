...
public:
	...
	char                                                         pad0x7_L4YSO[0x7];                                 // 0x11(0x7)
...
public:
	...
	char                                                         pad0x3_KRY1B[0x3];                                 // 0x21(0x3)
...
public:
	...
	char                                                         pad0x3_I7OLP[0x3];                                 // 0x2d(0x3)
...
public:
	...
	char                                                         pad0x6_3BV3W[0x6];                                 // 0xd2(0x6)
...
public:
	...
	byte                                                         PlayMode;                                          // 0xd0(0x1)
	byte                                                         PlayModeVariant;                                   // 0xd1(0x1)
	char                                                         pad0x2_D58LE[0x2];                                 // 0xd2(0x2)
	int                                                          Value;                                             // 0xd4(0x4)
	double                                                       CreatedAt;                                         // 0xd8(0x8)
};
