...
{
public:
	char                                                         pad0x8_URSOL[0x8];                                 // 0xb8(0x8)
	...
	char                                                         pad0x3_ZGFZ1[0x3];                                 // 0x1b9(0x3)
	...
	char                                                         pad0x4_QWSX7[0x4];                                 // 0x254(0x4)
	class UClass*                                                DamagerTypeClass;                                  // 0x258(0x8)
	char                                                         HealthChangedReason;                               // 0x260(0x1)
	char                                                         pad0x7_Z3VBN[0x7];                                 // 0x261(0x7)
	char                                                         pad0x78_10VBB[0x78];                               // 0x268(0x78)
};
...
public:
	...
	char                                                         pad0x3_NW7H3[0x3];                                 // 0x489(0x3)
	...
	char                                                         pad0x3_QBEY4[0x3];                                 // 0x571(0x3)
	float                                                        ReplicatedAnimationTime;                           // 0x574(0x4)
	char                                                         pad0x20_GIJBD[0x20];                               // 0x578(0x20)
	struct FName                                                 LeverCooldownRtpcName;                             // 0x598(0x8)
	char                                                         pad0x30_AVVO0[0x30];                               // 0x5a0(0x30)
};
