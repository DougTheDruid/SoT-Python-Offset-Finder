...
public:
	...
	struct                                                       FireGridCellSelectionParams;                       // 0xc(0x44)
};
...
{
public:
	struct                                                       LightPositionOffset;                               // 0x30(0xc)
...
public:
	...
	struct                                                       AdditionalGridOffsetForCharring;                   // 0x10(0xc)
...
public:
	...
	struct                                                       SidewaysPropagationTimeOverride;                   // 0x14(0x10)
	struct                                                       UpwardPropagationTimeOverride;                     // 0x24(0x10)
	struct                                                       DownwardPropagationTimeOverride;                   // 0x34(0x10)
};
...
{
public:
	struct                                                       KindleTime;                                        // 0x0(0x10)
	struct                                                       BurningTime;                                       // 0x10(0x10)
	struct                                                       RainExposureTime;                                  // 0x20(0x10)
	float                                                        CharringTime;                                      // 0x30(0x4)
	struct                                                       SmoulderingTime;                                   // 0x34(0x10)
	struct                                                       SteamingTime;                                      // 0x44(0x10)
	struct                                                       WetTime;                                           // 0x54(0x10)
	struct                                                       SidewaysPropagationTime;                           // 0x64(0x10)
	struct                                                       UpwardPropagationTime;                             // 0x74(0x10)
	struct                                                       DownwardPropagationTime;                           // 0x84(0x10)
};
...
{
public:
	struct                                                       InitialIgnitionTime;                               // 0x0(0x10)
	struct                                                       SuccessIgnitionTime;                               // 0x10(0x10)
	struct                                                       FailureIgnitionTime;                               // 0x20(0x10)
	float                                                        ChanceToIgnite;                                    // 0x30(0x4)
	struct                                                       IgnitionSelection;                                 // 0x34(0x44)
};
...
{
public:
	struct                                                       ExtinguishLocation;                                // 0x0(0xc)
};
...
{
public:
	struct                                                       Template;                                          // 0x0(0x38)
	struct                                                       CellDesc;                                          // 0x40(0x100)
};
...
public:
	...
	struct                                                       ParticleTemplate;                                  // 0x10(0x38)
};
...
public:
	...
	struct                                                       TimeInFireBeforeDamage;                            // 0x20(0x10)
...
public:
	...
	interface                                                    KnockbackInterface;                                // 0x30(0x10)
};
...
public:
	...
	struct                                                       LowFrequencyParticleSpawnSettings;                 // 0x30(0x10)
...
public:
	...
	struct                                                       BoundingBox;                                       // 0xc(0x1c)
	struct                                                       GridPosition;                                      // 0x28(0xc)
	...
	struct                                                       DefaultParticleEffectSpawnTransform;               // 0x50(0x30)
	struct                                                       DefaultParticleEffectPlane;                        // 0x80(0x10)
	TArray<struct FireCellStateParticleTemplate>                 CustomParticleEffectTemplates;                     // 0x90(0x10)
	struct                                                       CustomParticleEffectSpawnTransform;                // 0xa0(0x30)
...
public:
	...
	struct                                                       LightTemplate;                                     // 0x10(0xd0)
