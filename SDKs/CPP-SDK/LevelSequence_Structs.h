...
{
public:
	char                                                         pad0x20_GEHLF[0x20];                               // 0x0(0x20)
	struct FString                                               ComponentName;                                     // 0x20(0x10)
	char                                                         pad0x8_O41YP[0x8];                                 // 0x30(0x8)
};
...
{
public:
	char                                                         pad0x20_YUKVK[0x20];                               // 0x0(0x20)
};
...
{
public:
	char                                                         pad0xa0_QRJR2[0xa0];                               // 0x0(0xa0)
};
...
{
public:
	char                                                         pad0x28_VN6T3[0x28];                               // 0x0(0x28)
};
