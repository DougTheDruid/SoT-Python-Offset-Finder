...
{
public:
	char                                                         pad0x20_DE2MD[0x20];                               // 0x0(0x20)
};
...
{
public:
	char                                                         pad0xa0_72EBD[0xa0];                               // 0x0(0xa0)
};
...
{
public:
	char                                                         pad0x20_DQILZ[0x20];                               // 0x0(0x20)
	struct FString                                               ComponentName;                                     // 0x20(0x10)
	char                                                         pad0x8_1MBX9[0x8];                                 // 0x30(0x8)
};
...
{
public:
	char                                                         pad0x28_GVUSD[0x28];                               // 0x0(0x28)
};
