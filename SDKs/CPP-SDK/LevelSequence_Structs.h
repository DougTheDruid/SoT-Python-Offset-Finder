...
{
public:
	char                                                         pad0x20_R3LQT[0x20];                               // 0x0(0x20)
	struct FString                                               ComponentName;                                     // 0x20(0x10)
	char                                                         pad0x8_D9XZT[0x8];                                 // 0x30(0x8)
};
...
{
public:
	char                                                         pad0x28_8S5SR[0x28];                               // 0x0(0x28)
};
...
{
public:
	char                                                         pad0x20_8PN47[0x20];                               // 0x0(0x20)
};
...
{
public:
	char                                                         pad0xa0_WZ4D7[0xa0];                               // 0x0(0xa0)
};
