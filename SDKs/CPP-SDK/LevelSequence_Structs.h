...
{
public:
	char                                                         pad0x28_S40WW[0x28];                               // 0x0(0x28)
};
...
{
public:
	char                                                         pad0x20_LM4BV[0x20];                               // 0x0(0x20)
	struct FString                                               ComponentName;                                     // 0x20(0x10)
	char                                                         pad0x8_HF6UM[0x8];                                 // 0x30(0x8)
};
...
{
public:
	char                                                         pad0x20_6HPK3[0x20];                               // 0x0(0x20)
};
...
{
public:
	char                                                         pad0xa0_JPSOU[0xa0];                               // 0x0(0xa0)
};
