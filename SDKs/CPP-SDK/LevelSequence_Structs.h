...
{
public:
	char                                                         pad0xa0_T9TS7[0xa0];                               // 0x0(0xa0)
};
...
{
public:
	char                                                         pad0x20_PLIO6[0x20];                               // 0x0(0x20)
	struct FString                                               ComponentName;                                     // 0x20(0x10)
	char                                                         pad0x8_03TQH[0x8];                                 // 0x30(0x8)
};
...
{
public:
	char                                                         pad0x20_T0OJL[0x20];                               // 0x0(0x20)
};
...
{
public:
	char                                                         pad0x28_H2HUE[0x28];                               // 0x0(0x28)
};
