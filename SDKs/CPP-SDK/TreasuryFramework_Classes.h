...
{
public:
	char                                                         pad0x8_0DAKF[0x8];                                 // 0x410(0x8)
};
...
{
public:
	char                                                         pad0x8_JQ661[0x8];                                 // 0x410(0x8)
};
...
{
public:
	char                                                         pad0x20_UQ4HP[0x20];                               // 0x480(0x20)
};
...
{
public:
	char                                                         pad0xa8_7WZ8S[0xa8];                               // 0x3a0(0xa8)
};
...
{
public:
	char                                                         pad0x10_LUOQ5[0x10];                               // 0x4d8(0x10)
	...
	char                                                         pad0x70_D1HPW[0x70];                               // 0x518(0x70)
};
...
{
public:
	char                                                         pad0x20_IBJR8[0x20];                               // 0x3a0(0x20)
	...
	char                                                         pad0x4_O0RBC[0x4];                                 // 0x4e4(0x4)
	...
	char                                                         pad0x18_J2IVK[0x18];                               // 0x5d0(0x18)
};
