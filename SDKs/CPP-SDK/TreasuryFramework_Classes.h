...
{
public:
	char                                                         pad0x30_5Y9HZ[0x30];                               // 0x4c0(0x30)
};
...
{
public:
	char                                                         pad0x8_1PMO0[0x8];                                 // 0x410(0x8)
};
...
{
public:
	char                                                         pad0x10_PW8AF[0x10];                               // 0x4d8(0x10)
	...
	char                                                         pad0x70_BPNAM[0x70];                               // 0x518(0x70)
};
...
{
public:
	char                                                         pad0xa8_EC5CQ[0xa8];                               // 0x3a0(0xa8)
};
...
{
public:
	char                                                         pad0x8_G85RV[0x8];                                 // 0x410(0x8)
};
...
{
public:
	char                                                         pad0x20_P6L0Q[0x20];                               // 0x3a0(0x20)
	...
	char                                                         pad0x4_RTA3R[0x4];                                 // 0x4e4(0x4)
	...
	char                                                         pad0x18_OHVQ5[0x18];                               // 0x5d0(0x18)
};
