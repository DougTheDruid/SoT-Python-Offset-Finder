...
{
public:
	char                                                         pad0x8_LCI11[0x8];                                 // 0x410(0x8)
};
...
{
public:
	char                                                         pad0x10_8TY0H[0x10];                               // 0x4d8(0x10)
	...
	char                                                         pad0x70_00XG1[0x70];                               // 0x518(0x70)
};
...
{
public:
	char                                                         pad0xa8_1NJTA[0xa8];                               // 0x3a0(0xa8)
};
...
{
public:
	char                                                         pad0x30_ABLRJ[0x30];                               // 0x4c0(0x30)
};
...
{
public:
	char                                                         pad0x8_61IVU[0x8];                                 // 0x410(0x8)
};
...
{
public:
	char                                                         pad0x20_E7UX2[0x20];                               // 0x3a0(0x20)
	...
	char                                                         pad0x4_GGW5M[0x4];                                 // 0x4e4(0x4)
	...
	char                                                         pad0x18_EGRP4[0x18];                               // 0x5d0(0x18)
};
