...
{
public:
	char                                                         pad0x28_D5GGN[0x28];                               // 0x0(0x28)
	char                                                         TutorialStarterType;                               // 0x28(0x1)
	char                                                         pad0x7_2YZOT[0x7];                                 // 0x29(0x7)
};
...
public:
	...
	char                                                         pad0x4_EXGW5[0x4];                                 // 0x34(0x4)
};
...
{
public:
	char                                                         pad0x18_FZSRA[0x18];                               // 0x0(0x18)
	bool                                                         HasTaleCheckpointVoyage;                           // 0x18(0x1)
	char                                                         pad0x7_WASY1[0x7];                                 // 0x19(0x7)
};
...
public:
	...
	char                                                         pad0x6_RCMEY[0x6];                                 // 0x22(0x6)
};
...
{
public:
	char                                                         pad0x1_J0WX7[0x1];                                 // 0x0(0x1)
};


// Size 0x10
struct RequestShowPlayerTutorialToUI
{
public:
...
{
public:
	char                                                         pad0x20_GFJFI[0x20];                               // 0x0(0x20)
