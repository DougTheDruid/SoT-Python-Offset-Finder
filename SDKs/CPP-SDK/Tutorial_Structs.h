...
{
public:
	char                                                         pad0x28_GY0SN[0x28];                               // 0x0(0x28)
	char                                                         TutorialStarterType;                               // 0x28(0x1)
	char                                                         pad0x7_WATCB[0x7];                                 // 0x29(0x7)
};
...
public:
	...
	char                                                         pad0x4_7PPI5[0x4];                                 // 0x34(0x4)
};
...
{
public:
	char                                                         pad0x20_WJQP6[0x20];                               // 0x0(0x20)
...
public:
	...
	char                                                         pad0x6_61A94[0x6];                                 // 0x22(0x6)
};
...
{
public:
	char                                                         pad0x18_35KX1[0x18];                               // 0x0(0x18)
	bool                                                         HasTaleCheckpointVoyage;                           // 0x18(0x1)
	char                                                         pad0x7_B8ZHS[0x7];                                 // 0x19(0x7)
};
