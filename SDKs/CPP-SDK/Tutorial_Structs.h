...
{
public:
	char                                                         pad0x18_FG876[0x18];                               // 0x0(0x18)
	bool                                                         HasTaleCheckpointVoyage;                           // 0x18(0x1)
	char                                                         pad0x7_ZFTU1[0x7];                                 // 0x19(0x7)
};
...
{
public:
	char                                                         pad0x28_AMHQ6[0x28];                               // 0x0(0x28)
	char                                                         TutorialStarterType;                               // 0x28(0x1)
	char                                                         pad0x7_2T5NA[0x7];                                 // 0x29(0x7)
};
...
public:
	...
	char                                                         pad0x6_3D45O[0x6];                                 // 0x22(0x6)
};
...
public:
	...
	char                                                         pad0x4_4LA4C[0x4];                                 // 0x34(0x4)
};
...
{
public:
	char                                                         pad0x20_R4MU3[0x20];                               // 0x0(0x20)
