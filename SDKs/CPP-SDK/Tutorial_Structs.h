...
{
public:
	char                                                         pad0x18_1NZF3[0x18];                               // 0x0(0x18)
	bool                                                         HasTaleCheckpointVoyage;                           // 0x18(0x1)
	char                                                         pad0x7_5PITC[0x7];                                 // 0x19(0x7)
};
...
{
public:
	char                                                         pad0x28_MOW18[0x28];                               // 0x0(0x28)
	char                                                         TutorialStarterType;                               // 0x28(0x1)
	char                                                         pad0x7_P86S7[0x7];                                 // 0x29(0x7)
};
...
{
public:
	char                                                         pad0x20_1FVA7[0x20];                               // 0x0(0x20)
...
public:
	...
	char                                                         pad0x4_2BP6H[0x4];                                 // 0x34(0x4)
};
...
public:
	...
	char                                                         pad0x6_QIKV8[0x6];                                 // 0x22(0x6)
};
