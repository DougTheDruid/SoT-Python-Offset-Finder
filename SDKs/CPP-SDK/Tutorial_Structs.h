...
public:
	...
	char                                                         pad0x6_MB0J3[0x6];                                 // 0x22(0x6)
};
...
{
public:
	char                                                         pad0x28_WG977[0x28];                               // 0x0(0x28)
	char                                                         TutorialStarterType;                               // 0x28(0x1)
	char                                                         pad0x7_MC5TM[0x7];                                 // 0x29(0x7)
};
...
{
public:
	char                                                         pad0x18_IOUVV[0x18];                               // 0x0(0x18)
	bool                                                         HasTaleCheckpointVoyage;                           // 0x18(0x1)
	char                                                         pad0x7_O75MO[0x7];                                 // 0x19(0x7)
};
...
public:
	...
	char                                                         pad0x4_MS1KC[0x4];                                 // 0x34(0x4)
};
...
{
public:
	char                                                         pad0x20_0174M[0x20];                               // 0x0(0x20)
