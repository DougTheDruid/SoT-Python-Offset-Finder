...
{
public:
	char                                                         pad0x18_S2UZI[0x18];                               // 0x440(0x18)
	...
	char                                                         pad0xc_WYVR0[0xc];                                 // 0x57c(0xc)
	...
	char                                                         pad0x4_PNYXG[0x4];                                 // 0x59c(0x4)
	...
	char                                                         pad0x8_50W7G[0x8];                                 // 0x5c0(0x8)
	bool                                                         AnimationsLoaded;                                  // 0x5c8(0x1)
	char                                                         pad0x3_45K7J[0x3];                                 // 0x5c9(0x3)
	float                                                        AimUpAlpha;                                        // 0x5cc(0x4)
	float                                                        AimDownAlpha;                                      // 0x5d0(0x4)
	char                                                         pad0x4_YJJMT[0x4];                                 // 0x5d4(0x4)
	...
	char                                                         pad0x88_L5FB1[0x88];                               // 0x6d6(0x88)
};
