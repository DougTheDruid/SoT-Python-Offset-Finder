...
{
public:
	char                                                         pad0x18_E59HP[0x18];                               // 0x440(0x18)
	...
	char                                                         pad0xc_EU71L[0xc];                                 // 0x57c(0xc)
	...
	char                                                         pad0x4_UJ8E3[0x4];                                 // 0x59c(0x4)
	...
	char                                                         pad0x8_QEI0D[0x8];                                 // 0x5c0(0x8)
	bool                                                         AnimationsLoaded;                                  // 0x5c8(0x1)
	char                                                         pad0x3_BWS3S[0x3];                                 // 0x5c9(0x3)
	float                                                        AimUpAlpha;                                        // 0x5cc(0x4)
	float                                                        AimDownAlpha;                                      // 0x5d0(0x4)
	char                                                         pad0x4_VGRYY[0x4];                                 // 0x5d4(0x4)
	...
	char                                                         pad0x38_9HWRT[0x38];                               // 0x6d8(0x38)
};
