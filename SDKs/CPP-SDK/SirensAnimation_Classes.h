...
{
public:
	char                                                         pad0x18_2E1ZV[0x18];                               // 0x440(0x18)
	...
	char                                                         pad0xc_KVAU2[0xc];                                 // 0x57c(0xc)
	...
	char                                                         pad0x4_SL7JW[0x4];                                 // 0x59c(0x4)
	...
	char                                                         pad0x8_1T75A[0x8];                                 // 0x5c0(0x8)
	bool                                                         AnimationsLoaded;                                  // 0x5c8(0x1)
	char                                                         pad0x3_2N68T[0x3];                                 // 0x5c9(0x3)
	float                                                        AimUpAlpha;                                        // 0x5cc(0x4)
	float                                                        AimDownAlpha;                                      // 0x5d0(0x4)
	char                                                         pad0x4_9I91V[0x4];                                 // 0x5d4(0x4)
	...
	char                                                         pad0x38_0LZB2[0x38];                               // 0x6d8(0x38)
};
