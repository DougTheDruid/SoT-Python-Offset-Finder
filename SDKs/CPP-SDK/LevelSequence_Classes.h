...
{
public:
	char                                                         pad0x8_VK564[0x8];                                 // 0x3c8(0x8)
	bool                                                         bAutoPlay;                                         // 0x3d0(0x1)
	char                                                         pad0x7_PAWL0[0x7];                                 // 0x3d1(0x7)
...
public:
	...
	char                                                         pad0x50_KC5FW[0x50];                               // 0x350(0x50)
};
...
public:
	...
	char                                                         pad0x38_IYWIK[0x38];                               // 0x610(0x38)
};
...
public:
	...
	char                                                         pad0x7_A0NZ6[0x7];                                 // 0x29(0x7)
