...
public:
	...
	char                                                         pad0x7_E8A9Q[0x7];                                 // 0x29(0x7)
...
{
public:
	char                                                         pad0x8_1HIG7[0x8];                                 // 0x3a0(0x8)
	bool                                                         bAutoPlay;                                         // 0x3a8(0x1)
	char                                                         pad0x7_X6XC4[0x7];                                 // 0x3a9(0x7)
...
public:
	...
	char                                                         pad0x50_BT4HQ[0x50];                               // 0x350(0x50)
};
...
public:
	...
	char                                                         pad0x38_7DHKD[0x38];                               // 0x610(0x38)
};
