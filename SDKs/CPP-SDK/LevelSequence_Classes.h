...
public:
	...
	char                                                         pad0x50_OV4BY[0x50];                               // 0x350(0x50)
};
...
public:
	...
	char                                                         pad0x38_8WXNN[0x38];                               // 0x610(0x38)
};
...
public:
	...
	char                                                         pad0x7_VMI1B[0x7];                                 // 0x29(0x7)
...
{
public:
	char                                                         pad0x8_BBG3H[0x8];                                 // 0x3c8(0x8)
	bool                                                         bAutoPlay;                                         // 0x3d0(0x1)
	char                                                         pad0x7_O743D[0x7];                                 // 0x3d1(0x7)
