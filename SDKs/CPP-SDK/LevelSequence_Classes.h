...
public:
	...
	char                                                         pad0x50_ZWAFE[0x50];                               // 0x350(0x50)
};
...
public:
	...
	char                                                         pad0x38_TU2D0[0x38];                               // 0x610(0x38)
};
...
public:
	...
	char                                                         pad0x7_A8JN7[0x7];                                 // 0x29(0x7)
...
{
public:
	char                                                         pad0x8_AOZ9Q[0x8];                                 // 0x3c8(0x8)
	bool                                                         bAutoPlay;                                         // 0x3d0(0x1)
	char                                                         pad0x7_CM9PR[0x7];                                 // 0x3d1(0x7)
