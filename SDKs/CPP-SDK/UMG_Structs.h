...
{
public:
	char                                                         pad0x18_R81CS[0x18];                               // 0x0(0x18)
	struct MovieScenePropertySectionData                         PropertyData;                                      // 0x18(0x20)
...
public:
	...
	char                                                         pad0x3_U25D1[0x3];                                 // 0x21(0x3)
};
...
{
public:
	char                                                         pad0x48_258V9[0x48];                               // 0x0(0x48)
...
public:
	char                                                         Rule;                                              // 0x0(0x1)
	char                                                         pad0x3_FQ6U1[0x3];                                 // 0x1(0x3)
	struct FName                                                 WidgetToFocus;                                     // 0x4(0x8)
	char                                                         pad0x8_STBF8[0x8];                                 // 0xc(0x8)
};
...
{
public:
	char                                                         pad0xe8_YAVGL[0xe8];                               // 0x0(0xe8)
};
...
{
public:
	char                                                         pad0x30_HYZ8K[0x30];                               // 0x0(0x30)
};
...
public:
	...
	char                                                         Kind;                                              // 0x30(0x1)
	char                                                         pad0x7_468F2[0x7];                                 // 0x31(0x7)
};
