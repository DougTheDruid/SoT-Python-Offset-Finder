...
public:
	...
	char                                                         pad0x3_K4S8J[0x3];                                 // 0x21(0x3)
};
...
{
public:
	char                                                         pad0x18_2LXUA[0x18];                               // 0x0(0x18)
...
{
public:
	char                                                         pad0x30_FRGTG[0x30];                               // 0x0(0x30)
};
...
{
public:
	char                                                         pad0xe8_VV712[0xe8];                               // 0x0(0xe8)
};
...
public:
	char                                                         Rule;                                              // 0x0(0x1)
	char                                                         pad0x3_5DMQV[0x3];                                 // 0x1(0x3)
	struct FName                                                 WidgetToFocus;                                     // 0x4(0x8)
	char                                                         pad0x8_DPJ07[0x8];                                 // 0xc(0x8)
};
...
{
public:
	char                                                         pad0x48_CXUQO[0x48];                               // 0x0(0x48)
...
public:
	...
	char                                                         Kind;                                              // 0x30(0x1)
	char                                                         pad0x7_LNDFH[0x7];                                 // 0x31(0x7)
};
