...
{
public:
	char                                                         pad0x30_QCF78[0x30];                               // 0x0(0x30)
};
...
{
public:
	char                                                         pad0x18_Q9CQ2[0x18];                               // 0x0(0x18)
...
{
public:
	char                                                         pad0x48_FIU6W[0x48];                               // 0x0(0x48)
...
public:
	char                                                         Rule;                                              // 0x0(0x1)
	char                                                         pad0x3_GE3F0[0x3];                                 // 0x1(0x3)
	struct FName                                                 WidgetToFocus;                                     // 0x4(0x8)
	char                                                         pad0x8_7FWS8[0x8];                                 // 0xc(0x8)
};
...
public:
	...
	char                                                         pad0x3_3VV8O[0x3];                                 // 0x21(0x3)
};
...
{
public:
	char                                                         pad0xe8_8IJ08[0xe8];                               // 0x0(0xe8)
};
...
public:
	...
	char                                                         Kind;                                              // 0x30(0x1)
	char                                                         pad0x7_GXG3S[0x7];                                 // 0x31(0x7)
};
