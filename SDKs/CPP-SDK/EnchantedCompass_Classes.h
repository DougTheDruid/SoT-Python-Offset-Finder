...
public:
	...
	char                                                         pad0x8_O8YJR[0x8];                                 // 0x918(0x8)
};
...
{
public:
	char                                                         pad0x10_76CAJ[0x10];                               // 0x98(0x10)
};
...
public:
	...
	char                                                         pad0x4_09Q1H[0x4];                                 // 0xcc(0x4)
	bool                                                         IsSettingEnabled;                                  // 0x110(0x1)
	char                                                         pad0xef_UC84A[0xef];                               // 0x111(0xef)
};
...
{
public:
	char                                                         pad0x8_QC5TI[0x8];                                 // 0x98(0x8)
};
...
{
public:
	char                                                         pad0x8_701W6[0x8];                                 // 0x1d8(0x8)
};
...
{
public:
	char                                                         pad0x20_DYIVM[0x20];                               // 0x170(0x20)
};
...
{
public:
	char                                                         pad0x60_C0BPS[0x60];                               // 0x98(0x60)
};
...
public:
	...
	char                                                         pad0x7_LE28R[0x7];                                 // 0x81(0x7)
};
