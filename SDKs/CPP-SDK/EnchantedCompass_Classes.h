...
{
public:
	char                                                         pad0x10_8DN5I[0x10];                               // 0x98(0x10)
};
...
public:
	...
	char                                                         pad0x4_CK0VQ[0x4];                                 // 0xcc(0x4)
	bool                                                         IsSettingEnabled;                                  // 0x110(0x1)
	char                                                         pad0xef_4WR60[0xef];                               // 0x111(0xef)
};
...
{
public:
	char                                                         pad0x8_1ZJ2D[0x8];                                 // 0x1d8(0x8)
};
...
{
public:
	char                                                         pad0x20_Y4B1R[0x20];                               // 0x170(0x20)
};
...
{
public:
	char                                                         pad0x60_K1OJE[0x60];                               // 0x98(0x60)
};
...
{
public:
	char                                                         pad0x8_W15CH[0x8];                                 // 0x98(0x8)
};
...
public:
	...
	char                                                         pad0x7_86FT9[0x7];                                 // 0x81(0x7)
};
...
public:
	...
	char                                                         pad0x8_TQKIK[0x8];                                 // 0x918(0x8)
};
