...
{
public:
	char                                                         pad0x60_6JNOU[0x60];                               // 0x98(0x60)
};
...
public:
	...
	char                                                         pad0x4_DJBK9[0x4];                                 // 0xdc(0x4)
	bool                                                         IsSettingEnabled;                                  // 0x120(0x1)
	char                                                         pad0xef_I0V90[0xef];                               // 0x121(0xef)
};
...
public:
	...
	char                                                         pad0x8_9PQI9[0x8];                                 // 0x908(0x8)
};
...
{
public:
	char                                                         pad0x10_1XFDV[0x10];                               // 0x98(0x10)
};
...
{
public:
	char                                                         pad0x20_0Y02B[0x20];                               // 0x170(0x20)
};
...
public:
	...
	char                                                         pad0x7_XUCXT[0x7];                                 // 0x81(0x7)
};
...
{
public:
	char                                                         pad0x8_FP46D[0x8];                                 // 0x98(0x8)
};
...
{
public:
	char                                                         pad0x8_VI0LS[0x8];                                 // 0x1e8(0x8)
};
