...
class BP_FeatureIslandWashedUpResourceMerchantCratesSpawner_C: public StaticMeshComponent
{
public:
	char                                                         pad0x488_HSFYR[0x488];                             // 0x0(0x488)
