...
{
public:
	char                                                         pad0x8_4RT20[0x8];                                 // 0x0(0x8)
	struct FeatureFlag                                           Feature;                                           // 0x8(0xc)
	char                                                         pad0x4_03BER[0x4];                                 // 0x14(0x4)
};
...
{
public:
	char                                                         pad0x18_SSL9W[0x18];                               // 0x0(0x18)
};
...
{
public:
	char                                                         pad0x28_HLBRJ[0x28];                               // 0x0(0x28)
...
{
public:
	char                                                         pad0x28_CA28Z[0x28];                               // 0x0(0x28)
	char                                                         TargetMode;                                        // 0x28(0x1)
	char                                                         pad0x7_IWGK3[0x7];                                 // 0x29(0x7)
};
...
{
public:
	char                                                         pad0x28_6T1HP[0x28];                               // 0x0(0x28)
	char                                                         TargetMode;                                        // 0x28(0x1)
	char                                                         pad0x7_W068N[0x7];                                 // 0x29(0x7)
};
...
{
public:
	char                                                         pad0x20_0L9QV[0x20];                               // 0x0(0x20)
};
...
{
public:
	char                                                         pad0x18_UFFV5[0x18];                               // 0x0(0x18)
};
...
{
public:
	char                                                         pad0x20_VTTTM[0x20];                               // 0x0(0x20)
};
