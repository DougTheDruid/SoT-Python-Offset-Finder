...
{
public:
	char                                                         pad0x8_2FZUY[0x8];                                 // 0x0(0x8)
	struct FeatureFlag                                           Feature;                                           // 0x8(0xc)
	char                                                         pad0x4_PLZ44[0x4];                                 // 0x14(0x4)
};
...
{
public:
	char                                                         pad0x20_S1LI5[0x20];                               // 0x0(0x20)
};
...
{
public:
	char                                                         pad0x18_AZQ0B[0x18];                               // 0x0(0x18)
};
...
{
public:
	char                                                         pad0x20_1IC73[0x20];                               // 0x0(0x20)
};
...
{
public:
	char                                                         pad0x28_4K21G[0x28];                               // 0x0(0x28)
	char                                                         TargetMode;                                        // 0x28(0x1)
	char                                                         pad0x7_QYAFN[0x7];                                 // 0x29(0x7)
};
...
{
public:
	char                                                         pad0x28_ZSAMR[0x28];                               // 0x0(0x28)
	char                                                         TargetMode;                                        // 0x28(0x1)
	char                                                         pad0x7_F5V0D[0x7];                                 // 0x29(0x7)
};
...
{
public:
	char                                                         pad0x18_F8U3C[0x18];                               // 0x0(0x18)
};
...
{
public:
	char                                                         pad0x28_VWMMN[0x28];                               // 0x0(0x28)
