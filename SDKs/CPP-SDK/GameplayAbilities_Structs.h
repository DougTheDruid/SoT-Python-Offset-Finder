...
{
public:
	char                                                         pad0x10_OYA0Z[0x10];                               // 0x0(0x10)
	...
	char                                                         pad0x2b_A9JO2[0x2b];                               // 0x2d5(0x2b)
};
...
{
public:
	char                                                         pad0x20_JOI00[0x20];                               // 0x0(0x20)
};
...
public:
	...
	char                                                         pad0x30_IVMR1[0x30];                               // 0x78(0x30)
};
...
public:
	...
	char                                                         pad0x7_T9D44[0x7];                                 // 0x21(0x7)
};
...
public:
	...
	char                                                         pad0x18_FXG3P[0x18];                               // 0x10(0x18)
};
...
{
public:
	char                                                         pad0x20_L5SGE[0x20];                               // 0x0(0x20)
};
...
{
public:
	char                                                         pad0x10_H4BOH[0x10];                               // 0x0(0x10)
};
...
public:
	...
	char                                                         pad0x4_418KI[0x4];                                 // 0x9c(0x4)
};
...
public:
	...
	char                                                         pad0x4_P18S6[0x4];                                 // 0x8c(0x4)
};
...
{
public:
	char                                                         pad0xa8_OS8SS[0xa8];                               // 0x0(0xa8)
...
public:
	...
	char                                                         pad0x2_F2M9H[0x2];                                 // 0x16(0x2)
...
{
public:
	char                                                         pad0xa8_HIGD5[0xa8];                               // 0x0(0xa8)
	TArray<struct GameplayAbilitySpec>                           Items;                                             // 0xa8(0x10)
	char                                                         pad0x8_5EPMM[0x8];                                 // 0xb8(0x8)
};
...
{
public:
	char                                                         pad0x8_8LRRP[0x8];                                 // 0x0(0x8)
	struct GameplayAbilitySpecHandle                             Handle;                                            // 0x8(0x4)
	char                                                         pad0x4_3EXOK[0x4];                                 // 0xc(0x4)
	...
	char                                                         pad0x5_P90G9[0x5];                                 // 0x2b(0x5)
	...
	char                                                         pad0x3_W6O9P[0x3];                                 // 0x75(0x3)
};
...
{
public:
	char                                                         pad0x18_EZKCT[0x18];                               // 0x0(0x18)
};
...
public:
	float                                                        Value;                                             // 0x0(0x4)
	char                                                         pad0x4_B3W1A[0x4];                                 // 0x4(0x4)
	struct CurveTableRowHandle                                   Curve;                                             // 0x8(0x10)
	char                                                         pad0x8_R2XC5[0x8];                                 // 0x18(0x8)
};
...
{
public:
	char                                                         pad0x10_09BVA[0x10];                               // 0x0(0x10)
};
...
{
public:
	char                                                         pad0x10_1S3UI[0x10];                               // 0x0(0x10)
...
{
public:
	char                                                         pad0x10_F2P1C[0x10];                               // 0x0(0x10)
	byte                                                         LocationType;                                      // 0x10(0x1)
	char                                                         pad0xf_KFLOE[0xf];                                 // 0x11(0xf)
...
{
public:
	char                                                         pad0x10_OLHLU[0x10];                               // 0x0(0x10)
	struct GameplayAbilityTargetingLocationInfo                  SourceLocation;                                    // 0x10(0x70)
...
{
public:
	char                                                         pad0x38_CE4FH[0x38];                               // 0x0(0x38)
};
...
{
public:
	char                                                         pad0x50_99BMM[0x50];                               // 0x0(0x50)
};
...
{
public:
	char                                                         pad0x18_S05H1[0x18];                               // 0x0(0x18)
	...
	char                                                         pad0x10_DHIJV[0x10];                               // 0xc0(0x10)
};
...
public:
	...
	char                                                         pad0x7_U16D5[0x7];                                 // 0x81(0x7)
...
public:
	...
	char                                                         pad0x7_7NZXX[0x7];                                 // 0x11(0x7)
...
public:
	...
	char                                                         pad0x7_L1U04[0x7];                                 // 0x21(0x7)
...
public:
	...
	char                                                         pad0x8_A7E29[0x8];                                 // 0x20(0x8)
};
...
public:
	...
	char                                                         pad0x7_RJERL[0x7];                                 // 0x11(0x7)
};
...
{
public:
	char                                                         pad0x88_327ZN[0x88];                               // 0x0(0x88)
};
