...
{
public:
	char                                                         pad0x88_IXQA9[0x88];                               // 0x0(0x88)
};
...
{
public:
	char                                                         pad0x50_AU1W6[0x50];                               // 0x0(0x50)
};
...
{
public:
	char                                                         pad0x18_WYAJ2[0x18];                               // 0x0(0x18)
};
...
public:
	...
	char                                                         pad0x30_Q6G8M[0x30];                               // 0x78(0x30)
};
...
{
public:
	char                                                         pad0x10_HF99W[0x10];                               // 0x0(0x10)
};
...
public:
	...
	char                                                         pad0x8_0IH2E[0x8];                                 // 0x20(0x8)
};
...
public:
	float                                                        Value;                                             // 0x0(0x4)
	char                                                         pad0x4_EXAXJ[0x4];                                 // 0x4(0x4)
	struct CurveTableRowHandle                                   Curve;                                             // 0x8(0x10)
	char                                                         pad0x8_G7LEU[0x8];                                 // 0x18(0x8)
};
...
{
public:
	char                                                         pad0x10_IXSVD[0x10];                               // 0x0(0x10)
};
...
{
public:
	char                                                         pad0x20_E8T3K[0x20];                               // 0x0(0x20)
};
...
{
public:
	char                                                         pad0x20_6Q2F7[0x20];                               // 0x0(0x20)
};
...
{
public:
	char                                                         pad0x38_NPN2V[0x38];                               // 0x0(0x38)
};
...
{
public:
	char                                                         pad0x10_8KG6T[0x10];                               // 0x0(0x10)
	char                                                         LocationType;                                      // 0x10(0x1)
	char                                                         pad0xf_ZYWZY[0xf];                                 // 0x11(0xf)
...
public:
	...
	char                                                         pad0x4_S1HUW[0x4];                                 // 0x9c(0x4)
};
...
{
public:
	char                                                         pad0x18_E98YB[0x18];                               // 0x0(0x18)
	...
	char                                                         pad0x10_SJF2O[0x10];                               // 0xc0(0x10)
};
...
public:
	...
	char                                                         pad0x2_0YWFH[0x2];                                 // 0x16(0x2)
...
{
public:
	char                                                         pad0x10_BIT3I[0x10];                               // 0x0(0x10)
...
{
public:
	char                                                         pad0x10_83TSM[0x10];                               // 0x0(0x10)
	struct GameplayAbilityTargetingLocationInfo                  SourceLocation;                                    // 0x10(0x70)
...
public:
	...
	char                                                         pad0x7_LFVR0[0x7];                                 // 0x81(0x7)
...
public:
	...
	char                                                         pad0x7_SKVSZ[0x7];                                 // 0x11(0x7)
};
...
{
public:
	char                                                         pad0xa8_AI3AJ[0xa8];                               // 0x0(0xa8)
...
{
public:
	char                                                         pad0x8_ZGDNJ[0x8];                                 // 0x0(0x8)
	struct GameplayAbilitySpecHandle                             Handle;                                            // 0x8(0x4)
	char                                                         pad0x4_TWHGG[0x4];                                 // 0xc(0x4)
	...
	char                                                         pad0x5_T14WQ[0x5];                                 // 0x2b(0x5)
	...
	char                                                         pad0x3_Z8RP5[0x3];                                 // 0x75(0x3)
};
...
public:
	...
	char                                                         pad0x18_GS4U5[0x18];                               // 0x10(0x18)
};
...
public:
	...
	char                                                         pad0x4_ZPFIJ[0x4];                                 // 0x8c(0x4)
};
...
public:
	...
	char                                                         pad0x7_8GHZT[0x7];                                 // 0x21(0x7)
};
...
public:
	...
	char                                                         pad0x7_EY1LT[0x7];                                 // 0x21(0x7)
...
{
public:
	char                                                         pad0xa8_GN2F9[0xa8];                               // 0x0(0xa8)
	TArray<struct GameplayAbilitySpec>                           Items;                                             // 0xa8(0x10)
	char                                                         pad0x8_JVEAR[0x8];                                 // 0xb8(0x8)
};
...
public:
	...
	char                                                         pad0x7_Z8XTN[0x7];                                 // 0x11(0x7)
...
{
public:
	char                                                         pad0x10_92EZ5[0x10];                               // 0x0(0x10)
	...
	char                                                         pad0x2b_71O5R[0x2b];                               // 0x2d5(0x2b)
};
