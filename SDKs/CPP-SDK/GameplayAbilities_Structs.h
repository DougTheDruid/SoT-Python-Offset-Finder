...
{
public:
	char                                                         pad0x18_BJZPP[0x18];                               // 0x0(0x18)
};
...
{
public:
	char                                                         pad0x20_BTSHX[0x20];                               // 0x0(0x20)
};
...
{
public:
	char                                                         pad0x20_HOQO0[0x20];                               // 0x0(0x20)
};
...
public:
	...
	char                                                         pad0x30_84BQA[0x30];                               // 0x78(0x30)
};
...
{
public:
	char                                                         pad0x88_IV5U3[0x88];                               // 0x0(0x88)
};
...
public:
	...
	char                                                         pad0x8_I2FSF[0x8];                                 // 0x20(0x8)
};
...
{
public:
	char                                                         pad0x50_P47I6[0x50];                               // 0x0(0x50)
};
...
{
public:
	char                                                         pad0x10_8OENQ[0x10];                               // 0x0(0x10)
};
...
{
public:
	char                                                         pad0x38_LGX8G[0x38];                               // 0x0(0x38)
};
...
{
public:
	char                                                         pad0x10_XVGOY[0x10];                               // 0x0(0x10)
};
...
public:
	float                                                        Value;                                             // 0x0(0x4)
	char                                                         pad0x4_ZN5CQ[0x4];                                 // 0x4(0x4)
	struct CurveTableRowHandle                                   Curve;                                             // 0x8(0x10)
	char                                                         pad0x8_2QHA7[0x8];                                 // 0x18(0x8)
};
...
{
public:
	char                                                         pad0x10_0T8GB[0x10];                               // 0x0(0x10)
	char                                                         LocationType;                                      // 0x10(0x1)
	char                                                         pad0xf_E9RJ6[0xf];                                 // 0x11(0xf)
...
public:
	...
	char                                                         pad0x2_6XCMJ[0x2];                                 // 0x16(0x2)
...
{
public:
	char                                                         pad0x10_G1R7U[0x10];                               // 0x0(0x10)
...
public:
	...
	char                                                         pad0x4_5NDNE[0x4];                                 // 0x9c(0x4)
};
...
{
public:
	char                                                         pad0x18_06DTW[0x18];                               // 0x0(0x18)
	...
	char                                                         pad0x10_DB70H[0x10];                               // 0xc0(0x10)
};
...
{
public:
	char                                                         pad0x10_63Z3L[0x10];                               // 0x0(0x10)
	struct GameplayAbilityTargetingLocationInfo                  SourceLocation;                                    // 0x10(0x70)
...
{
public:
	char                                                         pad0xa8_1GS0R[0xa8];                               // 0x0(0xa8)
...
public:
	...
	char                                                         pad0x18_Q76X5[0x18];                               // 0x10(0x18)
};
...
public:
	...
	char                                                         pad0x4_53Y0C[0x4];                                 // 0x8c(0x4)
};
...
{
public:
	char                                                         pad0x8_L5267[0x8];                                 // 0x0(0x8)
	struct GameplayAbilitySpecHandle                             Handle;                                            // 0x8(0x4)
	char                                                         pad0x4_I86AM[0x4];                                 // 0xc(0x4)
	...
	char                                                         pad0x5_PFFB9[0x5];                                 // 0x2b(0x5)
	...
	char                                                         pad0x3_O77RJ[0x3];                                 // 0x75(0x3)
};
...
public:
	...
	char                                                         pad0x7_32Q2T[0x7];                                 // 0x11(0x7)
};
...
public:
	...
	char                                                         pad0x7_GMLUC[0x7];                                 // 0x81(0x7)
...
public:
	...
	char                                                         pad0x7_8MZJM[0x7];                                 // 0x21(0x7)
};
...
public:
	...
	char                                                         pad0x7_M5KZJ[0x7];                                 // 0x21(0x7)
...
{
public:
	char                                                         pad0xa8_H122D[0xa8];                               // 0x0(0xa8)
	TArray<struct GameplayAbilitySpec>                           Items;                                             // 0xa8(0x10)
	char                                                         pad0x8_O4D5M[0x8];                                 // 0xb8(0x8)
};
...
public:
	...
	char                                                         pad0x7_BV0M7[0x7];                                 // 0x11(0x7)
...
{
public:
	char                                                         pad0x10_C78GK[0x10];                               // 0x0(0x10)
	...
	char                                                         pad0x2b_JQYBM[0x2b];                               // 0x2d5(0x2b)
};
