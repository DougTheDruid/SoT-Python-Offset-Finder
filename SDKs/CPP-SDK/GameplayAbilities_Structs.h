...
public:
	float                                                        Value;                                             // 0x0(0x4)
	char                                                         pad0x4_ONRXO[0x4];                                 // 0x4(0x4)
	struct CurveTableRowHandle                                   Curve;                                             // 0x8(0x10)
	char                                                         pad0x8_JDR6Q[0x8];                                 // 0x18(0x8)
};
...
{
public:
	char                                                         pad0x10_JMLUS[0x10];                               // 0x0(0x10)
	char                                                         LocationType;                                      // 0x10(0x1)
	char                                                         pad0xf_J37GM[0xf];                                 // 0x11(0xf)
...
{
public:
	char                                                         pad0x50_ZW1T3[0x50];                               // 0x0(0x50)
};
...
{
public:
	char                                                         pad0x20_3XKVG[0x20];                               // 0x0(0x20)
};
...
public:
	...
	char                                                         pad0x8_PLCZM[0x8];                                 // 0x20(0x8)
};
...
{
public:
	char                                                         pad0x18_XLNWW[0x18];                               // 0x0(0x18)
};
...
{
public:
	char                                                         pad0x38_BOLUT[0x38];                               // 0x0(0x38)
};
...
{
public:
	char                                                         pad0x10_ML3R1[0x10];                               // 0x0(0x10)
};
...
public:
	...
	char                                                         pad0x30_3X7D7[0x30];                               // 0x78(0x30)
};
...
{
public:
	char                                                         pad0x88_AN1QB[0x88];                               // 0x0(0x88)
};
...
{
public:
	char                                                         pad0x10_7Z35J[0x10];                               // 0x0(0x10)
};
...
{
public:
	char                                                         pad0x20_GYSMV[0x20];                               // 0x0(0x20)
};
...
public:
	...
	char                                                         pad0x2_GJB1P[0x2];                                 // 0x16(0x2)
...
{
public:
	char                                                         pad0x10_K2J43[0x10];                               // 0x0(0x10)
...
public:
	...
	char                                                         pad0x4_KJJCV[0x4];                                 // 0x9c(0x4)
};
...
{
public:
	char                                                         pad0x18_85SGE[0x18];                               // 0x0(0x18)
	...
	char                                                         pad0x10_7HMA8[0x10];                               // 0xc0(0x10)
};
...
{
public:
	char                                                         pad0x10_WO6QO[0x10];                               // 0x0(0x10)
	struct GameplayAbilityTargetingLocationInfo                  SourceLocation;                                    // 0x10(0x70)
...
public:
	...
	char                                                         pad0x7_GI0LA[0x7];                                 // 0x81(0x7)
...
public:
	...
	char                                                         pad0x7_JD01I[0x7];                                 // 0x11(0x7)
};
...
{
public:
	char                                                         pad0xa8_8LKDS[0xa8];                               // 0x0(0xa8)
...
public:
	...
	char                                                         pad0x4_JN10Q[0x4];                                 // 0x8c(0x4)
};
...
{
public:
	char                                                         pad0x8_26C0E[0x8];                                 // 0x0(0x8)
	struct GameplayAbilitySpecHandle                             Handle;                                            // 0x8(0x4)
	char                                                         pad0x4_HQ1DX[0x4];                                 // 0xc(0x4)
	...
	char                                                         pad0x5_V291S[0x5];                                 // 0x2b(0x5)
	...
	char                                                         pad0x3_BINDE[0x3];                                 // 0x75(0x3)
};
...
public:
	...
	char                                                         pad0x18_4EVG2[0x18];                               // 0x10(0x18)
};
...
{
public:
	char                                                         pad0xa8_DAVIP[0xa8];                               // 0x0(0xa8)
	TArray<struct GameplayAbilitySpec>                           Items;                                             // 0xa8(0x10)
	char                                                         pad0x8_VZTUY[0x8];                                 // 0xb8(0x8)
};
...
public:
	...
	char                                                         pad0x7_94XQC[0x7];                                 // 0x21(0x7)
};
...
public:
	...
	char                                                         pad0x7_W4XAX[0x7];                                 // 0x21(0x7)
...
public:
	...
	char                                                         pad0x7_AKJND[0x7];                                 // 0x11(0x7)
...
{
public:
	char                                                         pad0x10_7W4L0[0x10];                               // 0x0(0x10)
	...
	char                                                         pad0x2b_9M5YK[0x2b];                               // 0x2d5(0x2b)
};
