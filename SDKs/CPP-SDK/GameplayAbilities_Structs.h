...
public:
	float                                                        Value;                                             // 0x0(0x4)
	char                                                         pad0x4_D3ANT[0x4];                                 // 0x4(0x4)
	struct CurveTableRowHandle                                   Curve;                                             // 0x8(0x10)
	char                                                         pad0x8_7CLS0[0x8];                                 // 0x18(0x8)
};
...
{
public:
	char                                                         pad0x20_A5GR2[0x20];                               // 0x0(0x20)
};
...
{
public:
	char                                                         pad0x10_29CNZ[0x10];                               // 0x0(0x10)
	char                                                         LocationType;                                      // 0x10(0x1)
	char                                                         pad0xf_F8TO7[0xf];                                 // 0x11(0xf)
...
{
public:
	char                                                         pad0x20_6GBK0[0x20];                               // 0x0(0x20)
};
...
{
public:
	char                                                         pad0x10_SKHK0[0x10];                               // 0x0(0x10)
};
...
{
public:
	char                                                         pad0x38_I150W[0x38];                               // 0x0(0x38)
};
...
public:
	...
	char                                                         pad0x30_X1GTQ[0x30];                               // 0x78(0x30)
};
...
{
public:
	char                                                         pad0x50_L3CFJ[0x50];                               // 0x0(0x50)
};
...
public:
	...
	char                                                         pad0x8_DYOYL[0x8];                                 // 0x20(0x8)
};
...
{
public:
	char                                                         pad0x10_KKJUZ[0x10];                               // 0x0(0x10)
};
...
{
public:
	char                                                         pad0x88_XT4N1[0x88];                               // 0x0(0x88)
};
...
{
public:
	char                                                         pad0x18_VTENY[0x18];                               // 0x0(0x18)
};
...
{
public:
	char                                                         pad0x10_3GRXT[0x10];                               // 0x0(0x10)
...
public:
	...
	char                                                         pad0x2_H42PT[0x2];                                 // 0x16(0x2)
...
{
public:
	char                                                         pad0x10_75QB8[0x10];                               // 0x0(0x10)
	struct GameplayAbilityTargetingLocationInfo                  SourceLocation;                                    // 0x10(0x70)
...
{
public:
	char                                                         pad0x18_SX4H0[0x18];                               // 0x0(0x18)
	...
	char                                                         pad0x10_SBZSD[0x10];                               // 0xc0(0x10)
};
...
public:
	...
	char                                                         pad0x4_JHBCQ[0x4];                                 // 0x9c(0x4)
};
...
public:
	...
	char                                                         pad0x4_ZRVS5[0x4];                                 // 0x8c(0x4)
};
...
public:
	...
	char                                                         pad0x18_97K4T[0x18];                               // 0x10(0x18)
};
...
{
public:
	char                                                         pad0x8_QI00S[0x8];                                 // 0x0(0x8)
	struct GameplayAbilitySpecHandle                             Handle;                                            // 0x8(0x4)
	char                                                         pad0x4_05ERD[0x4];                                 // 0xc(0x4)
	...
	char                                                         pad0x5_5V4XV[0x5];                                 // 0x2b(0x5)
	...
	char                                                         pad0x3_GGLHN[0x3];                                 // 0x75(0x3)
};
...
public:
	...
	char                                                         pad0x7_NJS2F[0x7];                                 // 0x81(0x7)
...
public:
	...
	char                                                         pad0x7_EY1U8[0x7];                                 // 0x11(0x7)
};
...
{
public:
	char                                                         pad0xa8_39BQL[0xa8];                               // 0x0(0xa8)
...
{
public:
	char                                                         pad0xa8_HFQYN[0xa8];                               // 0x0(0xa8)
	TArray<struct GameplayAbilitySpec>                           Items;                                             // 0xa8(0x10)
	char                                                         pad0x8_O6PQ7[0x8];                                 // 0xb8(0x8)
};
...
public:
	...
	char                                                         pad0x7_VY77X[0x7];                                 // 0x21(0x7)
};
...
public:
	...
	char                                                         pad0x7_NMSVT[0x7];                                 // 0x21(0x7)
...
public:
	...
	char                                                         pad0x7_WON02[0x7];                                 // 0x11(0x7)
...
{
public:
	char                                                         pad0x10_MECCF[0x10];                               // 0x0(0x10)
	...
	char                                                         pad0x2b_OVHG6[0x2b];                               // 0x2d5(0x2b)
};
