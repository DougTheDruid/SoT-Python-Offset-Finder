...
{
public:
	char                                                         pad0x8_IU32R[0x8];                                 // 0x60(0x8)
};
...
{
public:
	char                                                         pad0x10_Q2OX5[0x10];                               // 0x300(0x10)
};
...
{
public:
	char                                                         pad0x18_0CVGL[0x18];                               // 0xb8(0x18)
...
{
public:
	char                                                         pad0x20_QEYJN[0x20];                               // 0x518(0x20)
	...
	char                                                         pad0x7_4UI94[0x7];                                 // 0x549(0x7)
	...
	char                                                         pad0x10_3OFIZ[0x10];                               // 0x588(0x10)
};
...
public:
	...
	char                                                         pad0x70_EDEWA[0x70];                               // 0xc8(0x70)
	class UClass*                                                PetType_Cached;                                    // 0x138(0x8)
	char                                                         pad0x168_4SK43[0x168];                             // 0x140(0x168)
};
...
public:
	...
	char                                                         pad0x80_K2Q5L[0x80];                               // 0xc0(0x80)
};
...
public:
	...
	char                                                         pad0x4_LYR1B[0x4];                                 // 0x5c(0x4)
...
{
public:
	char                                                         pad0x20_R01L4[0x20];                               // 0xa08(0x20)
...
public:
	...
	char                                                         pad0x7_9X253[0x7];                                 // 0x51(0x7)
};
...
public:
	...
	char                                                         pad0x4_HOEUL[0x4];                                 // 0x8c(0x4)
};
...
public:
	...
	char                                                         pad0x7_TGF89[0x7];                                 // 0x61(0x7)
};
...
{
public:
	char                                                         pad0x18_B0OBZ[0x18];                               // 0xb8(0x18)
};
...
{
public:
	char                                                         pad0x18_4MDJP[0x18];                               // 0x140(0x18)
	...
	char                                                         pad0x5_GBIOY[0x5];                                 // 0x183(0x5)
};
...
public:
	...
	char                                                         pad0x3_B77WI[0x3];                                 // 0x89(0x3)
	struct HangoutSpotId                                         ForcedId;                                          // 0x8c(0x8)
	char                                                         pad0x4_C4TXW[0x4];                                 // 0x94(0x4)
};
...
public:
	...
	char                                                         pad0x28_A97F0[0x28];                               // 0xc0(0x28)
	...
	char                                                         pad0x50_UB6W4[0x50];                               // 0x118(0x50)
};
...
public:
	float                                                        TaskDuration;                                      // 0x88(0x4)
	char                                                         pad0x4_DM8CY[0x4];                                 // 0x8c(0x4)
};
...
{
public:
	char                                                         pad0x60_UO9VR[0x60];                               // 0x28(0x60)
	class AIPetsOnDemandSpawner*                                 Spawner;                                           // 0x88(0x8)
	char                                                         pad0x18_BRNPI[0x18];                               // 0x90(0x18)
	...
	char                                                         pad0x1a8_JSFD4[0x1a8];                             // 0x130(0x1a8)
	class PetHangoutSpotsDataAsset*                              PetHangoutDataAsset;                               // 0x2d8(0x8)
	char                                                         pad0x50_3V6EJ[0x50];                               // 0x2e0(0x50)
};
...
{
public:
	char                                                         pad0x38_CD5FN[0x38];                               // 0x7f0(0x38)
	float                                                        ThirdPersonScalingModifier;                        // 0x828(0x4)
	char                                                         pad0x4_GXXP5[0x4];                                 // 0x82c(0x4)
...
public:
	...
	char                                                         pad0xd0_JS0VL[0xd0];                               // 0xc0(0xd0)
};
