...
public:
	...
	char                                                         pad0x4_TYELJ[0x4];                                 // 0x8c(0x4)
};
...
public:
	float                                                        TaskDuration;                                      // 0x88(0x4)
	char                                                         pad0x4_GG1GJ[0x4];                                 // 0x8c(0x4)
};
...
public:
	...
	char                                                         pad0x3_KTL29[0x3];                                 // 0x89(0x3)
	Struct HangoutSpotId                                         ForcedId;                                          // 0x8c(0x8)
	char                                                         pad0x4_JHSMI[0x4];                                 // 0x94(0x4)
};
...
public:
	...
	char                                                         pad0x7_BCN5Q[0x7];                                 // 0x61(0x7)
};
...
public:
	...
	char                                                         pad0xd0_MV4AO[0xd0];                               // 0xd0(0xd0)
};
...
public:
	...
	char                                                         pad0x70_1W0AO[0x70];                               // 0xd8(0x70)
	class                                                        PetType_Cached;                                    // 0x148(0x8)
	char                                                         pad0x168_G96GX[0x168];                             // 0x150(0x168)
};
...
{
public:
	char                                                         pad0x20_DHQ21[0x20];                               // 0x960(0x20)
...
{
public:
	char                                                         pad0x20_PA3DD[0x20];                               // 0x510(0x20)
	...
	char                                                         pad0x7_QDOHK[0x7];                                 // 0x541(0x7)
	...
	char                                                         pad0x10_LN9HV[0x10];                               // 0x580(0x10)
};
...
{
public:
	char                                                         pad0x18_SQ0IO[0x18];                               // 0xc8(0x18)
...
{
public:
	char                                                         pad0x18_SU0JC[0x18];                               // 0x128(0x18)
	...
	char                                                         pad0x5_M3R9Q[0x5];                                 // 0x16b(0x5)
};
...
{
public:
	char                                                         pad0x60_KTT88[0x60];                               // 0x28(0x60)
	Class AIPetsOnDemandSpawner*                                 Spawner;                                           // 0x88(0x8)
	char                                                         pad0x18_8LGRJ[0x18];                               // 0x90(0x18)
	...
	char                                                         pad0x1a8_69XUR[0x1a8];                             // 0x130(0x1a8)
	Class PetHangoutSpotsDataAsset*                              PetHangoutDataAsset;                               // 0x2d8(0x8)
	char                                                         pad0x50_KAP7X[0x50];                               // 0x2e0(0x50)
};
...
{
public:
	char                                                         pad0x38_A3W1V[0x38];                               // 0x7e0(0x38)
	float                                                        ThirdPersonScalingModifier;                        // 0x818(0x4)
	char                                                         pad0x4_QUN0M[0x4];                                 // 0x81c(0x4)
...
public:
	...
	char                                                         pad0x80_LXA5M[0x80];                               // 0xd0(0x80)
};
...
public:
	...
	char                                                         pad0x4_HHKPI[0x4];                                 // 0x5c(0x4)
...
public:
	...
	char                                                         pad0x28_I01PR[0x28];                               // 0xd0(0x28)
	...
	char                                                         pad0x50_YXI10[0x50];                               // 0x128(0x50)
};
...
public:
	...
	char                                                         pad0x7_EN2KP[0x7];                                 // 0x51(0x7)
};
