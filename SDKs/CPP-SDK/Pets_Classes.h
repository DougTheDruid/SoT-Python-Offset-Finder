...
// Size 0xe8 (Full Size[0xa78] - InheritedSize[0x990]
class PetAIController: public AthenaAIController
{
public:
	char                                                         pad0x20_JR48J[0x20];                               // 0x990(0x20)
	TArray<struct AIStategyControllerMovementMod>                StrategyControllerMovementMods;                    // 0x9b0(0x10)
	float                                                        DefaultControlRotationInterpSpeed;                 // 0x9c0(0x4)
	char                                                         pad0x4_971XM[0x4];                                 // 0x9c4(0x4)
	class UClass*                                                DefaultStrategy;                                   // 0x9c8(0x8)
	class ReactStateMappingsDataAsset*                           ReactMappings;                                     // 0x9d0(0x8)
	char                                                         pad0x8_K8Q7O[0x8];                                 // 0x9d8(0x8)
	class PetHangoutSpotSelectorComponent*                       HangoutSpotSelectorComponent;                      // 0x9e0(0x8)
	class PetHangoutSpotComponent*                               ForcedHangoutSpotComponent;                        // 0x9e8(0x8)
	class BlackboardData*                                        DefaultBlackboardAsset;                            // 0x9f0(0x8)
	class BehaviorTree*                                          DefaultTree;                                       // 0x9f8(0x8)
	class BehaviorTree*                                          HangoutTree;                                       // 0xa00(0x8)
	class BehaviorTree*                                          IdleTree;                                          // 0xa08(0x8)
	float                                                        MaximumReactRange;                                 // 0xa10(0x4)
	char                                                         pad0x4_7H5SS[0x4];                                 // 0xa14(0x4)
	class PetDangerComponent*                                    DangerComponent;                                   // 0xa18(0x8)
	float                                                        MinAgentHalfHeightPctOverride;                     // 0xa20(0x4)
	char                                                         pad0x54_5E25Z[0x54];                               // 0xa24(0x54)
};
...
{
public:
	char                                                         pad0x18_K4XS3[0x18];                               // 0x140(0x18)
	...
	char                                                         pad0x5_STREJ[0x5];                                 // 0x183(0x5)
};
...
{
public:
	char                                                         pad0x10_K8T8Z[0x10];                               // 0x300(0x10)
};
...
public:
	...
	char                                                         pad0x7_QAT9A[0x7];                                 // 0x61(0x7)
};
...
{
public:
	char                                                         pad0x20_SV7PO[0x20];                               // 0x508(0x20)
	...
	char                                                         pad0x7_2TP7S[0x7];                                 // 0x539(0x7)
	...
	char                                                         pad0x10_8APFJ[0x10];                               // 0x578(0x10)
};
...
public:
	...
	char                                                         pad0x4_RL5E9[0x4];                                 // 0x8c(0x4)
};
...
public:
	...
	char                                                         pad0x80_ER8NE[0x80];                               // 0xc0(0x80)
};
...
public:
	...
	char                                                         pad0x70_PVGVE[0x70];                               // 0xc8(0x70)
	class UClass*                                                PetType_Cached;                                    // 0x138(0x8)
	char                                                         pad0x168_L6UZZ[0x168];                             // 0x140(0x168)
};
...
public:
	...
	char                                                         pad0x3_6RGOK[0x3];                                 // 0x89(0x3)
	struct HangoutSpotId                                         ForcedId;                                          // 0x8c(0x8)
	char                                                         pad0x4_TVWLO[0x4];                                 // 0x94(0x4)
};
...
public:
	...
	char                                                         pad0xd0_69LUC[0xd0];                               // 0xc0(0xd0)
};
...
public:
	...
	char                                                         pad0x7_1LUO1[0x7];                                 // 0x51(0x7)
};
...
{
public:
	char                                                         pad0x18_883J2[0x18];                               // 0xb8(0x18)
};
...
{
public:
	char                                                         pad0x60_PA76A[0x60];                               // 0x28(0x60)
	class AIPetsOnDemandSpawner*                                 Spawner;                                           // 0x88(0x8)
	char                                                         pad0x18_XE29Z[0x18];                               // 0x90(0x18)
	...
	char                                                         pad0x1a8_IHGKY[0x1a8];                             // 0x130(0x1a8)
	class PetHangoutSpotsDataAsset*                              PetHangoutDataAsset;                               // 0x2d8(0x8)
	char                                                         pad0x50_F33QF[0x50];                               // 0x2e0(0x50)
};
...
public:
	float                                                        TaskDuration;                                      // 0x88(0x4)
	char                                                         pad0x4_SPZ7L[0x4];                                 // 0x8c(0x4)
};
...
{
public:
	char                                                         pad0x8_49DXV[0x8];                                 // 0x60(0x8)
};
...
public:
	...
	char                                                         pad0x4_HN4YN[0x4];                                 // 0x5c(0x4)
...
{
public:
	char                                                         pad0x18_CC2TN[0x18];                               // 0xb8(0x18)
...
{
public:
	char                                                         pad0x38_NBC90[0x38];                               // 0x7f0(0x38)
	float                                                        ThirdPersonScalingModifier;                        // 0x828(0x4)
	char                                                         pad0x4_U3QJB[0x4];                                 // 0x82c(0x4)
...
public:
	...
	char                                                         pad0x28_BFLXP[0x28];                               // 0xc0(0x28)
	...
	char                                                         pad0x50_GB728[0x50];                               // 0x118(0x50)
};
