...
public:
	...
	char                                                         pad0x7_8RZLK[0x7];                                 // 0x61(0x7)
};
...
{
public:
	char                                                         pad0x20_D5SU9[0x20];                               // 0x508(0x20)
	...
	char                                                         pad0x7_HMFAA[0x7];                                 // 0x539(0x7)
	...
	char                                                         pad0x10_0VJX5[0x10];                               // 0x578(0x10)
};
...
public:
	...
	char                                                         pad0x28_GE742[0x28];                               // 0xc0(0x28)
	...
	char                                                         pad0x50_EQE5A[0x50];                               // 0x118(0x50)
};
...
public:
	...
	char                                                         pad0x4_FHL0D[0x4];                                 // 0x5c(0x4)
...
{
public:
	char                                                         pad0x8_AJUDC[0x8];                                 // 0x60(0x8)
};
...
{
public:
	char                                                         pad0x18_Q92K2[0x18];                               // 0xb8(0x18)
...
public:
	...
	char                                                         pad0x80_E6Q9E[0x80];                               // 0xc0(0x80)
};
...
{
public:
	char                                                         pad0x60_M6R6X[0x60];                               // 0x28(0x60)
	class AIPetsOnDemandSpawner*                                 Spawner;                                           // 0x88(0x8)
	char                                                         pad0x18_HPOIL[0x18];                               // 0x90(0x18)
	...
	char                                                         pad0x1a8_J01G0[0x1a8];                             // 0x130(0x1a8)
	class PetHangoutSpotsDataAsset*                              PetHangoutDataAsset;                               // 0x2d8(0x8)
	char                                                         pad0x50_2YKLG[0x50];                               // 0x2e0(0x50)
};
...
public:
	...
	char                                                         pad0x3_T8SOH[0x3];                                 // 0x89(0x3)
	struct HangoutSpotId                                         ForcedId;                                          // 0x8c(0x8)
	char                                                         pad0x4_5X6RE[0x4];                                 // 0x94(0x4)
};
...
{
public:
	char                                                         pad0x20_96J5I[0x20];                               // 0x9a8(0x20)
...
public:
	...
	char                                                         pad0x70_ZXVFM[0x70];                               // 0xc8(0x70)
	class UClass*                                                PetType_Cached;                                    // 0x138(0x8)
	char                                                         pad0x168_2JMSC[0x168];                             // 0x140(0x168)
};
...
{
public:
	char                                                         pad0x10_JXFQA[0x10];                               // 0x300(0x10)
};
...
{
public:
	char                                                         pad0x18_9ZV54[0x18];                               // 0xb8(0x18)
};
...
public:
	...
	char                                                         pad0x4_V66A0[0x4];                                 // 0x8c(0x4)
};
...
public:
	float                                                        TaskDuration;                                      // 0x88(0x4)
	char                                                         pad0x4_P5MHH[0x4];                                 // 0x8c(0x4)
};
...
public:
	...
	char                                                         pad0x7_7IQVO[0x7];                                 // 0x51(0x7)
};
...
{
public:
	char                                                         pad0x38_M5GXQ[0x38];                               // 0x7f0(0x38)
	float                                                        ThirdPersonScalingModifier;                        // 0x828(0x4)
	char                                                         pad0x4_1E4WM[0x4];                                 // 0x82c(0x4)
...
public:
	...
	char                                                         pad0xd0_F5KOQ[0xd0];                               // 0xc0(0xd0)
};
...
{
public:
	char                                                         pad0x18_ADPFX[0x18];                               // 0x140(0x18)
	...
	char                                                         pad0x5_4GCPA[0x5];                                 // 0x183(0x5)
};
