...
{
public:
	char                                                         pad0x20_WTQMR[0x20];                               // 0x0(0x20)
	float                                                        Weight;                                            // 0x20(0x4)
	char                                                         pad0x4_8PZ0K[0x4];                                 // 0x24(0x4)
};
...
public:
	...
	char                                                         pad0x3_2D828[0x3];                                 // 0x1d(0x3)
	char                                                         pad0x4_LRPAR[0x4];                                 // 0x20(0x4)
};
...
public:
	...
	char                                                         pad0x8_A7OC8[0x8];                                 // 0x48(0x8)
};
...
public:
	...
	char                                                         pad0x4_IEV00[0x4];                                 // 0x14(0x4)
};
...
{
public:
	char                                                         pad0x30_GDFVX[0x30];                               // 0x0(0x30)
};
...
public:
	...
	char                                                         pad0x3_5H0G4[0x3];                                 // 0x11(0x3)
};
...
public:
	...
	char                                                         pad0x28_01XS8[0x28];                               // 0x38(0x28)
};
