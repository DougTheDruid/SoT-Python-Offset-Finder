...
{
public:
	char                                                         pad0x20_PGFFI[0x20];                               // 0x0(0x20)
	float                                                        Weight;                                            // 0x20(0x4)
	char                                                         pad0x4_XJ2DS[0x4];                                 // 0x24(0x4)
};
...
public:
	...
	char                                                         pad0x4_4Q8ET[0x4];                                 // 0x14(0x4)
};
...
public:
	...
	char                                                         pad0x28_Z5Z9V[0x28];                               // 0x38(0x28)
};
...
{
public:
	char                                                         pad0x30_SBX51[0x30];                               // 0x0(0x30)
};
...
public:
	...
	char                                                         pad0x3_GVDJH[0x3];                                 // 0x11(0x3)
};
...
public:
	...
	char                                                         pad0x3_QLRKO[0x3];                                 // 0x1d(0x3)
};
