...
{
public:
	char                                                         pad0x20_JLGY6[0x20];                               // 0x0(0x20)
	float                                                        Weight;                                            // 0x20(0x4)
	char                                                         pad0x4_T8C05[0x4];                                 // 0x24(0x4)
};
...
public:
	...
	char                                                         pad0x4_NYZLH[0x4];                                 // 0x14(0x4)
};
...
public:
	...
	char                                                         pad0x3_ABDNS[0x3];                                 // 0x11(0x3)
};
...
{
public:
	char                                                         pad0x30_YZ1YB[0x30];                               // 0x0(0x30)
};
...
public:
	...
	char                                                         pad0x3_B0EKE[0x3];                                 // 0x1d(0x3)
};
...
public:
	...
	char                                                         pad0x28_OXVOF[0x28];                               // 0x38(0x28)
};
