...
public:
	...
	char                                                         pad0x4_ACPC8[0x4];                                 // 0x14(0x4)
};
...
public:
	...
	char                                                         pad0x3_MD2JO[0x3];                                 // 0x11(0x3)
};
...
public:
	...
	char                                                         pad0x3_P3P00[0x3];                                 // 0x1d(0x3)
	char                                                         pad0x4_XD6YN[0x4];                                 // 0x20(0x4)
};
...
public:
	...
	char                                                         pad0x8_FL727[0x8];                                 // 0x48(0x8)
};
...
{
public:
	char                                                         pad0x30_OHLJ7[0x30];                               // 0x0(0x30)
};
...
{
public:
	char                                                         pad0x20_107WY[0x20];                               // 0x0(0x20)
	float                                                        Weight;                                            // 0x20(0x4)
	char                                                         pad0x4_DC1AZ[0x4];                                 // 0x24(0x4)
};
...
public:
	...
	char                                                         pad0x28_G9OM5[0x28];                               // 0x38(0x28)
};
