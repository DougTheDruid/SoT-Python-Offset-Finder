...
public:
	...
	char                                                         pad0x3_GGQEJ[0x3];                                 // 0x15(0x3)
	int                                                          PvPSkillLevel;                                     // 0x18(0x4)
	char                                                         pad0x4_TFOVP[0x4];                                 // 0x1c(0x4)
...
public:
	...
	char                                                         pad0x4_XTBGW[0x4];                                 // 0x14(0x4)
};
...
public:
	...
	char                                                         pad0x3_RYTXA[0x3];                                 // 0x8d(0x3)
	...
	char                                                         pad0x7_ZPBVR[0x7];                                 // 0xd9(0x7)
};
...
public:
	...
	char                                                         pad0x6_RX5BS[0x6];                                 // 0x32(0x6)
};
...
{
public:
	char                                                         pad0x50_PMT3H[0x50];                               // 0x0(0x50)
};
