...
{
public:
	char                                                         pad0x50_DLPOK[0x50];                               // 0x0(0x50)
};
...
public:
	...
	char                                                         pad0x3_GX9KG[0x3];                                 // 0x8d(0x3)
	...
	char                                                         pad0x7_F1XHV[0x7];                                 // 0xd9(0x7)
};
...
public:
	...
	char                                                         pad0x6_K6GID[0x6];                                 // 0x32(0x6)
};
...
public:
	...
	char                                                         pad0x4_VUHRZ[0x4];                                 // 0x14(0x4)
};
...
public:
	...
	char                                                         pad0x3_BNDU1[0x3];                                 // 0x15(0x3)
	int                                                          PvPSkillLevel;                                     // 0x18(0x4)
	char                                                         pad0x4_RG9UF[0x4];                                 // 0x1c(0x4)
