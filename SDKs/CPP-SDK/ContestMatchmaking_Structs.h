...
public:
	...
	char                                                         pad0x6_HSEMI[0x6];                                 // 0x32(0x6)
};
...
public:
	...
	char                                                         pad0x3_UQYK0[0x3];                                 // 0x8d(0x3)
...
public:
	...
	char                                                         pad0x4_6IFUG[0x4];                                 // 0x14(0x4)
};
...
public:
	...
	char                                                         pad0x3_CG3IT[0x3];                                 // 0x15(0x3)
	int                                                          PvPSkillLevel;                                     // 0x18(0x4)
	char                                                         pad0x4_B1H6N[0x4];                                 // 0x1c(0x4)
...
public:
	...
	TArray<String>                                               PlayModeTags;                                      // 0x38(0x10)
...
{
public:
	char                                                         pad0x50_5SNXJ[0x50];                               // 0x0(0x50)
};
...
public:
	...
	TArray<String>                                               PlayModeTags;                                      // 0x58(0x10)
	TArray<String>                                               PlayModeStates;                                    // 0x68(0x10)
	TArray<struct ServerCrewModel>                               Crews;                                             // 0x78(0x10)
	char                                                         MatchmakingRequestReason;                          // 0x88(0x1)
	char                                                         pad0x3_3W7OB[0x3];                                 // 0x89(0x3)
	struct Guid                                                  RequestCorrelationId;                              // 0x8c(0x10)
	struct Guid                                                  SaferSeasServerIdOverride;                         // 0x9c(0x10)
	char                                                         pad0x4_N8RJH[0x4];                                 // 0xac(0x4)
};
...
public:
	...
	TArray<int>                                                  CrewSessionTypes;                                  // 0x98(0x10)
