...
{
public:
	struct                                                       EstimatedWaitTime;                                 // 0x0(0x8)
	struct                                                       RetryAfter;                                        // 0x8(0x8)
};
...
public:
	...
	struct                                                       TimeInMatchmaking;                                 // 0x20(0x8)
	struct FString                                               ForcedStamp;                                       // 0x28(0x10)
	struct                                                       GuildId;                                           // 0x38(0x10)
...
public:
	struct                                                       CrewId;                                            // 0x0(0x10)
	struct                                                       UserId;                                            // 0x10(0x18)
	struct                                                       ServerId;                                          // 0x28(0x10)
...
public:
	...
	struct                                                       AvgWaitTime;                                       // 0x10(0x8)
	struct                                                       MaxWaitTime;                                       // 0x18(0x8)
};
...
public:
	...
	map                                                          OptionalPlayModeInfo;                              // 0x18(0x50)
	struct                                                       RetryAfter;                                        // 0x68(0x8)
	struct                                                       MigrationThreshold;                                // 0x70(0x8)
	struct                                                       ExpireAfter;                                       // 0x78(0x8)
};
...
public:
	...
	struct                                                       SaferSeasServerId;                                 // 0x30(0x10)
	...
	struct                                                       Uptime;                                            // 0xc8(0x8)
	struct                                                       Contended;                                         // 0xd0(0x30)
	struct                                                       GameEvents;                                        // 0x100(0x20)
};
...
public:
	...
	struct                                                       RequestCorrelationId;                              // 0x9c(0x10)
	struct                                                       SaferSeasServerIdOverride;                         // 0xac(0x10)
};
