...
public:
	...
	char                                                         pad0x3_FUO8P[0x3];                                 // 0x8d(0x3)
	...
	char                                                         pad0x7_FBTU6[0x7];                                 // 0xd9(0x7)
};
...
public:
	...
	char                                                         pad0x6_E2E5M[0x6];                                 // 0x32(0x6)
};
...
public:
	...
	char                                                         pad0x4_WJ6AA[0x4];                                 // 0x14(0x4)
};
...
{
public:
	char                                                         pad0x50_1XSJ9[0x50];                               // 0x0(0x50)
};
...
public:
	...
	char                                                         pad0x3_BAZEF[0x3];                                 // 0x15(0x3)
	int                                                          PvPSkillLevel;                                     // 0x18(0x4)
	char                                                         pad0x4_HX5XN[0x4];                                 // 0x1c(0x4)
