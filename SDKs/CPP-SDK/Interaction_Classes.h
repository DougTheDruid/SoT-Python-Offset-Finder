...
{
public:
	char                                                         pad0x8_MU216[0x8];                                 // 0xb8(0x8)
};
...
{
public:
	char                                                         pad0x8_JKO0U[0x8];                                 // 0xb8(0x8)
	TArray<struct UniqueNetIdRepl>                               InteractedPlayers;                                 // 0xc0(0x10)
	char                                                         pad0x10_64YRR[0x10];                               // 0xd0(0x10)
};
...
{
public:
	char                                                         pad0x8_ZKV0G[0x8];                                 // 0x5d0(0x8)
	class InteractableArea*                                      CurrentOptimalInteractable;                        // 0x5d8(0x8)
	char                                                         pad0xc0_EUCO4[0xc0];                               // 0x5e0(0xc0)
};
...
{
public:
	char                                                         pad0x8_XY06G[0x8];                                 // 0xb8(0x8)
...
{
public:
	char                                                         pad0x8_SHCYL[0x8];                                 // 0xb8(0x8)
	...
	char                                                         pad0x3_QZ5RW[0x3];                                 // 0xed(0x3)
	float                                                        InteractionRadius;                                 // 0xf0(0x4)
	char                                                         pad0x4_7HZHR[0x4];                                 // 0xf4(0x4)
...
public:
	...
	char                                                         pad0x4_RN66M[0x4];                                 // 0x4c(0x4)
	class Object*                                                Interactable;                                      // 0x50(0x8)
	class Actor*                                                 Parent;                                            // 0x58(0x8)
	char                                                         pad0x10_DIJ1U[0x10];                               // 0x60(0x10)
};
...
{
public:
	char                                                         pad0x18_D9CFM[0x18];                               // 0x28(0x18)
};
...
{
public:
	char                                                         pad0x10_0CLOC[0x10];                               // 0x3a0(0x10)
};
...
{
public:
	char                                                         pad0x10_N9M7X[0x10];                               // 0x28(0x10)
	TArray<class InteractableArea*>                              InteractableAreas;                                 // 0x38(0x10)
	char                                                         pad0x28_A7JP5[0x28];                               // 0x48(0x28)
};
...
{
public:
	char                                                         pad0x8_AOUSL[0x8];                                 // 0x3a0(0x8)
	...
	char                                                         pad0x8_HFWV4[0x8];                                 // 0x3d0(0x8)
};
