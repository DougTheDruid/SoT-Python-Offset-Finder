...
{
public:
	char                                                         pad0x8_YVO74[0x8];                                 // 0x5d0(0x8)
	class InteractableArea*                                      CurrentOptimalInteractable;                        // 0x5d8(0x8)
	char                                                         pad0xc0_FULNK[0xc0];                               // 0x5e0(0xc0)
};
...
{
public:
	char                                                         pad0x10_4RPNB[0x10];                               // 0x28(0x10)
	TArray<class InteractableArea*>                              InteractableAreas;                                 // 0x38(0x10)
	char                                                         pad0x28_JF2JW[0x28];                               // 0x48(0x28)
};
...
{
public:
	char                                                         pad0x8_ITPJG[0x8];                                 // 0xb8(0x8)
...
{
public:
	char                                                         pad0x10_LF842[0x10];                               // 0x3a0(0x10)
};
...
{
public:
	char                                                         pad0x8_KLY74[0x8];                                 // 0xb8(0x8)
	TArray<struct UniqueNetIdRepl>                               InteractedPlayers;                                 // 0xc0(0x10)
	char                                                         pad0x10_63I1A[0x10];                               // 0xd0(0x10)
};
...
{
public:
	char                                                         pad0x8_6EAMS[0x8];                                 // 0xb8(0x8)
};
...
{
public:
	char                                                         pad0x8_X9QBY[0x8];                                 // 0xb8(0x8)
	...
	char                                                         pad0x3_76Y9X[0x3];                                 // 0xed(0x3)
	float                                                        InteractionRadius;                                 // 0xf0(0x4)
	char                                                         pad0x4_O9JBF[0x4];                                 // 0xf4(0x4)
...
{
public:
	char                                                         pad0x18_SYR8M[0x18];                               // 0x28(0x18)
};
...
{
public:
	char                                                         pad0x8_UKB7Z[0x8];                                 // 0x3a0(0x8)
	...
	char                                                         pad0x8_NEVU8[0x8];                                 // 0x3d0(0x8)
};
...
public:
	...
	char                                                         pad0x4_549SO[0x4];                                 // 0x4c(0x4)
	class Object*                                                Interactable;                                      // 0x50(0x8)
	class Actor*                                                 Parent;                                            // 0x58(0x8)
	char                                                         pad0x10_YVMPS[0x10];                               // 0x60(0x10)
};
