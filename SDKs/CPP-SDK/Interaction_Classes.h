...
{
public:
	char                                                         pad0x10_WZVWY[0x10];                               // 0x3c8(0x10)
};
...
{
public:
	char                                                         pad0x8_0QBD8[0x8];                                 // 0xc8(0x8)
...
{
public:
	char                                                         pad0x8_KXNWT[0x8];                                 // 0xc8(0x8)
	...
	char                                                         pad0x3_P1P32[0x3];                                 // 0xfd(0x3)
	float                                                        InteractionRadius;                                 // 0x100(0x4)
	char                                                         pad0x4_7YWZC[0x4];                                 // 0x104(0x4)
	...
	char                                                         pad0x17_TYMC4[0x17];                               // 0x121(0x17)
};
...
{
public:
	char                                                         pad0x8_IRGI1[0x8];                                 // 0x3c8(0x8)
...
public:
	...
	char                                                         pad0xc8_PEBX9[0xc8];                               // 0x5f8(0xc8)
};
...
{
public:
	char                                                         pad0x18_H4X2X[0x18];                               // 0x28(0x18)
};
...
{
public:
	char                                                         pad0x10_KQF3L[0x10];                               // 0x28(0x10)
	TArray<class InteractableArea*>                              InteractableAreas;                                 // 0x38(0x10)
	char                                                         pad0x28_D48K9[0x28];                               // 0x48(0x28)
};
...
{
public:
	char                                                         pad0x8_3ONSB[0x8];                                 // 0xc8(0x8)
	TArray<struct UniqueNetIdRepl>                               InteractedPlayers;                                 // 0xd0(0x10)
	char                                                         pad0x10_PTRSE[0x10];                               // 0xe0(0x10)
};
...
{
public:
	char                                                         pad0x8_Y3EGK[0x8];                                 // 0xc8(0x8)
};
...
public:
	...
	char                                                         pad0x4_LZ8IH[0x4];                                 // 0x4c(0x4)
	class Object*                                                Interactable;                                      // 0x50(0x8)
	class Actor*                                                 Parent;                                            // 0x58(0x8)
	char                                                         pad0x10_DCGSZ[0x10];                               // 0x60(0x10)
};
