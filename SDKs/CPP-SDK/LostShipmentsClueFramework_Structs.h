...
public:
	...
	char                                                         pad0x10_LCG4J[0x10];                               // 0x10(0x10)
};
...
{
public:
	char                                                         pad0x30_GZWLW[0x30];                               // 0x0(0x30)
};
...
public:
	...
	char                                                         pad0x4_04WL1[0x4];                                 // 0x1c(0x4)
};
...
{
public:
	char                                                         pad0x30_5X36E[0x30];                               // 0x0(0x30)
};
...
{
public:
	char                                                         pad0x20_HCDFE[0x20];                               // 0x0(0x20)
	float                                                        Weight;                                            // 0x20(0x4)
	char                                                         pad0x4_2A2GJ[0x4];                                 // 0x24(0x4)
};
...
{
public:
	char                                                         pad0x30_VYU9B[0x30];                               // 0x0(0x30)
};
...
public:
	...
	char                                                         pad0x10_J0GQ6[0x10];                               // 0x10(0x10)
};
