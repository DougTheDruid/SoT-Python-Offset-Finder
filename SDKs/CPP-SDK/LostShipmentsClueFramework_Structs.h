...
{
public:
	char                                                         pad0x30_L2WAI[0x30];                               // 0x0(0x30)
};
...
public:
	...
	char                                                         pad0x10_66RWA[0x10];                               // 0x10(0x10)
};
...
public:
	...
	char                                                         pad0x4_O2558[0x4];                                 // 0x1c(0x4)
};
...
public:
	...
	char                                                         pad0x10_3YX34[0x10];                               // 0x10(0x10)
};
...
{
public:
	char                                                         pad0x30_1AALK[0x30];                               // 0x0(0x30)
};
...
{
public:
	char                                                         pad0x20_HG0XW[0x20];                               // 0x0(0x20)
	float                                                        Weight;                                            // 0x20(0x4)
	char                                                         pad0x4_CJTAQ[0x4];                                 // 0x24(0x4)
};
...
{
public:
	char                                                         pad0x30_LWPKO[0x30];                               // 0x0(0x30)
};
