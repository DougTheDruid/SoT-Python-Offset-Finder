...
public:
	...
	char                                                         pad0x4_QNHXN[0x4];                                 // 0x1c(0x4)
};
...
public:
	...
	char                                                         pad0x10_NSK3Z[0x10];                               // 0x10(0x10)
};
...
{
public:
	char                                                         pad0x30_U614M[0x30];                               // 0x0(0x30)
};
...
{
public:
	char                                                         pad0x30_MOYK1[0x30];                               // 0x0(0x30)
};
...
{
public:
	char                                                         pad0x30_VG50J[0x30];                               // 0x0(0x30)
};
...
public:
	...
	char                                                         pad0x10_5ADOQ[0x10];                               // 0x10(0x10)
};
...
{
public:
	char                                                         pad0x20_R9KNW[0x20];                               // 0x0(0x20)
	float                                                        Weight;                                            // 0x20(0x4)
	char                                                         pad0x4_0Q1CT[0x4];                                 // 0x24(0x4)
};
