...
{
public:
	char                                                         pad0x30_KTLZ9[0x30];                               // 0x0(0x30)
};
...
{
public:
	char                                                         pad0x20_UTDT6[0x20];                               // 0x0(0x20)
	float                                                        Weight;                                            // 0x20(0x4)
	char                                                         pad0x4_RSHBW[0x4];                                 // 0x24(0x4)
};
...
{
public:
	char                                                         pad0x30_S2N74[0x30];                               // 0x0(0x30)
};
...
public:
	...
	char                                                         pad0x4_0Y3W4[0x4];                                 // 0x1c(0x4)
};
...
public:
	...
	char                                                         pad0x10_O6AV8[0x10];                               // 0x10(0x10)
};
...
public:
	...
	char                                                         pad0x10_FVV1Q[0x10];                               // 0x10(0x10)
};
...
{
public:
	char                                                         pad0x30_R3WN2[0x30];                               // 0x0(0x30)
};
