...
public:
	...
	char                                                         pad0x10_CMT5J[0x10];                               // 0x10(0x10)
};
...
public:
	...
	char                                                         pad0x4_V2MCZ[0x4];                                 // 0x1c(0x4)
};
...
{
public:
	char                                                         pad0x30_25R8O[0x30];                               // 0x0(0x30)
};
...
{
public:
	char                                                         pad0x20_WWKQG[0x20];                               // 0x0(0x20)
	float                                                        Weight;                                            // 0x20(0x4)
	char                                                         pad0x4_HY6CA[0x4];                                 // 0x24(0x4)
};
...
{
public:
	char                                                         pad0x30_MYX54[0x30];                               // 0x0(0x30)
};
...
public:
	...
	char                                                         pad0x10_TJFQE[0x10];                               // 0x10(0x10)
};
...
{
public:
	char                                                         pad0x30_Y5P75[0x30];                               // 0x0(0x30)
};
