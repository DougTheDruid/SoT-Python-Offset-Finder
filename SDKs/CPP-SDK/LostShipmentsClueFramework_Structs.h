...
{
public:
	char                                                         pad0x30_4RNH3[0x30];                               // 0x0(0x30)
};
...
public:
	...
	char                                                         pad0x10_SWO2E[0x10];                               // 0x10(0x10)
};
...
{
public:
	char                                                         pad0x30_RF8GD[0x30];                               // 0x0(0x30)
};
...
public:
	...
	char                                                         pad0x10_FHNZC[0x10];                               // 0x10(0x10)
};
...
public:
	...
	char                                                         pad0x4_JFHNQ[0x4];                                 // 0x1c(0x4)
};
...
{
public:
	char                                                         pad0x20_AJWOJ[0x20];                               // 0x0(0x20)
	float                                                        Weight;                                            // 0x20(0x4)
	char                                                         pad0x4_POE6U[0x4];                                 // 0x24(0x4)
};
...
{
public:
	char                                                         pad0x30_RW4AK[0x30];                               // 0x0(0x30)
};
