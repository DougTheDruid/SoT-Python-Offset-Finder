...
{
public:
	char                                                         pad0x8_P06VS[0x8];                                 // 0xb8(0x8)
};
...
{
public:
	char                                                         pad0x20_T45MF[0x20];                               // 0x140(0x20)
};
...
{
public:
	char                                                         pad0x128_VXG6L[0x128];                             // 0x160(0x128)
};
...
{
public:
	char                                                         pad0x70_DQKNA[0x70];                               // 0x160(0x70)
};
...
{
public:
	char                                                         pad0x8_9UMGP[0x8];                                 // 0x288(0x8)
};
