...
{
public:
	char                                                         pad0x8_JZ64M[0x8];                                 // 0xb8(0x8)
};
...
{
public:
	char                                                         pad0x20_5IU6D[0x20];                               // 0x140(0x20)
};
...
{
public:
	char                                                         pad0x70_GN2U6[0x70];                               // 0x160(0x70)
};
...
{
public:
	char                                                         pad0x128_Z48JL[0x128];                             // 0x160(0x128)
};
...
{
public:
	char                                                         pad0x8_I7KRY[0x8];                                 // 0x288(0x8)
};
