...
public:
	...
	char                                                         pad0x4_N398K[0x4];                                 // 0x54(0x4)
};
...
// Size 0x8
struct EventUnregisterGeyserExclusionVolume
{
public:
	char                                                         pad0x8_CBRC3[0x8];                                 // 0x0(0x8)
};
...
public:
	...
	char                                                         pad0x6_H0VK8[0x6];                                 // 0x2(0x6)
	class Actor*                                                 Target;                                            // 0x8(0x8)
	int                                                          NumExtraShots;                                     // 0x10(0x4)
	char                                                         pad0x4_HRJ6N[0x4];                                 // 0x14(0x4)
};


// Size 0x8
struct EventRegisterGeyserExclusionVolume
{
public:
	char                                                         pad0x8_7TEIK[0x8];                                 // 0x0(0x8)
};


// Size 0x24
struct VolcanoLocalMiniProjectileData
{
public:
	struct Vector                                                LaunchVelocity;                                    // 0x0(0xc)
	struct Vector                                                StartPosition;                                     // 0xc(0xc)
	struct Vector                                                TargetPosition;                                    // 0x18(0xc)
};


// Size 0x10
struct VolcanoEruptionTelemetryEvent
{
public:
	char                                                         pad0x8_8X2JY[0x8];                                 // 0x0(0x8)
	struct FName                                                 VolcanoName;                                       // 0x8(0x8)
};
...
public:
	...
	char                                                         pad0x4_AOLDA[0x4];                                 // 0x24(0x4)
