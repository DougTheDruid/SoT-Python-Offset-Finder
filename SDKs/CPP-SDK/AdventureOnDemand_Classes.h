...
public:
	...
	char                                                         pad0xe0_Y5L7W[0xe0];                               // 0x48(0xe0)
	class VoyageDescDataAsset*                                   LeaveTunnelVoyageDesc;                             // 0x128(0x8)
	char                                                         pad0x14_MNV2P[0x14];                               // 0x130(0x14)
	float                                                        RetryRequestEventFrequency;                        // 0x144(0x4)
	char                                                         pad0x10_5CTWW[0x10];                               // 0x148(0x10)
};
...
{
public:
	char                                                         pad0x10_FFJWS[0x10];                               // 0x3a0(0x10)
	...
	char                                                         pad0xa0_6X08J[0xa0];                               // 0x3d0(0xa0)
	...
	char                                                         pad0x1f0_53Z68[0x1f0];                             // 0x4c0(0x1f0)
};
...
public:
	...
	char                                                         pad0x17_6ETQV[0x17];                               // 0x159(0x17)
	float                                                        ResurfaceMaxRadiusModifier;                        // 0x170(0x4)
	char                                                         pad0x14_8XC7U[0x14];                               // 0x174(0x14)
};
...
{
public:
	char                                                         pad0x10_OCLNC[0x10];                               // 0x158(0x10)
};
...
{
public:
	char                                                         pad0x10_ISEYC[0x10];                               // 0x188(0x10)
};
...
{
public:
	char                                                         pad0x18_IEEP8[0x18];                               // 0x188(0x18)
};
...
{
public:
	char                                                         pad0x10_30QJZ[0x10];                               // 0x188(0x10)
};
...
{
public:
	char                                                         pad0x10_3OCCG[0x10];                               // 0x188(0x10)
};
...
{
public:
	char                                                         pad0x10_5DOVV[0x10];                               // 0x188(0x10)
};
