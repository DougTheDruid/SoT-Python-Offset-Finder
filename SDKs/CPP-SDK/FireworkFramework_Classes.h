...
{
public:
	struct                                                       PercentageTimeUntilTrailDisappears;                // 0x28(0x30)
	struct                                                       TimeUntilExplosion;                                // 0x58(0x30)
	bool                                                         IsFlare;                                           // 0x88(0x1)
	bool                                                         ShouldCastAmbientLight;                            // 0x89(0x1)
	struct                                                       FireworkAmbientLightData;                          // 0x8c(0x14)
	TArray<struct WeightedFireworkVFXData>                       Explosions;                                        // 0xa0(0x10)
	struct                                                       NumExplosions;                                     // 0xb0(0x20)
	struct                                                       TimeBetweenExplosions;                             // 0xd0(0x30)
	struct                                                       ExplosionLocationOffset;                           // 0x100(0x30)
...
// Size 0x108 (Full Size[0x718] - InheritedSize[0x610]
class FireworkProjectile: public LaunchableProjectile
{
public:
	class SphereComponent*                                       CollisionComponent;                                // 0x620(0x8)
	class StaticMeshComponent*                                   MeshComponent;                                     // 0x628(0x8)
	class ExplosionComponent*                                    ExplosionComponent;                                // 0x630(0x8)
	class FireworkStatsComponent*                                FireworkStatsComponent;                            // 0x638(0x8)
	class SceneComponent*                                        MeshDirectionComponent;                            // 0x640(0x8)
	class ProjectileAnimationComponent*                          AnimationComponent;                                // 0x648(0x8)
	struct                                                       GeneratedFireworkData;                             // 0x650(0x58)
};
...
public:
	...
	struct                                                       AnimationOffsetCurve;                              // 0xe0(0x170)
};
...
public:
	...
	struct                                                       FuseMeshAssetReference;                            // 0x58(0x10)
};
...
{
public:
	struct                                                       GeneratedFireworkData;                             // 0x3d0(0x58)
	...
	struct                                                       AudioEmitter;                                      // 0x440(0x20)
};
...
public:
	...
	struct                                                       FireworkDataAsset;                                 // 0x538(0x10)
