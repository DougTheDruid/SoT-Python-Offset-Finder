...
{
public:
	char                                                         pad0x50_R0X3K[0x50];                               // 0x4a0(0x50)
};
...
public:
	...
	char                                                         pad0x2_VBJHQ[0x2];                                 // 0x8a(0x2)
	...
	char                                                         pad0x4_7QR23[0x4];                                 // 0x134(0x4)
...
{
public:
	char                                                         pad0x8_KVYOP[0x8];                                 // 0x3c8(0x8)
	...
	char                                                         pad0x40_5X8HV[0x40];                               // 0x460(0x40)
};
...
public:
	...
	char                                                         pad0x4_VO8X5[0x4];                                 // 0x54c(0x4)
};
...
{
public:
	char                                                         pad0x10_P4GGI[0x10];                               // 0x600(0x10)
	...
	char                                                         pad0x70_36TN3[0x70];                               // 0x698(0x70)
};
...
{
public:
	char                                                         pad0x78_E8RZU[0x78];                               // 0x3c8(0x78)
	int                                                          NumberOfCachedFlares;                              // 0x440(0x4)
	char                                                         pad0x1c_09JIH[0x1c];                               // 0x444(0x1c)
};
...
public:
	...
	char                                                         pad0x4_48GOB[0x4];                                 // 0x4c(0x4)
};
...
public:
	...
	char                                                         pad0x4_EM77U[0x4];                                 // 0x2c(0x4)
...
public:
	...
	char                                                         pad0x4_2TC7L[0x4];                                 // 0xcc(0x4)
	...
	char                                                         pad0xbc_QVZUJ[0xbc];                               // 0xdc(0xbc)
};
...
public:
	...
	char                                                         pad0x3_7QNFQ[0x3];                                 // 0x135(0x3)
...
public:
	...
	char                                                         pad0x40_ISQKM[0x40];                               // 0x250(0x40)
};
