...
public:
	...
	char                                                         pad0x2_MVGI2[0x2];                                 // 0x8a(0x2)
	...
	char                                                         pad0x4_G8QFC[0x4];                                 // 0x134(0x4)
...
{
public:
	char                                                         pad0x8_RARDW[0x8];                                 // 0x3c8(0x8)
	...
	char                                                         pad0x40_XQO1T[0x40];                               // 0x460(0x40)
};
...
public:
	...
	char                                                         pad0x4_VKZPA[0x4];                                 // 0x52c(0x4)
};
...
{
public:
	char                                                         pad0x10_NFQIK[0x10];                               // 0x600(0x10)
	...
	char                                                         pad0x70_SJ1TJ[0x70];                               // 0x698(0x70)
};
...
{
public:
	char                                                         pad0x78_1KNE6[0x78];                               // 0x3c8(0x78)
	int                                                          NumberOfCachedFlares;                              // 0x440(0x4)
	char                                                         pad0x1c_Q7X32[0x1c];                               // 0x444(0x1c)
};
...
public:
	...
	char                                                         pad0x4_95MBN[0x4];                                 // 0x4c(0x4)
};
...
public:
	...
	char                                                         pad0x4_IL8OU[0x4];                                 // 0x2c(0x4)
...
public:
	...
	char                                                         pad0x4_C48XW[0x4];                                 // 0xcc(0x4)
	...
	char                                                         pad0xac_DJ2K9[0xac];                               // 0xdc(0xac)
};
...
public:
	...
	char                                                         pad0x3_KJ6GP[0x3];                                 // 0x135(0x3)
...
public:
	...
	char                                                         pad0x40_LO7T1[0x40];                               // 0x250(0x40)
};
