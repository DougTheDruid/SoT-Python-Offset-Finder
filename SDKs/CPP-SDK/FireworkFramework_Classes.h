...
{
public:
	char                                                         pad0x50_TTYXX[0x50];                               // 0x4a0(0x50)
};
...
public:
	...
	char                                                         pad0x2_NFY3D[0x2];                                 // 0x8a(0x2)
	...
	char                                                         pad0x4_O6ID5[0x4];                                 // 0x134(0x4)
...
{
public:
	char                                                         pad0x8_4TX4K[0x8];                                 // 0x3c8(0x8)
	...
	char                                                         pad0x40_YQDNQ[0x40];                               // 0x460(0x40)
};
...
public:
	...
	char                                                         pad0x4_OI979[0x4];                                 // 0x54c(0x4)
};
...
{
public:
	char                                                         pad0x10_0OXTQ[0x10];                               // 0x600(0x10)
	...
	char                                                         pad0x70_HWY03[0x70];                               // 0x698(0x70)
};
...
{
public:
	char                                                         pad0x78_GMBVL[0x78];                               // 0x3c8(0x78)
	int                                                          NumberOfCachedFlares;                              // 0x440(0x4)
	char                                                         pad0x1c_G3PT0[0x1c];                               // 0x444(0x1c)
};
...
public:
	...
	char                                                         pad0x4_ISPI1[0x4];                                 // 0x4c(0x4)
};
...
public:
	...
	char                                                         pad0x4_OIAOY[0x4];                                 // 0x2c(0x4)
...
public:
	...
	char                                                         pad0x4_4609S[0x4];                                 // 0xcc(0x4)
	...
	char                                                         pad0xbc_OK7BE[0xbc];                               // 0xdc(0xbc)
};
...
public:
	...
	char                                                         pad0x3_Z8AX1[0x3];                                 // 0x135(0x3)
...
public:
	...
	char                                                         pad0x40_WL92A[0x40];                               // 0x250(0x40)
};
