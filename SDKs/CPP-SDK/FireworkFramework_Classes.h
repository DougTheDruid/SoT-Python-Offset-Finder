...
public:
	...
	char                                                         pad0x2_Z3KSR[0x2];                                 // 0x8a(0x2)
	...
	char                                                         pad0x4_TRQOC[0x4];                                 // 0x134(0x4)
...
{
public:
	char                                                         pad0x8_ADOFO[0x8];                                 // 0x3c8(0x8)
	...
	char                                                         pad0x40_N74PJ[0x40];                               // 0x460(0x40)
};
...
public:
	...
	char                                                         pad0x4_EV3XA[0x4];                                 // 0x52c(0x4)
};
...
{
public:
	char                                                         pad0x10_ZW3SM[0x10];                               // 0x600(0x10)
	...
	char                                                         pad0x70_D4XEK[0x70];                               // 0x698(0x70)
};
...
{
public:
	char                                                         pad0x78_M5UHP[0x78];                               // 0x3c8(0x78)
	int                                                          NumberOfCachedFlares;                              // 0x440(0x4)
	char                                                         pad0x1c_7VVWK[0x1c];                               // 0x444(0x1c)
};
...
public:
	...
	char                                                         pad0x4_094CY[0x4];                                 // 0x4c(0x4)
};
...
public:
	...
	char                                                         pad0x4_ENPDZ[0x4];                                 // 0x2c(0x4)
...
public:
	...
	char                                                         pad0x4_4ZCH9[0x4];                                 // 0xcc(0x4)
	...
	char                                                         pad0xbc_PDWFT[0xbc];                               // 0xdc(0xbc)
};
...
public:
	...
	char                                                         pad0x3_8FSL4[0x3];                                 // 0x135(0x3)
...
public:
	...
	char                                                         pad0x40_VK0YP[0x40];                               // 0x250(0x40)
};
