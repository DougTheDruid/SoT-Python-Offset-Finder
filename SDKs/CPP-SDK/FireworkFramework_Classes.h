...
{
public:
	char                                                         pad0x78_FLV1B[0x78];                               // 0x3a0(0x78)
	int                                                          NumberOfCachedFlares;                              // 0x418(0x4)
	char                                                         pad0x1c_JOLLO[0x1c];                               // 0x41c(0x1c)
};
...
public:
	...
	char                                                         pad0x40_CFFCH[0x40];                               // 0x240(0x40)
};
...
public:
	...
	char                                                         pad0x4_IQS2Y[0x4];                                 // 0x4c(0x4)
};
...
// Size 0x110 (Full Size[0x778] - InheritedSize[0x668]
class FireworkProjectile: public LaunchableProjectile
{
public:
	char                                                         pad0x10_N4IWS[0x10];                               // 0x668(0x10)
	...
	char                                                         pad0x78_XMWVZ[0x78];                               // 0x700(0x78)
};
...
public:
	...
	char                                                         pad0x3_VVX09[0x3];                                 // 0x14d(0x3)
...
public:
	...
	char                                                         pad0x2_U8FCM[0x2];                                 // 0x8a(0x2)
	...
	char                                                         pad0x4_7YDUK[0x4];                                 // 0x134(0x4)
...
public:
	...
	char                                                         pad0x4_P63CM[0x4];                                 // 0xbc(0x4)
	...
	char                                                         pad0xbc_ZMD2T[0xbc];                               // 0xcc(0xbc)
};
...
{
public:
	char                                                         pad0x50_DP6K3[0x50];                               // 0x490(0x50)
};
...
public:
	...
	char                                                         pad0x4_OGKT5[0x4];                                 // 0x2c(0x4)
...
// Size 0x20 (Full Size[0x538] - InheritedSize[0x518]
class FireworkItemInfo: public ItemInfo
{
public:
	class LoadableFireworkComponent*                             LoadableProjectileComponent;                       // 0x518(0x8)
	struct StringAssetReference                                  FireworkDataAsset;                                 // 0x520(0x10)
	int                                                          GeneratedDataRNGSeed;                              // 0x530(0x4)
	char                                                         pad0x4_DZUPO[0x4];                                 // 0x534(0x4)
};
...
{
public:
	char                                                         pad0x8_BIA6Z[0x8];                                 // 0x3a0(0x8)
	...
	char                                                         pad0x40_IDZMD[0x40];                               // 0x438(0x40)
};
