...
public:
	...
	char                                                         pad0x40_2M78F[0x40];                               // 0x250(0x40)
};
...
public:
	...
	char                                                         pad0x4_O69DZ[0x4];                                 // 0x2c(0x4)
...
public:
	...
	char                                                         pad0x4_Q89EM[0x4];                                 // 0x54c(0x4)
};
...
{
public:
	char                                                         pad0x10_LX43A[0x10];                               // 0x600(0x10)
	...
	char                                                         pad0x70_Y19Y4[0x70];                               // 0x698(0x70)
};
...
{
public:
	char                                                         pad0x50_U6MQD[0x50];                               // 0x4a0(0x50)
};
...
public:
	...
	char                                                         pad0x3_2ZZVB[0x3];                                 // 0x135(0x3)
...
{
public:
	char                                                         pad0x78_8FSQO[0x78];                               // 0x3c8(0x78)
	int                                                          NumberOfCachedFlares;                              // 0x440(0x4)
	char                                                         pad0x1c_4TV1N[0x1c];                               // 0x444(0x1c)
};
...
{
public:
	char                                                         pad0x8_7TYZW[0x8];                                 // 0x3c8(0x8)
	...
	char                                                         pad0x40_7IZIZ[0x40];                               // 0x460(0x40)
};
...
public:
	...
	char                                                         pad0x4_ZNKYF[0x4];                                 // 0x4c(0x4)
};
...
public:
	...
	char                                                         pad0x2_ENDFQ[0x2];                                 // 0x8a(0x2)
	...
	char                                                         pad0x4_7QMSJ[0x4];                                 // 0x134(0x4)
...
public:
	...
	char                                                         pad0x4_GGUK4[0x4];                                 // 0xcc(0x4)
	...
	char                                                         pad0xbc_PBI3A[0xbc];                               // 0xdc(0xbc)
};
