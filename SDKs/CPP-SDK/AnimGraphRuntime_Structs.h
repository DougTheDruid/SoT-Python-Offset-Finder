...
{
public:
	char                                                         pad0x58_WJIP4[0x58];                               // 0x0(0x58)
	...
	char                                                         pad0x2_RPLOP[0x2];                                 // 0x8e(0x2)
};
...
{
public:
	char                                                         pad0x58_NAY9Y[0x58];                               // 0x0(0x58)
...
public:
	...
	char                                                         pad0x3_XD9TN[0x3];                                 // 0x95(0x3)
	...
	char                                                         pad0x2_X3Q0P[0x2];                                 // 0x9a(0x2)
	char                                                         ModificationMode;                                  // 0x9c(0x1)
	char                                                         pad0x3_N8DFW[0x3];                                 // 0x9d(0x3)
};
...
public:
	...
	char                                                         pad0x29_FLUOB[0x29];                               // 0x7f(0x29)
};
...
{
public:
	char                                                         pad0x58_PU3GI[0x58];                               // 0x0(0x58)
	struct BoneReference                                         SourceBone;                                        // 0x58(0xc)
	...
	char                                                         pad0x5_AZWYD[0x5];                                 // 0x73(0x5)
};
...
public:
	...
	char                                                         pad0xb_DJ9R0[0xb];                                 // 0xc5(0xb)
};
...
{
public:
	char                                                         pad0x58_Q7VVY[0x58];                               // 0x0(0x58)
	struct BoneReference                                         BoneToModify;                                      // 0x58(0xc)
...
{
public:
	char                                                         pad0x58_ZVAE7[0x58];                               // 0x0(0x58)
	...
	char                                                         pad0x2_WJEXM[0x2];                                 // 0x76(0x2)
};
...
{
public:
	char                                                         pad0x58_CTWVW[0x58];                               // 0x0(0x58)
	...
	char                                                         pad0x4_RYQWH[0x4];                                 // 0x9c(0x4)
};
...
{
public:
	char                                                         pad0x58_Z70SR[0x58];                               // 0x0(0x58)
	...
	char                                                         pad0x1_JFWYT[0x1];                                 // 0x6b(0x1)
	...
	char                                                         pad0x5f_X6P51[0x5f];                               // 0x81(0x5f)
};
