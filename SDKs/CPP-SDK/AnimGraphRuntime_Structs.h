...
public:
	...
	char                                                         pad0x29_1T4AK[0x29];                               // 0x7f(0x29)
};
...
{
public:
	char                                                         pad0x58_HO5EP[0x58];                               // 0x0(0x58)
...
{
public:
	char                                                         pad0x58_R2GHW[0x58];                               // 0x0(0x58)
	struct BoneReference                                         BoneToModify;                                      // 0x58(0xc)
	...
	char                                                         pad0x2_RD1MJ[0x2];                                 // 0x8e(0x2)
};
...
public:
	...
	char                                                         pad0x3_8ELAH[0x3];                                 // 0x95(0x3)
	...
	char                                                         pad0x2_G95W3[0x2];                                 // 0x9a(0x2)
	char                                                         ModificationMode;                                  // 0x9c(0x1)
	char                                                         pad0x3_K3MPK[0x3];                                 // 0x9d(0x3)
};
...
{
public:
	char                                                         pad0x58_RMFGK[0x58];                               // 0x0(0x58)
...
{
public:
	char                                                         pad0x58_I9SZW[0x58];                               // 0x0(0x58)
	struct BoneReference                                         SourceBone;                                        // 0x58(0xc)
	...
	char                                                         pad0x5_TK1ZD[0x5];                                 // 0x73(0x5)
};
...
public:
	...
	char                                                         pad0xb_E34PD[0xb];                                 // 0xc5(0xb)
};
...
{
public:
	char                                                         pad0x58_4XD72[0x58];                               // 0x0(0x58)
	...
	char                                                         pad0x4_D1ZU9[0x4];                                 // 0x9c(0x4)
};
...
{
public:
	char                                                         pad0x58_UFLNO[0x58];                               // 0x0(0x58)
	...
	char                                                         pad0x2_7YZXZ[0x2];                                 // 0x76(0x2)
};
...
{
public:
	char                                                         pad0x58_W2MQA[0x58];                               // 0x0(0x58)
	...
	char                                                         pad0x1_1RVD5[0x1];                                 // 0x6b(0x1)
	...
	char                                                         pad0x5f_ZYQWX[0x5f];                               // 0x81(0x5f)
};
