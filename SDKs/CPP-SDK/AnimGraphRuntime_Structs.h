...
{
public:
	char                                                         pad0x58_EYVU5[0x58];                               // 0x0(0x58)
	...
	char                                                         pad0x2_JEZYH[0x2];                                 // 0x76(0x2)
};
...
public:
	...
	char                                                         pad0x3_PDWKD[0x3];                                 // 0x95(0x3)
	...
	char                                                         pad0x2_9VL56[0x2];                                 // 0x9a(0x2)
	char                                                         ModificationMode;                                  // 0x9c(0x1)
	char                                                         pad0x3_Y5BAD[0x3];                                 // 0x9d(0x3)
};
...
public:
	...
	char                                                         pad0xb_SK5XE[0xb];                                 // 0xc5(0xb)
};
...
public:
	...
	char                                                         pad0x29_9ME15[0x29];                               // 0x7f(0x29)
};
...
{
public:
	char                                                         pad0x58_AM8V4[0x58];                               // 0x0(0x58)
	struct BoneReference                                         SourceBone;                                        // 0x58(0xc)
	...
	char                                                         pad0x5_MVIS6[0x5];                                 // 0x73(0x5)
};
...
{
public:
	char                                                         pad0x58_5XNOM[0x58];                               // 0x0(0x58)
...
{
public:
	char                                                         pad0x58_ZHPIF[0x58];                               // 0x0(0x58)
	...
	char                                                         pad0x2_5KR8L[0x2];                                 // 0x8e(0x2)
};
...
{
public:
	char                                                         pad0x58_MMFEU[0x58];                               // 0x0(0x58)
	...
	char                                                         pad0x1_TI7XT[0x1];                                 // 0x6b(0x1)
	...
	char                                                         pad0x5f_88O77[0x5f];                               // 0x81(0x5f)
};
...
{
public:
	char                                                         pad0x58_HVHFL[0x58];                               // 0x0(0x58)
	...
	char                                                         pad0x4_WCS2Y[0x4];                                 // 0x9c(0x4)
};
...
{
public:
	char                                                         pad0x58_GETEL[0x58];                               // 0x0(0x58)
	struct BoneReference                                         BoneToModify;                                      // 0x58(0xc)
