...
public:
	...
	char                                                         pad0x29_UAP81[0x29];                               // 0x7f(0x29)
};
...
{
public:
	char                                                         pad0x58_4RKDQ[0x58];                               // 0x0(0x58)
...
public:
	...
	char                                                         pad0xb_FYMRM[0xb];                                 // 0xc5(0xb)
};
...
{
public:
	char                                                         pad0x58_TP48I[0x58];                               // 0x0(0x58)
	...
	char                                                         pad0x2_NNATI[0x2];                                 // 0x8e(0x2)
};
...
{
public:
	char                                                         pad0x58_KXBIE[0x58];                               // 0x0(0x58)
	...
	char                                                         pad0x2_G90Q0[0x2];                                 // 0x76(0x2)
};
...
{
public:
	char                                                         pad0x58_XIO6M[0x58];                               // 0x0(0x58)
	...
	char                                                         pad0x4_WPWMG[0x4];                                 // 0x9c(0x4)
};
...
{
public:
	char                                                         pad0x58_RF0F1[0x58];                               // 0x0(0x58)
	...
	char                                                         pad0x5_NAK5F[0x5];                                 // 0x73(0x5)
};
...
{
public:
	char                                                         pad0x58_KFM9K[0x58];                               // 0x0(0x58)
	...
	char                                                         pad0x1_O3AE7[0x1];                                 // 0x6b(0x1)
	...
	char                                                         pad0x5f_QIWUR[0x5f];                               // 0x81(0x5f)
};
...
{
public:
	char                                                         pad0x58_N1B7V[0x58];                               // 0x0(0x58)
	struct BoneReference                                         BoneToModify;                                      // 0x58(0xc)
...
{
public:
	char                                                         pad0x58_Z441F[0x58];                               // 0x0(0x58)
	struct BoneReference                                         SourceBone;                                        // 0x58(0xc)
	char                                                         SourceComponent;                                   // 0x64(0x1)
	char                                                         pad0x3_Y8MWM[0x3];                                 // 0x65(0x3)
	class CurveFloat*                                            DrivingCurve;                                      // 0x68(0x8)
	float                                                        Multiplier;                                        // 0x70(0x4)
	bool                                                         bUseRange;                                         // 0x74(0x1)
	char                                                         pad0x3_G9QWB[0x3];                                 // 0x75(0x3)
	...
	char                                                         pad0x3_CV4MZ[0x3];                                 // 0x95(0x3)
	...
	char                                                         pad0x2_HTSL3[0x2];                                 // 0x9a(0x2)
	char                                                         ModificationMode;                                  // 0x9c(0x1)
	char                                                         pad0x3_N45NI[0x3];                                 // 0x9d(0x3)
};
