...
{
public:
	char                                                         pad0x58_YDH2O[0x58];                               // 0x0(0x58)
	...
	char                                                         pad0x2_B4SNY[0x2];                                 // 0x8e(0x2)
};
...
{
public:
	char                                                         pad0x58_LJ12I[0x58];                               // 0x0(0x58)
	...
	char                                                         pad0x5_NAZJA[0x5];                                 // 0x73(0x5)
};
...
{
public:
	char                                                         pad0x58_DZCWX[0x58];                               // 0x0(0x58)
	...
	char                                                         pad0x2_AQWUC[0x2];                                 // 0x76(0x2)
};
...
{
public:
	char                                                         pad0x58_4UQ4V[0x58];                               // 0x0(0x58)
	struct BoneReference                                         SourceBone;                                        // 0x58(0xc)
	char                                                         SourceComponent;                                   // 0x64(0x1)
	char                                                         pad0x3_1WDEL[0x3];                                 // 0x65(0x3)
	class CurveFloat*                                            DrivingCurve;                                      // 0x68(0x8)
	float                                                        Multiplier;                                        // 0x70(0x4)
	bool                                                         bUseRange;                                         // 0x74(0x1)
	char                                                         pad0x3_IHQUJ[0x3];                                 // 0x75(0x3)
	...
	char                                                         pad0x3_69FI7[0x3];                                 // 0x95(0x3)
	...
	char                                                         pad0x2_6B5IB[0x2];                                 // 0x9a(0x2)
	char                                                         ModificationMode;                                  // 0x9c(0x1)
	char                                                         pad0x3_7H2B1[0x3];                                 // 0x9d(0x3)
};
...
public:
	...
	char                                                         pad0x29_C3SA8[0x29];                               // 0x7f(0x29)
};
...
{
public:
	char                                                         pad0x58_RXQ48[0x58];                               // 0x0(0x58)
	...
	char                                                         pad0x4_FI03Y[0x4];                                 // 0x9c(0x4)
};
...
{
public:
	char                                                         pad0x58_N5VOA[0x58];                               // 0x0(0x58)
	...
	char                                                         pad0x1_13NPK[0x1];                                 // 0x6b(0x1)
	...
	char                                                         pad0x5f_B75P0[0x5f];                               // 0x81(0x5f)
};
...
{
public:
	char                                                         pad0x58_7JZLF[0x58];                               // 0x0(0x58)
	struct BoneReference                                         BoneToModify;                                      // 0x58(0xc)
...
public:
	...
	char                                                         pad0xb_W2HDJ[0xb];                                 // 0xc5(0xb)
};
...
{
public:
	char                                                         pad0x58_P79SI[0x58];                               // 0x0(0x58)
