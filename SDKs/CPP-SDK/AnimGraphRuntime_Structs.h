...
{
public:
	char                                                         pad0x58_WDMVT[0x58];                               // 0x0(0x58)
...
{
public:
	char                                                         pad0x58_RJHMA[0x58];                               // 0x0(0x58)
	...
	char                                                         pad0x2_978LZ[0x2];                                 // 0x76(0x2)
};
...
public:
	...
	char                                                         pad0xb_A0XR7[0xb];                                 // 0xc5(0xb)
};
...
{
public:
	char                                                         pad0x58_RXHFX[0x58];                               // 0x0(0x58)
	...
	char                                                         pad0x4_PTED1[0x4];                                 // 0x9c(0x4)
};
...
public:
	...
	char                                                         pad0x3_ZUODQ[0x3];                                 // 0x95(0x3)
	...
	char                                                         pad0x2_76VWY[0x2];                                 // 0x9a(0x2)
	char                                                         ModificationMode;                                  // 0x9c(0x1)
	char                                                         pad0x3_1C10N[0x3];                                 // 0x9d(0x3)
};
...
{
public:
	char                                                         pad0x58_5LUDO[0x58];                               // 0x0(0x58)
	...
	char                                                         pad0x1_XEF4M[0x1];                                 // 0x6b(0x1)
	...
	char                                                         pad0x5f_Z0RC6[0x5f];                               // 0x81(0x5f)
};
...
{
public:
	char                                                         pad0x58_ZQLK3[0x58];                               // 0x0(0x58)
...
{
public:
	char                                                         pad0x58_E7QIK[0x58];                               // 0x0(0x58)
	struct BoneReference                                         BoneToModify;                                      // 0x58(0xc)
	...
	char                                                         pad0x2_OD1TK[0x2];                                 // 0x8e(0x2)
};
...
public:
	...
	char                                                         pad0x29_PP9F8[0x29];                               // 0x7f(0x29)
};
...
{
public:
	char                                                         pad0x58_H6H8S[0x58];                               // 0x0(0x58)
	struct BoneReference                                         SourceBone;                                        // 0x58(0xc)
	...
	char                                                         pad0x5_M2AYZ[0x5];                                 // 0x73(0x5)
};
