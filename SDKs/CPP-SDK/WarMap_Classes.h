...
public:
	...
	char                                                         pad0xef_9RHH4[0xef];                               // 0x41(0xef)
};
...
public:
	...
	char                                                         pad0x230_DZUN2[0x230];                             // 0x3f0(0x230)
};
...
public:
	...
	char                                                         pad0x67_OTUIR[0x67];                               // 0x41(0x67)
	TArray<class PlayerState*>                                   Votes;                                             // 0xa8(0x10)
	char                                                         pad0x58_NU2NF[0x58];                               // 0xb8(0x58)
};
...
{
public:
	char                                                         pad0x10_8CPER[0x10];                               // 0x168(0x10)
};
...
{
public:
	char                                                         pad0x8_0PNAF[0x8];                                 // 0x140(0x8)
	...
	char                                                         pad0x20_Q0GWL[0x20];                               // 0x1c0(0x20)
};
...
public:
	...
	char                                                         pad0x7_PJ68Z[0x7];                                 // 0x131(0x7)
};
