...
public:
	...
	char                                                         pad0x230_N82TK[0x230];                             // 0x3f0(0x230)
};
...
{
public:
	char                                                         pad0x8_OCS3O[0x8];                                 // 0x140(0x8)
	...
	char                                                         pad0x20_OFRKQ[0x20];                               // 0x1c0(0x20)
};
...
{
public:
	char                                                         pad0x10_5P1KE[0x10];                               // 0x168(0x10)
};
...
public:
	...
	char                                                         pad0x67_MAYOJ[0x67];                               // 0x41(0x67)
	TArray<class PlayerState*>                                   Votes;                                             // 0xa8(0x10)
	char                                                         pad0x58_7UUTR[0x58];                               // 0xb8(0x58)
};
...
public:
	...
	char                                                         pad0xef_2IRDO[0xef];                               // 0x41(0xef)
};
...
public:
	...
	char                                                         pad0x7_TSSTF[0x7];                                 // 0x131(0x7)
};
