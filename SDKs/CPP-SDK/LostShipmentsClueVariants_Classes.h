...
{
public:
	char                                                         pad0x20_PK60Z[0x20];                               // 0xc8(0x20)
	...
	char                                                         pad0x80_DP6UX[0x80];                               // 0x150(0x80)
};
...
public:
	...
	char                                                         pad0x50_2DUKY[0x50];                               // 0x170(0x50)
};
...
{
public:
	char                                                         pad0x10_93ESA[0x10];                               // 0x7e0(0x10)
	...
	char                                                         pad0xf_ZLTYZ[0xf];                                 // 0x811(0xf)
};
...
public:
	...
	char                                                         pad0x2c_RRTN2[0x2c];                               // 0x44(0x2c)
};
...
{
public:
	char                                                         pad0x10_A0J65[0x10];                               // 0xc8(0x10)
...
{
public:
	char                                                         pad0x20_V2YEO[0x20];                               // 0x890(0x20)
	Struct MapRadialIconData                                     MapRadialIconData;                                 // 0x8b0(0x18)
	char                                                         pad0x8_VXGA9[0x8];                                 // 0x8c8(0x8)
};
...
public:
	Struct Vector                                                SpawnLocation;                                     // 0x38(0xc)
	char                                                         pad0x2c_2AY3V[0x2c];                               // 0x44(0x2c)
};
...
public:
	...
	char                                                         pad0x7_CTJVZ[0x7];                                 // 0x41(0x7)
};
...
public:
	...
	char                                                         pad0x4_Q9CDC[0x4];                                 // 0x54(0x4)
};
...
public:
	...
	char                                                         pad0x4_7Y0TD[0x4];                                 // 0x44(0x4)
};
...
public:
	...
	char                                                         pad0x30_Y84RG[0x30];                               // 0xf0(0x30)
};
...
{
public:
	char                                                         pad0x8_95ADO[0x8];                                 // 0x148(0x8)
...
public:
	...
	char                                                         pad0x4_2QPUG[0x4];                                 // 0x4c(0x4)
};
...
{
public:
	char                                                         pad0x18_U8RJP[0x18];                               // 0x60(0x18)
	TArray<class ClueDescriptor*>                                ObtainedClues;                                     // 0x78(0x10)
	char                                                         pad0x50_882VL[0x50];                               // 0x88(0x50)
...
public:
	...
	char                                                         pad0x98_H0XXG[0x98];                               // 0xa8(0x98)
};
...
{
public:
	char                                                         pad0x20_DE4SK[0x20];                               // 0x30(0x20)
	...
	char                                                         pad0x4_YVOSZ[0x4];                                 // 0x6c(0x4)
...
public:
	...
	Struct Transform                                             SpawnTransform;                                    // 0x60(0x30)
	char                                                         pad0x30_NA82D[0x30];                               // 0x90(0x30)
};
...
public:
	...
	char                                                         pad0x4_0RLOH[0x4];                                 // 0x6c(0x4)
};
...
{
public:
	char                                                         pad0x8_9KL5W[0x8];                                 // 0xc8(0x8)
	byte                                                         GrammaticalGender;                                 // 0xd0(0x1)
	char                                                         pad0x7_9MM5J[0x7];                                 // 0xd1(0x7)
};
