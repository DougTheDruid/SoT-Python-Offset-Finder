...
public:
	...
	char                                                         pad0x2c_DDH4N[0x2c];                               // 0x44(0x2c)
};
...
public:
	...
	char                                                         pad0x4_RLCFU[0x4];                                 // 0x44(0x4)
};
...
{
public:
	char                                                         pad0x20_XSGUL[0x20];                               // 0xb8(0x20)
	...
	char                                                         pad0x80_4OZX0[0x80];                               // 0x140(0x80)
};
...
public:
	...
	char                                                         pad0x4_ANDMK[0x4];                                 // 0x54(0x4)
};
...
{
public:
	char                                                         pad0xb8_6WB9A[0xb8];                               // 0x28(0xb8)
};
...
{
public:
	char                                                         pad0x8_VDK8O[0x8];                                 // 0xb8(0x8)
	char                                                         GrammaticalGender;                                 // 0xc0(0x1)
	char                                                         pad0x7_VYLFE[0x7];                                 // 0xc1(0x7)
};
...
{
public:
	char                                                         pad0x40_ZG415[0x40];                               // 0x28(0x40)
};
...
public:
	...
	char                                                         pad0x30_D9VDA[0x30];                               // 0xf0(0x30)
};
...
{
public:
	char                                                         pad0x18_Y2Z7C[0x18];                               // 0x60(0x18)
	TArray<class ClueDescriptor*>                                ObtainedClues;                                     // 0x78(0x10)
	char                                                         pad0x50_H0XI3[0x50];                               // 0x88(0x50)
...
{
public:
	char                                                         pad0x8_K8ZAO[0x8];                                 // 0x138(0x8)
...
public:
	...
	char                                                         pad0x98_MNEZ0[0x98];                               // 0xa8(0x98)
};
...
{
public:
	char                                                         pad0x10_SAA6S[0x10];                               // 0xb8(0x10)
...
public:
	...
	char                                                         pad0x4_EI3SE[0x4];                                 // 0x6c(0x4)
};
...
public:
	...
	struct Transform                                             SpawnTransform;                                    // 0x60(0x30)
	char                                                         pad0x30_RF1ZE[0x30];                               // 0x90(0x30)
};
...
{
public:
	char                                                         pad0x10_01144[0x10];                               // 0x4c0(0x10)
};
...
public:
	...
	char                                                         pad0x50_NSROE[0x50];                               // 0x160(0x50)
};
...
{
public:
	char                                                         pad0x20_E5267[0x20];                               // 0x30(0x20)
	...
	char                                                         pad0x4_38OHV[0x4];                                 // 0x6c(0x4)
...
public:
	...
	char                                                         pad0x7_DH56J[0x7];                                 // 0x41(0x7)
};
...
public:
	struct Vector                                                SpawnLocation;                                     // 0x38(0xc)
	char                                                         pad0x2c_8J3EI[0x2c];                               // 0x44(0x2c)
};
...
{
public:
	char                                                         pad0x20_C1114[0x20];                               // 0x8c0(0x20)
	struct MapRadialIconData                                     MapRadialIconData;                                 // 0x8e0(0x18)
	char                                                         pad0x8_R7ABB[0x8];                                 // 0x8f8(0x8)
};
...
{
public:
	char                                                         pad0x10_JCB8H[0x10];                               // 0x7f0(0x10)
	...
	char                                                         pad0xf_VTKOO[0xf];                                 // 0x821(0xf)
};
...
public:
	...
	char                                                         pad0x4_FR14Z[0x4];                                 // 0x4c(0x4)
};
...
{
public:
	char                                                         pad0x80_UNFK5[0x80];                               // 0x150(0x80)
};
