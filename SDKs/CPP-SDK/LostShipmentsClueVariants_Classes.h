...
{
public:
	char                                                         pad0x20_SRO8L[0x20];                               // 0xc8(0x20)
	...
	char                                                         pad0x80_GQ44J[0x80];                               // 0x150(0x80)
};
...
public:
	...
	char                                                         pad0x50_BGC7M[0x50];                               // 0x170(0x50)
};
...
{
public:
	char                                                         pad0x10_2J4HH[0x10];                               // 0x7e0(0x10)
	...
	char                                                         pad0xf_XX964[0xf];                                 // 0x811(0xf)
};
...
public:
	...
	char                                                         pad0x2c_PZOJJ[0x2c];                               // 0x44(0x2c)
};
...
{
public:
	char                                                         pad0x10_04QEN[0x10];                               // 0xc8(0x10)
...
{
public:
	char                                                         pad0x20_Z1NEW[0x20];                               // 0x890(0x20)
	Struct MapRadialIconData                                     MapRadialIconData;                                 // 0x8b0(0x18)
	char                                                         pad0x8_XQORG[0x8];                                 // 0x8c8(0x8)
};
...
public:
	Struct Vector                                                SpawnLocation;                                     // 0x38(0xc)
	char                                                         pad0x2c_6ROKU[0x2c];                               // 0x44(0x2c)
};
...
public:
	...
	char                                                         pad0x7_7WDP8[0x7];                                 // 0x41(0x7)
};
...
public:
	...
	char                                                         pad0x4_B24TJ[0x4];                                 // 0x54(0x4)
};
...
public:
	...
	char                                                         pad0x4_IJ5HQ[0x4];                                 // 0x44(0x4)
};
...
public:
	...
	char                                                         pad0x30_PVCIK[0x30];                               // 0xf0(0x30)
};
...
{
public:
	char                                                         pad0x8_RSZ8F[0x8];                                 // 0x148(0x8)
...
public:
	...
	char                                                         pad0x4_12GSQ[0x4];                                 // 0x4c(0x4)
};
...
{
public:
	char                                                         pad0x18_RIRTM[0x18];                               // 0x60(0x18)
	TArray<class ClueDescriptor*>                                ObtainedClues;                                     // 0x78(0x10)
	char                                                         pad0x50_OXJLJ[0x50];                               // 0x88(0x50)
...
public:
	...
	char                                                         pad0x98_JV817[0x98];                               // 0xa8(0x98)
};
...
{
public:
	char                                                         pad0x20_QZ3L4[0x20];                               // 0x30(0x20)
	...
	char                                                         pad0x4_SX37T[0x4];                                 // 0x6c(0x4)
...
public:
	...
	Struct Transform                                             SpawnTransform;                                    // 0x60(0x30)
	char                                                         pad0x30_CV9CH[0x30];                               // 0x90(0x30)
};
...
public:
	...
	char                                                         pad0x4_5TAVS[0x4];                                 // 0x6c(0x4)
};
...
{
public:
	char                                                         pad0x8_MVI5Y[0x8];                                 // 0xc8(0x8)
	byte                                                         GrammaticalGender;                                 // 0xd0(0x1)
	char                                                         pad0x7_JYRD6[0x7];                                 // 0xd1(0x7)
};
