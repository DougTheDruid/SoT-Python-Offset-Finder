...
{
public:
	char                                                         pad0xb8_L6FHN[0xb8];                               // 0x28(0xb8)
};
...
public:
	...
	char                                                         pad0x4_91L59[0x4];                                 // 0x54(0x4)
};
...
public:
	...
	char                                                         pad0x2c_AGF1Y[0x2c];                               // 0x44(0x2c)
};
...
public:
	...
	char                                                         pad0x7_A21UA[0x7];                                 // 0x41(0x7)
};
...
{
public:
	char                                                         pad0x8_AWKFQ[0x8];                                 // 0x138(0x8)
...
{
public:
	char                                                         pad0x20_FMMD8[0x20];                               // 0xb8(0x20)
	...
	char                                                         pad0x80_IFRPL[0x80];                               // 0x140(0x80)
};
...
{
public:
	char                                                         pad0x20_7O521[0x20];                               // 0x30(0x20)
	...
	char                                                         pad0x4_NIUPG[0x4];                                 // 0x6c(0x4)
...
{
public:
	char                                                         pad0x10_K6DYQ[0x10];                               // 0xb8(0x10)
...
public:
	...
	char                                                         pad0x30_0D4SG[0x30];                               // 0xf0(0x30)
};
...
public:
	struct Vector                                                SpawnLocation;                                     // 0x38(0xc)
	char                                                         pad0x2c_9MFI0[0x2c];                               // 0x44(0x2c)
};
...
{
public:
	char                                                         pad0x10_NARDC[0x10];                               // 0x7f0(0x10)
	...
	char                                                         pad0xf_VRLWB[0xf];                                 // 0x821(0xf)
};
...
public:
	...
	char                                                         pad0x4_5PGP1[0x4];                                 // 0x44(0x4)
};
...
{
public:
	char                                                         pad0x20_FI1G0[0x20];                               // 0x8c0(0x20)
	struct MapRadialIconData                                     MapRadialIconData;                                 // 0x8e0(0x18)
	char                                                         pad0x8_Y9EHN[0x8];                                 // 0x8f8(0x8)
};
...
public:
	...
	char                                                         pad0x4_7SN71[0x4];                                 // 0x4c(0x4)
};
...
public:
	...
	char                                                         pad0x4_PNEEU[0x4];                                 // 0x6c(0x4)
};
...
{
public:
	char                                                         pad0x10_BNYXY[0x10];                               // 0x4c0(0x10)
};
...
public:
	...
	char                                                         pad0x98_9JCFQ[0x98];                               // 0xa8(0x98)
};
...
{
public:
	char                                                         pad0x40_12W5J[0x40];                               // 0x28(0x40)
};
...
{
public:
	char                                                         pad0x8_GDR59[0x8];                                 // 0xb8(0x8)
	char                                                         GrammaticalGender;                                 // 0xc0(0x1)
	char                                                         pad0x7_922LX[0x7];                                 // 0xc1(0x7)
};
...
{
public:
	char                                                         pad0x18_3BCZW[0x18];                               // 0x60(0x18)
	TArray<class ClueDescriptor*>                                ObtainedClues;                                     // 0x78(0x10)
	char                                                         pad0x50_U04VX[0x50];                               // 0x88(0x50)
...
public:
	...
	struct Transform                                             SpawnTransform;                                    // 0x60(0x30)
	char                                                         pad0x30_91F9D[0x30];                               // 0x90(0x30)
};
...
public:
	...
	char                                                         pad0x50_TXBOH[0x50];                               // 0x160(0x50)
};
...
{
public:
	char                                                         pad0x80_4P424[0x80];                               // 0x150(0x80)
};
