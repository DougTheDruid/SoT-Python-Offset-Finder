...
public:
	...
	char                                                         pad0x98_H055G[0x98];                               // 0xa8(0x98)
};
...
{
public:
	char                                                         pad0x10_PXRQP[0x10];                               // 0x7e0(0x10)
	...
	char                                                         QuestMapIcon;                                      // 0x810(0x1)
	char                                                         pad0xf_Q8K9R[0xf];                                 // 0x811(0xf)
};
...
public:
	...
	char                                                         pad0x4_WV489[0x4];                                 // 0x6c(0x4)
};
...
public:
	...
	char                                                         pad0x30_NDS37[0x30];                               // 0xf0(0x30)
};
...
public:
	...
	char                                                         pad0x7_H9QUM[0x7];                                 // 0x41(0x7)
};
...
{
public:
	char                                                         pad0x20_9OCLZ[0x20];                               // 0x890(0x20)
	struct MapRadialIconData                                     MapRadialIconData;                                 // 0x8b0(0x18)
	char                                                         pad0x8_JW6B9[0x8];                                 // 0x8c8(0x8)
};
...
public:
	...
	char                                                         pad0x4_R7ZO0[0x4];                                 // 0x54(0x4)
};
...
public:
	...
	char                                                         pad0x2c_424U5[0x2c];                               // 0x44(0x2c)
};
...
public:
	...
	char                                                         pad0x4_RELYK[0x4];                                 // 0x4c(0x4)
};
...
{
public:
	char                                                         pad0x20_11ZVZ[0x20];                               // 0x30(0x20)
	...
	char                                                         pad0x4_JSW2R[0x4];                                 // 0x6c(0x4)
...
{
public:
	char                                                         pad0x8_RZGB4[0x8];                                 // 0x148(0x8)
...
{
public:
	char                                                         pad0xb8_R7ASU[0xb8];                               // 0x28(0xb8)
};
...
{
public:
	char                                                         pad0x10_PQWUZ[0x10];                               // 0xc8(0x10)
...
{
public:
	char                                                         pad0x18_3HXIV[0x18];                               // 0x60(0x18)
	TArray<class ClueDescriptor*>                                ObtainedClues;                                     // 0x78(0x10)
	char                                                         pad0x50_XRY4G[0x50];                               // 0x88(0x50)
...
{
public:
	char                                                         pad0x20_ZPSAZ[0x20];                               // 0xc8(0x20)
	...
	char                                                         pad0x80_KCMUH[0x80];                               // 0x150(0x80)
};
...
{
public:
	char                                                         pad0x10_DPYPX[0x10];                               // 0x470(0x10)
};
...
{
public:
	char                                                         pad0x8_DH74T[0x8];                                 // 0xc8(0x8)
	char                                                         GrammaticalGender;                                 // 0xd0(0x1)
	char                                                         pad0x7_BK77M[0x7];                                 // 0xd1(0x7)
};
...
public:
	...
	char                                                         pad0x4_L3QY8[0x4];                                 // 0x44(0x4)
};
...
{
public:
	char                                                         pad0x40_GY2MO[0x40];                               // 0x28(0x40)
};
...
public:
	struct Vector                                                SpawnLocation;                                     // 0x38(0xc)
	char                                                         pad0x2c_B6DIM[0x2c];                               // 0x44(0x2c)
};
...
public:
	...
	char                                                         pad0x50_LJ2Q1[0x50];                               // 0x170(0x50)
};
...
public:
	...
	struct Transform                                             SpawnTransform;                                    // 0x60(0x30)
	char                                                         pad0x30_3P89Y[0x30];                               // 0x90(0x30)
};
...
{
public:
	char                                                         pad0x80_476H7[0x80];                               // 0x160(0x80)
};
