...
{
public:
	class WieldableItemCanvasRenderingComponent*                 WieldableItemCanvasRenderingComponent;             // 0x820(0x8)
	class AbandonedNoteWieldableRenderingComponent*              AbandonedNoteRenderingComponent;                   // 0x828(0x8)
...
{
public:
	assetobject                                                  InventoryRadialBackgroundTexture;                  // 0x8c0(0x20)
