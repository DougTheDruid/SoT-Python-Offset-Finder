...
public:
	...
	struct                                                       IslandSpawnLocationReservationId;                  // 0x50(0x10)
	struct                                                       SpawnTransform;                                    // 0x60(0x30)
};
...
public:
	...
	struct                                                       CurrentClueDestination;                            // 0x100(0x10)
...
{
public:
	struct                                                       ExistingNPCActor;                                  // 0x80(0x30)
	struct                                                       ObtainedPhasedNPCActorType;                        // 0xb0(0x30)
	struct                                                       PhasingSourceActor;                                // 0xe0(0x30)
...
{
public:
	struct                                                       ClueSite;                                          // 0x80(0x30)
	struct                                                       ClueDescriptor;                                    // 0xb0(0x30)
	struct                                                       SkeletonActor;                                     // 0xe0(0x30)
	struct                                                       ClueItem;                                          // 0x110(0x30)
...
{
public:
	struct                                                       NPCIdentifier;                                     // 0x40(0x10)
};
...
{
public:
	struct                                                       Clue;                                              // 0x80(0x30)
	struct                                                       ClueActor;                                         // 0xb0(0x30)
	struct                                                       Discoverer;                                        // 0xe0(0x30)
};
...
{
public:
	class WieldableItemCanvasRenderingComponent*                 WieldableItemCanvasRenderingComponent;             // 0x7f8(0x8)
	class AbandonedNoteWieldableRenderingComponent*              AbandonedNoteRenderingComponent;                   // 0x800(0x8)
...
public:
	struct                                                       ClueSite;                                          // 0x80(0x30)
	struct                                                       NPCFromClueSite;                                   // 0xb0(0x30)
};
...
public:
	...
	struct                                                       BodyTextLayout;                                    // 0xe8(0x3c)
	struct                                                       TitleTextLayout;                                   // 0x124(0x3c)
...
{
public:
	struct                                                       SeaLocationIdentifier;                             // 0x40(0xc)
};
...
public:
	...
	struct                                                       IslandSpawnLocationReservationId;                  // 0x48(0x10)
	struct                                                       SpawnTransform;                                    // 0x60(0x30)
...
{
public:
	struct                                                       ShipwreckSpawnedOn;                                // 0x80(0x30)
	struct                                                       SpawnedMerchantCaptain;                            // 0xb0(0x30)
};
...
{
public:
	assetobject                                                  InventoryRadialBackgroundTexture;                  // 0x898(0x20)
	struct                                                       MapRadialIconData;                                 // 0x8b8(0x18)
};
...
public:
	struct                                                       ClueSite;                                          // 0x80(0x30)
	struct                                                       ClueDescriptor;                                    // 0xb0(0x30)
	struct                                                       MessageInABottle;                                  // 0xe0(0x30)
};
