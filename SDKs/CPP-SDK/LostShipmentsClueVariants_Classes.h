...
public:
	...
	char                                                         pad0x4_05JAR[0x4];                                 // 0x54(0x4)
};
...
{
public:
	char                                                         pad0x18_IWTKT[0x18];                               // 0x60(0x18)
	TArray<class ClueDescriptor*>                                ObtainedClues;                                     // 0x78(0x10)
	char                                                         pad0x50_A81SR[0x50];                               // 0x88(0x50)
...
public:
	...
	char                                                         pad0x30_N5WWJ[0x30];                               // 0xf0(0x30)
};
...
public:
	...
	char                                                         pad0x2c_NUTMN[0x2c];                               // 0x44(0x2c)
};
...
{
public:
	char                                                         pad0x10_Z1HAG[0x10];                               // 0xb8(0x10)
...
public:
	...
	char                                                         pad0x98_FY9M7[0x98];                               // 0xa8(0x98)
};
...
public:
	...
	char                                                         pad0x7_GSPKP[0x7];                                 // 0x41(0x7)
};
...
{
public:
	char                                                         pad0x10_HJU4S[0x10];                               // 0x480(0x10)
};
...
public:
	...
	char                                                         pad0x4_WX6SY[0x4];                                 // 0x6c(0x4)
};
...
public:
	...
	char                                                         pad0x50_ZACWU[0x50];                               // 0x160(0x50)
};
...
{
public:
	char                                                         pad0x10_TAPM6[0x10];                               // 0x7f0(0x10)
	...
	char                                                         pad0xf_90HZN[0xf];                                 // 0x821(0xf)
};
...
{
public:
	char                                                         pad0xb8_KAI3W[0xb8];                               // 0x28(0xb8)
};
...
public:
	...
	char                                                         pad0x4_2GX1Z[0x4];                                 // 0x44(0x4)
};
...
public:
	...
	char                                                         pad0x30_Q2A07[0x30];                               // 0x90(0x30)
};
...
{
public:
	char                                                         pad0x40_JRRDP[0x40];                               // 0x28(0x40)
};
...
public:
	...
	char                                                         pad0x8_CUPA3[0x8];                                 // 0x58(0x8)
	struct Transform                                             SpawnTransform;                                    // 0x60(0x30)
	TArray<class Class*>                                         SinkIntoSandItems;                                 // 0x90(0x10)
	char                                                         pad0x40_FEBW9[0x40];                               // 0xa0(0x40)
};
...
public:
	...
	char                                                         pad0x4_4O60Q[0x4];                                 // 0x4c(0x4)
};
...
{
public:
	char                                                         pad0x8_5CCII[0x8];                                 // 0xb8(0x8)
	char                                                         GrammaticalGender;                                 // 0xc0(0x1)
	char                                                         pad0x7_G2YWA[0x7];                                 // 0xc1(0x7)
};
...
{
public:
	char                                                         pad0x20_EUS8P[0x20];                               // 0x8c0(0x20)
	struct MapRadialIconData                                     MapRadialIconData;                                 // 0x8e0(0x18)
	char                                                         pad0x8_S1BID[0x8];                                 // 0x8f8(0x8)
};
...
public:
	struct Vector                                                SpawnLocation;                                     // 0x38(0xc)
	char                                                         pad0x2c_38Z6T[0x2c];                               // 0x44(0x2c)
};
...
{
public:
	char                                                         pad0x20_YKOBE[0x20];                               // 0x30(0x20)
	...
	char                                                         pad0x4_7N6IO[0x4];                                 // 0x6c(0x4)
...
{
public:
	char                                                         pad0x20_KTN5M[0x20];                               // 0xb8(0x20)
	...
	char                                                         pad0x80_DFAQ6[0x80];                               // 0x140(0x80)
};
...
{
public:
	char                                                         pad0x8_LJUW7[0x8];                                 // 0x138(0x8)
...
{
public:
	char                                                         pad0x80_NT6EC[0x80];                               // 0x150(0x80)
};
