...
public:
	...
	char                                                         pad0x4_QZ53X[0x4];                                 // 0x5c(0x4)
...
public:
	...
	char                                                         pad0x68_ZGT9D[0x68];                               // 0x3d0(0x68)
};
...
public:
	...
	char                                                         pad0x7_RH63Z[0x7];                                 // 0x29(0x7)
	...
	char                                                         pad0x4_XAAP8[0x4];                                 // 0xc4(0x4)
	...
	char                                                         pad0x4_BGDAU[0x4];                                 // 0x164(0x4)
	...
	char                                                         pad0x4_66NCY[0x4];                                 // 0x3bc(0x4)
	...
	char                                                         pad0x4_EG5LN[0x4];                                 // 0x42c(0x4)
...
{
public:
	char                                                         pad0x10_O09C4[0x10];                               // 0x3c8(0x10)
	...
	char                                                         pad0x18_CS2L7[0x18];                               // 0x400(0x18)
	byte                                                         GeyserState;                                       // 0x418(0x1)
	char                                                         pad0x7_WS4SO[0x7];                                 // 0x419(0x7)
...
public:
	bool                                                         IsEnabled;                                         // 0x28(0x1)
	char                                                         pad0x7_MLCLA[0x7];                                 // 0x29(0x7)
	struct WeightedProbabilityRangeOfRanges                      WarmUpDuration;                                    // 0x30(0x30)
	...
	char                                                         pad0x4_GLC67[0x4];                                 // 0x104(0x4)
	...
	char                                                         pad0x4_WW5SI[0x4];                                 // 0x25c(0x4)
...
{
public:
	char                                                         pad0x10_5C75L[0x10];                               // 0x3c8(0x10)
	...
	char                                                         pad0x4_FIOCK[0x4];                                 // 0x414(0x4)
	...
	char                                                         pad0x4_C6N3G[0x4];                                 // 0x454(0x4)
	...
	char                                                         pad0x14f_ME5F3[0x14f];                             // 0x469(0x14f)
};
...
public:
	...
	char                                                         pad0x7_DR9J3[0x7];                                 // 0x4b9(0x7)
...
public:
	bool                                                         IsEnabled;                                         // 0x28(0x1)
	char                                                         pad0x7_76ED9[0x7];                                 // 0x29(0x7)
...
public:
	...
	char                                                         pad0x4f_16UNK[0x4f];                               // 0x3f9(0x4f)
};
...
{
public:
	char                                                         pad0x20_3DG6U[0x20];                               // 0x470(0x20)
};
...
public:
	bool                                                         IsEnabled;                                         // 0x28(0x1)
	char                                                         pad0x7_QZRND[0x7];                                 // 0x29(0x7)
	struct WeightedProbabilityRangeOfRanges                      DormantDuration;                                   // 0x30(0x30)
	...
	char                                                         pad0x3_FKL4U[0x3];                                 // 0xe1(0x3)
...
public:
	...
	char                                                         pad0x5_JC0K2[0x5];                                 // 0x44b(0x5)
	char                                                         pad0x20_QUDMZ[0x20];                               // 0x450(0x20)
};
...
public:
	...
	char                                                         pad0x70_O4LOV[0x70];                               // 0x50(0x70)
};
...
public:
	...
	char                                                         pad0x4_CAATE[0x4];                                 // 0x64(0x4)
...
{
public:
	char                                                         pad0x10_VVPI3[0x10];                               // 0x468(0x10)
	...
	char                                                         pad0xd0_SN7AP[0xd0];                               // 0x4a0(0xd0)
};
...
{
public:
	char                                                         pad0x18_1JS07[0x18];                               // 0x3c8(0x18)
	...
	char                                                         pad0x7_G10FZ[0x7];                                 // 0x409(0x7)
	...
	char                                                         pad0x4_X8F7D[0x4];                                 // 0x46c(0x4)
	...
	char                                                         pad0x138_BWEU5[0x138];                             // 0x4b8(0x138)
};
...
{
public:
	char                                                         pad0x58_GBHGG[0x58];                               // 0x28(0x58)
};
