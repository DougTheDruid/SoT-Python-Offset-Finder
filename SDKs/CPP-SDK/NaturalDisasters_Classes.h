...
public:
	...
	char                                                         pad0x4_38ZWT[0x4];                                 // 0x5c(0x4)
...
public:
	...
	char                                                         pad0x68_KQU58[0x68];                               // 0x3d0(0x68)
};
...
public:
	...
	char                                                         pad0x7_QHPDS[0x7];                                 // 0x29(0x7)
	...
	char                                                         pad0x4_WY97P[0x4];                                 // 0xc4(0x4)
	...
	char                                                         pad0x4_LODKZ[0x4];                                 // 0x164(0x4)
	...
	char                                                         pad0x4_1DT0B[0x4];                                 // 0x3bc(0x4)
	...
	char                                                         pad0x4_OIR1I[0x4];                                 // 0x42c(0x4)
...
{
public:
	char                                                         pad0x10_OWHBR[0x10];                               // 0x3c8(0x10)
	...
	char                                                         pad0x18_3CKEG[0x18];                               // 0x400(0x18)
	byte                                                         GeyserState;                                       // 0x418(0x1)
	char                                                         pad0x7_GQ3F8[0x7];                                 // 0x419(0x7)
...
public:
	bool                                                         IsEnabled;                                         // 0x28(0x1)
	char                                                         pad0x7_P1SV0[0x7];                                 // 0x29(0x7)
	struct WeightedProbabilityRangeOfRanges                      WarmUpDuration;                                    // 0x30(0x30)
	...
	char                                                         pad0x4_MOL15[0x4];                                 // 0x104(0x4)
	...
	char                                                         pad0x4_NNNEX[0x4];                                 // 0x25c(0x4)
...
{
public:
	char                                                         pad0x10_UUEBA[0x10];                               // 0x3c8(0x10)
	...
	char                                                         pad0x4_IVN67[0x4];                                 // 0x414(0x4)
	...
	char                                                         pad0x4_HO0J3[0x4];                                 // 0x454(0x4)
	...
	char                                                         pad0x14f_3RS0S[0x14f];                             // 0x469(0x14f)
};
...
public:
	...
	char                                                         pad0x7_YGGTU[0x7];                                 // 0x4b9(0x7)
...
public:
	bool                                                         IsEnabled;                                         // 0x28(0x1)
	char                                                         pad0x7_TCZ9V[0x7];                                 // 0x29(0x7)
...
public:
	...
	char                                                         pad0x4f_6D7Y7[0x4f];                               // 0x3f9(0x4f)
};
...
{
public:
	char                                                         pad0x20_HXZC2[0x20];                               // 0x470(0x20)
};
...
public:
	bool                                                         IsEnabled;                                         // 0x28(0x1)
	char                                                         pad0x7_KXUXZ[0x7];                                 // 0x29(0x7)
	struct WeightedProbabilityRangeOfRanges                      DormantDuration;                                   // 0x30(0x30)
	...
	char                                                         pad0x3_UCKQD[0x3];                                 // 0xe1(0x3)
...
public:
	...
	char                                                         pad0x5_F6G8G[0x5];                                 // 0x44b(0x5)
	char                                                         pad0x20_03N0X[0x20];                               // 0x450(0x20)
};
...
public:
	...
	char                                                         pad0x70_177IW[0x70];                               // 0x50(0x70)
};
...
public:
	...
	char                                                         pad0x4_CIKDZ[0x4];                                 // 0x64(0x4)
...
{
public:
	char                                                         pad0x10_1LYOV[0x10];                               // 0x468(0x10)
	...
	char                                                         pad0xd0_Y46RD[0xd0];                               // 0x4a0(0xd0)
};
...
{
public:
	char                                                         pad0x18_61YDS[0x18];                               // 0x3c8(0x18)
	...
	char                                                         pad0x7_IGO54[0x7];                                 // 0x409(0x7)
	...
	char                                                         pad0x4_MSZW2[0x4];                                 // 0x46c(0x4)
	...
	char                                                         pad0x138_N7RM3[0x138];                             // 0x4b8(0x138)
};
...
{
public:
	char                                                         pad0x58_5WNAB[0x58];                               // 0x28(0x58)
};
