...
public:
	...
	char                                                         pad0x4_URYKZ[0x4];                                 // 0x5c(0x4)
...
public:
	...
	char                                                         pad0x68_MA1A9[0x68];                               // 0x3d0(0x68)
};
...
public:
	...
	char                                                         pad0x7_TVNK5[0x7];                                 // 0x29(0x7)
	...
	char                                                         pad0x4_B01GB[0x4];                                 // 0xc4(0x4)
	...
	char                                                         pad0x4_1UJVK[0x4];                                 // 0x164(0x4)
	...
	char                                                         pad0x4_JKHM0[0x4];                                 // 0x3bc(0x4)
	...
	char                                                         pad0x4_7GZJY[0x4];                                 // 0x42c(0x4)
...
{
public:
	char                                                         pad0x10_VUFS0[0x10];                               // 0x3c8(0x10)
	...
	char                                                         pad0x18_HCS2X[0x18];                               // 0x400(0x18)
	byte                                                         GeyserState;                                       // 0x418(0x1)
	char                                                         pad0x7_ELEHH[0x7];                                 // 0x419(0x7)
	...
	char                                                         pad0x7_ZF9MN[0x7];                                 // 0x461(0x7)
	class                                                        GeyserHoleClass;                                   // 0x468(0x8)
	Class Hole*                                                  GeyserHole;                                        // 0x470(0x8)
	char                                                         pad0x40_A6ZKF[0x40];                               // 0x478(0x40)
};
...
public:
	bool                                                         IsEnabled;                                         // 0x28(0x1)
	char                                                         pad0x7_B8XBM[0x7];                                 // 0x29(0x7)
	Struct WeightedProbabilityRangeOfRanges                      WarmUpDuration;                                    // 0x30(0x30)
	...
	char                                                         pad0x4_HYTPN[0x4];                                 // 0x104(0x4)
	...
	char                                                         pad0x4_54QT8[0x4];                                 // 0x25c(0x4)
...
{
public:
	char                                                         pad0x10_HL6NS[0x10];                               // 0x3c8(0x10)
	...
	char                                                         pad0x4_YUY1U[0x4];                                 // 0x414(0x4)
	...
	char                                                         pad0x4_QCS2N[0x4];                                 // 0x454(0x4)
	...
	char                                                         pad0x14f_EF3J2[0x14f];                             // 0x469(0x14f)
};
...
public:
	...
	char                                                         pad0x7_P2TE8[0x7];                                 // 0x4b9(0x7)
...
public:
	bool                                                         IsEnabled;                                         // 0x28(0x1)
	char                                                         pad0x7_OUPYZ[0x7];                                 // 0x29(0x7)
...
public:
	...
	char                                                         pad0x4f_LL9Y0[0x4f];                               // 0x3f9(0x4f)
};
...
public:
	bool                                                         IsEnabled;                                         // 0x28(0x1)
	char                                                         pad0x7_7TW0P[0x7];                                 // 0x29(0x7)
	Struct WeightedProbabilityRangeOfRanges                      DormantDuration;                                   // 0x30(0x30)
	...
	char                                                         pad0x3_BSJEA[0x3];                                 // 0xe1(0x3)
...
public:
	...
	char                                                         pad0x5_YKDD4[0x5];                                 // 0x44b(0x5)
	char                                                         pad0x20_IH6PC[0x20];                               // 0x450(0x20)
};
...
public:
	...
	char                                                         pad0x70_62XXG[0x70];                               // 0x50(0x70)
};
...
public:
	...
	char                                                         pad0x4_WRG9G[0x4];                                 // 0x64(0x4)
...
{
public:
	char                                                         pad0x10_HEYKO[0x10];                               // 0x468(0x10)
	...
	char                                                         pad0xd0_NJM5F[0xd0];                               // 0x4a0(0xd0)
};
...
{
public:
	char                                                         pad0x18_MJ46W[0x18];                               // 0x3c8(0x18)
	...
	char                                                         pad0x7_3XYTX[0x7];                                 // 0x409(0x7)
	...
	char                                                         pad0x4_BPGXH[0x4];                                 // 0x46c(0x4)
	...
	char                                                         pad0x138_GGX07[0x138];                             // 0x4b8(0x138)
};
