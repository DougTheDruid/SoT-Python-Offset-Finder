...
{
public:
	struct                                                       CustomViewNames;                                   // 0x28(0x50)
...
public:
	...
	struct                                                       ActivationKey;                                     // 0x110(0x28)
	struct                                                       CategoryZeroBind;                                  // 0x138(0x28)
	struct                                                       CategoryOneBind;                                   // 0x160(0x28)
	struct                                                       CategoryTwoBind;                                   // 0x188(0x28)
	struct                                                       CategoryThreeBind;                                 // 0x1b0(0x28)
	struct                                                       CategoryFourBind;                                  // 0x1d8(0x28)
	struct                                                       CategoryFiveBind;                                  // 0x200(0x28)
	struct                                                       CategorySixBind;                                   // 0x228(0x28)
	struct                                                       CategorySevenBind;                                 // 0x250(0x28)
	struct                                                       CategoryEightBind;                                 // 0x278(0x28)
	struct                                                       CategoryNineBind;                                  // 0x2a0(0x28)
	struct                                                       CycleDetailsViewBind;                              // 0x2c8(0x28)
	struct                                                       DebugCameraBind;                                   // 0x2f0(0x28)
	struct                                                       OnScreenDebugMessagesBind;                         // 0x318(0x28)
	struct                                                       GameHUDBind;                                       // 0x340(0x28)
};
...
public:
	...
	struct                                                       SensingComponentLocation;                          // 0x768(0xc)
