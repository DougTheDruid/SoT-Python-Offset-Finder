...
public:
	...
	char                                                         pad0x4_TESYA[0x4];                                 // 0x5d4(0x4)
	...
	char                                                         pad0x7_N9QVU[0x7];                                 // 0x769(0x7)
	Class Actor*                                                 TargetActor;                                       // 0x770(0x8)
	char                                                         pad0x78_03WTA[0x78];                               // 0x778(0x78)
};
...
public:
	...
	char                                                         pad0xd0_8O504[0xd0];                               // 0x3e8(0xd0)
};
...
public:
	...
	char                                                         pad0x3_78KTX[0x3];                                 // 0x7d(0x3)
	...
	char                                                         pad0x1e_Y7CWY[0x1e];                               // 0x8a(0x1e)
};
...
public:
	...
	char                                                         pad0x28_1M2S5[0x28];                               // 0xe8(0x28)
...
public:
	...
	char                                                         pad0x4_FO04L[0x4];                                 // 0x3fc(0x4)
	...
	char                                                         pad0x1_9YYFD[0x1];                                 // 0x41f(0x1)
	...
	char                                                         pad0x4e_NQFWK[0x4e];                               // 0x42a(0x4e)
};
