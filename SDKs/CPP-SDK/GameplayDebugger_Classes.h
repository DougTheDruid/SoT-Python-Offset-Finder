...
{
public:
	char                                                         pad0x30_NWCXO[0x30];                               // 0x4c0(0x30)
};
...
public:
	...
	char                                                         pad0xd0_5DHYE[0xd0];                               // 0x3e8(0xd0)
};
...
public:
	...
	char                                                         pad0x4_X9B1W[0x4];                                 // 0x3fc(0x4)
	...
	char                                                         pad0x1_2BO7L[0x1];                                 // 0x41f(0x1)
	...
	char                                                         pad0x4e_GV1OO[0x4e];                               // 0x42a(0x4e)
};
...
public:
	...
	char                                                         pad0x28_5WI54[0x28];                               // 0xe8(0x28)
...
public:
	...
	char                                                         pad0x4_540TX[0x4];                                 // 0x5d4(0x4)
	...
	char                                                         pad0x7_F07RI[0x7];                                 // 0x769(0x7)
	class Actor*                                                 TargetActor;                                       // 0x770(0x8)
	char                                                         pad0x78_HTABK[0x78];                               // 0x778(0x78)
};
...
public:
	...
	char                                                         pad0x3_1NZNJ[0x3];                                 // 0x7d(0x3)
	...
	char                                                         pad0x1e_ZQW47[0x1e];                               // 0x8a(0x1e)
};
