...
public:
	...
	char                                                         pad0x7_7XZCN[0x7];                                 // 0x31(0x7)
};
...
public:
	...
	char                                                         pad0x4_XELR9[0x4];                                 // 0x4c(0x4)
...
public:
	...
	char                                                         pad0x7_I96KI[0x7];                                 // 0x129(0x7)
};
...
{
public:
	char                                                         pad0x10_XAKQK[0x10];                               // 0xb8(0x10)
};
...
public:
	char                                                         CommodityDemand;                                   // 0x30(0x1)
	char                                                         pad0x1f_SQFUK[0x1f];                               // 0x31(0x1f)
};
...
{
public:
	char                                                         pad0x8_JVBZ8[0x8];                                 // 0xb8(0x8)
...
{
public:
	char                                                         pad0x8_K7D30[0x8];                                 // 0xb8(0x8)
...
{
public:
	char                                                         pad0x8_EQYSS[0x8];                                 // 0xb8(0x8)
	struct FText                                                 RedeemTooltipText;                                 // 0xc0(0x38)
	char                                                         pad0x40_GI36W[0x40];                               // 0xf8(0x40)
	TArray<class Actor*>                                         PendingRedemptions;                                // 0x138(0x10)
	char                                                         pad0xa8_0AAA8[0xa8];                               // 0x148(0xa8)
};
...
{
public:
	char                                                         pad0x20_FH36I[0x20];                               // 0x3a0(0x20)
	...
	char                                                         pad0x30_9UV6J[0x30];                               // 0x3e8(0x30)
};
...
{
public:
	char                                                         pad0x90_BM3ST[0x90];                               // 0xb8(0x90)
};
