...
{
public:
	char                                                         pad0x8_HPY2L[0x8];                                 // 0xb8(0x8)
...
public:
	...
	char                                                         pad0x7_TP7C9[0x7];                                 // 0x129(0x7)
};
...
public:
	...
	char                                                         pad0x1f_49DRR[0x1f];                               // 0x31(0x1f)
};
...
{
public:
	char                                                         pad0x10_W3ZUM[0x10];                               // 0xb8(0x10)
};
...
public:
	...
	char                                                         pad0x4_4FQNW[0x4];                                 // 0x4c(0x4)
...
{
public:
	char                                                         pad0x8_V8EKS[0x8];                                 // 0xb8(0x8)
	struct FText                                                 RedeemTooltipText;                                 // 0xc0(0x38)
	char                                                         pad0x40_11V5Y[0x40];                               // 0xf8(0x40)
	TArray<class Actor*>                                         PendingRedemptions;                                // 0x138(0x10)
	char                                                         pad0xa8_BKCGH[0xa8];                               // 0x148(0xa8)
};
...
{
public:
	char                                                         pad0x90_U3541[0x90];                               // 0xb8(0x90)
};
...
public:
	char                                                         CommodityDemand;                                   // 0x30(0x1)
	char                                                         pad0x7_0Q4K4[0x7];                                 // 0x31(0x7)
};
...
{
public:
	char                                                         pad0x8_6X3VI[0x8];                                 // 0xb8(0x8)
...
{
public:
	char                                                         pad0x20_0UHZI[0x20];                               // 0x3a0(0x20)
	...
	char                                                         pad0x30_9IIOP[0x30];                               // 0x3e8(0x30)
};
