...
public:
	...
	char                                                         pad0x4_3R2JK[0x4];                                 // 0x4c(0x4)
...
{
public:
	char                                                         pad0x20_D3W2D[0x20];                               // 0x3c8(0x20)
	...
	char                                                         pad0x30_8LHX2[0x30];                               // 0x410(0x30)
};
...
public:
	...
	char                                                         pad0x7_BFG49[0x7];                                 // 0x129(0x7)
};
...
{
public:
	char                                                         pad0x90_8X4R4[0x90];                               // 0xc8(0x90)
};
...
{
public:
	char                                                         pad0x8_RDHA5[0x8];                                 // 0xc8(0x8)
	struct FText                                                 RedeemTooltipText;                                 // 0xd0(0x38)
	char                                                         pad0x78_FTR2C[0x78];                               // 0x108(0x78)
...
{
public:
	char                                                         pad0x8_7LF9V[0x8];                                 // 0xc8(0x8)
...
{
public:
	char                                                         pad0x10_KC6G5[0x10];                               // 0xc8(0x10)
};
...
public:
	...
	char                                                         pad0x1f_3UEYB[0x1f];                               // 0x31(0x1f)
};
...
{
public:
	char                                                         pad0x8_4SCUW[0x8];                                 // 0xc8(0x8)
...
public:
	byte                                                         CommodityDemand;                                   // 0x30(0x1)
	char                                                         pad0x7_9ENVG[0x7];                                 // 0x31(0x7)
};
