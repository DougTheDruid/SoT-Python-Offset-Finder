...
public:
	...
	char                                                         pad0x20_O0BFQ[0x20];                               // 0x70(0x20)
};
...
public:
	...
	char                                                         pad0x4_U4NJL[0x4];                                 // 0x84(0x4)
...
public:
	...
	char                                                         pad0x63_8L956[0x63];                               // 0x2e5(0x63)
	TArray<struct Guid>                                          SuppressedCrews;                                   // 0x348(0x10)
	char                                                         pad0x8_AVG4D[0x8];                                 // 0x358(0x8)
};
...
{
public:
	char                                                         pad0x8_VOX6L[0x8];                                 // 0xb8(0x8)
	float                                                        RevisitCooldown;                                   // 0xc0(0x4)
	char                                                         pad0x34_580TO[0x34];                               // 0xc4(0x34)
};
...
public:
	...
	char                                                         pad0x3_Z22BH[0x3];                                 // 0x81(0x3)
