...
public:
	...
	Class ChildActorComponent*                                   BP_ShipFlagCustomizationChest;                     // 0xab8(0x8)
	Class StaticMeshComponent*                                   CrowsNest;                                         // 0xac0(0x8)
	Class ChildActorComponent*                                   BP_BellLower;                                      // 0xac8(0x8)
	Class StaticMeshComponent*                                   BellSupportLower;                                  // 0xad0(0x8)
};
