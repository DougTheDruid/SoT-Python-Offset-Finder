...
public:
	...
	Class ChildActorComponent*                                   BP_Cabin_Left_LowCabinetDoor_01;                   // 0x3f8(0x8)
	Class ChildActorComponent*                                   BP_Cabin_Right_LowCabinetDoor_01;                  // 0x400(0x8)
	Class StaticMeshComponent*                                   cap_cabinet_02_b;                                  // 0x408(0x8)
	Class StaticMeshComponent*                                   cap_cage_01_b;                                     // 0x410(0x8)
	Class StaticMeshComponent*                                   cap_cage_01_a;                                     // 0x418(0x8)
	Class ParticleSystemComponent*                               vfx_tavern_candle_looping_01_a8;                   // 0x420(0x8)
	Class ParticleSystemComponent*                               vfx_tavern_candle_looping_01_a1;                   // 0x428(0x8)
	Class StaticMeshComponent*                                   gmp_pl_cabin_cabinet_a_01;                         // 0x430(0x8)
	Class StaticMeshComponent*                                   shp_item_shelf_01_a;                               // 0x438(0x8)
	Class StaticMeshComponent*                                   cap_cabin_drawer_01_a;                             // 0x440(0x8)
	Class StaticMeshComponent*                                   cap_cabin_trunk_01_a;                              // 0x448(0x8)
	Class StaticMeshComponent*                                   cap_cabin_trunk_01_a1;                             // 0x450(0x8)
	Class MergedStaticMeshComponent*                             MergedStaticMesh_col;                              // 0x458(0x8)
	Class StaticMeshComponent*                                   cap_skull_candle_01_a;                             // 0x460(0x8)
	Class StaticMeshComponent*                                   cap_cabin_map_rolls_01_a;                          // 0x468(0x8)
	Class MergedStaticMeshComponent*                             MergedStaticMesh;                                  // 0x470(0x8)
	Class StaticMeshComponent*                                   shp_interior_captains_cabin_01_a;                  // 0x478(0x8)
};
