...
public:
	...
	char                                                         pad0x20_VV3SY[0x20];                               // 0x6a8(0x20)
};
...
{
public:
	char                                                         pad0x28_5XBWY[0x28];                               // 0x60(0x28)
};
...
{
public:
	char                                                         pad0x20_DMQVT[0x20];                               // 0x28(0x20)
};
...
public:
	...
	char                                                         pad0x5_DDYG6[0x5];                                 // 0xc3(0x5)
};
...
{
public:
	char                                                         pad0x28_OT93S[0x28];                               // 0xb8(0x28)
	class UClass*                                                EquippedCustomization;                             // 0xe0(0x8)
	char                                                         pad0x18_GQJYU[0x18];                               // 0xe8(0x18)
};
...
{
public:
	char                                                         pad0x8_G0JUD[0x8];                                 // 0x3a0(0x8)
};
...
public:
	...
	char                                                         pad0x4_0Y99Q[0x4];                                 // 0x4c(0x4)
...
{
public:
	char                                                         pad0x8_42ZNE[0x8];                                 // 0x3a0(0x8)
	TArray<class ItemProxy*>                                     AttachedItems;                                     // 0x3a8(0x10)
	char                                                         pad0xf8_9LGF6[0xf8];                               // 0x3b8(0xf8)
};
...
public:
	...
	char                                                         pad0x1d0_NZW7J[0x1d0];                             // 0x2e0(0x1d0)
};
...
{
public:
	char                                                         pad0x8_UUMC9[0x8];                                 // 0xb8(0x8)
...
public:
	...
	char                                                         pad0x3c_L3RZM[0x3c];                               // 0x4bc(0x3c)
	...
	char                                                         pad0x4_OJMBL[0x4];                                 // 0x574(0x4)
	char                                                         pad0x1b0_RGUGM[0x1b0];                             // 0x578(0x1b0)
};
...
{
public:
	char                                                         pad0x20_1SEUD[0x20];                               // 0x28(0x20)
};
...
{
public:
	char                                                         pad0x8_FCF3V[0x8];                                 // 0xb8(0x8)
	float                                                        MinIntervalBetweenScrapeDamage;                    // 0xc0(0x4)
	char                                                         pad0x4_IE3RX[0x4];                                 // 0xc4(0x4)
...
{
public:
	char                                                         pad0x20_UUTFR[0x20];                               // 0x28(0x20)
};
...
{
public:
	char                                                         pad0x50_MEAAT[0x50];                               // 0x728(0x50)
	...
	char                                                         pad0x7_C3J2C[0x7];                                 // 0x799(0x7)
	...
	char                                                         pad0x4_LBAGA[0x4];                                 // 0x7e4(0x4)
	...
	char                                                         pad0x3_7GCZ4[0x3];                                 // 0x8c1(0x3)
