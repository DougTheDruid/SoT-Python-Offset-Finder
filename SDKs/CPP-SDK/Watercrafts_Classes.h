...
{
public:
	struct                                                       RowboatTypesEntitlementsMapDataAsset;              // 0x38(0x10)
	struct                                                       RowboatLiveryEntitlementsMapDataAsset;             // 0x48(0x10)
};
...
{
public:
	struct                                                       RowboatDescDataAsset;                              // 0xc8(0x10)
};
...
public:
	...
	struct                                                       RolloverCorrector;                                 // 0x408(0xc)
	...
	struct                                                       MovementTimeStamp;                                 // 0x458(0x70)
	struct                                                       PhysicsErrorCorrection;                            // 0x4c8(0x1c)
	struct                                                       BuoyancySampleMovement;                            // 0x520(0x68)
...
{
public:
	struct                                                       BothTriggers_Row;                                  // 0xd0(0x3)
};
...
public:
	...
	struct                                                       SafeZoneCenterDirection;                           // 0xe0(0xc)
...
public:
	...
	struct                                                       WaterExclusionOffset;                              // 0x7d0(0xc)
	struct                                                       OverrideMountedCollisionProfileName;               // 0x7dc(0x8)
	...
	struct                                                       DamageEffectData;                                  // 0x848(0x18)
	struct                                                       StrainDamageData;                                  // 0x860(0x20)
