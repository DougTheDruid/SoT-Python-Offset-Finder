...
{
public:
	char                                                         pad0x28_I2VZS[0x28];                               // 0x60(0x28)
};
...
{
public:
	char                                                         pad0x20_75GYB[0x20];                               // 0x28(0x20)
};
...
public:
	...
	char                                                         pad0x20_MFA8H[0x20];                               // 0x6a8(0x20)
};
...
{
public:
	char                                                         pad0x8_H0PYO[0x8];                                 // 0xb8(0x8)
...
public:
	...
	char                                                         pad0x5_FB97G[0x5];                                 // 0xc3(0x5)
};
...
public:
	...
	char                                                         pad0x4_J4Z2Q[0x4];                                 // 0x4c(0x4)
...
public:
	...
	char                                                         pad0x3c_TBGUI[0x3c];                               // 0x4bc(0x3c)
	...
	char                                                         pad0x4_SXEK6[0x4];                                 // 0x574(0x4)
	char                                                         pad0x1b0_B0X5A[0x1b0];                             // 0x578(0x1b0)
};
...
{
public:
	char                                                         pad0x20_B0NCP[0x20];                               // 0x28(0x20)
};
...
{
public:
	char                                                         pad0x28_YP1ZQ[0x28];                               // 0xb8(0x28)
	class UClass*                                                EquippedCustomization;                             // 0xe0(0x8)
	char                                                         pad0x18_C1725[0x18];                               // 0xe8(0x18)
};
...
{
public:
	char                                                         pad0x8_TXN2S[0x8];                                 // 0x3a0(0x8)
};
...
{
public:
	char                                                         pad0x8_430UR[0x8];                                 // 0x3a0(0x8)
	TArray<class ItemProxy*>                                     AttachedItems;                                     // 0x3a8(0x10)
	char                                                         pad0xf8_YWR2U[0xf8];                               // 0x3b8(0xf8)
};
...
public:
	...
	char                                                         pad0x1d0_WHH7U[0x1d0];                             // 0x2e0(0x1d0)
};
...
{
public:
	char                                                         pad0x8_3SF5B[0x8];                                 // 0xb8(0x8)
	float                                                        MinIntervalBetweenScrapeDamage;                    // 0xc0(0x4)
	char                                                         pad0x4_Z8X5F[0x4];                                 // 0xc4(0x4)
...
{
public:
	char                                                         pad0x20_XEXLA[0x20];                               // 0x28(0x20)
};
...
{
public:
	char                                                         pad0x50_EQ5RJ[0x50];                               // 0x728(0x50)
	...
	char                                                         pad0x7_KFBJS[0x7];                                 // 0x799(0x7)
	...
	char                                                         pad0x4_1HCMF[0x4];                                 // 0x7e4(0x4)
	...
	char                                                         pad0x3_F5GBF[0x3];                                 // 0x8c1(0x3)
