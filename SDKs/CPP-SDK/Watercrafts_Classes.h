...
{
public:
	char                                                         pad0x8_QC3ZJ[0x8];                                 // 0x3a0(0x8)
	TArray<class ItemProxy*>                                     AttachedItems;                                     // 0x3a8(0x10)
	char                                                         pad0xf8_V7BYE[0xf8];                               // 0x3b8(0xf8)
};
...
{
public:
	char                                                         pad0x8_BLNLF[0x8];                                 // 0xb8(0x8)
	float                                                        MinIntervalBetweenScrapeDamage;                    // 0xc0(0x4)
	char                                                         pad0x4_4EMO5[0x4];                                 // 0xc4(0x4)
...
public:
	...
	char                                                         pad0x20_JVZUP[0x20];                               // 0x688(0x20)
};
...
{
public:
	char                                                         pad0x20_LDZLI[0x20];                               // 0x28(0x20)
};
...
public:
	...
	char                                                         pad0x5_O0PCA[0x5];                                 // 0xc3(0x5)
};
...
public:
	...
	char                                                         pad0x4_PIQLP[0x4];                                 // 0x4c(0x4)
...
{
public:
	char                                                         pad0x28_TDV1E[0x28];                               // 0x60(0x28)
};
...
{
public:
	char                                                         pad0x8_DB2YW[0x8];                                 // 0x3a0(0x8)
};
...
{
public:
	char                                                         pad0x20_OG4PL[0x20];                               // 0x28(0x20)
};
...
{
public:
	char                                                         pad0x28_37ZRZ[0x28];                               // 0xb8(0x28)
	class UClass*                                                EquippedCustomization;                             // 0xe0(0x8)
	char                                                         pad0x18_ZGC0D[0x18];                               // 0xe8(0x18)
};
...
public:
	...
	char                                                         pad0x3c_O9AHY[0x3c];                               // 0x4bc(0x3c)
	...
	char                                                         pad0x4_3YI98[0x4];                                 // 0x574(0x4)
	char                                                         pad0x190_I3N4V[0x190];                             // 0x578(0x190)
};
...
{
public:
	char                                                         pad0x8_8A6NO[0x8];                                 // 0xb8(0x8)
...
public:
	...
	char                                                         pad0x1d0_QF1QS[0x1d0];                             // 0x2e0(0x1d0)
};
...
{
public:
	char                                                         pad0x20_H7B4P[0x20];                               // 0x28(0x20)
};
...
// Size 0x3a8 (Full Size[0xab0] - InheritedSize[0x708]
class Rowboat: public Watercraft
{
public:
	char                                                         pad0x50_VRMVJ[0x50];                               // 0x708(0x50)
	...
	char                                                         pad0x7_SBXYG[0x7];                                 // 0x779(0x7)
	...
	char                                                         pad0x4_NOWFF[0x4];                                 // 0x7c4(0x4)
	...
	char                                                         pad0x3_ICWCD[0x3];                                 // 0x8a1(0x3)
	...
	char                                                         pad0x4_VLGZE[0x4];                                 // 0x8bc(0x4)
	struct FString                                               SubjectName;                                       // 0x8c0(0x10)
	struct FName                                                 PremountCollisionProfileName;                      // 0x8d0(0x8)
	char                                                         pad0x1d8_KWRV5[0x1d8];                             // 0x8d8(0x1d8)
};
