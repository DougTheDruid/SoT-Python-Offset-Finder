...
public:
	...
	char                                                         pad0x4_OOAWL[0x4];                                 // 0x4(0x4)
	class Pawn*                                                  Despawn_Pawn;                                      // 0x8(0x8)
	char                                                         Despawn_Reason;                                    // 0x10(0x1)
	char                                                         pad0x7_RBEN5[0x7];                                 // 0x11(0x7)
...
public:
	...
	char                                                         pad0x3_UCZPM[0x3];                                 // 0x1d(0x3)
