...
class BP_DarkBrethren_Prisoner_C: public None
{
public:
	char                                                         pad0x430_UUSSB[0x430];                             // 0x0(0x430)
	...
	char                                                         pad0x8_UWCLK[0x8];                                 // 0x4e8(0x8)
	...
	char                                                         pad0x19_UDEPU[0x19];                               // 0x770(0x19)
	bool                                                         OfferingEnabled;                                   // 0x789(0x1)
	char                                                         pad0x2_QN778[0x2];                                 // 0x78a(0x2)
