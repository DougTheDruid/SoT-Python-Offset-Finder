...
public:
	...
	char                                                         pad0x4_3E3ZD[0x4];                                 // 0xb4(0x4)
...
public:
	...
	char                                                         pad0x3_JG5BX[0x3];                                 // 0x14d(0x3)
...
{
public:
	char                                                         pad0x8_5QEGE[0x8];                                 // 0x98(0x8)
	struct IntegralCurve                                         ActorGuidIndexCurve;                               // 0xa0(0x70)
	char                                                         pad0x10_R8P91[0x10];                               // 0x110(0x10)
...
public:
	...
	char                                                         pad0x3_50V2X[0x3];                                 // 0xc5(0x3)
	struct Rotator                                               UserDefinedPlaySpace;                              // 0xc8(0xc)
	char                                                         pad0x4_5HED9[0x4];                                 // 0xd4(0x4)
};
...
{
public:
	char                                                         pad0x8_9XVD2[0x8];                                 // 0x98(0x8)
...
public:
	...
	char                                                         pad0x7_48XYN[0x7];                                 // 0x99(0x7)
...
{
public:
	char                                                         pad0x8_77G53[0x8];                                 // 0x98(0x8)
...
public:
	...
	char                                                         pad0x7_CP5KN[0x7];                                 // 0xd1(0x7)
};
...
{
public:
	char                                                         pad0x8_0DCU1[0x8];                                 // 0x98(0x8)
...
{
public:
	char                                                         pad0x8_NG0TF[0x8];                                 // 0x98(0x8)
...
public:
	...
	char                                                         pad0x88_0L5VZ[0x88];                               // 0x120(0x88)
};
...
{
public:
	char                                                         pad0x8_Y78DU[0x8];                                 // 0x98(0x8)
	bool                                                         DefaultValue;                                      // 0xa0(0x1)
	char                                                         pad0x7_P0SJQ[0x7];                                 // 0xa1(0x7)
...
{
public:
	char                                                         pad0x8_RWJX7[0x8];                                 // 0x98(0x8)
	struct RichCurve                                             Translation;                                       // 0xa0(0x78)
	char                                                         pad0xf0_F9N0L[0xf0];                               // 0x118(0xf0)
	struct RichCurve                                             Rotation;                                          // 0x208(0x78)
	char                                                         pad0xf0_1FE43[0xf0];                               // 0x280(0xf0)
	struct RichCurve                                             Scale;                                             // 0x370(0x78)
	char                                                         pad0xf0_A5YDF[0xf0];                               // 0x3e8(0xf0)
};
...
{
public:
	char                                                         pad0x8_BP7UN[0x8];                                 // 0x98(0x8)
...
{
public:
	char                                                         pad0x8_6B2C5[0x8];                                 // 0x98(0x8)
...
{
public:
	char                                                         pad0x8_GIRA7[0x8];                                 // 0x98(0x8)
	struct RichCurve                                             Curves;                                            // 0xa0(0x78)
	char                                                         pad0x168_V82SE[0x168];                             // 0x118(0x168)
	int                                                          ChannelsUsed;                                      // 0x280(0x4)
	char                                                         pad0x4_NPQ3H[0x4];                                 // 0x284(0x4)
};
...
public:
	...
	char                                                         pad0x7_M5EYV[0x7];                                 // 0x1a1(0x7)
};
...
public:
	...
	char                                                         pad0x7_BVP6D[0x7];                                 // 0x89(0x7)
...
public:
	...
	char                                                         pad0x7_VSUBK[0x7];                                 // 0x89(0x7)
...
public:
	...
	char                                                         pad0x7_RUENF[0x7];                                 // 0xb9(0x7)
};
...
public:
	...
	char                                                         pad0x4_49CKF[0x4];                                 // 0x9c(0x4)
};
...
public:
	...
	char                                                         pad0x4_NF70Y[0x4];                                 // 0xb4(0x4)
};
...
public:
	...
	char                                                         pad0x7_VW0BV[0x7];                                 // 0xb1(0x7)
};
...
public:
	...
	char                                                         pad0x7_EEH1D[0x7];                                 // 0x129(0x7)
};
