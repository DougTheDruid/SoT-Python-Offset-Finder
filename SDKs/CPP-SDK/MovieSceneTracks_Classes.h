...
{
public:
	char                                                         pad0x8_F152B[0x8];                                 // 0x98(0x8)
	struct RichCurve                                             Translation;                                       // 0xa0(0x78)
	char                                                         pad0xf0_3YYUL[0xf0];                               // 0x118(0xf0)
	struct RichCurve                                             Rotation;                                          // 0x208(0x78)
	char                                                         pad0xf0_12HWW[0xf0];                               // 0x280(0xf0)
	struct RichCurve                                             Scale;                                             // 0x370(0x78)
	char                                                         pad0xf0_EW16R[0xf0];                               // 0x3e8(0xf0)
};
...
{
public:
	char                                                         pad0x8_7TS82[0x8];                                 // 0x98(0x8)
	struct IntegralCurve                                         ActorGuidIndexCurve;                               // 0xa0(0x70)
	char                                                         pad0x10_J4EC5[0x10];                               // 0x110(0x10)
...
{
public:
	char                                                         pad0x8_OBABX[0x8];                                 // 0x98(0x8)
...
public:
	...
	char                                                         pad0x7_ZCWOD[0x7];                                 // 0x89(0x7)
...
{
public:
	char                                                         pad0x8_JOYNA[0x8];                                 // 0x98(0x8)
...
{
public:
	char                                                         pad0x8_6IQB1[0x8];                                 // 0x98(0x8)
...
public:
	...
	char                                                         pad0x3_RUECY[0x3];                                 // 0x14d(0x3)
...
{
public:
	char                                                         pad0x8_AUMKD[0x8];                                 // 0x98(0x8)
...
public:
	...
	char                                                         pad0x7_PMYCX[0x7];                                 // 0xd1(0x7)
};
...
public:
	...
	char                                                         pad0x7_1QDFC[0x7];                                 // 0x1a1(0x7)
};
...
{
public:
	char                                                         pad0x8_V5BZG[0x8];                                 // 0x98(0x8)
...
public:
	...
	char                                                         pad0x88_KD68V[0x88];                               // 0x120(0x88)
};
...
{
public:
	char                                                         pad0x8_G0M8N[0x8];                                 // 0x98(0x8)
...
{
public:
	char                                                         pad0x8_9P9D7[0x8];                                 // 0x98(0x8)
	bool                                                         DefaultValue;                                      // 0xa0(0x1)
	char                                                         pad0x7_K3UV2[0x7];                                 // 0xa1(0x7)
...
public:
	...
	char                                                         pad0x4_3FCHS[0x4];                                 // 0xb4(0x4)
...
{
public:
	char                                                         pad0x8_N2N65[0x8];                                 // 0x98(0x8)
	struct RichCurve                                             Curves;                                            // 0xa0(0x78)
	char                                                         pad0x168_IVRGA[0x168];                             // 0x118(0x168)
	int                                                          ChannelsUsed;                                      // 0x280(0x4)
	char                                                         pad0x4_47Z96[0x4];                                 // 0x284(0x4)
};
...
public:
	...
	char                                                         pad0x7_TKCAK[0x7];                                 // 0x99(0x7)
...
public:
	...
	char                                                         pad0x7_2YXWZ[0x7];                                 // 0x89(0x7)
...
public:
	...
	char                                                         pad0x3_NI9X9[0x3];                                 // 0xc5(0x3)
	struct Rotator                                               UserDefinedPlaySpace;                              // 0xc8(0xc)
	char                                                         pad0x4_TED3Q[0x4];                                 // 0xd4(0x4)
};
...
public:
	...
	char                                                         pad0x7_L2MTH[0x7];                                 // 0x129(0x7)
};
...
public:
	...
	char                                                         pad0x7_ZF265[0x7];                                 // 0xb9(0x7)
};
...
public:
	...
	char                                                         pad0x4_2S16F[0x4];                                 // 0x9c(0x4)
};
...
public:
	...
	char                                                         pad0x4_373QG[0x4];                                 // 0xb4(0x4)
};
...
public:
	...
	char                                                         pad0x7_J9FZR[0x7];                                 // 0xb1(0x7)
};
