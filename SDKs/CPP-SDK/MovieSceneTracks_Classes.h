...
public:
	...
	char                                                         pad0x7_NHDI5[0x7];                                 // 0xb9(0x7)
};
...
{
public:
	char                                                         pad0x8_869MC[0x8];                                 // 0x98(0x8)
	struct RichCurve                                             Translation;                                       // 0xa0(0x78)
	char                                                         pad0xf0_QK1S1[0xf0];                               // 0x118(0xf0)
	struct RichCurve                                             Rotation;                                          // 0x208(0x78)
	char                                                         pad0xf0_D5ME8[0xf0];                               // 0x280(0xf0)
	struct RichCurve                                             Scale;                                             // 0x370(0x78)
	char                                                         pad0xf0_1SLO4[0xf0];                               // 0x3e8(0xf0)
};
...
{
public:
	char                                                         pad0x8_MM8JS[0x8];                                 // 0x98(0x8)
	struct IntegralCurve                                         ActorGuidIndexCurve;                               // 0xa0(0x70)
	char                                                         pad0x10_X33PU[0x10];                               // 0x110(0x10)
...
public:
	...
	char                                                         pad0x7_LUIX9[0x7];                                 // 0x1a1(0x7)
};
...
{
public:
	char                                                         pad0x8_S78L4[0x8];                                 // 0x98(0x8)
	bool                                                         DefaultValue;                                      // 0xa0(0x1)
	char                                                         pad0x7_LJP0T[0x7];                                 // 0xa1(0x7)
...
{
public:
	char                                                         pad0x8_L9FMU[0x8];                                 // 0x98(0x8)
...
public:
	...
	char                                                         pad0x7_B9A1B[0x7];                                 // 0xd1(0x7)
};
...
public:
	...
	char                                                         pad0x3_0E8CD[0x3];                                 // 0xc5(0x3)
	struct Rotator                                               UserDefinedPlaySpace;                              // 0xc8(0xc)
	char                                                         pad0x4_62D5W[0x4];                                 // 0xd4(0x4)
};
...
{
public:
	char                                                         pad0x8_WWXU5[0x8];                                 // 0x98(0x8)
...
{
public:
	char                                                         pad0x8_59MXN[0x8];                                 // 0x98(0x8)
...
public:
	...
	char                                                         pad0x88_2A39Y[0x88];                               // 0x120(0x88)
};
...
public:
	...
	char                                                         pad0x7_IAQ0O[0x7];                                 // 0x89(0x7)
...
{
public:
	char                                                         pad0x8_R9X7E[0x8];                                 // 0x98(0x8)
...
public:
	...
	char                                                         pad0x7_Z40IN[0x7];                                 // 0x129(0x7)
};
...
{
public:
	char                                                         pad0x8_TIWR7[0x8];                                 // 0x98(0x8)
...
public:
	...
	char                                                         pad0x7_ENEAZ[0x7];                                 // 0x99(0x7)
...
public:
	...
	char                                                         pad0x4_EUNWJ[0x4];                                 // 0x9c(0x4)
};
...
public:
	...
	char                                                         pad0x7_HAAUQ[0x7];                                 // 0xb1(0x7)
};
...
public:
	...
	char                                                         pad0x4_B934J[0x4];                                 // 0xb4(0x4)
};
...
public:
	...
	char                                                         pad0x3_PZ09P[0x3];                                 // 0x14d(0x3)
...
public:
	...
	char                                                         pad0x7_MYTF8[0x7];                                 // 0x89(0x7)
...
{
public:
	char                                                         pad0x8_VUMCW[0x8];                                 // 0x98(0x8)
...
public:
	...
	char                                                         pad0x4_9ASTS[0x4];                                 // 0xb4(0x4)
...
{
public:
	char                                                         pad0x8_KB676[0x8];                                 // 0x98(0x8)
	struct RichCurve                                             Curves;                                            // 0xa0(0x78)
	char                                                         pad0x168_ZZMJX[0x168];                             // 0x118(0x168)
	int                                                          ChannelsUsed;                                      // 0x280(0x4)
	char                                                         pad0x4_8PA88[0x4];                                 // 0x284(0x4)
};
