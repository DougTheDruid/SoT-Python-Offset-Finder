...
public:
	...
	char                                                         pad0x3_IAGON[0x3];                                 // 0xc5(0x3)
	struct Rotator                                               UserDefinedPlaySpace;                              // 0xc8(0xc)
	char                                                         pad0x4_DVRKL[0x4];                                 // 0xd4(0x4)
};
...
public:
	...
	char                                                         pad0x7_RRG6Y[0x7];                                 // 0x1a1(0x7)
};
...
public:
	...
	char                                                         pad0x7_KOUYA[0x7];                                 // 0x89(0x7)
...
{
public:
	char                                                         pad0x8_D2A0F[0x8];                                 // 0x98(0x8)
...
{
public:
	char                                                         pad0x8_9V8RU[0x8];                                 // 0x98(0x8)
...
{
public:
	char                                                         pad0x8_SIVIT[0x8];                                 // 0x98(0x8)
	bool                                                         DefaultValue;                                      // 0xa0(0x1)
	char                                                         pad0x7_2V2RK[0x7];                                 // 0xa1(0x7)
...
public:
	...
	char                                                         pad0x7_CVF1M[0x7];                                 // 0xd1(0x7)
};
...
{
public:
	char                                                         pad0x8_1NCFS[0x8];                                 // 0x98(0x8)
...
{
public:
	char                                                         pad0x8_5FUBO[0x8];                                 // 0x98(0x8)
	struct RichCurve                                             Curves;                                            // 0xa0(0x78)
	char                                                         pad0x168_0I4I0[0x168];                             // 0x118(0x168)
	int                                                          ChannelsUsed;                                      // 0x280(0x4)
	char                                                         pad0x4_73PSU[0x4];                                 // 0x284(0x4)
};
...
public:
	...
	char                                                         pad0x3_5E00D[0x3];                                 // 0x14d(0x3)
...
public:
	...
	char                                                         pad0x7_8285G[0x7];                                 // 0x99(0x7)
...
{
public:
	char                                                         pad0x8_E7056[0x8];                                 // 0x98(0x8)
	struct IntegralCurve                                         ActorGuidIndexCurve;                               // 0xa0(0x70)
	char                                                         pad0x10_1OJK2[0x10];                               // 0x110(0x10)
...
{
public:
	char                                                         pad0x8_809OT[0x8];                                 // 0x98(0x8)
...
public:
	...
	char                                                         pad0x88_95UUA[0x88];                               // 0x120(0x88)
};
...
{
public:
	char                                                         pad0x8_SVSJS[0x8];                                 // 0x98(0x8)
...
public:
	...
	char                                                         pad0x7_XNK93[0x7];                                 // 0x89(0x7)
...
{
public:
	char                                                         pad0x8_FZ2OQ[0x8];                                 // 0x98(0x8)
	struct RichCurve                                             Translation;                                       // 0xa0(0x78)
	char                                                         pad0xf0_4E0TR[0xf0];                               // 0x118(0xf0)
	struct RichCurve                                             Rotation;                                          // 0x208(0x78)
	char                                                         pad0xf0_FM0UD[0xf0];                               // 0x280(0xf0)
	struct RichCurve                                             Scale;                                             // 0x370(0x78)
	char                                                         pad0xf0_P3RKW[0xf0];                               // 0x3e8(0xf0)
};
...
{
public:
	char                                                         pad0x8_7T58B[0x8];                                 // 0x98(0x8)
...
public:
	...
	char                                                         pad0x4_JRJ0L[0x4];                                 // 0xb4(0x4)
...
public:
	...
	char                                                         pad0x7_PSK64[0x7];                                 // 0xb1(0x7)
};
...
public:
	...
	char                                                         pad0x4_VQW78[0x4];                                 // 0xb4(0x4)
};
...
public:
	...
	char                                                         pad0x7_DCGF0[0x7];                                 // 0x129(0x7)
};
...
public:
	...
	char                                                         pad0x7_2O5G3[0x7];                                 // 0xb9(0x7)
};
...
public:
	...
	char                                                         pad0x4_J2YSF[0x4];                                 // 0x9c(0x4)
};
