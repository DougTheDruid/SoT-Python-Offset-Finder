...
public:
	...
	char                                                         pad0x7_DRY7S[0x7];                                 // 0xb9(0x7)
};
...
{
public:
	char                                                         pad0x8_YSD1C[0x8];                                 // 0x98(0x8)
	Struct RichCurve                                             Translation;                                       // 0xa0(0x78)
	char                                                         pad0xf0_59CIF[0xf0];                               // 0x118(0xf0)
	Struct RichCurve                                             Rotation;                                          // 0x208(0x78)
	char                                                         pad0xf0_JFJ47[0xf0];                               // 0x280(0xf0)
	Struct RichCurve                                             Scale;                                             // 0x370(0x78)
	char                                                         pad0xf0_W3KGI[0xf0];                               // 0x3e8(0xf0)
};
...
{
public:
	char                                                         pad0x8_EKK17[0x8];                                 // 0x98(0x8)
	Struct IntegralCurve                                         ActorGuidIndexCurve;                               // 0xa0(0x70)
	char                                                         pad0x10_GF7IF[0x10];                               // 0x110(0x10)
...
public:
	...
	char                                                         pad0x7_REG2K[0x7];                                 // 0x1a1(0x7)
};
...
{
public:
	char                                                         pad0x8_MVKYD[0x8];                                 // 0x98(0x8)
	bool                                                         DefaultValue;                                      // 0xa0(0x1)
	char                                                         pad0x7_YXMN6[0x7];                                 // 0xa1(0x7)
...
{
public:
	char                                                         pad0x8_TNF8V[0x8];                                 // 0x98(0x8)
...
public:
	...
	char                                                         pad0x7_39QRV[0x7];                                 // 0xd1(0x7)
};
...
public:
	...
	char                                                         pad0x3_TJA5E[0x3];                                 // 0xc5(0x3)
	Struct Rotator                                               UserDefinedPlaySpace;                              // 0xc8(0xc)
	char                                                         pad0x4_I7VS2[0x4];                                 // 0xd4(0x4)
};
...
{
public:
	char                                                         pad0x8_C9W63[0x8];                                 // 0x98(0x8)
...
{
public:
	char                                                         pad0x8_KQHRG[0x8];                                 // 0x98(0x8)
...
public:
	...
	char                                                         pad0x88_BQ9TR[0x88];                               // 0x120(0x88)
};
...
public:
	...
	char                                                         pad0x7_01DMW[0x7];                                 // 0x89(0x7)
...
{
public:
	char                                                         pad0x8_EZXBF[0x8];                                 // 0x98(0x8)
...
public:
	...
	char                                                         pad0x7_PKXD8[0x7];                                 // 0x129(0x7)
};
...
{
public:
	char                                                         pad0x8_KEIHH[0x8];                                 // 0x98(0x8)
...
public:
	...
	char                                                         pad0x7_0VCZB[0x7];                                 // 0x99(0x7)
...
public:
	...
	char                                                         pad0x4_I8LPS[0x4];                                 // 0x9c(0x4)
};
...
public:
	...
	char                                                         pad0x7_I5XYZ[0x7];                                 // 0xb1(0x7)
};
...
public:
	...
	char                                                         pad0x4_VDM2R[0x4];                                 // 0xb4(0x4)
};
...
public:
	...
	char                                                         pad0x3_YT2UK[0x3];                                 // 0x14d(0x3)
...
public:
	...
	char                                                         pad0x7_ZSLYZ[0x7];                                 // 0x89(0x7)
...
{
public:
	char                                                         pad0x8_5YVJ6[0x8];                                 // 0x98(0x8)
...
public:
	...
	char                                                         pad0x4_X74WQ[0x4];                                 // 0xb4(0x4)
...
{
public:
	char                                                         pad0x8_6QYCF[0x8];                                 // 0x98(0x8)
	Struct RichCurve                                             Curves;                                            // 0xa0(0x78)
	char                                                         pad0x168_W4I85[0x168];                             // 0x118(0x168)
	int                                                          ChannelsUsed;                                      // 0x280(0x4)
	char                                                         pad0x4_59L6N[0x4];                                 // 0x284(0x4)
};
