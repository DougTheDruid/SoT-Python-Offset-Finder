...
{
public:
	char                                                         pad0x8_19AZV[0x8];                                 // 0x98(0x8)
...
public:
	...
	char                                                         pad0x3_FLOM2[0x3];                                 // 0xc5(0x3)
	struct Rotator                                               UserDefinedPlaySpace;                              // 0xc8(0xc)
	char                                                         pad0x4_DT9XC[0x4];                                 // 0xd4(0x4)
};
...
public:
	...
	char                                                         pad0x88_BFS26[0x88];                               // 0x120(0x88)
};
...
public:
	...
	char                                                         pad0x7_UI9BO[0x7];                                 // 0xd1(0x7)
};
...
public:
	...
	char                                                         pad0x7_M6IXV[0x7];                                 // 0x89(0x7)
...
{
public:
	char                                                         pad0x8_KOCHO[0x8];                                 // 0x98(0x8)
...
{
public:
	char                                                         pad0x8_61QPY[0x8];                                 // 0x98(0x8)
	bool                                                         DefaultValue;                                      // 0xa0(0x1)
	char                                                         pad0x7_VQTGY[0x7];                                 // 0xa1(0x7)
...
public:
	...
	char                                                         pad0x3_DWJX1[0x3];                                 // 0x14d(0x3)
...
public:
	...
	char                                                         pad0x7_XUPB6[0x7];                                 // 0x89(0x7)
...
{
public:
	char                                                         pad0x8_IDNXR[0x8];                                 // 0x98(0x8)
...
{
public:
	char                                                         pad0x8_RYK7Y[0x8];                                 // 0x98(0x8)
	struct RichCurve                                             Curves;                                            // 0xa0(0x78)
	char                                                         pad0x168_ZN6WP[0x168];                             // 0x118(0x168)
	int                                                          ChannelsUsed;                                      // 0x280(0x4)
	char                                                         pad0x4_X56Z5[0x4];                                 // 0x284(0x4)
};
...
{
public:
	char                                                         pad0x8_CZXSS[0x8];                                 // 0x98(0x8)
	struct RichCurve                                             Translation;                                       // 0xa0(0x78)
	char                                                         pad0xf0_C95YX[0xf0];                               // 0x118(0xf0)
	struct RichCurve                                             Rotation;                                          // 0x208(0x78)
	char                                                         pad0xf0_RQAJR[0xf0];                               // 0x280(0xf0)
	struct RichCurve                                             Scale;                                             // 0x370(0x78)
	char                                                         pad0xf0_TABM9[0xf0];                               // 0x3e8(0xf0)
};
...
{
public:
	char                                                         pad0x8_OQ0MG[0x8];                                 // 0x98(0x8)
...
{
public:
	char                                                         pad0x8_U4SQH[0x8];                                 // 0x98(0x8)
...
public:
	...
	char                                                         pad0x7_9VSC9[0x7];                                 // 0x1a1(0x7)
};
...
{
public:
	char                                                         pad0x8_NBTCZ[0x8];                                 // 0x98(0x8)
	struct IntegralCurve                                         ActorGuidIndexCurve;                               // 0xa0(0x70)
	char                                                         pad0x10_XAMTW[0x10];                               // 0x110(0x10)
...
{
public:
	char                                                         pad0x8_RADQG[0x8];                                 // 0x98(0x8)
...
public:
	...
	char                                                         pad0x4_TXOGS[0x4];                                 // 0xb4(0x4)
...
public:
	...
	char                                                         pad0x7_G9OO5[0x7];                                 // 0x99(0x7)
...
public:
	...
	char                                                         pad0x7_GU07R[0x7];                                 // 0xb9(0x7)
};
...
public:
	...
	char                                                         pad0x4_OGG3U[0x4];                                 // 0xb4(0x4)
};
...
public:
	...
	char                                                         pad0x7_MDJUV[0x7];                                 // 0x129(0x7)
};
...
public:
	...
	char                                                         pad0x4_2KLSB[0x4];                                 // 0x9c(0x4)
};
...
public:
	...
	char                                                         pad0x7_X162A[0x7];                                 // 0xb1(0x7)
};
