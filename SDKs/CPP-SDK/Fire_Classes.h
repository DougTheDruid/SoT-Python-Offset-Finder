...
{
public:
	struct                                                       CookerIgnitionParams;                              // 0xc8(0x78)
};
...
{
public:
	struct                                                       FireAudioParams;                                   // 0x28(0x40)
...
public:
	...
	struct                                                       GridDimensions;                                    // 0xf4(0xc)
	struct                                                       GridOffset;                                        // 0x100(0xc)
	...
	struct                                                       BurnStatus;                                        // 0x140(0x18)
	class FireGridVFXManager*                                    VFXManager;                                        // 0x158(0x8)
	struct                                                       VfxSpawnSettings;                                  // 0x160(0x58)
	struct                                                       FireLightManager;                                  // 0x1b8(0x150)
	struct                                                       FireCharringManager;                               // 0x308(0xd8)
	TArray<struct ReplicatedFireCellData>                        ReplicatedCellData;                                // 0x3e0(0x10)
	struct                                                       ReplicatedCellCharringData;                        // 0x3f0(0x18)
	class FireGridAudioManager*                                  FireAudioManager;                                  // 0x408(0x8)
	struct                                                       FireAudioParams;                                   // 0x410(0x40)
};
...
{
public:
	struct                                                       FireDamageParams;                                  // 0x28(0x18)
};
...
{
public:
	struct                                                       IgnitedStatus;                                     // 0xe0(0x18)
};
...
public:
	...
	struct                                                       FireStatus;                                        // 0x120(0x18)
	struct                                                       BurnStatus;                                        // 0x138(0x18)
...
{
public:
	struct                                                       FireGridLocation;                                  // 0x1f8(0xc)
};
