...
{
public:
	char                                                         pad0x8_QRY4H[0x8];                                 // 0xb8(0x8)
	struct Vector                                                FireGridCellActorSpaceLocation;                    // 0xc0(0xc)
	char                                                         pad0x4_3Z0WN[0x4];                                 // 0xcc(0x4)
};
...
{
public:
	char                                                         pad0x8_MIV5C[0x8];                                 // 0x3a0(0x8)
	...
	char                                                         pad0x30_PMSTK[0x30];                               // 0x3d8(0x30)
};
...
public:
	...
	char                                                         pad0x4_ZEU1P[0x4];                                 // 0x3c(0x4)
};
...
{
public:
	char                                                         pad0x18_NKF36[0x18];                               // 0xb8(0x18)
	bool                                                         OnFire;                                            // 0xd0(0x1)
	char                                                         pad0x7_6QIK5[0x7];                                 // 0xd1(0x7)
};
...
public:
	...
	char                                                         pad0x4_LF0RC[0x4];                                 // 0xbc(0x4)
};
...
{
public:
	char                                                         pad0x18_TIQQJ[0x18];                               // 0xb8(0x18)
	...
	char                                                         pad0x4_0Q3Z7[0x4];                                 // 0xfc(0x4)
	...
	char                                                         pad0x10_989SC[0x10];                               // 0x120(0x10)
	...
	char                                                         pad0x68_J55O6[0x68];                               // 0x420(0x68)
};
...
{
public:
	char                                                         pad0x8_W6PLD[0x8];                                 // 0x750(0x8)
	...
	char                                                         pad0x10_ID0XO[0x10];                               // 0x770(0x10)
};
...
public:
	...
	char                                                         pad0x58_1OZIK[0x58];                               // 0x78(0x58)
};
...
public:
	...
	char                                                         pad0x2_X2HED[0x2];                                 // 0xda(0x2)
...
public:
	...
	char                                                         pad0x10_NHNZQ[0x10];                               // 0xe0(0x10)
...
{
public:
	char                                                         pad0x8_DWZ25[0x8];                                 // 0x1f8(0x8)
	struct Vector                                                FireGridLocation;                                  // 0x200(0xc)
	char                                                         pad0x14_PXG5Y[0x14];                               // 0x20c(0x14)
};
