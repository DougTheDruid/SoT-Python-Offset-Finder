...
public:
	...
	char                                                         pad0x4_5MZNH[0x4];                                 // 0xbc(0x4)
};
...
{
public:
	char                                                         pad0x18_V2LXH[0x18];                               // 0xb8(0x18)
	...
	char                                                         pad0x4_L2MT8[0x4];                                 // 0xfc(0x4)
	...
	char                                                         pad0x10_JCSG0[0x10];                               // 0x120(0x10)
	...
	char                                                         pad0x68_RHYP6[0x68];                               // 0x420(0x68)
};
...
public:
	...
	char                                                         pad0x4_1ON7P[0x4];                                 // 0x3c(0x4)
};
...
{
public:
	char                                                         pad0x18_T9XXS[0x18];                               // 0xb8(0x18)
	bool                                                         OnFire;                                            // 0xd0(0x1)
	char                                                         pad0x7_8GYT4[0x7];                                 // 0xd1(0x7)
};
...
{
public:
	char                                                         pad0x8_BK0AH[0x8];                                 // 0x3a0(0x8)
	...
	char                                                         pad0x30_K87S9[0x30];                               // 0x3d8(0x30)
};
...
{
public:
	char                                                         pad0x8_DCW33[0x8];                                 // 0x750(0x8)
	...
	char                                                         pad0x10_KBZK4[0x10];                               // 0x770(0x10)
};
...
public:
	...
	char                                                         pad0x58_3Z77G[0x58];                               // 0x78(0x58)
};
...
public:
	...
	char                                                         pad0x2_ZXT96[0x2];                                 // 0xda(0x2)
...
public:
	...
	char                                                         pad0x10_JK5YM[0x10];                               // 0xe0(0x10)
...
{
public:
	char                                                         pad0x8_ZECL9[0x8];                                 // 0x1f8(0x8)
	struct Vector                                                FireGridLocation;                                  // 0x200(0xc)
	char                                                         pad0x14_M805W[0x14];                               // 0x20c(0x14)
};
