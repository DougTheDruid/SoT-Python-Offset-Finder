...
{
public:
	char                                                         pad0x10_KTO5J[0x10];                               // 0x7f0(0x10)
	...
	char                                                         pad0x5c_ENXE2[0x5c];                               // 0x814(0x5c)
	...
	char                                                         pad0x108_ZU83A[0x108];                             // 0x888(0x108)
};
...
{
public:
	char                                                         pad0x30_TTK5V[0x30];                               // 0x290(0x30)
};
...
{
public:
	char                                                         pad0x28_D3IL7[0x28];                               // 0x3a0(0x28)
	...
	char                                                         pad0x58_UVFQ7[0x58];                               // 0x3e0(0x58)
};
