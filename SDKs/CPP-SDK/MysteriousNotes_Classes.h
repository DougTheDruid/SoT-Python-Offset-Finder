...
public:
	...
	struct                                                       DefaultNoteLayoutItem;                             // 0x98(0xe0)
...
public:
	...
	struct                                                       MysteriousNotesCompletionStringsAsset;             // 0x30(0x10)
	struct                                                       WieldableNoteDataAsset;                            // 0x40(0x10)
	struct                                                       Image;                                             // 0x50(0x10)
	struct                                                       NotificationBackground;                            // 0x60(0x10)
};
