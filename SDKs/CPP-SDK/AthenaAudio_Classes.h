...
public:
	...
	char                                                         pad0x3_FE0ZP[0x3];                                 // 0x2ed(0x3)
	...
	char                                                         pad0x28_1KNXW[0x28];                               // 0x318(0x28)
};
...
public:
	...
	char                                                         pad0x18_DCEBL[0x18];                               // 0x638(0x18)
};
...
public:
	...
	char                                                         pad0x8_MB9JB[0x8];                                 // 0x3d0(0x8)
};
...
public:
	...
	char                                                         pad0x4_03JFY[0x4];                                 // 0x34(0x4)
...
public:
	...
	char                                                         pad0x14_K2IE6[0x14];                               // 0x31c(0x14)
	Class Character*                                             LocalPlayer;                                       // 0x330(0x8)
	char                                                         pad0x38_J7I4B[0x38];                               // 0x338(0x38)
};
