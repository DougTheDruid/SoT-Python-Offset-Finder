...
public:
	...
	char                                                         pad0x1f_7RBT6[0x1f];                               // 0xb9(0x1f)
};
...
public:
	...
	char                                                         pad0x14_LAB0D[0x14];                               // 0x30c(0x14)
	class Character*                                             LocalPlayer;                                       // 0x320(0x8)
	char                                                         pad0x38_4Z45S[0x38];                               // 0x328(0x38)
};
...
{
public:
	char                                                         pad0x60_TCNA5[0x60];                               // 0x28(0x60)
	class Texture2D*                                             DebugImmerseQRCodeTexture;                         // 0x88(0x8)
	class ImmerseCosmeticUnlockerComponent*                      LocalCosmeticUnlocker;                             // 0x90(0x8)
	char                                                         pad0x8_40V2J[0x8];                                 // 0x98(0x8)
};
...
public:
	...
	char                                                         pad0x8_D20Q7[0x8];                                 // 0x3a8(0x8)
};
...
public:
	...
	char                                                         pad0x3_E3T3G[0x3];                                 // 0x2dd(0x3)
	...
	char                                                         pad0x28_EXTCK[0x28];                               // 0x308(0x28)
};
...
public:
	...
	char                                                         pad0x4_8K1UR[0x4];                                 // 0x34(0x4)
...
public:
	...
	char                                                         pad0x18_KHXZR[0x18];                               // 0x618(0x18)
};
...
{
public:
	char                                                         pad0xb0_X090S[0xb0];                               // 0x28(0xb0)
};
