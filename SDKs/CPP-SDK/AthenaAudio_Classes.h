...
public:
	...
	char                                                         pad0x3_FBPLE[0x3];                                 // 0x2dd(0x3)
	...
	char                                                         pad0x28_1OBHP[0x28];                               // 0x308(0x28)
};
...
public:
	...
	char                                                         pad0x8_MW457[0x8];                                 // 0x3a8(0x8)
};
...
public:
	...
	char                                                         pad0x4_84BKC[0x4];                                 // 0x34(0x4)
...
{
public:
	char                                                         pad0xb0_TM1AE[0xb0];                               // 0x28(0xb0)
};
...
public:
	...
	char                                                         pad0x14_PCSZO[0x14];                               // 0x30c(0x14)
	class Character*                                             LocalPlayer;                                       // 0x320(0x8)
	char                                                         pad0x38_4HZUP[0x38];                               // 0x328(0x38)
};
...
public:
	...
	char                                                         pad0x1f_U3TP1[0x1f];                               // 0xb9(0x1f)
};
...
public:
	...
	char                                                         pad0x18_JESPC[0x18];                               // 0x618(0x18)
};
