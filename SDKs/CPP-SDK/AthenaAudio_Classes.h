...
public:
	...
	char                                                         pad0x18_DZQEX[0x18];                               // 0x618(0x18)
};
...
public:
	...
	char                                                         pad0x1f_THWRP[0x1f];                               // 0xb9(0x1f)
};
...
{
public:
	char                                                         pad0xb0_VJ8HH[0xb0];                               // 0x28(0xb0)
};
...
public:
	...
	char                                                         pad0x8_0L7E7[0x8];                                 // 0x3a8(0x8)
};
...
public:
	...
	char                                                         pad0x4_OYSMF[0x4];                                 // 0x34(0x4)
...
public:
	...
	char                                                         pad0x14_5T8Q8[0x14];                               // 0x30c(0x14)
	class Character*                                             LocalPlayer;                                       // 0x320(0x8)
	char                                                         pad0x38_SNCZF[0x38];                               // 0x328(0x38)
};
...
public:
	...
	char                                                         pad0x3_PUQAA[0x3];                                 // 0x2dd(0x3)
	...
	char                                                         pad0x28_LMDGA[0x28];                               // 0x308(0x28)
};
