...
public:
	...
	char                                                         pad0x3_GN090[0x3];                                 // 0x21(0x3)
...
{
public:
	char                                                         pad0x50_QIUWF[0x50];                               // 0x0(0x50)
};
...
{
public:
	char                                                         pad0x10_OCDIR[0x10];                               // 0x0(0x10)
...
{
public:
	char                                                         pad0x48_Y298S[0x48];                               // 0x0(0x48)
};
...
{
public:
	char                                                         pad0x10_SLFAV[0x10];                               // 0x0(0x10)
	char                                                         ReactionType;                                      // 0x10(0x1)
	char                                                         pad0x3_TERA3[0x3];                                 // 0x11(0x3)
};
...
{
public:
	char                                                         pad0x10_SFUKN[0x10];                               // 0x0(0x10)
};
...
public:
	...
	char                                                         pad0xc_CVLAE[0xc];                                 // 0x14(0xc)
};
...
{
public:
	char                                                         pad0x10_OPT6A[0x10];                               // 0x0(0x10)
...
{
public:
	char                                                         pad0x10_H2ZTM[0x10];                               // 0x0(0x10)
	class Actor*                                                 FeedingActor;                                      // 0x10(0x8)
};
...
public:
	...
	char                                                         pad0x10_WX1A2[0x10];                               // 0x10(0x10)
};
...
public:
	...
	char                                                         pad0x4_QWUKS[0x4];                                 // 0xc4(0x4)
...
public:
	...
	char                                                         pad0x4_QO542[0x4];                                 // 0x3c(0x4)
};
...
public:
	bool                                                         IsOnPerch;                                         // 0x0(0x1)
	char                                                         pad0x3_XVAW2[0x3];                                 // 0x1(0x3)
	char                                                         pad0x8_DZ049[0x8];                                 // 0x4(0x8)
};
...
public:
	...
	char                                                         pad0x18_P7V32[0x18];                               // 0x8(0x18)
};
...
{
public:
	char                                                         pad0x50_12E1O[0x50];                               // 0x0(0x50)
};
...
public:
	...
	char                                                         pad0x7_D0V3G[0x7];                                 // 0x11(0x7)
};
...
public:
	...
	char                                                         pad0x3_TU0Y3[0x3];                                 // 0x11(0x3)
};
...
public:
	...
	char                                                         pad0x4_2RYWD[0x4];                                 // 0x3c(0x4)
};
...
public:
	...
	char                                                         pad0xe_Y052Y[0xe];                                 // 0x72(0xe)
};
