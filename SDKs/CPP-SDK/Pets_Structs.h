...
public:
	...
	char                                                         pad0x4_CCT19[0x4];                                 // 0xc4(0x4)
...
public:
	...
	char                                                         pad0xc_N7JSP[0xc];                                 // 0x14(0xc)
};
...
public:
	...
	char                                                         pad0x3_STAVC[0x3];                                 // 0x11(0x3)
};
...
public:
	...
	char                                                         pad0x18_DL45F[0x18];                               // 0x8(0x18)
};
...
{
public:
	char                                                         pad0x10_BAGSW[0x10];                               // 0x0(0x10)
...
{
public:
	char                                                         pad0x50_CHC43[0x50];                               // 0x0(0x50)
};
...
public:
	...
	char                                                         pad0x4_3ICGA[0x4];                                 // 0x3c(0x4)
};
...
{
public:
	char                                                         pad0x10_WWZ3C[0x10];                               // 0x0(0x10)
	char                                                         ReactionType;                                      // 0x10(0x1)
	char                                                         pad0x3_O0BUJ[0x3];                                 // 0x11(0x3)
};
...
{
public:
	char                                                         pad0x48_8YU5T[0x48];                               // 0x0(0x48)
};
...
public:
	...
	char                                                         pad0x4_2T7EN[0x4];                                 // 0x3c(0x4)
};
...
public:
	...
	char                                                         pad0x10_QTOOV[0x10];                               // 0x10(0x10)
};
...
{
public:
	char                                                         pad0x10_JMAQZ[0x10];                               // 0x0(0x10)
};
...
public:
	...
	char                                                         pad0x3_6M7U9[0x3];                                 // 0x21(0x3)
...
{
public:
	char                                                         pad0x50_UKMUG[0x50];                               // 0x0(0x50)
};
...
{
public:
	char                                                         pad0x10_WATQF[0x10];                               // 0x0(0x10)
...
{
public:
	char                                                         pad0x10_PD4FT[0x10];                               // 0x0(0x10)
	class Actor*                                                 FeedingActor;                                      // 0x10(0x8)
};
...
public:
	...
	char                                                         pad0x7_VH5WX[0x7];                                 // 0x11(0x7)
};
...
public:
	bool                                                         IsOnPerch;                                         // 0x0(0x1)
	char                                                         pad0x3_BK7ZF[0x3];                                 // 0x1(0x3)
	char                                                         pad0x8_2CFCT[0x8];                                 // 0x4(0x8)
};
...
public:
	...
	char                                                         pad0xe_NJLCJ[0xe];                                 // 0x72(0xe)
};
