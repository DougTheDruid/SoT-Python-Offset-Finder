...
{
public:
	char                                                         pad0xa0_7AETX[0xa0];                               // 0x0(0xa0)
};
...
{
public:
	char                                                         pad0x50_0UOV4[0x50];                               // 0x0(0x50)
};
...
{
public:
	char                                                         pad0x8_D0K4Y[0x8];                                 // 0x0(0x8)
	class Struct*                                                EventType;                                         // 0x8(0x8)
	char                                                         pad0x48_390RM[0x48];                               // 0x10(0x48)
};
