...
{
public:
	char                                                         pad0xa0_O54OY[0xa0];                               // 0x0(0xa0)
};
...
{
public:
	char                                                         pad0x8_UTYDM[0x8];                                 // 0x0(0x8)
	class Struct*                                                EventType;                                         // 0x8(0x8)
	char                                                         pad0x48_3MMKC[0x48];                               // 0x10(0x48)
};
...
{
public:
	char                                                         pad0x50_WU01U[0x50];                               // 0x0(0x50)
};
