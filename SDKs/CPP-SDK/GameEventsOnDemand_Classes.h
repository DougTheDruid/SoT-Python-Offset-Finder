...
{
public:
	char                                                         pad0xa0_A9UBT[0xa0];                               // 0x28(0xa0)
	class World*                                                 World;                                             // 0xc8(0x8)
	char                                                         pad0x18_1OEQA[0x18];                               // 0xd0(0x18)
};
