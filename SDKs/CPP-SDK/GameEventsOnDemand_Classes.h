...
{
public:
	char                                                         pad0xd0_Y8MS3[0xd0];                               // 0x28(0xd0)
	class World*                                                 World;                                             // 0xf8(0x8)
	char                                                         pad0x18_LBD4U[0x18];                               // 0x100(0x18)
};
