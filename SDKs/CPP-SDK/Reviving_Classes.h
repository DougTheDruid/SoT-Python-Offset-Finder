...
public:
	...
	char                                                         pad0x3_7E5HL[0x3];                                 // 0x51(0x3)
	...
	char                                                         pad0x4_LVY5R[0x4];                                 // 0x8c(0x4)
};
...
{
public:
	char                                                         pad0x8_B36NJ[0x8];                                 // 0x138(0x8)
	bool                                                         HasGivenUp;                                        // 0x140(0x1)
	char                                                         pad0x47_83EDU[0x47];                               // 0x141(0x47)
};
...
public:
	...
	char                                                         pad0x18_55Y8U[0x18];                               // 0x318(0x18)
};
...
{
public:
	char                                                         pad0x10_9H2R2[0x10];                               // 0x138(0x10)
	class Character*                                             OwningCharacter;                                   // 0x148(0x8)
	class Actor*                                                 ReviveableRepresentationActor;                     // 0x150(0x8)
	byte                                                         ReviveState;                                       // 0x158(0x1)
	byte                                                         InteractionState;                                  // 0x159(0x1)
	char                                                         pad0x6_9C2WQ[0x6];                                 // 0x15a(0x6)
	class UClass*                                                ReviveableRepresentationClass;                     // 0x160(0x8)
	char                                                         pad0xc_YB99H[0xc];                                 // 0x168(0xc)
	bool                                                         ReviveWindowIsOpen;                                // 0x174(0x1)
	char                                                         pad0xd3_EIJ3U[0xd3];                               // 0x175(0xd3)
	struct Status                                                RevivableStatus;                                   // 0x248(0x18)
	char                                                         pad0x18_B8VY1[0x18];                               // 0x260(0x18)
};
...
{
public:
	char                                                         pad0x98_O9B0W[0x98];                               // 0xc8(0x98)
};
...
{
public:
	char                                                         pad0x10_81DN8[0x10];                               // 0x3c8(0x10)
	...
	char                                                         pad0x10_2O960[0x10];                               // 0x420(0x10)
	byte                                                         RevivableOwnerNetRole;                             // 0x430(0x1)
	char                                                         pad0x7_6JWDT[0x7];                                 // 0x431(0x7)
	...
	char                                                         pad0x13c_OSHGC[0x13c];                             // 0x4a0(0x13c)
	...
	char                                                         pad0x4_2NW02[0x4];                                 // 0x624(0x4)
};
