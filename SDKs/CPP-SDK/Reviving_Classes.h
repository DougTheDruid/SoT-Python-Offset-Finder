...
public:
	...
	char                                                         pad0x3_6K9WI[0x3];                                 // 0x51(0x3)
	...
	char                                                         pad0x4_V6IA9[0x4];                                 // 0x8c(0x4)
};
...
{
public:
	char                                                         pad0x8_E20WH[0x8];                                 // 0x138(0x8)
	bool                                                         HasGivenUp;                                        // 0x140(0x1)
	char                                                         pad0x47_RVSQO[0x47];                               // 0x141(0x47)
};
...
public:
	...
	char                                                         pad0x18_GQECY[0x18];                               // 0x318(0x18)
};
...
{
public:
	char                                                         pad0x10_A73E6[0x10];                               // 0x138(0x10)
	...
	char                                                         pad0x6_VQOWZ[0x6];                                 // 0x15a(0x6)
	class UClass*                                                ReviveableRepresentationClass;                     // 0x160(0x8)
	char                                                         pad0xc_7MFC7[0xc];                                 // 0x168(0xc)
	bool                                                         ReviveWindowIsOpen;                                // 0x174(0x1)
	char                                                         pad0xd3_FZ1FG[0xd3];                               // 0x175(0xd3)
	struct Status                                                RevivableStatus;                                   // 0x248(0x18)
	char                                                         pad0x18_IQ2PW[0x18];                               // 0x260(0x18)
};
...
{
public:
	char                                                         pad0x98_D0DVS[0x98];                               // 0xc8(0x98)
};
...
{
public:
	char                                                         pad0x10_EKGLX[0x10];                               // 0x3c8(0x10)
	...
	char                                                         pad0x10_QYFF2[0x10];                               // 0x420(0x10)
	byte                                                         RevivableOwnerNetRole;                             // 0x430(0x1)
	char                                                         pad0x7_3D78H[0x7];                                 // 0x431(0x7)
	...
	char                                                         pad0x13c_FHI70[0x13c];                             // 0x4a0(0x13c)
	...
	char                                                         pad0x4_QQGRL[0x4];                                 // 0x624(0x4)
};
