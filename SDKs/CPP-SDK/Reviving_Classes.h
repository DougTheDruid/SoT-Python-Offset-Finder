...
public:
	...
	struct                                                       RevivableStatus;                                   // 0x248(0x18)
};
...
public:
	...
	struct                                                       ReviveEffectsValues;                               // 0x448(0x20)
	struct                                                       ReviveSettings;                                    // 0x468(0x38)
	...
	struct                                                       GhostPlayModeSpecificParameters;                   // 0x618(0xc)
};
