...
public:
	...
	char                                                         pad0x18_CKJN5[0x18];                               // 0x308(0x18)
};
...
{
public:
	char                                                         pad0x10_JHUX4[0x10];                               // 0x140(0x10)
	...
	char                                                         pad0x6_5U0J8[0x6];                                 // 0x162(0x6)
	class UClass*                                                ReviveableRepresentationClass;                     // 0x168(0x8)
	char                                                         pad0xc_J6501[0xc];                                 // 0x170(0xc)
	bool                                                         ReviveWindowIsOpen;                                // 0x17c(0x1)
	char                                                         pad0xd3_FBFGB[0xd3];                               // 0x17d(0xd3)
	struct Status                                                RevivableStatus;                                   // 0x250(0x20)
	char                                                         pad0x70_UZIE6[0x70];                               // 0x270(0x70)
};
...
public:
	...
	char                                                         pad0x54_6HR68[0x54];                               // 0x12c(0x54)
	float                                                        ReviveTime;                                        // 0x180(0x4)
	char                                                         pad0x4_S0XT2[0x4];                                 // 0x184(0x4)
	...
	char                                                         pad0x68_I7LHU[0x68];                               // 0x1b8(0x68)
};
...
{
public:
	char                                                         pad0x8_PEU72[0x8];                                 // 0x140(0x8)
	bool                                                         HasGivenUp;                                        // 0x148(0x1)
	char                                                         pad0x47_YPUAY[0x47];                               // 0x149(0x47)
};
...
{
public:
	char                                                         pad0x98_5NDKS[0x98];                               // 0xb8(0x98)
};
...
{
public:
	char                                                         pad0xc8_Q38X5[0xc8];                               // 0x3a0(0xc8)
};
...
public:
	...
	char                                                         pad0x3_VZUGQ[0x3];                                 // 0x4d(0x3)
	...
	char                                                         pad0x4_OGFDD[0x4];                                 // 0x84(0x4)
};
...
public:
	...
	char                                                         pad0x8_I0HDK[0x8];                                 // 0x4b0(0x8)
	char                                                         RevivableOwnerNetRole;                             // 0x4b8(0x1)
	char                                                         pad0x7_XKQFF[0x7];                                 // 0x4b9(0x7)
	...
	char                                                         pad0x8c_GSB6W[0x8c];                               // 0x528(0x8c)
	...
	char                                                         pad0x4_X3JDP[0x4];                                 // 0x5fc(0x4)
};
...
public:
	...
	char                                                         pad0x8_EQQYN[0x8];                                 // 0x478(0x8)
};
