...
{
public:
	char                                                         pad0x18_MM7M7[0x18];                               // 0x0(0x18)
};
...
{
public:
	char                                                         pad0x18_QBMVB[0x18];                               // 0x0(0x18)
...
{
public:
	char                                                         pad0x18_02CTC[0x18];                               // 0x0(0x18)
...
{
public:
	char                                                         pad0x18_WOLT9[0x18];                               // 0x0(0x18)
...
{
public:
	char                                                         pad0x18_2N387[0x18];                               // 0x0(0x18)
	char                                                         Visibility;                                        // 0x18(0x1)
	char                                                         pad0x7_23UPA[0x7];                                 // 0x19(0x7)
...
{
public:
	char                                                         pad0x18_LUJTF[0x18];                               // 0x0(0x18)
	struct MovieScenePropertySectionData                         PropertyData;                                      // 0x18(0x20)
...
{
public:
	char                                                         pad0x18_EINMS[0x18];                               // 0x0(0x18)
...
{
public:
	char                                                         pad0x18_UKZAA[0x18];                               // 0x0(0x18)
};
...
{
public:
	char                                                         pad0x48_HZM0W[0x48];                               // 0x0(0x48)
};
...
{
public:
	char                                                         pad0x8_8SNU4[0x8];                                 // 0x0(0x8)
	struct LinearColor                                           Color;                                             // 0x8(0x10)
	char                                                         pad0x40_4DYY8[0x40];                               // 0x18(0x40)
};
...
{
public:
	char                                                         pad0x98_9HNYT[0x98];                               // 0x0(0x98)
...
{
public:
	char                                                         pad0x18_5Q0HF[0x18];                               // 0x0(0x18)
...
{
public:
	char                                                         pad0x18_TBL89[0x18];                               // 0x0(0x18)
	struct MovieScenePropertySectionData                         PropertyData;                                      // 0x18(0x20)
...
{
public:
	char                                                         pad0x18_JWB7O[0x18];                               // 0x0(0x18)
...
{
public:
	char                                                         pad0x48_BL6T4[0x48];                               // 0x0(0x48)
};
...
{
public:
	char                                                         pad0x18_OBHJG[0x18];                               // 0x0(0x18)
};
...
{
public:
	char                                                         pad0x48_O73KL[0x48];                               // 0x0(0x48)
	int                                                          MaterialIndex;                                     // 0x48(0x4)
	char                                                         pad0x4_ZXGEI[0x4];                                 // 0x4c(0x4)
};
...
{
public:
	char                                                         pad0x48_V7A6T[0x48];                               // 0x0(0x48)
...
{
public:
	char                                                         pad0x18_NA131[0x18];                               // 0x0(0x18)
};
...
{
public:
	char                                                         pad0x18_OLS1D[0x18];                               // 0x0(0x18)
	struct MovieScenePropertySectionData                         PropertyData;                                      // 0x18(0x20)
...
{
public:
	char                                                         pad0x8_RUZCW[0x8];                                 // 0x0(0x8)
	struct Vector                                                Location;                                          // 0x8(0xc)
	char                                                         pad0x1c_1C7KP[0x1c];                               // 0x14(0x1c)
};
...
public:
	...
	char                                                         pad0x3_BFYMW[0x3];                                 // 0x15(0x3)
...
{
public:
	char                                                         pad0x18_R4E2J[0x18];                               // 0x0(0x18)
	struct MovieScenePropertySectionData                         PropertyData;                                      // 0x18(0x20)
...
public:
	...
	char                                                         pad0x3_AKTQY[0x3];                                 // 0xd(0x3)
	struct Rotator                                               UserDefinedPlaySpace;                              // 0x10(0xc)
	char                                                         pad0x4_2SEQ6[0x4];                                 // 0x1c(0x4)
};
...
{
public:
	char                                                         pad0x48_XYOLO[0x48];                               // 0x0(0x48)
	struct Vector                                                Vector;                                            // 0x48(0xc)
	char                                                         pad0x4_IFS0D[0x4];                                 // 0x54(0x4)
};
...
{
public:
	char                                                         pad0x8_BD0KC[0x8];                                 // 0x0(0x8)
	struct Vector                                                Scale;                                             // 0x8(0xc)
	char                                                         pad0x1c_PP4O9[0x1c];                               // 0x14(0x1c)
};
...
public:
	...
	char                                                         pad0x7_O8O6Q[0x7];                                 // 0x19(0x7)
};
...
{
public:
	char                                                         pad0x18_RD1XB[0x18];                               // 0x0(0x18)
	struct MovieScenePropertySectionData                         PropertyData;                                      // 0x18(0x20)
...
{
public:
	char                                                         pad0x18_J91Z2[0x18];                               // 0x0(0x18)
	struct MovieScenePropertySectionData                         PropertyData;                                      // 0x18(0x20)
	struct RichCurve                                             ComponentCurves;                                   // 0x38(0x78)
	char                                                         pad0x168_UBNKG[0x168];                             // 0xb0(0x168)
	int                                                          NumChannelsUsed;                                   // 0x218(0x4)
	char                                                         pad0x4_9WIXV[0x4];                                 // 0x21c(0x4)
};
...
{
public:
	char                                                         pad0xa8_78Z8M[0xa8];                               // 0x0(0xa8)
	bool                                                         bTemporarilyHiddenInGame;                          // 0xa8(0x1)
	char                                                         pad0x7_U6NWH[0x7];                                 // 0xa9(0x7)
};
...
{
public:
	char                                                         pad0x18_MPQM4[0x18];                               // 0x0(0x18)
	struct MovieScenePropertySectionData                         PropertyData;                                      // 0x18(0x20)
...
{
public:
	char                                                         pad0x18_P0YCU[0x18];                               // 0x0(0x18)
	struct RichCurve                                             TranslationCurve;                                  // 0x18(0x78)
	char                                                         pad0xf0_SQSS9[0xf0];                               // 0x90(0xf0)
	struct RichCurve                                             RotationCurve;                                     // 0x180(0x78)
	char                                                         pad0xf0_NF7M5[0xf0];                               // 0x1f8(0xf0)
	struct RichCurve                                             ScaleCurve;                                        // 0x2e8(0x78)
	char                                                         pad0xf0_P0DU1[0xf0];                               // 0x360(0xf0)
};
...
{
public:
	char                                                         pad0x8_2NLYU[0x8];                                 // 0x0(0x8)
	struct Rotator                                               Rotation;                                          // 0x8(0xc)
	char                                                         pad0x1c_XJ5EU[0x1c];                               // 0x14(0x1c)
};
...
{
public:
	char                                                         pad0x18_LYWEU[0x18];                               // 0x0(0x18)
};
...
{
public:
	char                                                         pad0x50_11RQ2[0x50];                               // 0x0(0x50)
...
public:
	...
	char                                                         pad0x3_UP56C[0x3];                                 // 0x9(0x3)
	int                                                          ActorNumber;                                       // 0xc(0x4)
	int                                                          SubtitleIndex;                                     // 0x10(0x4)
	char                                                         pad0x4_VYTO4[0x4];                                 // 0x14(0x4)
...
{
public:
	char                                                         pad0x18_TZLQR[0x18];                               // 0x0(0x18)
	struct MovieSceneCameraAnimSectionData                       SourceData;                                        // 0x18(0x20)
	float                                                        SectionStartTime;                                  // 0x38(0x4)
	char                                                         pad0x4_9ZQKG[0x4];                                 // 0x3c(0x4)
};
...
{
public:
	char                                                         pad0x18_3SEDA[0x18];                               // 0x0(0x18)
...
{
public:
	char                                                         pad0x18_700U3[0x18];                               // 0x0(0x18)
...
{
public:
	char                                                         pad0x18_CSGHC[0x18];                               // 0x0(0x18)
	...
	char                                                         pad0x7_A4194[0x7];                                 // 0x39(0x7)
};
