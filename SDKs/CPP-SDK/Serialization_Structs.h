...
public:
	...
	char                                                         pad0x8_XU0YS[0x8];                                 // 0x18(0x8)
	float                                                        StaticFloatArray;                                  // 0x20(0x4)
	char                                                         pad0xc_7OFIN[0xc];                                 // 0x24(0xc)
...
public:
	...
	char                                                         pad0x2_HEGUR[0x2];                                 // 0x2(0x2)
	char                                                         pad0x4_RBG4A[0x4];                                 // 0x4(0x4)
};
...
{
public:
	char                                                         pad0x4_BTX8L[0x4];                                 // 0x0(0x4)
	int                                                          Int32;                                             // 0x4(0x4)
	byte                                                         UInt8;                                             // 0x10(0x1)
	char                                                         pad0x1_WMEXT[0x1];                                 // 0x11(0x1)
	float                                                        Float;                                             // 0x20(0x4)
	char                                                         pad0x4_1M70G[0x4];                                 // 0x24(0x4)
