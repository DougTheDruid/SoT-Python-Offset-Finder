...
public:
	...
	char                                                         pad0x8_ZVO9N[0x8];                                 // 0x18(0x8)
	float                                                        StaticFloatArray;                                  // 0x20(0x4)
	char                                                         pad0xc_WACOL[0xc];                                 // 0x24(0xc)
...
public:
	...
	char                                                         pad0x2_WZ02W[0x2];                                 // 0x2(0x2)
	char                                                         pad0x4_R1W3E[0x4];                                 // 0x4(0x4)
};
...
{
public:
	char                                                         pad0x4_61VP6[0x4];                                 // 0x0(0x4)
	int                                                          Int32;                                             // 0x4(0x4)
	char                                                         UInt8;                                             // 0x10(0x1)
	char                                                         pad0x1_SVBM3[0x1];                                 // 0x11(0x1)
	float                                                        Float;                                             // 0x20(0x4)
	char                                                         pad0x4_73QMY[0x4];                                 // 0x24(0x4)
