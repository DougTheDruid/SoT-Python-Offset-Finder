...
{
public:
	char                                                         pad0x4_TIFK2[0x4];                                 // 0x0(0x4)
	int                                                          Int32;                                             // 0x4(0x4)
	char                                                         UInt8;                                             // 0x10(0x1)
	char                                                         pad0x1_J58BX[0x1];                                 // 0x11(0x1)
	float                                                        Float;                                             // 0x20(0x4)
	char                                                         pad0x4_78NIY[0x4];                                 // 0x24(0x4)
...
public:
	...
	char                                                         pad0x8_7C3RT[0x8];                                 // 0x18(0x8)
	float                                                        StaticFloatArray;                                  // 0x20(0x4)
	char                                                         pad0xc_GJK8R[0xc];                                 // 0x24(0xc)
...
public:
	...
	char                                                         pad0x2_JN5BP[0x2];                                 // 0x2(0x2)
	char                                                         pad0x4_J6007[0x4];                                 // 0x4(0x4)
};
