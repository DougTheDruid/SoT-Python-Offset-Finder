...
public:
	...
	char                                                         pad0x4_JGBCE[0x4];                                 // 0xcc(0x4)
	...
	char                                                         pad0xb8_148VA[0xb8];                               // 0x108(0xb8)
};
...
{
public:
	char                                                         pad0x20_31PMW[0x20];                               // 0x3c8(0x20)
	float                                                        DespawnDelay;                                      // 0x3e8(0x4)
	char                                                         pad0x4_S0DHJ[0x4];                                 // 0x3ec(0x4)
	...
	char                                                         pad0x118_KOUA9[0x118];                             // 0x440(0x118)
};
...
public:
	...
	char                                                         pad0x7_WWXLY[0x7];                                 // 0xc9(0x7)
	...
	char                                                         pad0xd0_V5QKM[0xd0];                               // 0xf8(0xd0)
};
...
{
public:
	char                                                         pad0x4_ENA24[0x4];                                 // 0xc8(0x4)
	...
	char                                                         pad0x4_P1VCK[0x4];                                 // 0xf4(0x4)
	...
	char                                                         pad0x108_2RVI5[0x108];                             // 0x118(0x108)
};
...
{
public:
	char                                                         pad0x80_EIJ7G[0x80];                               // 0x470(0x80)
};
