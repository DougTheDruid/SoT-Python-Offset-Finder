...
public:
	...
	char                                                         pad0x7_TL54G[0x7];                                 // 0xc9(0x7)
	...
	char                                                         pad0xd0_W6GVV[0xd0];                               // 0xf8(0xd0)
};
...
{
public:
	char                                                         pad0x20_DDO3R[0x20];                               // 0x3c8(0x20)
	float                                                        DespawnDelay;                                      // 0x3e8(0x4)
	char                                                         pad0x4_5UYII[0x4];                                 // 0x3ec(0x4)
	...
	char                                                         pad0x118_MY8ZJ[0x118];                             // 0x440(0x118)
};
...
{
public:
	char                                                         pad0x4_WBWNI[0x4];                                 // 0xc8(0x4)
	...
	char                                                         pad0x4_9POYY[0x4];                                 // 0xf4(0x4)
	...
	char                                                         pad0x108_ZVQ4F[0x108];                             // 0x118(0x108)
};
...
{
public:
	char                                                         pad0x80_X6HJP[0x80];                               // 0x470(0x80)
};
...
public:
	...
	char                                                         pad0x4_PIZ1T[0x4];                                 // 0xcc(0x4)
	...
	char                                                         pad0xb8_TC11O[0xb8];                               // 0x108(0xb8)
};
