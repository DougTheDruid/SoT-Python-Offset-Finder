...
public:
	...
	char                                                         pad0x7_3W4R4[0x7];                                 // 0xc9(0x7)
	...
	char                                                         pad0xc0_GLD73[0xc0];                               // 0xf6(0xc0)
};
...
{
public:
	char                                                         pad0x20_T0A3S[0x20];                               // 0x3c8(0x20)
	float                                                        DespawnDelay;                                      // 0x3e8(0x4)
	char                                                         pad0x4_CJGBP[0x4];                                 // 0x3ec(0x4)
	...
	char                                                         pad0x118_G0ZL2[0x118];                             // 0x43e(0x118)
};
...
{
public:
	char                                                         pad0x4_I0TCO[0x4];                                 // 0xc8(0x4)
	...
	char                                                         pad0x4_2BRFD[0x4];                                 // 0xf4(0x4)
	...
	char                                                         pad0xe8_SS7FW[0xe8];                               // 0x116(0xe8)
};
...
public:
	...
	char                                                         pad0x4_76N6H[0x4];                                 // 0xcc(0x4)
	...
	char                                                         pad0xa8_DKZ2H[0xa8];                               // 0x106(0xa8)
};
