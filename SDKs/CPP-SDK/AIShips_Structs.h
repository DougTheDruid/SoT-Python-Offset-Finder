...
// Size 0x18
struct AIShipDescAssetToSandboxPerformanceConstraintActivity
{
public:
...
public:
	...
	char                                                         pad0x4_1QMUE[0x4];                                 // 0x4c(0x4)
};
...
public:
	...
	char                                                         pad0x3_VM0Q3[0x3];                                 // 0x11(0x3)
	...
	char                                                         pad0x2_LVA9U[0x2];                                 // 0x22(0x2)
...
public:
	...
	char                                                         pad0x4_BK6CN[0x4];                                 // 0x14(0x4)
};
...
public:
	...
	char                                                         pad0x3_8SC1C[0x3];                                 // 0x9(0x3)
	struct FName                                                 Rarity;                                            // 0xc(0x8)
	char                                                         pad0x4_3CDK7[0x4];                                 // 0x14(0x4)
};
...
public:
	...
	struct FString                                               AIShipEventType;                                   // 0x40(0x10)
	struct Guid                                                  SpawnConfigId;                                     // 0x50(0x10)
	struct FString                                               AIShipSize;                                        // 0x60(0x10)
	struct Vector                                                SpawnLocation;                                     // 0x70(0xc)
	int                                                          AIShipWaveIndex;                                   // 0x7c(0x4)
};
...
public:
	...
	struct FString                                               TargetingShipEventType;                            // 0x10(0x10)
	struct FString                                               TargetingState;                                    // 0x20(0x10)
	struct FString                                               TargetedShipId;                                    // 0x30(0x10)
};
...
public:
	...
	char                                                         pad0x7_4RKJ6[0x7];                                 // 0x11(0x7)
};
...
public:
	...
	char                                                         pad0x6_8RXHZ[0x6];                                 // 0x72(0x6)
...
public:
	...
	char                                                         pad0x4_UPA76[0x4];                                 // 0x3c(0x4)
...
public:
	...
	float                                                        Weight;                                            // 0x8(0x4)
	char                                                         pad0x4_NLV8I[0x4];                                 // 0xc(0x4)
	TArray<struct WeightedSpawnOffset>                           SpawnOffsets;                                      // 0x10(0x10)
	char                                                         pad0x90_N60T7[0x90];                               // 0x20(0x90)
};
...
public:
	...
	char                                                         pad0x4_K1XO1[0x4];                                 // 0x24(0x4)
...
public:
	...
	char                                                         pad0x4_H2P8O[0x4];                                 // 0x44(0x4)
};
...
public:
	...
	char                                                         pad0x90_CE0G5[0x90];                               // 0x10(0x90)
};
...
public:
	...
	char                                                         pad0x10_2UE9G[0x10];                               // 0x68(0x10)
};
...
{
public:
	class UClass*                                                AIShipEventSignal_SPCActivityType;                 // 0x0(0x8)
	struct AIShipContextDescGenerationSharedParams               SharedParams;                                      // 0x8(0x60)
	TArray<struct AIShipContextDescGenerationSharedParams>       EncounterSpecificParams;                           // 0x68(0x10)
	TArray<struct AIShipContextDescGenerationShipSpecificParams> ShipSpecificParams;                                // 0x78(0x10)
};
