...
public:
	...
	char                                                         pad0x3_N36R6[0x3];                                 // 0x9(0x3)
	struct FName                                                 Rarity;                                            // 0xc(0x8)
	char                                                         pad0x4_Q39BC[0x4];                                 // 0x14(0x4)
};
...
public:
	...
	char                                                         pad0x3_UDBE0[0x3];                                 // 0x11(0x3)
	...
	char                                                         pad0x2_3NU5Q[0x2];                                 // 0x22(0x2)
...
public:
	...
	char                                                         pad0x4_FQ3AQ[0x4];                                 // 0x14(0x4)
};
...
public:
	...
	char                                                         pad0x4_B43UD[0x4];                                 // 0x4c(0x4)
};
...
public:
	...
	char                                                         pad0x6_BOKY6[0x6];                                 // 0x72(0x6)
...
public:
	...
	char                                                         pad0x7_HI1G4[0x7];                                 // 0x11(0x7)
};
...
public:
	...
	float                                                        Weight;                                            // 0x8(0x4)
	char                                                         pad0x4_7VMTQ[0x4];                                 // 0xc(0x4)
	TArray<struct WeightedSpawnOffset>                           SpawnOffsets;                                      // 0x10(0x10)
	char                                                         pad0x90_KIHG6[0x90];                               // 0x20(0x90)
};
...
public:
	...
	char                                                         pad0x4_39ESS[0x4];                                 // 0x3c(0x4)
...
public:
	...
	char                                                         pad0x4_XH5OQ[0x4];                                 // 0x24(0x4)
...
public:
	...
	char                                                         pad0x90_RVIHZ[0x90];                               // 0x10(0x90)
};
...
public:
	...
	char                                                         pad0x4_QX3T2[0x4];                                 // 0x44(0x4)
};
...
public:
	...
	char                                                         pad0x10_TOK63[0x10];                               // 0x68(0x10)
};
...
public:
	...
	class UClass*                                                SPCActivityType;                                   // 0x10(0x8)
	class AIShipEncounterSpawnerTemplateDataAsset*               SpawnerTemplateDataAsset;                          // 0x18(0x8)
	TArray<struct AIShipGenerationParams>                        ShipGenerationParams;                              // 0x20(0x10)
};
