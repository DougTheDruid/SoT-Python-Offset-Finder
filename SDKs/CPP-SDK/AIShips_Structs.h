...
public:
	...
	struct                                                       SpawnRotations;                                    // 0x10(0x30)
};
...
public:
	...
	struct                                                       SpawnConfigId;                                     // 0x40(0x10)
	struct FString                                               AIShipSize;                                        // 0x50(0x10)
	struct                                                       SpawnLocation;                                     // 0x60(0xc)
...
{
public:
	struct                                                       SailRGB;                                           // 0x0(0x4)
	struct                                                       IconRGB;                                           // 0x4(0x4)
...
public:
	...
	struct                                                       NumberOfWaves;                                     // 0x8(0x20)
	struct                                                       MinMaxNumberOfShips;                               // 0x28(0x10)
...
public:
	...
	struct                                                       DynamicBalancingDesc;                              // 0x28(0x58)
};
