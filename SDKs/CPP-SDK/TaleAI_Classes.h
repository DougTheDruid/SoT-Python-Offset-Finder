...
{
public:
	char                                                         pad0x8_H59A4[0x8];                                 // 0x28(0x8)
	class AIProximityPlayerTracker*                              ProximityPlayerTracker;                            // 0x30(0x8)
	char                                                         pad0x38_TSX55[0x38];                               // 0x38(0x38)
};
...
{
public:
	char                                                         pad0x8_5XRSC[0x8];                                 // 0x80(0x8)
...
{
public:
	char                                                         pad0x8_417EU[0x8];                                 // 0x28(0x8)
	class TaleQuestSpawnAICustomRootStep*                        MyRootStep;                                        // 0x30(0x8)
	char                                                         pad0x40_R9GQW[0x40];                               // 0x38(0x40)
};
...
{
public:
	char                                                         pad0x8_27WWY[0x8];                                 // 0x28(0x8)
...
{
public:
	char                                                         pad0x8_I0FVX[0x8];                                 // 0x80(0x8)
...
{
public:
	char                                                         pad0xb0_XCP6L[0xb0];                               // 0x98(0xb0)
};
...
{
public:
	char                                                         pad0x8_HSZNQ[0x8];                                 // 0x28(0x8)
...
public:
	...
	char                                                         pad0x10_2ET86[0x10];                               // 0x80(0x10)
};
...
{
public:
	char                                                         pad0x10_1S5P1[0x10];                               // 0x78(0x10)
...
public:
	...
	char                                                         pad0x10_WD2AN[0x10];                               // 0x88(0x10)
};
...
{
public:
	char                                                         pad0x18_6EQME[0x18];                               // 0x78(0x18)
	struct SpawnAICustomPreSpawnTaskData                         TaskData;                                          // 0x90(0x78)
	char                                                         pad0x8_HJAQ9[0x8];                                 // 0x108(0x8)
};
...
{
public:
	char                                                         pad0x18_E2WVR[0x18];                               // 0x70(0x18)
};
...
public:
	...
	char                                                         pad0x10_A007Q[0x10];                               // 0x90(0x10)
};
...
{
public:
	char                                                         pad0x10_90G5U[0x10];                               // 0x78(0x10)
	struct SpawnAICustomOnSpawnTaskData                          TaskData;                                          // 0x88(0x18)
	char                                                         pad0x80_TYT7H[0x80];                               // 0xa0(0x80)
};
