...
{
public:
	char                                                         pad0x50_L263E[0x50];                               // 0x0(0x50)
};
...
{
public:
	char                                                         pad0x50_5X876[0x50];                               // 0x0(0x50)
};
...
{
public:
	char                                                         pad0x18_RT5FK[0x18];                               // 0x0(0x18)
};
...
{
public:
	char                                                         pad0x50_6ZSF3[0x50];                               // 0x0(0x50)
};
...
{
public:
	char                                                         pad0x50_DJFMD[0x50];                               // 0x0(0x50)
};
