...
{
public:
	char                                                         pad0x50_UNPX1[0x50];                               // 0x0(0x50)
};
...
{
public:
	char                                                         pad0x50_X6ZVH[0x50];                               // 0x0(0x50)
};
...
{
public:
	char                                                         pad0x18_8JUD2[0x18];                               // 0x0(0x18)
};
...
{
public:
	char                                                         pad0x50_RDQOO[0x50];                               // 0x0(0x50)
};
...
{
public:
	char                                                         pad0x50_I4LS7[0x50];                               // 0x0(0x50)
};
