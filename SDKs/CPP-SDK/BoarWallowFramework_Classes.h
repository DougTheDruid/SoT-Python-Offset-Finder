...
{
public:
	char                                                         pad0x8_XYHSJ[0x8];                                 // 0x3a0(0x8)
	TArray<struct Name>                                          BoarsAndBoarWallowIslandsMap;                      // 0x3a8(0x10)
	char                                                         pad0x98_3PKWO[0x98];                               // 0x3b8(0x98)
};
...
public:
	...
	char                                                         pad0x7_WBCW0[0x7];                                 // 0xc1(0x7)
};
