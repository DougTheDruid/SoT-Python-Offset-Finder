...
public:
	...
	char                                                         pad0x4_7DTVW[0x4];                                 // 0x34(0x4)
...
public:
	...
	char                                                         pad0x20_W4O7E[0x20];                               // 0xc0(0x20)
};
...
public:
	struct FeatureFlag                                           Feature;                                           // 0x28(0xc)
	char                                                         pad0x4_YSWGV[0x4];                                 // 0x34(0x4)
...
{
public:
	char                                                         pad0x8_H7I20[0x8];                                 // 0x3a0(0x8)
	...
	char                                                         pad0x20_3R04Y[0x20];                               // 0x3d8(0x20)
};
...
public:
	...
	char                                                         pad0x18_YZPB8[0x18];                               // 0x60(0x18)
};
...
{
public:
	char                                                         pad0x60_YERTM[0x60];                               // 0x3a0(0x60)
	TArray<uintptr_t>                                            PendingClaims;                                     // 0x400(0x10)
	char                                                         pad0x50_RT9ZS[0x50];                               // 0x410(0x50)
};
...
public:
	...
	char                                                         pad0x28_611FS[0x28];                               // 0x658(0x28)
};
...
public:
	...
	char                                                         pad0x10_X6ZKK[0x10];                               // 0x38(0x10)
};
...
public:
	...
	char                                                         pad0x20_KKLJD[0x20];                               // 0x330(0x20)
};
...
public:
	...
	char                                                         pad0x1f_9E5Q8[0x1f];                               // 0x61(0x1f)
};
...
public:
	struct FeatureFlag                                           Feature;                                           // 0x28(0xc)
	char                                                         pad0x4_BXAPB[0x4];                                 // 0x34(0x4)
...
{
public:
	char                                                         pad0x18_1SE1D[0x18];                               // 0x3a0(0x18)
	...
	char                                                         pad0x108_IFUOF[0x108];                             // 0x3d0(0x108)
};
...
public:
	...
	char                                                         pad0x38_J5IMT[0x38];                               // 0xc0(0x38)
};
