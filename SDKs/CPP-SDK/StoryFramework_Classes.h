...
{
public:
	struct                                                       ClaimedStoryFlag;                                  // 0xc8(0x8)
};
...
{
public:
	struct                                                       StorySpawnActorsDataAssetLocation;                 // 0x38(0x10)
};
...
{
public:
	struct                                                       StoryNamesCollectionDataAssetLocation;             // 0x38(0x10)
};
...
public:
	...
	struct                                                       CurrentStoryResponse;                              // 0x330(0x10)
};
