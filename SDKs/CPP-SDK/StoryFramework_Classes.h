...
public:
	...
	char                                                         pad0x1f_BUENA[0x1f];                               // 0x61(0x1f)
};
...
public:
	...
	char                                                         pad0x10_0WOVR[0x10];                               // 0x38(0x10)
};
...
public:
	...
	char                                                         pad0x20_WB0OB[0x20];                               // 0xd0(0x20)
};
...
{
public:
	char                                                         pad0x60_E14KL[0x60];                               // 0x3c8(0x60)
	TArray<Weakclass PendingClaims>                              PendingClaims;                                     // 0x428(0x10)
	char                                                         pad0x50_ZLU43[0x50];                               // 0x438(0x50)
};
...
public:
	...
	char                                                         pad0x20_LS9B3[0x20];                               // 0x340(0x20)
};
...
public:
	...
	char                                                         pad0x4_ZX048[0x4];                                 // 0x34(0x4)
...
public:
	...
	char                                                         pad0x28_4444O[0x28];                               // 0x588(0x28)
};
...
public:
	...
	char                                                         pad0x38_R38XD[0x38];                               // 0xd0(0x38)
};
...
public:
	Struct FeatureFlag                                           Feature;                                           // 0x28(0xc)
	char                                                         pad0x4_UO4RN[0x4];                                 // 0x34(0x4)
	TArray<struct StoryResponses>                                StoryResponses;                                    // 0x38(0x10)
...
public:
	Struct FeatureFlag                                           Feature;                                           // 0x28(0xc)
	char                                                         pad0x4_0M034[0x4];                                 // 0x34(0x4)
	TArray<struct StoryResponses>                                StoryResponses;                                    // 0x38(0x10)
...
{
public:
	char                                                         pad0x18_MYRA4[0x18];                               // 0x3c8(0x18)
	...
	char                                                         pad0x108_MS2J6[0x108];                             // 0x3f8(0x108)
};
...
{
public:
	char                                                         pad0x8_NVCCI[0x8];                                 // 0x3c8(0x8)
	...
	char                                                         pad0x20_4BEEX[0x20];                               // 0x400(0x20)
};
