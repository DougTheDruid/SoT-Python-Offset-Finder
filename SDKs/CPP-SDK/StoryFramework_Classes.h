...
public:
	...
	char                                                         pad0x1f_1JVTS[0x1f];                               // 0x61(0x1f)
};
...
public:
	...
	char                                                         pad0x10_H27DW[0x10];                               // 0x38(0x10)
};
...
public:
	...
	char                                                         pad0x20_4C6KQ[0x20];                               // 0xd0(0x20)
};
...
{
public:
	char                                                         pad0x60_Z07D0[0x60];                               // 0x3c8(0x60)
	TArray<Weakclass PendingClaims>                              PendingClaims;                                     // 0x428(0x10)
	char                                                         pad0x50_1CEX9[0x50];                               // 0x438(0x50)
};
...
public:
	...
	char                                                         pad0x20_KBE80[0x20];                               // 0x340(0x20)
};
...
public:
	...
	char                                                         pad0x4_LZQV5[0x4];                                 // 0x34(0x4)
...
public:
	...
	char                                                         pad0x28_ELBYT[0x28];                               // 0x588(0x28)
};
...
public:
	...
	char                                                         pad0x38_ODQIL[0x38];                               // 0xd0(0x38)
};
...
public:
	Struct FeatureFlag                                           Feature;                                           // 0x28(0xc)
	char                                                         pad0x4_HD74V[0x4];                                 // 0x34(0x4)
	TArray<struct StoryResponses>                                StoryResponses;                                    // 0x38(0x10)
...
public:
	Struct FeatureFlag                                           Feature;                                           // 0x28(0xc)
	char                                                         pad0x4_06KQ9[0x4];                                 // 0x34(0x4)
	TArray<struct StoryResponses>                                StoryResponses;                                    // 0x38(0x10)
...
{
public:
	char                                                         pad0x18_CMILB[0x18];                               // 0x3c8(0x18)
	...
	char                                                         pad0x108_HW0YC[0x108];                             // 0x3f8(0x108)
};
...
{
public:
	char                                                         pad0x8_BYML3[0x8];                                 // 0x3c8(0x8)
	...
	char                                                         pad0x20_VREG8[0x20];                               // 0x400(0x20)
};
