...
{
public:
	struct                                                       LocomotionData;                                    // 0x0(0x30)
	...
	struct                                                       HitReactionData;                                   // 0x40(0x8)
	struct                                                       SporeBreathData;                                   // 0x48(0x18)
	TArray<struct CustomAnimationMontageId>                      AttackInterruptMontages;                           // 0x60(0x10)
	struct                                                       DeathMontageId;                                    // 0x70(0x8)
	struct                                                       SpawnMontageId;                                    // 0x78(0x8)
	struct                                                       SpawnOnShipMontageId;                              // 0x80(0x8)
	struct                                                       SpawnBoardedMontageId;                             // 0x88(0x8)
};
