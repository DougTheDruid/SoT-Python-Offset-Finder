...
// Size 0x38
struct CompanySpecificComplexItemQualityOverrides
{
public:
	TArray<struct PerComanyComplexItemQualityEntry>              CompanySpecificComplexItemQualityLevelsOverrides;  // 0x0(0x10)
	TArray<struct PerComanyComplexItemQualityEntry>              CompanySpecificComplexItemQualityLevelsHandinOverrides; // 0x10(0x10)
