...
{
public:
	char                                                         pad0x28_LPVW1[0x28];                               // 0xb8(0x28)
	...
	char                                                         pad0x7_1N30Y[0x7];                                 // 0x109(0x7)
};
...
{
public:
	char                                                         pad0x48_E0CD8[0x48];                               // 0x3e8(0x48)
};
...
public:
	...
	char                                                         pad0x4_PGRJF[0x4];                                 // 0xd4(0x4)
...
{
public:
	char                                                         pad0x78_YLTMW[0x78];                               // 0x3a0(0x78)
...
{
public:
	char                                                         pad0x8_Z1TA2[0x8];                                 // 0x3a8(0x8)
};
...
{
public:
	char                                                         pad0x10_OCWCS[0x10];                               // 0x5b0(0x10)
};
...
{
public:
	char                                                         pad0x20_4BEF7[0x20];                               // 0x28(0x20)
};
...
{
public:
	char                                                         pad0x8_2WXKK[0x8];                                 // 0xb8(0x8)
...
{
public:
	char                                                         pad0x14_G7V4L[0x14];                               // 0x5d0(0x14)
	int                                                          ServerCorrectedWaterExclusionZoneCount;            // 0x5e4(0x4)
	char                                                         pad0x8_6665R[0x8];                                 // 0x5e8(0x8)
};
...
{
public:
	char                                                         pad0x10_QOSYS[0x10];                               // 0x28(0x10)
};
