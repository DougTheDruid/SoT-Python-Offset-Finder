...
{
public:
	char                                                         pad0x14_3PVU2[0x14];                               // 0x5f0(0x14)
	int                                                          ServerCorrectedWaterExclusionZoneCount;            // 0x604(0x4)
	char                                                         pad0x8_9EKUB[0x8];                                 // 0x608(0x8)
};
...
{
public:
	char                                                         pad0x8_BBGYX[0x8];                                 // 0x3d0(0x8)
};
...
{
public:
	char                                                         pad0x10_KLOVJ[0x10];                               // 0x28(0x10)
};
...
{
public:
	char                                                         pad0x48_BZETE[0x48];                               // 0x410(0x48)
};
...
public:
	...
	char                                                         pad0x4_IOVA2[0x4];                                 // 0xe4(0x4)
...
{
public:
	char                                                         pad0x10_00V4W[0x10];                               // 0x5d0(0x10)
};
...
{
public:
	char                                                         pad0x28_F9PV4[0x28];                               // 0xc8(0x28)
	...
	char                                                         pad0x7_RAA50[0x7];                                 // 0x119(0x7)
};
...
{
public:
	char                                                         pad0x20_MXH8N[0x20];                               // 0x28(0x20)
};
...
{
public:
	char                                                         pad0x78_P4ZKE[0x78];                               // 0x3c8(0x78)
