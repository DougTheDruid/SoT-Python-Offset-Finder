...
{
public:
	char                                                         pad0x8_73W5D[0x8];                                 // 0xb8(0x8)
	struct FName                                                 ConstellationID;                                   // 0xc0(0x8)
	char                                                         pad0x50_GCZ5U[0x50];                               // 0xc8(0x50)
};
...
{
public:
	char                                                         pad0x8_R0335[0x8];                                 // 0x3a0(0x8)
	...
	char                                                         pad0x1f_2A9W2[0x1f];                               // 0x3cd(0x1f)
...
{
public:
	char                                                         pad0x68_8N1WH[0x68];                               // 0xb8(0x68)
	class Actor*                                                 LightSourceManager;                                // 0x120(0x8)
	char                                                         pad0x8_RB3WO[0x8];                                 // 0x128(0x8)
};
