...
{
public:
	char                                                         pad0x8_92F5C[0x8];                                 // 0x3a0(0x8)
	...
	char                                                         pad0x1f_X16Y1[0x1f];                               // 0x3cd(0x1f)
...
{
public:
	char                                                         pad0x8_E2A7T[0x8];                                 // 0xb8(0x8)
	struct FName                                                 ConstellationID;                                   // 0xc0(0x8)
	char                                                         pad0x50_48A3B[0x50];                               // 0xc8(0x50)
};
...
{
public:
	char                                                         pad0x68_KVMBE[0x68];                               // 0xb8(0x68)
	class Actor*                                                 LightSourceManager;                                // 0x120(0x8)
	char                                                         pad0x8_JTAEM[0x8];                                 // 0x128(0x8)
};
