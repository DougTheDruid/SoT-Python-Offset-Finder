...
{
public:
	char                                                         pad0x8_NKVRS[0x8];                                 // 0x3a0(0x8)
	...
	char                                                         pad0x3_QIHB2[0x3];                                 // 0x3cd(0x3)
	TArray<struct LightBeamParams>                               LightEmitterParams;                                // 0x3d0(0x10)
	char                                                         pad0xc_XOPWT[0xc];                                 // 0x3e0(0xc)
...
{
public:
	char                                                         pad0x68_U8K7C[0x68];                               // 0xb8(0x68)
	class Actor*                                                 LightSourceManager;                                // 0x120(0x8)
	char                                                         pad0x8_SIBSX[0x8];                                 // 0x128(0x8)
};
...
{
public:
	char                                                         pad0x8_DFTHS[0x8];                                 // 0xb8(0x8)
	struct FName                                                 ConstellationID;                                   // 0xc0(0x8)
	char                                                         pad0x50_J87X2[0x50];                               // 0xc8(0x50)
};
