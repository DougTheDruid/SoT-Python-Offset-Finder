...
{
public:
	char                                                         pad0x8_3KSID[0x8];                                 // 0xb8(0x8)
	struct FName                                                 ConstellationID;                                   // 0xc0(0x8)
	char                                                         pad0x50_VPP93[0x50];                               // 0xc8(0x50)
};
...
{
public:
	char                                                         pad0x8_UKD5Y[0x8];                                 // 0x3a0(0x8)
	...
	char                                                         pad0x1f_281ZC[0x1f];                               // 0x3cd(0x1f)
...
{
public:
	char                                                         pad0x68_QCNS1[0x68];                               // 0xb8(0x68)
	class Actor*                                                 LightSourceManager;                                // 0x120(0x8)
	char                                                         pad0x8_YQ8DK[0x8];                                 // 0x128(0x8)
};
