...
{
public:
	char                                                         pad0x8_7T6VI[0x8];                                 // 0x3a0(0x8)
	...
	char                                                         pad0x1f_QA2XA[0x1f];                               // 0x3cd(0x1f)
...
{
public:
	char                                                         pad0x68_V92Z9[0x68];                               // 0xb8(0x68)
	class Actor*                                                 LightSourceManager;                                // 0x120(0x8)
	char                                                         pad0x8_KG89C[0x8];                                 // 0x128(0x8)
};
...
{
public:
	char                                                         pad0x8_NTSBN[0x8];                                 // 0xb8(0x8)
	struct FName                                                 ConstellationID;                                   // 0xc0(0x8)
	char                                                         pad0x50_44ARX[0x50];                               // 0xc8(0x50)
};
