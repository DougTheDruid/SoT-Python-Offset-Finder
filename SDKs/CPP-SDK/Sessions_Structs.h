...
{
public:
	char                                                         pad0x10_DEQ6K[0x10];                               // 0x0(0x10)
};
...
{
public:
	char                                                         pad0xb8_E2ER0[0xb8];                               // 0x0(0xb8)
};
...
{
public:
	char                                                         pad0x10_30W4L[0x10];                               // 0x0(0x10)
...
{
public:
	char                                                         pad0x10_390W4[0x10];                               // 0x0(0x10)
	...
	char                                                         pad0x4_LDVHJ[0x4];                                 // 0x6c(0x4)
};
...
public:
	...
	char                                                         pad0x3_LU0VJ[0x3];                                 // 0x15(0x3)
};
...
{
public:
	char                                                         pad0x90_J3RPB[0x90];                               // 0x0(0x90)
};
...
public:
	...
	char                                                         pad0x3_DRQVT[0x3];                                 // 0x11(0x3)
...
{
public:
	char                                                         pad0x120_9N3ZC[0x120];                             // 0x0(0x120)
	struct Guid                                                  NewCrewId;                                         // 0x120(0x10)
	int                                                          ResultCode;                                        // 0x130(0x4)
	char                                                         pad0x4_U3HPM[0x4];                                 // 0x134(0x4)
...
{
public:
	char                                                         pad0x20_EW5WF[0x20];                               // 0x0(0x20)
};
...
{
public:
	char                                                         pad0x88_4BEOD[0x88];                               // 0x0(0x88)
};
...
public:
	...
	char                                                         pad0x7_JBU3F[0x7];                                 // 0x21(0x7)
};
...
{
public:
	char                                                         pad0x28_8VGHG[0x28];                               // 0x0(0x28)
};
...
{
public:
	char                                                         pad0xa8_J9FXL[0xa8];                               // 0x0(0xa8)
};
...
{
public:
	char                                                         pad0x10_UQZ6Q[0x10];                               // 0x0(0x10)
};
...
public:
	...
	char                                                         pad0x2_GA4U2[0x2];                                 // 0x1e(0x2)
};
...
public:
	struct Guid                                                  CrewId;                                            // 0x0(0x10)
	char                                                         pad0x40_RTL3C[0x40];                               // 0x10(0x40)
};
...
{
public:
	char                                                         pad0x28_XBMXP[0x28];                               // 0x0(0x28)
};
...
{
public:
	char                                                         pad0x120_L5X9A[0x120];                             // 0x0(0x120)
...
{
public:
	char                                                         pad0x120_NE59N[0x120];                             // 0x0(0x120)
...
{
public:
	char                                                         pad0x10_KEONK[0x10];                               // 0x0(0x10)
