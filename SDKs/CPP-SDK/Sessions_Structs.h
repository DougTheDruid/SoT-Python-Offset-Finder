...
public:
	...
	char                                                         pad0x3_RKF9I[0x3];                                 // 0x11(0x3)
...
{
public:
	char                                                         pad0x28_0B9DZ[0x28];                               // 0x0(0x28)
};
...
{
public:
	char                                                         pad0x20_HZR63[0x20];                               // 0x0(0x20)
};
...
public:
	...
	char                                                         pad0x3_0KILT[0x3];                                 // 0x15(0x3)
};
...
{
public:
	char                                                         pad0x50_WIO4V[0x50];                               // 0x0(0x50)
	struct Guid                                                  NewCrewId;                                         // 0x50(0x10)
	int                                                          ResultCode;                                        // 0x60(0x4)
	char                                                         pad0x4_CH5Q1[0x4];                                 // 0x64(0x4)
...
{
public:
	char                                                         pad0x10_YMQ09[0x10];                               // 0x0(0x10)
...
public:
	...
	char                                                         pad0x7_YJY8N[0x7];                                 // 0x21(0x7)
};
...
{
public:
	char                                                         pad0x10_O85ZU[0x10];                               // 0x0(0x10)
...
{
public:
	char                                                         pad0x10_LPYQK[0x10];                               // 0x0(0x10)
	...
	char                                                         pad0x4_8TMUI[0x4];                                 // 0x6c(0x4)
};
...
{
public:
	char                                                         pad0x10_APVRJ[0x10];                               // 0x0(0x10)
};
...
{
public:
	char                                                         pad0x50_JI768[0x50];                               // 0x0(0x50)
...
public:
	...
	char                                                         pad0x2_MIVZE[0x2];                                 // 0x1e(0x2)
};
...
{
public:
	char                                                         pad0x50_6ZKC8[0x50];                               // 0x0(0x50)
