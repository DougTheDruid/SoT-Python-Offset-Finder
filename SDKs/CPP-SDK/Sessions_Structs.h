...
{
public:
	char                                                         pad0x20_AA009[0x20];                               // 0x0(0x20)
};
...
public:
	...
	char                                                         pad0x7_TY9BS[0x7];                                 // 0x21(0x7)
};
...
{
public:
	char                                                         pad0x120_ESC2Z[0x120];                             // 0x0(0x120)
	struct Guid                                                  NewCrewId;                                         // 0x120(0x10)
	int                                                          ResultCode;                                        // 0x130(0x4)
	char                                                         pad0x4_SPZTF[0x4];                                 // 0x134(0x4)
...
public:
	...
	char                                                         pad0x2_08QW2[0x2];                                 // 0x1e(0x2)
};
...
{
public:
	char                                                         pad0x88_V23HI[0x88];                               // 0x0(0x88)
};
...
{
public:
	char                                                         pad0x90_XKEDD[0x90];                               // 0x0(0x90)
};
...
{
public:
	char                                                         pad0x10_EXK1J[0x10];                               // 0x0(0x10)
...
public:
	...
	char                                                         pad0x3_12D1N[0x3];                                 // 0x15(0x3)
};
...
public:
	struct Guid                                                  CrewId;                                            // 0x0(0x10)
	char                                                         pad0x40_1K2IT[0x40];                               // 0x10(0x40)
};
...
{
public:
	char                                                         pad0x28_61ZW5[0x28];                               // 0x0(0x28)
};
...
public:
	...
	char                                                         pad0x3_U9P45[0x3];                                 // 0x11(0x3)
...
{
public:
	char                                                         pad0x10_9EY8Y[0x10];                               // 0x0(0x10)
};
...
{
public:
	char                                                         pad0x10_LODF6[0x10];                               // 0x0(0x10)
};
...
{
public:
	char                                                         pad0xb8_6HF8E[0xb8];                               // 0x0(0xb8)
};
...
{
public:
	char                                                         pad0x10_V8M1G[0x10];                               // 0x0(0x10)
	...
	char                                                         pad0x4_ENJL5[0x4];                                 // 0x6c(0x4)
};
...
{
public:
	char                                                         pad0xa8_NHX9I[0xa8];                               // 0x0(0xa8)
};
...
{
public:
	char                                                         pad0x28_MT1K5[0x28];                               // 0x0(0x28)
};
...
{
public:
	char                                                         pad0x120_0FKY2[0x120];                             // 0x0(0x120)
...
{
public:
	char                                                         pad0x120_9YDHI[0x120];                             // 0x0(0x120)
...
{
public:
	char                                                         pad0x10_06FIV[0x10];                               // 0x0(0x10)
