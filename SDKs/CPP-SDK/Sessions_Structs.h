...
{
public:
	char                                                         pad0x10_CY4NF[0x10];                               // 0x0(0x10)
};
...
{
public:
	char                                                         pad0x88_1WCC7[0x88];                               // 0x0(0x88)
};
...
{
public:
	char                                                         pad0x90_HCMI5[0x90];                               // 0x0(0x90)
};
...
public:
	struct Guid                                                  CrewId;                                            // 0x0(0x10)
	char                                                         pad0x40_AGO12[0x40];                               // 0x10(0x40)
};
...
{
public:
	char                                                         pad0x10_1442E[0x10];                               // 0x0(0x10)
	...
	char                                                         pad0x4_771Y7[0x4];                                 // 0x6c(0x4)
};
...
{
public:
	char                                                         pad0xb8_J0HWA[0xb8];                               // 0x0(0xb8)
};
...
public:
	...
	char                                                         pad0x3_E6EWL[0x3];                                 // 0x15(0x3)
};
...
{
public:
	char                                                         pad0xa8_83PYL[0xa8];                               // 0x0(0xa8)
};
...
{
public:
	char                                                         pad0x28_NT12Y[0x28];                               // 0x0(0x28)
};
...
public:
	...
	char                                                         pad0x3_YV04R[0x3];                                 // 0x11(0x3)
...
{
public:
	char                                                         pad0x20_G8PXD[0x20];                               // 0x0(0x20)
};
...
{
public:
	char                                                         pad0x10_9X08D[0x10];                               // 0x0(0x10)
};
...
public:
	...
	char                                                         pad0x7_Y85SD[0x7];                                 // 0x21(0x7)
};
...
{
public:
	char                                                         pad0x10_AJ0XK[0x10];                               // 0x0(0x10)
...
public:
	...
	char                                                         pad0x2_4WXKE[0x2];                                 // 0x1e(0x2)
};
...
{
public:
	char                                                         pad0x120_LDEZY[0x120];                             // 0x0(0x120)
	struct Guid                                                  NewCrewId;                                         // 0x120(0x10)
	int                                                          ResultCode;                                        // 0x130(0x4)
	char                                                         pad0x4_T0MLO[0x4];                                 // 0x134(0x4)
...
{
public:
	char                                                         pad0x28_RNQZO[0x28];                               // 0x0(0x28)
};
...
{
public:
	char                                                         pad0x120_VW0ZP[0x120];                             // 0x0(0x120)
...
{
public:
	char                                                         pad0x120_QI1QM[0x120];                             // 0x0(0x120)
...
{
public:
	char                                                         pad0x10_RIWA7[0x10];                               // 0x0(0x10)
