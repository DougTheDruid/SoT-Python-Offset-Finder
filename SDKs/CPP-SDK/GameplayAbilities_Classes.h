...
{
public:
	char                                                         pad0x18_SQ1H8[0x18];                               // 0x440(0x18)
...
public:
	...
	char                                                         pad0x7_1MIRQ[0x7];                                 // 0x39(0x7)
};
...
{
public:
	char                                                         pad0x10_R0NY5[0x10];                               // 0x58(0x10)
};
...
{
public:
	char                                                         pad0x40_Z9EP9[0x40];                               // 0x28(0x40)
	struct GameplayTagContainer                                  AbilityTags;                                       // 0x68(0x28)
	char                                                         pad0x18_LARV5[0x18];                               // 0x90(0x18)
	bool                                                         bReplicateInputDirectly;                           // 0xa8(0x1)
	char                                                         pad0x27_88F5P[0x27];                               // 0xa9(0x27)
	...
	char                                                         pad0x4_VXUMW[0x4];                                 // 0xd4(0x4)
	...
	char                                                         pad0x7_6C8H5[0x7];                                 // 0x199(0x7)
	...
	char                                                         pad0x70_A0ULW[0x70];                               // 0x3c8(0x70)
	...
	char                                                         pad0x5_ZWNF1[0x5];                                 // 0x443(0x5)
};
...
public:
	...
	char                                                         pad0x50_JN2QG[0x50];                               // 0x38(0x50)
};
...
public:
	...
	char                                                         pad0x50_63CP1[0x50];                               // 0x38(0x50)
};
...
public:
	...
	char                                                         pad0x7_XH2F9[0x7];                                 // 0xf1(0x7)
	...
	char                                                         pad0x18_KD9X9[0x18];                               // 0x118(0x18)
};
...
public:
	...
	char                                                         pad0x3_DHGZ9[0x3];                                 // 0x3b1(0x3)
	...
	char                                                         pad0x5_GRNOH[0x5];                                 // 0x3bb(0x5)
};
...
{
public:
	char                                                         pad0x8_UF3O9[0x8];                                 // 0x28(0x8)
};
...
{
public:
	char                                                         pad0x8_U1IWA[0x8];                                 // 0x118(0x8)
	...
	char                                                         pad0x78_WKDLG[0x78];                               // 0x158(0x78)
	...
	char                                                         pad0x50_E1R7M[0x50];                               // 0x298(0x50)
	TArray<class GameplayAbility*>                               AllReplicatedInstancedAbilities;                   // 0x2e8(0x10)
	char                                                         pad0x1b0_38GY6[0x1b0];                             // 0x2f8(0x1b0)
	...
	char                                                         pad0xa0_8QEAX[0xa0];                               // 0x518(0xa0)
	class Actor*                                                 OwnerActor;                                        // 0x5b8(0x8)
	class Actor*                                                 AvatarActor;                                       // 0x5c0(0x8)
	char                                                         pad0x18_MJH80[0x18];                               // 0x5c8(0x18)
	...
	char                                                         pad0x130_1LVLX[0x130];                             // 0xa08(0x130)
	TArray<char>                                                 BlockedAbilityBindings;                            // 0xb38(0x10)
	char                                                         pad0x140_ZVCYD[0x140];                             // 0xb48(0x140)
};
...
{
public:
	char                                                         pad0x8_ZF786[0x8];                                 // 0x28(0x8)
	char                                                         DurationPolicy;                                    // 0x30(0x1)
	char                                                         pad0x7_9O3T0[0x7];                                 // 0x31(0x7)
	...
	char                                                         pad0x7_DXUT2[0x7];                                 // 0x1c9(0x7)
	...
	char                                                         pad0x6_XAD6C[0x6];                                 // 0x242(0x6)
	...
	char                                                         pad0x7_TE5OY[0x7];                                 // 0x269(0x7)
...
public:
	...
	char                                                         pad0x7_VNYBG[0x7];                                 // 0x39(0x7)
};
...
{
public:
	char                                                         pad0x30_7E2GE[0x30];                               // 0x68(0x30)
};
...
{
public:
	char                                                         pad0x20_HSH8E[0x20];                               // 0x68(0x20)
};
...
{
public:
	char                                                         pad0x28_W62B0[0x28];                               // 0x68(0x28)
};
...
{
public:
	char                                                         pad0x40_QO0IN[0x40];                               // 0x68(0x40)
};
...
public:
	...
	char                                                         pad0xb_N7N8L[0xb];                                 // 0x4c5(0xb)
};
...
{
public:
	char                                                         pad0x20_JA8IS[0x20];                               // 0x68(0x20)
};
...
{
public:
	char                                                         pad0x20_0VCLG[0x20];                               // 0x68(0x20)
};
...
public:
	...
	char                                                         pad0x4_MC8SZ[0x4];                                 // 0x4bc(0x4)
};
...
{
public:
	char                                                         pad0x30_ULY44[0x30];                               // 0x68(0x30)
};
...
public:
	...
	char                                                         pad0x4_F7QQB[0x4];                                 // 0x45c(0x4)
...
{
public:
	char                                                         pad0x18_5Q6QL[0x18];                               // 0x68(0x18)
};
...
{
public:
	char                                                         pad0x20_73ZO2[0x20];                               // 0x68(0x20)
};
...
{
public:
	char                                                         pad0x18_9H003[0x18];                               // 0x68(0x18)
};
...
{
public:
	char                                                         pad0x10_6GS76[0x10];                               // 0x68(0x10)
};
...
{
public:
	char                                                         pad0x30_IN2E4[0x30];                               // 0x68(0x30)
};
...
{
public:
	char                                                         pad0x38_EFG5R[0x38];                               // 0x68(0x38)
};
...
{
public:
	char                                                         pad0x28_16GYH[0x28];                               // 0x68(0x28)
};
...
{
public:
	char                                                         pad0x30_SJMSM[0x30];                               // 0x68(0x30)
};
...
{
public:
	char                                                         pad0x40_D6G6C[0x40];                               // 0x68(0x40)
};
...
{
public:
	char                                                         pad0x20_LDL56[0x20];                               // 0x68(0x20)
};
...
{
public:
	char                                                         pad0xc8_562J3[0xc8];                               // 0x68(0xc8)
};
...
{
public:
	char                                                         pad0x10_QNHZQ[0x10];                               // 0x68(0x10)
	class MovementComponent*                                     CachedMovementComponent;                           // 0x78(0x8)
	char                                                         pad0x10_5VOLL[0x10];                               // 0x80(0x10)
};
...
{
public:
	char                                                         pad0x18_PU5EB[0x18];                               // 0x68(0x18)
};
...
{
public:
	char                                                         pad0x58_MST3R[0x58];                               // 0x68(0x58)
};
...
{
public:
	char                                                         pad0x30_XY47I[0x30];                               // 0x68(0x30)
};
...
public:
	...
	char                                                         pad0x18_1MUNY[0x18];                               // 0x4d8(0x18)
};
...
{
public:
	char                                                         pad0x18_EFSKC[0x18];                               // 0x130(0x18)
};
...
{
public:
	char                                                         pad0x18_XVZSG[0x18];                               // 0x130(0x18)
};
...
{
public:
	char                                                         pad0x10_6923K[0x10];                               // 0x88(0x10)
};
...
{
public:
	char                                                         pad0x10_5L46A[0x10];                               // 0x88(0x10)
};
...
public:
	...
	char                                                         pad0x10_ZD68M[0x10];                               // 0x500(0x10)
};
