...
{
public:
	char                                                         pad0x8_UACGT[0x8];                                 // 0x28(0x8)
	byte                                                         DurationPolicy;                                    // 0x30(0x1)
	char                                                         pad0x7_N6DRZ[0x7];                                 // 0x31(0x7)
	...
	char                                                         pad0x7_AL61J[0x7];                                 // 0x1c9(0x7)
	...
	char                                                         pad0x6_UQ551[0x6];                                 // 0x242(0x6)
	...
	char                                                         pad0x7_IX5XU[0x7];                                 // 0x269(0x7)
...
{
public:
	char                                                         pad0x40_PA2BU[0x40];                               // 0x28(0x40)
	Struct GameplayTagContainer                                  AbilityTags;                                       // 0x68(0x28)
	char                                                         pad0x18_NG77E[0x18];                               // 0x90(0x18)
	bool                                                         bReplicateInputDirectly;                           // 0xa8(0x1)
	char                                                         pad0x27_03WCZ[0x27];                               // 0xa9(0x27)
	...
	char                                                         pad0x4_4VPKN[0x4];                                 // 0xd4(0x4)
	...
	char                                                         pad0x7_1O677[0x7];                                 // 0x199(0x7)
	...
	char                                                         pad0x70_9E043[0x70];                               // 0x3c8(0x70)
	...
	char                                                         pad0x5_SM837[0x5];                                 // 0x443(0x5)
};
...
{
public:
	char                                                         pad0x8_8ZH8D[0x8];                                 // 0x128(0x8)
	...
	char                                                         pad0x78_FB4PV[0x78];                               // 0x168(0x78)
	...
	char                                                         pad0x50_753FZ[0x50];                               // 0x2a8(0x50)
	TArray<class GameplayAbility*>                               AllReplicatedInstancedAbilities;                   // 0x2f8(0x10)
	char                                                         pad0x1b0_A15IF[0x1b0];                             // 0x308(0x1b0)
	...
	char                                                         pad0xa0_LRHL0[0xa0];                               // 0x528(0xa0)
	Class Actor*                                                 OwnerActor;                                        // 0x5c8(0x8)
	Class Actor*                                                 AvatarActor;                                       // 0x5d0(0x8)
	char                                                         pad0x18_0GRTT[0x18];                               // 0x5d8(0x18)
	...
	char                                                         pad0x130_PFHPZ[0x130];                             // 0xa18(0x130)
	TArray<Byte BlockedAbilityBindings>                          BlockedAbilityBindings;                            // 0xb48(0x10)
	char                                                         pad0x140_D0W32[0x140];                             // 0xb58(0x140)
};
...
public:
	...
	char                                                         pad0x7_ZDKWG[0x7];                                 // 0xf1(0x7)
	...
	char                                                         pad0x18_H0O4I[0x18];                               // 0x118(0x18)
};
...
{
public:
	char                                                         pad0x18_RYYBD[0x18];                               // 0x468(0x18)
...
{
public:
	char                                                         pad0x10_E369I[0x10];                               // 0x68(0x10)
	Class MovementComponent*                                     CachedMovementComponent;                           // 0x78(0x8)
	char                                                         pad0x10_KKLY9[0x10];                               // 0x80(0x10)
};
...
public:
	...
	char                                                         pad0x4_O6P7J[0x4];                                 // 0x45c(0x4)
...
public:
	...
	char                                                         pad0x4_VNW9T[0x4];                                 // 0x4dc(0x4)
};
...
public:
	...
	char                                                         pad0xb_AQ7ZZ[0xb];                                 // 0x4e5(0xb)
};
...
public:
	...
	char                                                         pad0x18_CWDGP[0x18];                               // 0x4f8(0x18)
};
...
public:
	...
	char                                                         pad0x10_3P56P[0x10];                               // 0x520(0x10)
};
...
public:
	...
	char                                                         pad0x3_1MZSV[0x3];                                 // 0x3d9(0x3)
	...
	char                                                         pad0x5_8B6RM[0x5];                                 // 0x3e3(0x5)
};
...
public:
	...
	char                                                         pad0x7_UF6S1[0x7];                                 // 0x39(0x7)
};
...
public:
	...
	char                                                         pad0x50_X2900[0x50];                               // 0x38(0x50)
};
...
public:
	...
	char                                                         pad0x7_HRV54[0x7];                                 // 0x39(0x7)
};
...
public:
	...
	char                                                         pad0x50_1PA6E[0x50];                               // 0x38(0x50)
};
