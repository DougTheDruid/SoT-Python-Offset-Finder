...
{
public:
	char                                                         pad0x8_GEDBU[0x8];                                 // 0x28(0x8)
	byte                                                         DurationPolicy;                                    // 0x30(0x1)
	char                                                         pad0x7_E5J26[0x7];                                 // 0x31(0x7)
	...
	char                                                         pad0x7_GXLI6[0x7];                                 // 0x1c9(0x7)
	...
	char                                                         pad0x6_4CUUU[0x6];                                 // 0x242(0x6)
	...
	char                                                         pad0x7_4EP0Y[0x7];                                 // 0x269(0x7)
...
{
public:
	char                                                         pad0x40_NJXNE[0x40];                               // 0x28(0x40)
	Struct GameplayTagContainer                                  AbilityTags;                                       // 0x68(0x28)
	char                                                         pad0x18_5PUQJ[0x18];                               // 0x90(0x18)
	bool                                                         bReplicateInputDirectly;                           // 0xa8(0x1)
	char                                                         pad0x27_TNN2Y[0x27];                               // 0xa9(0x27)
	...
	char                                                         pad0x4_343JT[0x4];                                 // 0xd4(0x4)
	...
	char                                                         pad0x7_QE6LV[0x7];                                 // 0x199(0x7)
	...
	char                                                         pad0x70_GR23W[0x70];                               // 0x3c8(0x70)
	...
	char                                                         pad0x5_DHD41[0x5];                                 // 0x443(0x5)
};
...
{
public:
	char                                                         pad0x8_HMJQU[0x8];                                 // 0x128(0x8)
	...
	char                                                         pad0x78_YU28D[0x78];                               // 0x168(0x78)
	...
	char                                                         pad0x50_H39WK[0x50];                               // 0x2a8(0x50)
	TArray<class GameplayAbility*>                               AllReplicatedInstancedAbilities;                   // 0x2f8(0x10)
	char                                                         pad0x1b0_VRGCZ[0x1b0];                             // 0x308(0x1b0)
	...
	char                                                         pad0xa0_77SN6[0xa0];                               // 0x528(0xa0)
	Class Actor*                                                 OwnerActor;                                        // 0x5c8(0x8)
	Class Actor*                                                 AvatarActor;                                       // 0x5d0(0x8)
	char                                                         pad0x18_8DJYH[0x18];                               // 0x5d8(0x18)
	...
	char                                                         pad0x130_HQ4T0[0x130];                             // 0xa18(0x130)
	TArray<Byte BlockedAbilityBindings>                          BlockedAbilityBindings;                            // 0xb48(0x10)
	char                                                         pad0x140_Z64H7[0x140];                             // 0xb58(0x140)
};
...
public:
	...
	char                                                         pad0x7_0ZFIX[0x7];                                 // 0xf1(0x7)
	...
	char                                                         pad0x18_ZTP82[0x18];                               // 0x118(0x18)
};
...
{
public:
	char                                                         pad0x18_5S8L9[0x18];                               // 0x468(0x18)
...
{
public:
	char                                                         pad0x10_01EU0[0x10];                               // 0x68(0x10)
	Class MovementComponent*                                     CachedMovementComponent;                           // 0x78(0x8)
	char                                                         pad0x10_AVPSA[0x10];                               // 0x80(0x10)
};
...
public:
	...
	char                                                         pad0x4_QDN4W[0x4];                                 // 0x45c(0x4)
...
public:
	...
	char                                                         pad0x4_WD7TT[0x4];                                 // 0x4dc(0x4)
};
...
public:
	...
	char                                                         pad0xb_1KLM1[0xb];                                 // 0x4e5(0xb)
};
...
public:
	...
	char                                                         pad0x18_XCLPV[0x18];                               // 0x4f8(0x18)
};
...
public:
	...
	char                                                         pad0x10_DUFNW[0x10];                               // 0x520(0x10)
};
...
public:
	...
	char                                                         pad0x3_6ZJOC[0x3];                                 // 0x3d9(0x3)
	...
	char                                                         pad0x5_FBDLQ[0x5];                                 // 0x3e3(0x5)
};
...
public:
	...
	char                                                         pad0x7_S6RND[0x7];                                 // 0x39(0x7)
};
...
public:
	...
	char                                                         pad0x50_AJUI3[0x50];                               // 0x38(0x50)
};
...
public:
	...
	char                                                         pad0x7_MPOOB[0x7];                                 // 0x39(0x7)
};
...
public:
	...
	char                                                         pad0x50_K539E[0x50];                               // 0x38(0x50)
};
