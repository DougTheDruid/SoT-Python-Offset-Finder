...
{
public:
	char                                                         pad0x40_X59PR[0x40];                               // 0x28(0x40)
	struct GameplayTagContainer                                  AbilityTags;                                       // 0x68(0x28)
	char                                                         pad0x18_KEQ8C[0x18];                               // 0x90(0x18)
	bool                                                         bReplicateInputDirectly;                           // 0xa8(0x1)
	char                                                         pad0x27_3W4EX[0x27];                               // 0xa9(0x27)
	...
	char                                                         pad0x4_G4PLK[0x4];                                 // 0xd4(0x4)
	...
	char                                                         pad0x7_HV104[0x7];                                 // 0x199(0x7)
	...
	char                                                         pad0x70_1WN9D[0x70];                               // 0x3c8(0x70)
	...
	char                                                         pad0x5_RFU0F[0x5];                                 // 0x443(0x5)
};
...
{
public:
	char                                                         pad0x10_JH1E4[0x10];                               // 0x58(0x10)
};
...
public:
	...
	char                                                         pad0x7_24S7T[0x7];                                 // 0xf1(0x7)
	...
	char                                                         pad0x18_4OOBP[0x18];                               // 0x118(0x18)
};
...
{
public:
	char                                                         pad0x8_GCTRR[0x8];                                 // 0x28(0x8)
	char                                                         DurationPolicy;                                    // 0x30(0x1)
	char                                                         pad0x7_6IADJ[0x7];                                 // 0x31(0x7)
	...
	char                                                         pad0x7_VKRK6[0x7];                                 // 0x1c9(0x7)
	...
	char                                                         pad0x6_IVSK0[0x6];                                 // 0x242(0x6)
	...
	char                                                         pad0x7_E5JVH[0x7];                                 // 0x269(0x7)
...
{
public:
	char                                                         pad0x8_DQ8XR[0x8];                                 // 0x28(0x8)
};
...
public:
	...
	char                                                         pad0x50_BV0KJ[0x50];                               // 0x38(0x50)
};
...
public:
	...
	char                                                         pad0x50_OZ166[0x50];                               // 0x38(0x50)
};
...
public:
	...
	char                                                         pad0x3_78FL0[0x3];                                 // 0x3b1(0x3)
	...
	char                                                         pad0x5_ZMUHT[0x5];                                 // 0x3bb(0x5)
};
...
public:
	...
	char                                                         pad0x7_YVU5I[0x7];                                 // 0x39(0x7)
};
...
{
public:
	char                                                         pad0x8_HGQ69[0x8];                                 // 0x118(0x8)
	...
	char                                                         pad0x78_G3Z0O[0x78];                               // 0x158(0x78)
	...
	char                                                         pad0x50_1D5HA[0x50];                               // 0x298(0x50)
	TArray<class GameplayAbility*>                               AllReplicatedInstancedAbilities;                   // 0x2e8(0x10)
	char                                                         pad0x1b0_77PBQ[0x1b0];                             // 0x2f8(0x1b0)
	...
	char                                                         pad0xa0_F0PQG[0xa0];                               // 0x518(0xa0)
	class Actor*                                                 OwnerActor;                                        // 0x5b8(0x8)
	class Actor*                                                 AvatarActor;                                       // 0x5c0(0x8)
	char                                                         pad0x18_FBW4J[0x18];                               // 0x5c8(0x18)
	...
	char                                                         pad0x130_EUJWW[0x130];                             // 0xa08(0x130)
	TArray<char>                                                 BlockedAbilityBindings;                            // 0xb38(0x10)
	char                                                         pad0x140_S3MMN[0x140];                             // 0xb48(0x140)
};
...
{
public:
	char                                                         pad0x18_ZWH3Z[0x18];                               // 0x440(0x18)
...
{
public:
	char                                                         pad0x10_FCF3C[0x10];                               // 0x68(0x10)
};
...
{
public:
	char                                                         pad0x30_2IIOG[0x30];                               // 0x68(0x30)
};
...
{
public:
	char                                                         pad0x20_I15GE[0x20];                               // 0x68(0x20)
};
...
{
public:
	char                                                         pad0x30_L2G0A[0x30];                               // 0x68(0x30)
};
...
{
public:
	char                                                         pad0x18_4C3K1[0x18];                               // 0x68(0x18)
};
...
{
public:
	char                                                         pad0x20_KNSVX[0x20];                               // 0x68(0x20)
};
...
public:
	...
	char                                                         pad0xb_X2Y47[0xb];                                 // 0x4c5(0xb)
};
...
{
public:
	char                                                         pad0x40_YM3HS[0x40];                               // 0x68(0x40)
};
...
{
public:
	char                                                         pad0x30_GD6B9[0x30];                               // 0x68(0x30)
};
...
{
public:
	char                                                         pad0x58_1J8HI[0x58];                               // 0x68(0x58)
};
...
public:
	...
	char                                                         pad0x7_BLFK0[0x7];                                 // 0x39(0x7)
};
...
{
public:
	char                                                         pad0x18_TGL89[0x18];                               // 0x68(0x18)
};
...
{
public:
	char                                                         pad0x10_LXG9S[0x10];                               // 0x68(0x10)
	class MovementComponent*                                     CachedMovementComponent;                           // 0x78(0x8)
	char                                                         pad0x10_8ZX5S[0x10];                               // 0x80(0x10)
};
...
{
public:
	char                                                         pad0x20_11BAN[0x20];                               // 0x68(0x20)
};
...
{
public:
	char                                                         pad0x20_BLNHJ[0x20];                               // 0x68(0x20)
};
...
public:
	...
	char                                                         pad0x4_WBMLF[0x4];                                 // 0x45c(0x4)
...
{
public:
	char                                                         pad0xc8_69FB9[0xc8];                               // 0x68(0xc8)
};
...
{
public:
	char                                                         pad0x30_A58YO[0x30];                               // 0x68(0x30)
};
...
{
public:
	char                                                         pad0x18_ETJYH[0x18];                               // 0x68(0x18)
};
...
{
public:
	char                                                         pad0x28_VG8J5[0x28];                               // 0x68(0x28)
};
...
{
public:
	char                                                         pad0x20_MMWCG[0x20];                               // 0x68(0x20)
};
...
{
public:
	char                                                         pad0x28_IREDE[0x28];                               // 0x68(0x28)
};
...
{
public:
	char                                                         pad0x38_SNRAL[0x38];                               // 0x68(0x38)
};
...
{
public:
	char                                                         pad0x30_WCH31[0x30];                               // 0x68(0x30)
};
...
public:
	...
	char                                                         pad0x4_LC7SF[0x4];                                 // 0x4bc(0x4)
};
...
{
public:
	char                                                         pad0x40_ROYI3[0x40];                               // 0x68(0x40)
};
...
{
public:
	char                                                         pad0x18_E9TDX[0x18];                               // 0x130(0x18)
};
...
public:
	...
	char                                                         pad0x18_QHLWK[0x18];                               // 0x4d8(0x18)
};
...
{
public:
	char                                                         pad0x10_INQYG[0x10];                               // 0x88(0x10)
};
...
{
public:
	char                                                         pad0x10_EA19X[0x10];                               // 0x88(0x10)
};
...
{
public:
	char                                                         pad0x18_2DRVO[0x18];                               // 0x130(0x18)
};
...
public:
	...
	char                                                         pad0x10_OG65S[0x10];                               // 0x500(0x10)
};
