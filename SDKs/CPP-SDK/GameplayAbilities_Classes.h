...
{
public:
	char                                                         pad0x40_2CT9M[0x40];                               // 0x28(0x40)
	struct GameplayTagContainer                                  AbilityTags;                                       // 0x68(0x28)
	char                                                         pad0x18_UYXHQ[0x18];                               // 0x90(0x18)
	bool                                                         bReplicateInputDirectly;                           // 0xa8(0x1)
	char                                                         pad0x27_R68DP[0x27];                               // 0xa9(0x27)
	...
	char                                                         pad0x4_O4HTC[0x4];                                 // 0xd4(0x4)
	...
	char                                                         pad0x7_FRAQ4[0x7];                                 // 0x199(0x7)
	...
	char                                                         pad0x70_5L4DC[0x70];                               // 0x3c8(0x70)
	...
	char                                                         pad0x5_F1VZW[0x5];                                 // 0x443(0x5)
};
...
public:
	...
	char                                                         pad0x7_Y90FJ[0x7];                                 // 0xf1(0x7)
	...
	char                                                         pad0x18_K1FO7[0x18];                               // 0x118(0x18)
};
...
{
public:
	char                                                         pad0x10_UE61P[0x10];                               // 0x58(0x10)
};
...
public:
	...
	char                                                         pad0x50_YFUNT[0x50];                               // 0x38(0x50)
};
...
{
public:
	char                                                         pad0x8_KHPRB[0x8];                                 // 0x28(0x8)
};
...
public:
	...
	char                                                         pad0x3_AMZKU[0x3];                                 // 0x3d9(0x3)
	...
	char                                                         pad0x5_MVMDP[0x5];                                 // 0x3e3(0x5)
};
...
public:
	...
	char                                                         pad0x50_5DA8L[0x50];                               // 0x38(0x50)
};
...
{
public:
	char                                                         pad0x8_7YYJV[0x8];                                 // 0x128(0x8)
	...
	char                                                         pad0x78_JWHG3[0x78];                               // 0x168(0x78)
	...
	char                                                         pad0x50_EPLOY[0x50];                               // 0x2a8(0x50)
	TArray<class GameplayAbility*>                               AllReplicatedInstancedAbilities;                   // 0x2f8(0x10)
	char                                                         pad0x1b0_N73PG[0x1b0];                             // 0x308(0x1b0)
	...
	char                                                         pad0xa0_36FES[0xa0];                               // 0x528(0xa0)
	class Actor*                                                 OwnerActor;                                        // 0x5c8(0x8)
	class Actor*                                                 AvatarActor;                                       // 0x5d0(0x8)
	char                                                         pad0x18_S9JFJ[0x18];                               // 0x5d8(0x18)
	...
	char                                                         pad0x130_6HLUY[0x130];                             // 0xa18(0x130)
	TArray<char>                                                 BlockedAbilityBindings;                            // 0xb48(0x10)
	char                                                         pad0x140_1SUSC[0x140];                             // 0xb58(0x140)
};
...
{
public:
	char                                                         pad0x18_8TX1S[0x18];                               // 0x468(0x18)
...
public:
	...
	char                                                         pad0x7_TI4S5[0x7];                                 // 0x39(0x7)
};
...
{
public:
	char                                                         pad0x8_UPKMB[0x8];                                 // 0x28(0x8)
	char                                                         DurationPolicy;                                    // 0x30(0x1)
	char                                                         pad0x7_A3P2S[0x7];                                 // 0x31(0x7)
	...
	char                                                         pad0x7_R32XA[0x7];                                 // 0x1c9(0x7)
	...
	char                                                         pad0x6_GKS0R[0x6];                                 // 0x242(0x6)
	...
	char                                                         pad0x7_G8D4S[0x7];                                 // 0x269(0x7)
...
{
public:
	char                                                         pad0x18_0XA2Z[0x18];                               // 0x68(0x18)
};
...
{
public:
	char                                                         pad0x20_9C06W[0x20];                               // 0x68(0x20)
};
...
{
public:
	char                                                         pad0x30_EEHBS[0x30];                               // 0x68(0x30)
};
...
{
public:
	char                                                         pad0xc8_WMCAW[0xc8];                               // 0x68(0xc8)
};
...
public:
	...
	char                                                         pad0x4_1PBBR[0x4];                                 // 0x45c(0x4)
...
{
public:
	char                                                         pad0x30_2PXSC[0x30];                               // 0x68(0x30)
};
...
{
public:
	char                                                         pad0x40_072AM[0x40];                               // 0x68(0x40)
};
...
{
public:
	char                                                         pad0x10_4SVK5[0x10];                               // 0x68(0x10)
	class MovementComponent*                                     CachedMovementComponent;                           // 0x78(0x8)
	char                                                         pad0x10_4F0PY[0x10];                               // 0x80(0x10)
};
...
{
public:
	char                                                         pad0x20_ILVE8[0x20];                               // 0x68(0x20)
};
...
{
public:
	char                                                         pad0x28_2O90X[0x28];                               // 0x68(0x28)
};
...
{
public:
	char                                                         pad0x18_DE3DN[0x18];                               // 0x68(0x18)
};
...
{
public:
	char                                                         pad0x20_CKL0Z[0x20];                               // 0x68(0x20)
};
...
public:
	...
	char                                                         pad0xb_XHC7X[0xb];                                 // 0x4e5(0xb)
};
...
{
public:
	char                                                         pad0x18_ASUW9[0x18];                               // 0x68(0x18)
};
...
{
public:
	char                                                         pad0x20_TBSSW[0x20];                               // 0x68(0x20)
};
...
public:
	...
	char                                                         pad0x4_4B448[0x4];                                 // 0x4dc(0x4)
};
...
{
public:
	char                                                         pad0x38_4CA31[0x38];                               // 0x68(0x38)
};
...
{
public:
	char                                                         pad0x30_7I63I[0x30];                               // 0x68(0x30)
};
...
{
public:
	char                                                         pad0x20_MP2KR[0x20];                               // 0x68(0x20)
};
...
{
public:
	char                                                         pad0x40_84YYR[0x40];                               // 0x68(0x40)
};
...
{
public:
	char                                                         pad0x30_K5JSU[0x30];                               // 0x68(0x30)
};
...
{
public:
	char                                                         pad0x10_HS910[0x10];                               // 0x68(0x10)
};
...
{
public:
	char                                                         pad0x58_NZTDI[0x58];                               // 0x68(0x58)
};
...
{
public:
	char                                                         pad0x30_QYLFY[0x30];                               // 0x68(0x30)
};
...
{
public:
	char                                                         pad0x28_SN2Z8[0x28];                               // 0x68(0x28)
};
...
public:
	...
	char                                                         pad0x7_ZZR8B[0x7];                                 // 0x39(0x7)
};
...
{
public:
	char                                                         pad0x18_DR4SE[0x18];                               // 0x130(0x18)
};
...
{
public:
	char                                                         pad0x10_TSU9X[0x10];                               // 0x88(0x10)
};
...
{
public:
	char                                                         pad0x10_ZKS1T[0x10];                               // 0x88(0x10)
};
...
public:
	...
	char                                                         pad0x18_G2NS6[0x18];                               // 0x4f8(0x18)
};
...
{
public:
	char                                                         pad0x18_0OO3O[0x18];                               // 0x130(0x18)
};
...
public:
	...
	char                                                         pad0x10_92BHS[0x10];                               // 0x520(0x10)
};
