...
public:
	...
	TArray<class Source Actors*>                                 Source Actors;                                     // 0x3f8(0x10)
	...
	TArray<Struct Source Actors>                                 DataArray;                                         // 0x420(0x10)
	...
	TArray<class ActorsToIgnore*>                                ActorsToIgnore;                                    // 0x4c8(0x10)
	bool                                                         [[------DEFORM TERRAIN ------]];                   // 0x4d8(0x1)
	Struct HitResult                                             HirResult;                                         // 0x4dc(0x80)
	TArray<Struct ActorsToIgnore>                                TopSplineIntersectionPoints;                       // 0x560(0x10)
	TArray<class Local_InternalActorsToIgnore*>                  Local_InternalActorsToIgnore;                      // 0x570(0x10)
