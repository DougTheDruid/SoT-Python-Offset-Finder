...
{
public:
	char                                                         pad0x28_UELAR[0x28];                               // 0x28(0x28)
};
...
{
public:
	char                                                         pad0x50_8Z6E1[0x50];                               // 0x28(0x50)
};
...
{
public:
	char                                                         pad0x20_OO9NC[0x20];                               // 0x28(0x20)
};
...
{
public:
	char                                                         pad0x50_X11RZ[0x50];                               // 0x28(0x50)
};
...
{
public:
	char                                                         pad0x20_1YP1M[0x20];                               // 0x28(0x20)
};
...
public:
	...
	char                                                         pad0x3_LC8KT[0x3];                                 // 0x31(0x3)
	...
	char                                                         pad0xa_HQHAN[0xa];                                 // 0x46(0xa)
};
...
{
public:
	char                                                         pad0x60_WWALQ[0x60];                               // 0x28(0x60)
};
...
{
public:
	char                                                         pad0xd8_QOQBK[0xd8];                               // 0x28(0xd8)
};
...
public:
	...
	char                                                         pad0x10_TM2DG[0x10];                               // 0x38(0x10)
};
...
{
public:
	char                                                         pad0x8_46X75[0x8];                                 // 0x98(0x8)
...
public:
	...
	char                                                         pad0x28_T258G[0x28];                               // 0x48(0x28)
};
...
public:
	...
	char                                                         pad0x7_WF03E[0x7];                                 // 0x99(0x7)
};
