...
{
public:
	char                                                         pad0x50_BJ4JA[0x50];                               // 0x28(0x50)
};
...
{
public:
	char                                                         pad0x60_0LGNE[0x60];                               // 0x28(0x60)
};
...
{
public:
	char                                                         pad0x20_1406S[0x20];                               // 0x28(0x20)
};
...
{
public:
	char                                                         pad0x28_IC3KS[0x28];                               // 0x28(0x28)
};
...
{
public:
	char                                                         pad0x50_65GGH[0x50];                               // 0x28(0x50)
};
...
{
public:
	char                                                         pad0xd8_N9DK7[0xd8];                               // 0x28(0xd8)
};
...
{
public:
	char                                                         pad0x20_9ITHJ[0x20];                               // 0x28(0x20)
};
...
public:
	...
	char                                                         pad0x3_1SNF2[0x3];                                 // 0x31(0x3)
	...
	char                                                         pad0xa_NC85R[0xa];                                 // 0x46(0xa)
};
...
public:
	...
	char                                                         pad0x10_I413D[0x10];                               // 0x38(0x10)
};
...
public:
	...
	char                                                         pad0x28_IO9PH[0x28];                               // 0x48(0x28)
};
...
{
public:
	char                                                         pad0x8_EXCTJ[0x8];                                 // 0x98(0x8)
...
public:
	...
	char                                                         pad0x7_OT6FD[0x7];                                 // 0x99(0x7)
};
