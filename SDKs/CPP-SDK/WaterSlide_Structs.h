...
{
public:
	char                                                         pad0x30_T3CB6[0x30];                               // 0x0(0x30)
	float                                                        Duration;                                          // 0x30(0x4)
	char                                                         pad0x4_DA1UM[0x4];                                 // 0x34(0x4)
};
...
{
public:
	char                                                         pad0x1c_8AA8H[0x1c];                               // 0x0(0x1c)
};
...
{
public:
	char                                                         pad0x48_LTNT0[0x48];                               // 0x0(0x48)
	class SceneComponent*                                        SceneComponent;                                    // 0x48(0x8)
};
...
public:
	...
	char                                                         pad0x4_OMO3E[0x4];                                 // 0x1c(0x4)
...
{
public:
	char                                                         pad0x48_Q7CEH[0x48];                               // 0x0(0x48)
	class Ride*                                                  Ride;                                              // 0x48(0x8)
	char                                                         Direction;                                         // 0x50(0x1)
	char                                                         pad0x3_0XFP5[0x3];                                 // 0x51(0x3)
	float                                                        Offset;                                            // 0x54(0x4)
	char                                                         pad0x18_TPTGQ[0x18];                               // 0x58(0x18)
};
...
public:
	...
	char                                                         pad0x4_6BFMA[0x4];                                 // 0x1c(0x4)
...
public:
	...
	char                                                         pad0x4_9CBR1[0x4];                                 // 0x14(0x4)
...
public:
	...
	char                                                         pad0x3_U2SS6[0x3];                                 // 0x2d(0x3)
};
