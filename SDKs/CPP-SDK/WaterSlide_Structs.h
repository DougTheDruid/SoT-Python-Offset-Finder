...
{
public:
	char                                                         pad0x48_TJ4FM[0x48];                               // 0x0(0x48)
	class Ride*                                                  Ride;                                              // 0x48(0x8)
	char                                                         Direction;                                         // 0x50(0x1)
	char                                                         pad0x3_RQTSH[0x3];                                 // 0x51(0x3)
	float                                                        Offset;                                            // 0x54(0x4)
	char                                                         pad0x18_WSM8Y[0x18];                               // 0x58(0x18)
};
...
public:
	...
	char                                                         pad0x4_4NW1D[0x4];                                 // 0x1c(0x4)
...
public:
	...
	char                                                         pad0x4_EA879[0x4];                                 // 0x14(0x4)
...
{
public:
	char                                                         pad0x48_45SJZ[0x48];                               // 0x0(0x48)
	class SceneComponent*                                        SceneComponent;                                    // 0x48(0x8)
};
...
{
public:
	char                                                         pad0x1c_3P9JM[0x1c];                               // 0x0(0x1c)
};
...
public:
	...
	char                                                         pad0x4_Y0DQS[0x4];                                 // 0x1c(0x4)
...
{
public:
	char                                                         pad0x20_Z3PI0[0x20];                               // 0x0(0x20)
	float                                                        Duration;                                          // 0x20(0x4)
	char                                                         pad0x4_WHE3G[0x4];                                 // 0x24(0x4)
};
...
public:
	...
	char                                                         pad0x3_XVW97[0x3];                                 // 0x2d(0x3)
};
