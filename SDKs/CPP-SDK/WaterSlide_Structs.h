...
public:
	...
	char                                                         MovementDirection;                                 // 0x48(0x1)
	char                                                         InitialSwingDirection;                             // 0x49(0x1)
	double                                                       ZiplineStartSmoothedTime;                          // 0x50(0x8)
};
...
{
public:
	class Ride*                                                  Ride;                                              // 0x40(0x8)
	char                                                         Direction;                                         // 0x48(0x1)
	float                                                        Offset;                                            // 0x4c(0x4)
};
