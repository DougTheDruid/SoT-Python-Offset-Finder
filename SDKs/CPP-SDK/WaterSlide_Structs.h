...
{
public:
	char                                                         pad0x1c_MA6C0[0x1c];                               // 0x0(0x1c)
};
...
{
public:
	char                                                         pad0x48_5Q52F[0x48];                               // 0x0(0x48)
...
public:
	...
	char                                                         pad0x4_12GK7[0x4];                                 // 0x1c(0x4)
...
public:
	...
	char                                                         pad0x3_HKKGY[0x3];                                 // 0x2d(0x3)
};
...
{
public:
	char                                                         pad0x48_8YNFA[0x48];                               // 0x0(0x48)
	class Ride*                                                  Ride;                                              // 0x48(0x8)
	char                                                         Direction;                                         // 0x50(0x1)
	char                                                         pad0x3_TLAG6[0x3];                                 // 0x51(0x3)
	float                                                        Offset;                                            // 0x54(0x4)
	char                                                         pad0x18_A2EOX[0x18];                               // 0x58(0x18)
};
...
{
public:
	char                                                         pad0x10_QYXKW[0x10];                               // 0x0(0x10)
...
public:
	...
	char                                                         pad0x4_D7EB6[0x4];                                 // 0x14(0x4)
