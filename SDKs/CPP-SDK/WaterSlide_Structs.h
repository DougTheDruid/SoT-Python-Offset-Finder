...
{
public:
	char                                                         pad0x48_FV9RW[0x48];                               // 0x0(0x48)
	class Ride*                                                  Ride;                                              // 0x48(0x8)
	char                                                         Direction;                                         // 0x50(0x1)
	char                                                         pad0x3_0L8K3[0x3];                                 // 0x51(0x3)
	float                                                        Offset;                                            // 0x54(0x4)
	char                                                         pad0x18_8UEKZ[0x18];                               // 0x58(0x18)
};
...
public:
	...
	char                                                         pad0x4_BGNB8[0x4];                                 // 0x1c(0x4)
...
{
public:
	char                                                         pad0x48_DQQNF[0x48];                               // 0x0(0x48)
	class SceneComponent*                                        SceneComponent;                                    // 0x48(0x8)
};
...
{
public:
	char                                                         pad0x1c_KA3GI[0x1c];                               // 0x0(0x1c)
};
...
{
public:
	char                                                         pad0x30_EJPPI[0x30];                               // 0x0(0x30)
	float                                                        Duration;                                          // 0x30(0x4)
	char                                                         pad0x4_L2Q3K[0x4];                                 // 0x34(0x4)
};
...
public:
	...
	char                                                         pad0x4_83CLH[0x4];                                 // 0x1c(0x4)
...
public:
	...
	char                                                         pad0x3_4X6WY[0x3];                                 // 0x2d(0x3)
};
...
public:
	...
	char                                                         pad0x4_G7DEO[0x4];                                 // 0x14(0x4)
