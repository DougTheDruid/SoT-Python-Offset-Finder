...
{
public:
	char                                                         pad0x30_2K1RT[0x30];                               // 0x0(0x30)
	float                                                        Duration;                                          // 0x30(0x4)
	char                                                         pad0x4_83HXM[0x4];                                 // 0x34(0x4)
};
...
{
public:
	char                                                         pad0x48_TUH67[0x48];                               // 0x0(0x48)
...
public:
	...
	char                                                         pad0x4_XHYQ4[0x4];                                 // 0x1c(0x4)
...
public:
	...
	char                                                         pad0x4_CB0YY[0x4];                                 // 0x1c(0x4)
...
{
public:
	char                                                         pad0x48_AZ0AE[0x48];                               // 0x0(0x48)
	class Ride*                                                  Ride;                                              // 0x48(0x8)
	char                                                         Direction;                                         // 0x50(0x1)
	char                                                         pad0x3_2N1OA[0x3];                                 // 0x51(0x3)
	float                                                        Offset;                                            // 0x54(0x4)
	char                                                         pad0x18_R5H3K[0x18];                               // 0x58(0x18)
};
...
{
public:
	char                                                         pad0x1c_A9MJ5[0x1c];                               // 0x0(0x1c)
};
...
public:
	...
	char                                                         pad0x3_QGVTR[0x3];                                 // 0x2d(0x3)
};
...
public:
	...
	char                                                         pad0x4_JJ7SB[0x4];                                 // 0x14(0x4)
