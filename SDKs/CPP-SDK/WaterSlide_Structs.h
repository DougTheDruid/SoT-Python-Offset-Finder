...
public:
	...
	char                                                         pad0x4_3B5KV[0x4];                                 // 0x1c(0x4)
...
{
public:
	char                                                         pad0x48_773GH[0x48];                               // 0x0(0x48)
	class Ride*                                                  Ride;                                              // 0x48(0x8)
	char                                                         Direction;                                         // 0x50(0x1)
	char                                                         pad0x3_YF7I2[0x3];                                 // 0x51(0x3)
	float                                                        Offset;                                            // 0x54(0x4)
	char                                                         pad0x18_4KR69[0x18];                               // 0x58(0x18)
};
...
{
public:
	char                                                         pad0x10_76C1M[0x10];                               // 0x0(0x10)
...
public:
	...
	char                                                         pad0x4_VYR5C[0x4];                                 // 0x14(0x4)
...
{
public:
	char                                                         pad0x48_DCKJC[0x48];                               // 0x0(0x48)
...
{
public:
	char                                                         pad0x1c_AYSYP[0x1c];                               // 0x0(0x1c)
};
