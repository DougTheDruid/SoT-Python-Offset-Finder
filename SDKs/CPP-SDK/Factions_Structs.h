...
public:
	...
	struct                                                       CardOffset;                                        // 0x78(0x8)
	struct                                                       KeyArt;                                            // 0x80(0x10)
	struct                                                       Icon;                                              // 0x90(0x10)
};
...
public:
	...
	struct                                                       OpponentCrewId;                                    // 0x1c(0x10)
