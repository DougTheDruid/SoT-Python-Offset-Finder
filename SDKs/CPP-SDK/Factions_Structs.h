...
{
public:
	char                                                         pad0x18_6HIZV[0x18];                               // 0x0(0x18)
...
{
public:
	char                                                         pad0x18_YZBPJ[0x18];                               // 0x0(0x18)
	char                                                         OpponentFaction;                                   // 0x18(0x1)
	char                                                         pad0x3_Y1IT1[0x3];                                 // 0x19(0x3)
	...
	char                                                         pad0x3_19P4M[0x3];                                 // 0x3d(0x3)
};
...
public:
	...
	char                                                         pad0x7_BO4ON[0x7];                                 // 0x19(0x7)
};
...
public:
	...
	char                                                         pad0x18_HORJ7[0x18];                               // 0x8(0x18)
};
...
{
public:
	char                                                         pad0x18_2QBWP[0x18];                               // 0x0(0x18)
	char                                                         FactionId;                                         // 0x18(0x1)
	char                                                         pad0x7_CBPUK[0x7];                                 // 0x19(0x7)
};
...
{
public:
	char                                                         pad0x18_6JVZH[0x18];                               // 0x0(0x18)
};
