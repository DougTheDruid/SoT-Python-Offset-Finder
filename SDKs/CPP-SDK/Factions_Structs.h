...
{
public:
	char                                                         pad0x18_FQL06[0x18];                               // 0x0(0x18)
	char                                                         FactionId;                                         // 0x18(0x1)
	char                                                         pad0x7_OEHRA[0x7];                                 // 0x19(0x7)
};
...
public:
	...
	char                                                         pad0x7_HRABZ[0x7];                                 // 0x19(0x7)
};
...
{
public:
	char                                                         pad0x18_TBS8Q[0x18];                               // 0x0(0x18)
	char                                                         OpponentFaction;                                   // 0x18(0x1)
	char                                                         pad0x3_5WBPC[0x3];                                 // 0x19(0x3)
	...
	char                                                         pad0x3_W25VL[0x3];                                 // 0x3d(0x3)
};
...
public:
	class UClass*                                                Faction;                                           // 0x0(0x8)
	char                                                         pad0x18_WCMCL[0x18];                               // 0x8(0x18)
};
...
{
public:
	char                                                         pad0x18_2BX7E[0x18];                               // 0x0(0x18)
};
...
{
public:
	char                                                         pad0x18_A3ODQ[0x18];                               // 0x0(0x18)
