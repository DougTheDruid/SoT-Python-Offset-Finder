...
{
public:
	char                                                         pad0x18_0VX5P[0x18];                               // 0x0(0x18)
	char                                                         OpponentFaction;                                   // 0x18(0x1)
	char                                                         pad0x3_I0NXR[0x3];                                 // 0x19(0x3)
	...
	char                                                         pad0x3_7D2JP[0x3];                                 // 0x3d(0x3)
};
...
{
public:
	char                                                         pad0x18_PK6WW[0x18];                               // 0x0(0x18)
...
public:
	class UClass*                                                Faction;                                           // 0x0(0x8)
	char                                                         pad0x18_2M5WU[0x18];                               // 0x8(0x18)
};
...
{
public:
	char                                                         pad0x18_LP2AV[0x18];                               // 0x0(0x18)
};
...
public:
	...
	char                                                         pad0x7_37WS8[0x7];                                 // 0x19(0x7)
};
...
{
public:
	char                                                         pad0x18_32X9X[0x18];                               // 0x0(0x18)
	char                                                         FactionId;                                         // 0x18(0x1)
	char                                                         pad0x7_L9UWF[0x7];                                 // 0x19(0x7)
};
