...
class BP_RailingLight_SmallShip_Wheel_C: public ActionRules
{
public:
	char                                                         pad0x438_SIWQL[0x438];                             // 0x0(0x438)
	...
	char                                                         pad0x8_ZNKDQ[0x8];                                 // 0x4e8(0x8)
	...
	char                                                         pad0x19_QV05C[0x19];                               // 0x770(0x19)
	bool                                                         OfferingEnabled;                                   // 0x789(0x1)
	char                                                         pad0x2_W42ID[0x2];                                 // 0x78a(0x2)
