...
public:
	...
	char                                                         pad0x7_XTU1H[0x7];                                 // 0x31(0x7)
};
...
public:
	...
	char                                                         pad0x7_XLFUK[0x7];                                 // 0x41(0x7)
	...
	char                                                         pad0x5_AJB05[0x5];                                 // 0x53(0x5)
};
...
public:
	...
	char                                                         pad0x7_U0LQB[0x7];                                 // 0x39(0x7)
	...
	char                                                         pad0x4_4BBKY[0x4];                                 // 0x4c(0x4)
};
...
{
public:
	char                                                         pad0x28_ET4E7[0x28];                               // 0x28(0x28)
};
...
public:
	...
	char                                                         pad0x17_7PGJK[0x17];                               // 0x41(0x17)
};
...
public:
	...
	char                                                         pad0x7_BJFA2[0x7];                                 // 0x31(0x7)
	...
	char                                                         pad0x7_5QU8G[0x7];                                 // 0x69(0x7)
};
...
public:
	...
	char                                                         pad0x2_L3WRF[0x2];                                 // 0x3e(0x2)
};
...
public:
	...
	char                                                         pad0x6_KB1WC[0x6];                                 // 0x3a(0x6)
};
...
{
public:
	char                                                         pad0x20_H7GUA[0x20];                               // 0x28(0x20)
};
...
public:
	...
	char                                                         pad0x7_0CUW2[0x7];                                 // 0x39(0x7)
};
...
public:
	...
	char                                                         pad0x57_DAM7Q[0x57];                               // 0x41(0x57)
};
...
public:
	...
	char                                                         NewLocation;                                       // 0x39(0x1)
	char                                                         pad0x6_5CKN9[0x6];                                 // 0x3a(0x6)
};
...
public:
	...
	char                                                         pad0x7_FW3QX[0x7];                                 // 0x39(0x7)
};
...
public:
	...
	char                                                         pad0x7_C8V4L[0x7];                                 // 0x49(0x7)
};
...
public:
	...
	char                                                         pad0x4_K6774[0x4];                                 // 0x44(0x4)
};
...
{
public:
	char                                                         pad0x18_NBEHP[0x18];                               // 0x28(0x18)
...
public:
	...
	char                                                         pad0x8_UEP75[0x8];                                 // 0xd0(0x8)
	class AnimInstance*                                          AnimInstance;                                      // 0xd8(0x8)
	char                                                         pad0x20_4TJ02[0x20];                               // 0xe0(0x20)
};
...
{
public:
	char                                                         pad0x8_BSLT3[0x8];                                 // 0x3a0(0x8)
	class SkeletalMeshComponent*                                 MeshComponent;                                     // 0x3a8(0x8)
	char                                                         pad0xa0_UK2T1[0xa0];                               // 0x3b0(0xa0)
};
...
public:
	...
	char                                                         pad0x8_EWJBO[0x8];                                 // 0x78(0x8)
};
...
public:
	...
	char                                                         pad0x30_YVJ5R[0x30];                               // 0x30(0x30)
};
...
{
public:
	char                                                         pad0x58_PJBNR[0x58];                               // 0xb8(0x58)
	class CosmeticItemAnimationDataAsset*                        DataAsset;                                         // 0x110(0x8)
	char                                                         pad0x8_TZROL[0x8];                                 // 0x118(0x8)
};
...
{
public:
	char                                                         pad0x10_YJZES[0x10];                               // 0x440(0x10)
...
{
public:
	char                                                         pad0x8_DM0RV[0x8];                                 // 0xb8(0x8)
...
public:
	...
	char                                                         pad0xe0_HJ0CV[0xe0];                               // 0x40(0xe0)
};
...
public:
	...
	char                                                         pad0x7_80VKC[0x7];                                 // 0x51(0x7)
};
...
public:
	...
	char                                                         pad0x88_EWAHN[0x88];                               // 0x668(0x88)
};
