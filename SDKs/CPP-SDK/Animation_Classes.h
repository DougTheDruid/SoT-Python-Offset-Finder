...
public:
	char                                                         CurrentLocation;                                   // 0x38(0x1)
	struct                                                       PreviewLocationOffset;                             // 0x3c(0xc)
...
{
public:
	struct                                                       CustomAnimationMontageIdListings;                  // 0x38(0x10)
};
...
{
public:
	struct                                                       IKLeftHandUpdateParams;                            // 0x450(0x40)
	struct                                                       IKRightHandUpdateParams;                           // 0x490(0x40)
	struct FName                                                 RightHandIKSocketName;                             // 0x4d0(0x8)
	struct FName                                                 LeftHandIKSocketName;                              // 0x4d8(0x8)
	struct                                                       RightHandIK;                                       // 0x4e0(0x60)
	struct                                                       LeftHandIK;                                        // 0x540(0x60)
	struct                                                       RightFootIK;                                       // 0x5a0(0x60)
	struct                                                       LeftFootIK;                                        // 0x600(0x60)
};
...
{
public:
	struct                                                       ReplicatedData;                                    // 0xd0(0xc)
};
