...
{
public:
	struct                                                       SerialisedConstructionInfo;                        // 0x0(0x40)
};
...
{
public:
	struct                                                       LatestEpochIds;                                    // 0x0(0x1)
	struct                                                       LatestRequestIds;                                  // 0x5(0x1)
	struct                                                       PerTrackConstructionInfoStore;                     // 0x10(0x140)
};
