...
public:
	...
	char                                                         pad0x3_FF3TB[0x3];                                 // 0x479(0x3)
	char                                                         pad0x4c_7HXCS[0x4c];                               // 0x47c(0x4c)
};
...
public:
	...
	char                                                         pad0x17_WUIGS[0x17];                               // 0x401(0x17)
};
...
public:
	...
	char                                                         pad0x10_5SPPS[0x10];                               // 0x58(0x10)
};
...
{
public:
	char                                                         pad0x10_20YKZ[0x10];                               // 0x418(0x10)
	...
	char                                                         pad0x5_5LZBJ[0x5];                                 // 0x46b(0x5)
};
...
public:
	...
	char                                                         pad0x4_QA8V5[0x4];                                 // 0x3f4(0x4)
	TArray<class OnlineBeaconClient*>                            ClientActors;                                      // 0x3f8(0x10)
	char                                                         pad0xa0_HLPZA[0xa0];                               // 0x408(0xa0)
};
...
public:
	...
	char                                                         pad0x28_MIVVI[0x28];                               // 0x3f8(0x28)
...
{
public:
	char                                                         pad0x138_B79ZB[0x138];                             // 0x28(0x138)
	bool                                                         bIsFromInvite;                                     // 0x160(0x1)
	bool                                                         bHandlingDisconnect;                               // 0x161(0x1)
	char                                                         pad0x6_ZXZAV[0x6];                                 // 0x162(0x6)
};
