...
public:
	...
	char                                                         pad0xac_KGGLC[0xac];                               // 0x5d4(0xac)
};
...
public:
	...
	char                                                         pad0x7_0B92I[0x7];                                 // 0x71(0x7)
};
...
{
public:
	char                                                         pad0x8_WK8QR[0x8];                                 // 0x3c8(0x8)
	...
	char                                                         pad0x88_IAPRA[0x88];                               // 0x490(0x88)
};
...
public:
	...
	char                                                         pad0x8_13FM2[0x8];                                 // 0x318(0x8)
};
