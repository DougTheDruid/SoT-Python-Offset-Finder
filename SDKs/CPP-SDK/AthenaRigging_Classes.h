...
public:
	...
	char                                                         pad0xac_KVJNL[0xac];                               // 0x5d4(0xac)
};
...
public:
	...
	char                                                         pad0x7_IAIM3[0x7];                                 // 0x71(0x7)
};
...
{
public:
	char                                                         pad0x8_JKZVM[0x8];                                 // 0x3c8(0x8)
	...
	char                                                         pad0x88_MHGFQ[0x88];                               // 0x490(0x88)
};
...
public:
	...
	char                                                         pad0x8_NTFKI[0x8];                                 // 0x318(0x8)
};
