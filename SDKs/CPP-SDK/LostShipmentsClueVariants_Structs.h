...
public:
	...
	char                                                         pad0x20_Q1PGU[0x20];                               // 0x8(0x20)
};
...
public:
	...
	char                                                         pad0x4_WOZ9S[0x4];                                 // 0x74(0x4)
};
...
{
public:
	char                                                         pad0x40_TT7F9[0x40];                               // 0x0(0x40)
};
...
public:
	...
	char                                                         pad0x4_A4F5S[0x4];                                 // 0x14(0x4)
};
