...
{
public:
	char                                                         pad0x8_5XRVV[0x8];                                 // 0x3c8(0x8)
...
public:
	...
	char                                                         pad0x2_P2PE9[0x2];                                 // 0x3e2(0x2)
	...
	char                                                         pad0x2c_U0UTD[0x2c];                               // 0x714(0x2c)
	...
	char                                                         pad0x8_BLM4B[0x8];                                 // 0x760(0x8)
};


// Size 0x20 (Full Size[0x788] - InheritedSize[0x768]
...
public:
	...
	struct Vector2D                                              AttachPointLocationOffset;                         // 0x780(0x8)
};
...
{
public:
	char                                                         pad0x8_4S4VE[0x8];                                 // 0xe0(0x8)
	...
	char                                                         pad0x4_07C8O[0x4];                                 // 0xfc(0x4)
	...
	char                                                         pad0x14_FHCS8[0x14];                               // 0x12c(0x14)
...
{
public:
	char                                                         pad0x10_FCDS5[0x10];                               // 0x2a0(0x10)
};
...
{
public:
	char                                                         pad0x8_4XMO2[0x8];                                 // 0x2a0(0x8)
};
