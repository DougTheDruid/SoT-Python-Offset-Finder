...
{
public:
	char                                                         pad0x8_OHZC4[0x8];                                 // 0xd0(0x8)
	...
	char                                                         pad0x4_0A6U7[0x4];                                 // 0xec(0x4)
	...
	char                                                         pad0x14_TGFKD[0x14];                               // 0x11c(0x14)
...
{
public:
	char                                                         pad0x10_GS2AB[0x10];                               // 0x290(0x10)
};
...
{
public:
	char                                                         pad0x8_FKNUL[0x8];                                 // 0x290(0x8)
};
...
{
public:
	char                                                         pad0x8_PMZPK[0x8];                                 // 0x3a0(0x8)
...
public:
	...
	char                                                         pad0x2_71RTI[0x2];                                 // 0x3ba(0x2)
	...
	char                                                         pad0x2c_GGH4S[0x2c];                               // 0x6ec(0x2c)
	...
	char                                                         pad0xc_R4RIY[0xc];                                 // 0x73c(0xc)
};
