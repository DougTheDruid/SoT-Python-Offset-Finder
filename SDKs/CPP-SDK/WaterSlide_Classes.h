...
{
public:
	char                                                         pad0x8_0B5L7[0x8];                                 // 0x3a0(0x8)
...
{
public:
	char                                                         pad0x10_G45YV[0x10];                               // 0x290(0x10)
};
...
{
public:
	char                                                         pad0x8_67UH8[0x8];                                 // 0x290(0x8)
};
...
{
public:
	char                                                         pad0x8_K317L[0x8];                                 // 0xd0(0x8)
	...
	char                                                         pad0x4_Y3SCT[0x4];                                 // 0xec(0x4)
	...
	char                                                         pad0x14_K06XR[0x14];                               // 0x11c(0x14)
...
public:
	...
	char                                                         pad0x2_NI4SI[0x2];                                 // 0x3ba(0x2)
	...
	char                                                         pad0x2c_1VKLC[0x2c];                               // 0x6ec(0x2c)
	...
	char                                                         pad0xc_I5NS9[0xc];                                 // 0x73c(0xc)
};
