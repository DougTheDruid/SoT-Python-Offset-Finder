...
{
public:
	char                                                         pad0x8_5GV7H[0x8];                                 // 0xd0(0x8)
	...
	char                                                         pad0x4_8R2F8[0x4];                                 // 0xec(0x4)
	...
	char                                                         pad0x14_PV77F[0x14];                               // 0x11c(0x14)
...
{
public:
	char                                                         pad0x10_PG4CI[0x10];                               // 0x290(0x10)
};
...
{
public:
	char                                                         pad0x8_GH706[0x8];                                 // 0x290(0x8)
};
...
{
public:
	char                                                         pad0x8_MRN1Z[0x8];                                 // 0x3a0(0x8)
...
public:
	...
	char                                                         pad0x2_GW3R6[0x2];                                 // 0x3ba(0x2)
	...
	char                                                         pad0x2c_VM4XK[0x2c];                               // 0x6ec(0x2c)
	...
	char                                                         pad0xc_C18HV[0xc];                                 // 0x73c(0xc)
};
