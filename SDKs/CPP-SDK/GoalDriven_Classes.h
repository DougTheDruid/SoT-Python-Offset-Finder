...
public:
	...
	char                                                         pad0x8_468JI[0x8];                                 // 0x2c0(0x8)
};
...
{
public:
	char                                                         pad0x30_Z9TO5[0x30];                               // 0xc8(0x30)
};
...
{
public:
	char                                                         pad0xd0_GVYOH[0xd0];                               // 0x4b8(0xd0)
};
...
public:
	...
	char                                                         pad0x38_POCPU[0x38];                               // 0x5c8(0x38)
};
...
{
public:
	char                                                         pad0x10_ACYU0[0x10];                               // 0x600(0x10)
};
