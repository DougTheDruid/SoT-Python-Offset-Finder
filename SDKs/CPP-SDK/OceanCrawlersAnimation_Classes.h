...
{
public:
	char                                                         pad0x18_3ZVN5[0x18];                               // 0x440(0x18)
	...
	char                                                         pad0x4_21ER8[0x4];                                 // 0x504(0x4)
...
{
public:
	char                                                         pad0x8_KIJI7[0x8];                                 // 0x28(0x8)
	...
	char                                                         pad0xc_D80NK[0xc];                                 // 0x42(0xc)
};
