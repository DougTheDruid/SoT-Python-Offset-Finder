...
{
public:
	char                                                         pad0x10_YDJUK[0x10];                               // 0x5c0(0x10)
	float                                                        ExclusionRadius;                                   // 0x5d0(0x4)
	char                                                         pad0x4_XOL9J[0x4];                                 // 0x5d4(0x4)
	...
	char                                                         pad0x1_0WWN5[0x1];                                 // 0x5e7(0x1)
	float                                                        PlayerTeleportRadius;                              // 0x5e8(0x4)
	char                                                         pad0x4_JBQWJ[0x4];                                 // 0x5ec(0x4)
	bool                                                         UseRepelForce;                                     // 0x5f0(0x1)
	char                                                         pad0x3_TWS81[0x3];                                 // 0x5f1(0x3)
	float                                                        RepelForceRadius;                                  // 0x5f4(0x4)
	char                                                         pad0x4_F0H05[0x4];                                 // 0x5f8(0x4)
