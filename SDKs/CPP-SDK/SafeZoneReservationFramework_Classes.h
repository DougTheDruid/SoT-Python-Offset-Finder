...
{
public:
	char                                                         pad0x10_I60BN[0x10];                               // 0x5c0(0x10)
	float                                                        ExclusionRadius;                                   // 0x5d0(0x4)
	char                                                         pad0x4_9Y3K0[0x4];                                 // 0x5d4(0x4)
	...
	char                                                         pad0x1_KAODR[0x1];                                 // 0x5e7(0x1)
	float                                                        PlayerTeleportRadius;                              // 0x5e8(0x4)
	char                                                         pad0x4_S378S[0x4];                                 // 0x5ec(0x4)
	bool                                                         UseRepelForce;                                     // 0x5f0(0x1)
	char                                                         pad0x3_CTN1P[0x3];                                 // 0x5f1(0x3)
	float                                                        RepelForceRadius;                                  // 0x5f4(0x4)
	char                                                         pad0x4_4V59M[0x4];                                 // 0x5f8(0x4)
