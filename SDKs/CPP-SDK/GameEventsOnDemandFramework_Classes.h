...
public:
	...
	char                                                         pad0x60_M7TUI[0x60];                               // 0x40(0x60)
	char                                                         CompletedState;                                    // 0xa0(0x1)
	char                                                         pad0xdf_P8AW9[0xdf];                               // 0xa1(0xdf)
};
...
{
public:
	char                                                         pad0x90_5D3IX[0x90];                               // 0x98(0x90)
};
...
public:
	...
	char                                                         pad0x2_B10AV[0x2];                                 // 0x82(0x2)
	...
	char                                                         pad0x2_GFA1B[0x2];                                 // 0x8a(0x2)
...
{
public:
	char                                                         pad0x88_G1CXL[0x88];                               // 0x28(0x88)
	...
	char                                                         pad0x88_SPNWI[0x88];                               // 0xd8(0x88)
};
