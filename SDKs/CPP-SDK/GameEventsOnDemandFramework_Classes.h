...
public:
	...
	char                                                         pad0x60_AAX1I[0x60];                               // 0x40(0x60)
	char                                                         CompletedState;                                    // 0xa0(0x1)
	char                                                         pad0xdf_WEKHS[0xdf];                               // 0xa1(0xdf)
};
...
{
public:
	char                                                         pad0x88_JWP2B[0x88];                               // 0x28(0x88)
	...
	char                                                         pad0x88_HPEER[0x88];                               // 0xd8(0x88)
};
...
{
public:
	char                                                         pad0x90_OSB4E[0x90];                               // 0x98(0x90)
};
...
public:
	...
	char                                                         pad0x2_64U8F[0x2];                                 // 0x82(0x2)
	...
	char                                                         pad0x2_L8R9J[0x2];                                 // 0x8a(0x2)
