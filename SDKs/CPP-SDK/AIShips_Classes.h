...
public:
	...
	char                                                         pad0x3_YGNJ7[0x3];                                 // 0xb9(0x3)
	float                                                        Radius;                                            // 0xbc(0x4)
	char                                                         pad0x20_GHXS7[0x20];                               // 0xc0(0x20)
};
...
public:
	...
	char                                                         pad0x30_X2W6J[0x30];                               // 0x100(0x30)
};
...
public:
	...
	char                                                         pad0x28_EUHIS[0x28];                               // 0x428(0x28)
};
...
{
public:
	char                                                         pad0x38_NF4RR[0x38];                               // 0x88(0x38)
};


// Size 0x5b0 (Full Size[0x950] - InheritedSize[0x3a0]
class AIShipService: public Actor
{
public:
	char                                                         pad0x18_ZNAEB[0x18];                               // 0x3a0(0x18)
	class GameEventOnDemandAvailabilityHandler*                  GameEventOnDemandAvailabilityHandler;              // 0x3b8(0x8)
	char                                                         pad0x18_13XPY[0x18];                               // 0x3c0(0x18)
	class AIShipServiceDataAsset*                                Params;                                            // 0x3d8(0x8)
	char                                                         pad0x570_20A3C[0x570];                             // 0x3e0(0x570)
};
...
public:
	...
	char                                                         pad0x4_R4K9F[0x4];                                 // 0x264(0x4)
	...
	char                                                         pad0x4_GOZ8D[0x4];                                 // 0x464(0x4)
	...
	char                                                         pad0x4_S7J0V[0x4];                                 // 0x4a4(0x4)
...
public:
	...
	char                                                         pad0x7_YOB4K[0x7];                                 // 0x89(0x7)
};
...
{
public:
	char                                                         pad0x48_WSKB6[0x48];                               // 0xb8(0x48)
};
...
public:
	...
	char                                                         pad0x8_WYMXN[0x8];                                 // 0x90(0x8)
};
...
public:
	...
	char                                                         pad0x4_BTEYQ[0x4];                                 // 0x94(0x4)
	...
	char                                                         pad0x4_0OQSY[0x4];                                 // 0x21c(0x4)
	...
	char                                                         pad0x4_TQRFI[0x4];                                 // 0x254(0x4)
	...
	char                                                         pad0x4_83KSV[0x4];                                 // 0x274(0x4)
};
...
public:
	...
	char                                                         pad0x18_LJ04V[0x18];                               // 0x138(0x18)
};
...
{
public:
	char                                                         pad0xe0_YJDUU[0xe0];                               // 0x88(0xe0)
};
...
public:
	...
	char                                                         pad0x30_3ZKK4[0x30];                               // 0xa0(0x30)
};
...
public:
	...
	char                                                         pad0x7_YRMBJ[0x7];                                 // 0x99(0x7)
};
...
{
public:
	char                                                         pad0x88_IKUVB[0x88];                               // 0x3a0(0x88)
};
...
public:
	...
	char                                                         pad0x7_2TQWO[0x7];                                 // 0x5f1(0x7)
	class BehaviorTree*                                          BTAsset;                                           // 0x5f8(0x8)
	char                                                         pad0x28_C5QF3[0x28];                               // 0x600(0x28)
	...
	char                                                         pad0x118_ZMZE9[0x118];                             // 0x660(0x118)
};
...
public:
	...
	char                                                         pad0x1c_MMG8A[0x1c];                               // 0xb4(0x1c)
};
...
public:
	...
	char                                                         pad0x7_EACWI[0x7];                                 // 0x29(0x7)
};
...
public:
	...
	char                                                         pad0x3_I6CHH[0x3];                                 // 0x31(0x3)
	...
	char                                                         pad0x7_CEYD5[0x7];                                 // 0x89(0x7)
};
...
public:
	...
	char                                                         pad0x6_KRHQ5[0x6];                                 // 0x2a(0x6)
...
{
public:
	char                                                         pad0x20_9H2AH[0x20];                               // 0x88(0x20)
	struct TrackingNoiseGenerator                                TrackingNoiseGenerator;                            // 0xa8(0x18)
	char                                                         pad0x18_SW2SN[0x18];                               // 0xc0(0x18)
};
