...
{
public:
	char                                                         pad0x48_RP4KW[0x48];                               // 0xb8(0x48)
};
...
{
public:
	char                                                         pad0x88_KXOVI[0x88];                               // 0x3a0(0x88)
};
...
public:
	...
	char                                                         pad0x3_IK5GT[0x3];                                 // 0x31(0x3)
	...
	char                                                         pad0x7_TQOET[0x7];                                 // 0x89(0x7)
};
...
public:
	...
	char                                                         pad0x4_2M5A2[0x4];                                 // 0x94(0x4)
	...
	char                                                         pad0x4_HY5G4[0x4];                                 // 0x224(0x4)
	...
	char                                                         pad0x4_GCF4I[0x4];                                 // 0x25c(0x4)
	...
	char                                                         pad0x4_6CGUE[0x4];                                 // 0x27c(0x4)
	class VoyageLocationOnlyNamedIslandListDataAsset*            SmugglerIslands;                                   // 0x280(0x8)
};


// Size 0x0 (Full Size[0x28] - InheritedSize[0x28]
class SPC_Activity_AIShipBattleEventSignal: public SandboxPerformanceConstraintActivityType
{
public:
};
...
{
public:
	char                                                         pad0xe0_927LQ[0xe0];                               // 0x88(0xe0)
};
...
public:
	...
	char                                                         pad0x3_FILP8[0x3];                                 // 0xb9(0x3)
	float                                                        Radius;                                            // 0xbc(0x4)
	char                                                         pad0x20_TTK85[0x20];                               // 0xc0(0x20)
};
...
public:
	...
	char                                                         pad0x30_VPLWP[0x30];                               // 0x100(0x30)
};


// Size 0x0 (Full Size[0x28] - InheritedSize[0x28]
class SPC_Activity_AIShipPassive: public SandboxPerformanceConstraintActivityType
{
public:
};
...
public:
	...
	char                                                         pad0x1c_BH0XB[0x1c];                               // 0xb4(0x1c)
};
...
{
public:
	char                                                         pad0x38_T132B[0x38];                               // 0x88(0x38)
};
...
public:
	...
	char                                                         pad0x7_HN1WQ[0x7];                                 // 0x29(0x7)
};
...
public:
	...
	char                                                         pad0x28_AFGZK[0x28];                               // 0x428(0x28)
};
...
// Size 0x0 (Full Size[0x28] - InheritedSize[0x28]
class SPC_Activity_AIShipBattle: public SandboxPerformanceConstraintActivityType
{
public:
};
...
public:
	...
	char                                                         pad0x7_2FUK6[0x7];                                 // 0x89(0x7)
};
...
public:
	...
	char                                                         pad0x30_7NSB7[0x30];                               // 0xa0(0x30)
};
...
{
public:
	char                                                         pad0x20_VORXZ[0x20];                               // 0x88(0x20)
	struct TrackingNoiseGenerator                                TrackingNoiseGenerator;                            // 0xa8(0x18)
	char                                                         pad0x18_PLY1C[0x18];                               // 0xc0(0x18)
};
...
public:
	...
	char                                                         pad0x4_HN4XB[0x4];                                 // 0x264(0x4)
	...
	char                                                         pad0x4_FJK5R[0x4];                                 // 0x464(0x4)
	...
	char                                                         pad0x4_0CJSA[0x4];                                 // 0x4a4(0x4)
...
public:
	...
	char                                                         pad0x8_ZDF7J[0x8];                                 // 0x90(0x8)
};
...
// Size 0x0 (Full Size[0x28] - InheritedSize[0x28]
class SPC_Activity_AIShipAggressive: public SandboxPerformanceConstraintActivityType
{
public:
};
...
public:
	...
	char                                                         pad0x7_09YH0[0x7];                                 // 0x5f1(0x7)
	class BehaviorTree*                                          BTAsset;                                           // 0x5f8(0x8)
	char                                                         pad0x28_1DWFU[0x28];                               // 0x600(0x28)
	...
	char                                                         pad0x118_8TJ2A[0x118];                             // 0x660(0x118)
};


// Size 0x0 (Full Size[0x28] - InheritedSize[0x28]
class SPC_SharedResource_AIShipBattleEventSignal: public SandboxPerformanceConstraintSharedResourceType
{
public:
};
...
public:
	...
	char                                                         pad0x7_07AP1[0x7];                                 // 0x99(0x7)
};
...
public:
	...
	char                                                         pad0x6_IU3H0[0x6];                                 // 0x2a(0x6)
...
public:
	...
	char                                                         pad0x18_4HAJU[0x18];                               // 0x138(0x18)
};
