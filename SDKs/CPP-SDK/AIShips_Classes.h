...
{
public:
	char                                                         pad0x20_KPBAQ[0x20];                               // 0x88(0x20)
	Struct TrackingNoiseGenerator                                TrackingNoiseGenerator;                            // 0xa8(0x18)
	char                                                         pad0x48_1UEBY[0x48];                               // 0xbe(0x48)
};


// Size 0x350 (Full Size[0x480] - InheritedSize[0x130]
class AthenaAIShipControllerParamsDataAsset: public AthenaAIControllerParamsDataAsset
{
public:
	Struct ShipMovementParams                                    TrackingMovementParams;                            // 0x130(0x34)
	char                                                         pad0x4_I42A2[0x4];                                 // 0x164(0x4)
	Struct WeightedProbabilityRangeOfRanges                      TimesToSailBesideTarget;                           // 0x168(0x30)
	Struct WeightedProbabilityRangeOfRanges                      PerpendicularDistanceOffsets;                      // 0x198(0x30)
	Struct WeightedProbabilityRangeOfRanges                      TimesBeforeDistanceChange;                         // 0x1c8(0x30)
	float                                                        MaxParallelDistanceOffset;                         // 0x1f8(0x4)
	float                                                        AlignDistanceThreshold;                            // 0x1fc(0x4)
	float                                                        TimeToProjectIntoFutureForTracking;                // 0x200(0x4)
	float                                                        TargetSpeedThresholdToTrackShip;                   // 0x204(0x4)
	Struct TrackingNoiseGenerator                                TrackingNoiseGenerator;                            // 0x208(0x18)
	float                                                        WheelAngleMonitorDuration;                         // 0x220(0x4)
	float                                                        WheelAngleChangeThresholdToBreakTracking;          // 0x224(0x4)
	float                                                        SpeedMonitorDuration;                              // 0x228(0x4)
	float                                                        SpeedChangeThresholdToBreakTrackingInMPS;          // 0x22c(0x4)
	float                                                        TargetSpeedToConsiderAnchorLoweredInMPS;           // 0x230(0x4)
	char                                                         pad0x4_9M0W2[0x4];                                 // 0x234(0x4)
	Struct WeightedProbabilityRangeOfRanges                      TrackingLatencyTimes;                              // 0x238(0x30)
	Struct WeightedProbabilityRangeOfRanges                      TrackingLatencyTimesWhenAnchorLowered;             // 0x268(0x30)
	Class CurveFloat*                                            DistToTargetShipVSTrackingLatencyCurve;            // 0x298(0x8)
	Struct ShipMovementParams                                    CirclingMovementParams;                            // 0x2a0(0x34)
	float                                                        TargetSpeedThresholdInKnots;                       // 0x2d4(0x4)
	float                                                        SecondsInFutureToProjectTargetLocation;            // 0x2d8(0x4)
	char                                                         pad0x4_ZM6H2[0x4];                                 // 0x2dc(0x4)
	Struct WeightedProbabilityRangeOfRanges                      CircleRadiuses;                                    // 0x2e0(0x30)
	Struct WeightedProbabilityRangeOfRanges                      CirclingSpeedsInDegreesPerSecond;                  // 0x310(0x30)
	Struct WeightedProbabilityRangeOfRanges                      TimesToCircleBeforeChangingRadius;                 // 0x340(0x30)
	float                                                        MinDistanceFromTargetToStartRam;                   // 0x370(0x4)
	float                                                        MaxDistanceFromTargetToStartRam;                   // 0x374(0x4)
	float                                                        MaxSpeedToRamTarget;                               // 0x378(0x4)
	float                                                        RammingMaxTurnSpeed;                               // 0x37c(0x4)
	float                                                        RammingTimeDampingScalar;                          // 0x380(0x4)
	float                                                        MinAngleToTargetToAttemptRam;                      // 0x384(0x4)
	Struct WeightedProbabilityRangeOfRanges                      RammingLocationOffsets;                            // 0x388(0x30)
	Struct ShipMovementParams                                    SailingForwardMovementParams;                      // 0x3b8(0x34)
	float                                                        MinAllowedDistanceToObstacle;                      // 0x3ec(0x4)
	float                                                        MaxPathAvoidanceDistance;                          // 0x3f0(0x4)
	Struct ShipMovementParams                                    PassiveSailingMovementParams;                      // 0x3f4(0x34)
	float                                                        ChanceToAnchor;                                    // 0x428(0x4)
	char                                                         pad0x4_A4FBQ[0x4];                                 // 0x42c(0x4)
	Struct WeightedProbabilityRangeOfRanges                      TimesToStayAnchored;                               // 0x430(0x30)
	int                                                          NumIslandsToVisitBeforeReturning;                  // 0x460(0x4)
	float                                                        DistanceFromIslandsToSailTo;                       // 0x464(0x4)
	float                                                        DistanceToTargetToDropAnchor;                      // 0x468(0x4)
	char                                                         pad0x4_87HSS[0x4];                                 // 0x46c(0x4)
	TArray<Class AggressionOverrideImpactIDs>                    AggressionOverrideImpactIDs;                       // 0x470(0x10)
};
...
public:
	...
	char                                                         pad0x6_E4W6L[0x6];                                 // 0x2a(0x6)
...
public:
	...
	char                                                         pad0x3_XFM5O[0x3];                                 // 0x31(0x3)
	...
	char                                                         pad0x9_0696X[0x9];                                 // 0x87(0x9)
};
...
public:
	...
	char                                                         pad0x38_I4ONE[0x38];                               // 0x44e(0x38)
};
...
public:
	...
	char                                                         pad0x4_BJAX8[0x4];                                 // 0x5c(0x4)
...
public:
	...
	char                                                         pad0x4_VI4PQ[0x4];                                 // 0x6c(0x4)
	...
	char                                                         pad0x4_PH9PJ[0x4];                                 // 0x1f4(0x4)
	...
	char                                                         pad0x4_TQ6QK[0x4];                                 // 0x22c(0x4)
	...
	char                                                         pad0xc_5M887[0xc];                                 // 0x24a(0xc)
};
...
public:
	...
	char                                                         pad0x3_8NGRF[0x3];                                 // 0xc9(0x3)
	float                                                        Radius;                                            // 0xcc(0x4)
	char                                                         pad0x28_FDEC1[0x28];                               // 0xce(0x28)
};
...
{
public:
	char                                                         pad0x20_EEI8A[0x20];                               // 0x3c8(0x20)
	Class AIShipServiceDataAsset*                                Params;                                            // 0x3e8(0x8)
	char                                                         pad0x318_56I9A[0x318];                             // 0x3ee(0x318)
};
...
public:
	...
	char                                                         pad0x18_JP8EC[0x18];                               // 0x618(0x18)
	...
	char                                                         pad0x148_71PZ2[0x148];                             // 0x666(0x148)
};
...
public:
	...
	char                                                         pad0x68_OXVS8[0x68];                               // 0x136(0x68)
};
...
public:
	...
	char                                                         pad0x80_5WN98[0x80];                               // 0x96(0x80)
};
...
public:
	...
	char                                                         pad0x10_BHGJX[0x10];                               // 0x8e(0x10)
};
...
public:
	...
	char                                                         pad0x80_DD7PU[0x80];                               // 0xfe(0x80)
};
...
public:
	...
	char                                                         pad0x24_1NCBO[0x24];                               // 0xb2(0x24)
};
...
public:
	...
	char                                                         pad0x9_R69JH[0x9];                                 // 0x27(0x9)
};
