...
{
public:
	char                                                         pad0x20_M9XBP[0x20];                               // 0x88(0x20)
	Struct TrackingNoiseGenerator                                TrackingNoiseGenerator;                            // 0xa8(0x18)
	char                                                         pad0x18_R1Z4A[0x18];                               // 0xc0(0x18)
};
...
public:
	...
	char                                                         pad0x4_R4C07[0x4];                                 // 0x23c(0x4)
	...
	char                                                         pad0x4_VJMXW[0x4];                                 // 0x43c(0x4)
	...
	char                                                         pad0x4_DPY1K[0x4];                                 // 0x47c(0x4)
...
public:
	...
	char                                                         pad0x6_ZK9EG[0x6];                                 // 0x2a(0x6)
...
public:
	...
	char                                                         pad0x3_Y4VZB[0x3];                                 // 0x31(0x3)
	...
	char                                                         pad0x7_JFGLP[0x7];                                 // 0x89(0x7)
};
...
public:
	...
	char                                                         pad0x28_PIG2B[0x28];                               // 0x450(0x28)
};
...
public:
	...
	char                                                         pad0x4_QC6XG[0x4];                                 // 0x5c(0x4)
...
public:
	...
	char                                                         pad0x4_PAKND[0x4];                                 // 0x6c(0x4)
	...
	char                                                         pad0x4_XUZ6Y[0x4];                                 // 0x1f4(0x4)
	...
	char                                                         pad0x4_16KZZ[0x4];                                 // 0x22c(0x4)
	...
	char                                                         pad0x4_44HY2[0x4];                                 // 0x24c(0x4)
};
...
public:
	...
	char                                                         pad0x3_HMA03[0x3];                                 // 0xc9(0x3)
	float                                                        Radius;                                            // 0xcc(0x4)
	char                                                         pad0x20_JNBKE[0x20];                               // 0xd0(0x20)
};
...
{
public:
	char                                                         pad0x20_7O5KW[0x20];                               // 0x3c8(0x20)
	Class AIShipServiceDataAsset*                                Params;                                            // 0x3e8(0x8)
	char                                                         pad0x328_NIH89[0x328];                             // 0x3f0(0x328)
};
...
public:
	...
	char                                                         pad0x18_OKAH7[0x18];                               // 0x618(0x18)
	...
	char                                                         pad0x118_YZSTA[0x118];                             // 0x668(0x118)
};
...
public:
	...
	char                                                         pad0x18_91R2U[0x18];                               // 0x138(0x18)
};
...
public:
	...
	char                                                         pad0x30_6KYZ8[0x30];                               // 0x98(0x30)
};
...
public:
	...
	char                                                         pad0x8_Z34K7[0x8];                                 // 0x90(0x8)
};
...
public:
	...
	char                                                         pad0x30_SQCLU[0x30];                               // 0x100(0x30)
};
...
public:
	...
	char                                                         pad0x1c_Z677R[0x1c];                               // 0xb4(0x1c)
};
...
public:
	...
	char                                                         pad0x7_IBEWG[0x7];                                 // 0x29(0x7)
};
