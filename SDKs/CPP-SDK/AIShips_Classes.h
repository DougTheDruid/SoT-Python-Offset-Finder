...
{
public:
	char                                                         pad0xe0_6JG9D[0xe0];                               // 0x88(0xe0)
};
...
{
public:
	char                                                         pad0x20_5MO6D[0x20];                               // 0x88(0x20)
	struct TrackingNoiseGenerator                                TrackingNoiseGenerator;                            // 0xa8(0x18)
	char                                                         pad0x18_U7I69[0x18];                               // 0xc0(0x18)
};
...
public:
	...
	char                                                         pad0x28_5GVY1[0x28];                               // 0x428(0x28)
};
...
public:
	...
	char                                                         pad0x8_XYHEM[0x8];                                 // 0x90(0x8)
};
...
public:
	...
	char                                                         pad0x30_1IAOV[0x30];                               // 0x100(0x30)
};
...
public:
	...
	char                                                         pad0x3_LNA1L[0x3];                                 // 0xb9(0x3)
	float                                                        Radius;                                            // 0xbc(0x4)
	char                                                         pad0x20_F65KR[0x20];                               // 0xc0(0x20)
};
...
public:
	...
	char                                                         pad0x7_01HO2[0x7];                                 // 0x89(0x7)
};
...
public:
	...
	char                                                         pad0x4_WU5CM[0x4];                                 // 0x94(0x4)
	...
	char                                                         pad0x4_ZLQ7Y[0x4];                                 // 0x21c(0x4)
	...
	char                                                         pad0x4_E40ZY[0x4];                                 // 0x254(0x4)
	...
	char                                                         pad0x4_EIRCE[0x4];                                 // 0x274(0x4)
};
...
public:
	...
	char                                                         pad0x3_TCX8B[0x3];                                 // 0x31(0x3)
	...
	char                                                         pad0x7_OR4OX[0x7];                                 // 0x89(0x7)
};
...
public:
	...
	char                                                         pad0x7_SGK11[0x7];                                 // 0x5f1(0x7)
	class BehaviorTree*                                          BTAsset;                                           // 0x5f8(0x8)
	char                                                         pad0x28_A1US1[0x28];                               // 0x600(0x28)
	...
	char                                                         pad0x118_FZ12G[0x118];                             // 0x660(0x118)
};
...
public:
	...
	char                                                         pad0x4_8VPGS[0x4];                                 // 0x264(0x4)
	...
	char                                                         pad0x4_T33M4[0x4];                                 // 0x464(0x4)
	...
	char                                                         pad0x4_4Y5BB[0x4];                                 // 0x4a4(0x4)
...
public:
	...
	char                                                         pad0x7_C8Q1Z[0x7];                                 // 0x99(0x7)
};
...
{
public:
	char                                                         pad0x38_D9JAA[0x38];                               // 0x88(0x38)
};
...
public:
	...
	char                                                         pad0x1c_VXWWN[0x1c];                               // 0xb4(0x1c)
};
...
public:
	...
	char                                                         pad0x18_88IT7[0x18];                               // 0x138(0x18)
};
...
public:
	...
	char                                                         pad0x7_CAOBL[0x7];                                 // 0x29(0x7)
};
...
{
public:
	char                                                         pad0x88_P66R0[0x88];                               // 0x3a0(0x88)
};
...
public:
	...
	char                                                         pad0x30_0D2N7[0x30];                               // 0xa0(0x30)
};
...
{
public:
	char                                                         pad0x48_06VIG[0x48];                               // 0xb8(0x48)
};
...
public:
	...
	char                                                         pad0x6_0GDM0[0x6];                                 // 0x2a(0x6)
