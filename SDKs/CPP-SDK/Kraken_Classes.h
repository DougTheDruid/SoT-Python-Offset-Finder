...
{
public:
	char                                                         pad0x190_UEOVK[0x190];                             // 0xb8(0x190)
};
...
{
public:
	char                                                         pad0x8_N6OZ0[0x8];                                 // 0x3a0(0x8)
	struct KrakenServiceParams                                   KrakenServiceParams;                               // 0x3a8(0x40)
	char                                                         pad0xa0_UEQO6[0xa0];                               // 0x3e8(0xa0)
	class Kraken*                                                Kraken;                                            // 0x488(0x8)
	char                                                         pad0x240_UN8JR[0x240];                             // 0x490(0x240)
};
...
public:
	...
	char                                                         pad0x4_I9W1U[0x4];                                 // 0x3c4(0x4)
	...
	char                                                         pad0x68_9DFNT[0x68];                               // 0x3d8(0x68)
};
...
{
public:
	char                                                         pad0x28_KH4F5[0x28];                               // 0x3a0(0x28)
	...
	char                                                         pad0x10c_OX3MU[0x10c];                             // 0x3e4(0x10c)
};
...
{
public:
	char                                                         pad0x10_AI8V4[0x10];                               // 0x3a0(0x10)
	...
	char                                                         pad0x7_IDH0T[0x7];                                 // 0x4b9(0x7)
	class SceneComponent*                                        Root;                                              // 0x4c0(0x8)
	char                                                         pad0xc0_G79FL[0xc0];                               // 0x4c8(0xc0)
	struct FName                                                 BiteAttackImpactNamedPointsGroupName;              // 0x588(0x8)
	char                                                         pad0x20_XGWE1[0x20];                               // 0x590(0x20)
};
...
public:
	...
	char                                                         pad0x2_7ZB5H[0x2];                                 // 0x3e(0x2)
	float                                                        AnimationPlayRateScale;                            // 0x40(0x4)
	char                                                         pad0x4_TK71G[0x4];                                 // 0x44(0x4)
...
public:
	...
	char                                                         pad0x34_TOVUW[0x34];                               // 0x33c(0x34)
};
...
{
public:
	char                                                         pad0x8_3FKGE[0x8];                                 // 0x28(0x8)
...
public:
	...
	char                                                         pad0x7_TWBST[0x7];                                 // 0x39(0x7)
...
{
public:
	char                                                         pad0x18_PTVFP[0x18];                               // 0x3a0(0x18)
	float                                                        RelevancyDistance;                                 // 0x3b8(0x4)
	char                                                         pad0x14_3VDD3[0x14];                               // 0x3bc(0x14)
	...
	char                                                         pad0x1b2_U8L8Z[0x1b2];                             // 0x3de(0x1b2)
	class Murk*                                                  MurkActor;                                         // 0x590(0x8)
	char                                                         pad0xc0_UYZ83[0xc0];                               // 0x598(0xc0)
	...
	struct KrakenParams                                          Params;                                            // 0x680(0x160)
	char                                                         pad0x10_34Z0X[0x10];                               // 0x7e0(0x10)
	int                                                          NumTentaclesRemaining;                             // 0x7f0(0x4)
	char                                                         pad0x12c_WVJOW[0x12c];                             // 0x7f4(0x12c)
};
...
{
public:
	char                                                         pad0x20_3BZ0B[0x20];                               // 0x28(0x20)
...
public:
	...
	char                                                         pad0x70_ZY6AA[0x70];                               // 0x670(0x70)
};
