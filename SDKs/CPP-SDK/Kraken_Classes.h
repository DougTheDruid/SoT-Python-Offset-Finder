...
{
public:
	char                                                         pad0x20_073M2[0x20];                               // 0x3c8(0x20)
	...
	char                                                         pad0x10c_BDMZQ[0x10c];                             // 0x404(0x10c)
};
...
public:
	...
	char                                                         pad0x7_GFE6F[0x7];                                 // 0x39(0x7)
...
public:
	...
	char                                                         pad0x4_TR63T[0x4];                                 // 0x3ec(0x4)
	...
	char                                                         pad0x68_LS50U[0x68];                               // 0x400(0x68)
};
...
public:
	...
	char                                                         pad0x70_ONZ9Z[0x70];                               // 0x690(0x70)
};
...
{
public:
	char                                                         pad0x138_BRTW6[0x138];                             // 0xc8(0x138)
};
...
{
public:
	char                                                         pad0x18_J938N[0x18];                               // 0x3c8(0x18)
	float                                                        RelevancyDistance;                                 // 0x3e0(0x4)
	char                                                         pad0x14_X1B95[0x14];                               // 0x3e4(0x14)
	...
	char                                                         pad0x1b2_T4R86[0x1b2];                             // 0x406(0x1b2)
	class Murk*                                                  MurkActor;                                         // 0x5b8(0x8)
	char                                                         pad0xb8_NXLUR[0xb8];                               // 0x5c0(0xb8)
...
public:
	...
	char                                                         pad0x2_LNW1T[0x2];                                 // 0x3e(0x2)
	float                                                        AnimationPlayRateScale;                            // 0x40(0x4)
	char                                                         pad0x4_PYOTN[0x4];                                 // 0x44(0x4)
...
{
public:
	char                                                         pad0x20_FQC5S[0x20];                               // 0x28(0x20)
...
{
public:
	char                                                         pad0x10_M1FVZ[0x10];                               // 0x3c8(0x10)
	...
	char                                                         pad0x4_HIEXP[0x4];                                 // 0x4b4(0x4)
	...
	char                                                         pad0x7_CZEI0[0x7];                                 // 0x4d9(0x7)
	class SceneComponent*                                        Root;                                              // 0x4e0(0x8)
	char                                                         pad0xc0_YRXVX[0xc0];                               // 0x4e8(0xc0)
	struct FName                                                 BiteAttackImpactNamedPointsGroupName;              // 0x5a8(0x8)
	char                                                         pad0x20_JZ81H[0x20];                               // 0x5b0(0x20)
};
...
{
public:
	char                                                         pad0x8_FTIIG[0x8];                                 // 0x3c8(0x8)
	struct KrakenServiceParams                                   KrakenServiceParams;                               // 0x3d0(0x40)
	char                                                         pad0xa0_SQZB9[0xa0];                               // 0x410(0xa0)
	class Kraken*                                                Kraken;                                            // 0x4b0(0x8)
	char                                                         pad0x248_YVATM[0x248];                             // 0x4b8(0x248)
};
...
{
public:
	char                                                         pad0x8_XW9B7[0x8];                                 // 0x28(0x8)
...
public:
	...
	char                                                         pad0x38_OXSQU[0x38];                               // 0x348(0x38)
};
