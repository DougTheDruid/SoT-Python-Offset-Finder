...
public:
	...
	char                                                         pad0x34_IU3D4[0x34];                               // 0x33c(0x34)
};
...
{
public:
	char                                                         pad0x10_Q5HVS[0x10];                               // 0x3a0(0x10)
	...
	char                                                         pad0x7_MQP69[0x7];                                 // 0x4b9(0x7)
	class SceneComponent*                                        Root;                                              // 0x4c0(0x8)
	char                                                         pad0xc0_9CKV4[0xc0];                               // 0x4c8(0xc0)
	struct FName                                                 BiteAttackImpactNamedPointsGroupName;              // 0x588(0x8)
	char                                                         pad0x20_24YW3[0x20];                               // 0x590(0x20)
};


// Size 0x0 (Full Size[0x28] - InheritedSize[0x28]
class SPC_Activity_Kraken: public SandboxPerformanceConstraintActivityType
{
public:
};
...
public:
	...
	char                                                         pad0x2_XDFHF[0x2];                                 // 0x3e(0x2)
	float                                                        AnimationPlayRateScale;                            // 0x40(0x4)
	char                                                         pad0x4_NWCIE[0x4];                                 // 0x44(0x4)
...
{
public:
	bool                                                         UseTinyKrakenService;                              // 0x58(0x1)
	char                                                         pad0x7_VEW53[0x7];                                 // 0x59(0x7)
};
...
{
public:
	char                                                         pad0x190_5PW6J[0x190];                             // 0xb8(0x190)
};
...
{
public:
	char                                                         pad0x28_I1WA0[0x28];                               // 0x3a0(0x28)
	...
	char                                                         pad0x10c_NUY4C[0x10c];                             // 0x3e4(0x10c)
};
...
// Size 0x0 (Full Size[0x28] - InheritedSize[0x28]
class SPC_SharedResource_KrakenTentacle: public SandboxPerformanceConstraintSharedResourceType
{
public:
};
...
public:
	...
	char                                                         pad0x4_REN0T[0x4];                                 // 0x3c4(0x4)
	...
	char                                                         pad0x68_GWL15[0x68];                               // 0x3d8(0x68)
};


// Size 0x0 (Full Size[0x28] - InheritedSize[0x28]
class SPC_Activity_KrakenTentacleWrap: public SandboxPerformanceConstraintActivityType
{
public:
};
...
{
public:
	char                                                         pad0x10_V4HJE[0x10];                               // 0x3a0(0x10)
	struct KrakenServiceParams                                   KrakenServiceParams;                               // 0x3b0(0x40)
	char                                                         pad0x20_O6X5B[0x20];                               // 0x3f0(0x20)
	class Kraken*                                                Kraken;                                            // 0x410(0x8)
	char                                                         pad0x268_RC7ZH[0x268];                             // 0x418(0x268)
};
...
{
public:
	struct KrakenParams                                          Params;                                            // 0x28(0x170)
};


// Size 0x0 (Full Size[0x28] - InheritedSize[0x28]
class SPC_SharedResource_Kraken: public SandboxPerformanceConstraintSharedResourceType
{
public:
};
...
public:
	...
	char                                                         pad0x7_JLGQ3[0x7];                                 // 0x39(0x7)
...
// Size 0x5d0 (Full Size[0x970] - InheritedSize[0x3a0]
class Kraken: public Actor
{
public:
	char                                                         pad0x18_XAIL2[0x18];                               // 0x3a0(0x18)
	float                                                        RelevancyDistance;                                 // 0x3b8(0x4)
	char                                                         pad0x14_Q8SRK[0x14];                               // 0x3bc(0x14)
	...
	char                                                         pad0x1b2_91TVC[0x1b2];                             // 0x3de(0x1b2)
	class Murk*                                                  MurkActor;                                         // 0x590(0x8)
	struct Vector                                                LastTentacleKilledLocation;                        // 0x598(0xc)
	...
	struct KrakenParams                                          Params;                                            // 0x690(0x170)
	char                                                         pad0x18_5CF5H[0x18];                               // 0x800(0x18)
	int                                                          NumTentaclesRemaining;                             // 0x818(0x4)
	char                                                         pad0x154_UUOPR[0x154];                             // 0x81c(0x154)
};
...
// Size 0x448 (Full Size[0x470] - InheritedSize[0x28]
class KrakenShipWrappingBehaviourParamsDataAsset: public DataAsset
{
public:
	char                                                         pad0x8_TLF38[0x8];                                 // 0x28(0x8)
	struct KrakenShipWrappingBehaviourParams                     Params;                                            // 0x30(0x440)
};
...
// Size 0x0 (Full Size[0x28] - InheritedSize[0x28]
class SPC_Activity_KrakenTentacle: public SandboxPerformanceConstraintActivityType
{
public:
};
...
{
public:
	char                                                         pad0x20_8UQVE[0x20];                               // 0x28(0x20)
...
public:
	...
	char                                                         pad0x70_OTCQV[0x70];                               // 0x670(0x70)
};
