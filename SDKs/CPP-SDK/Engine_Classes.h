...
{
public:
	struct                                                       EmitterInfo;                                       // 0x50(0x2b0)
	struct                                                       ResourceData;                                      // 0x300(0xa60)
...
{
public:
	struct                                                       AdditionalAngle;                                   // 0x50(0x38)
};
...
{
public:
	struct                                                       MinInitialRotation;                                // 0x50(0xc)
	struct                                                       MaxInitialRotation;                                // 0x5c(0xc)
};
...
public:
	...
	struct                                                       StartSize;                                         // 0x58(0x38)
	struct                                                       AdditionalStartSizes;                              // 0x90(0x38)
...
public:
	...
	struct                                                       Distance;                                          // 0x80(0x38)
	char                                                         TaperMethod;                                       // 0xb8(0x1)
	struct                                                       TaperFactor;                                       // 0xc0(0x38)
	struct                                                       TaperScale;                                        // 0xf8(0x38)
...
public:
	...
	struct                                                       LightmassSettings;                                 // 0x3c(0x14)
};
...
public:
	...
	struct                                                       LocalizationGUID;                                  // 0x2c(0x10)
};
...
public:
	...
	struct                                                       InstancedNavMeshesDataAssetOveride;                // 0x3d8(0x10)
	...
	struct                                                       DefaultColorScale;                                 // 0x438(0xc)
	...
	struct                                                       LightmassSettings;                                 // 0x454(0x44)
	char                                                         LevelLightingQuality;                              // 0x498(0x1)
	struct                                                       DefaultReverbSettings;                             // 0x4a0(0x18)
	struct                                                       DefaultAmbientZoneSettings;                        // 0x4b8(0x24)
...
public:
	...
	struct                                                       LocalizationGUID;                                  // 0x50(0x10)
};
...
{
public:
	struct                                                       StartRotation;                                     // 0x50(0x38)
...
public:
	...
	struct                                                       RelativeLocation;                                  // 0x38(0xc)
	struct                                                       RelativeRotation;                                  // 0x44(0xc)
	struct                                                       RelativeScale;                                     // 0x50(0xc)
...
public:
	...
	struct                                                       Settings;                                          // 0x408(0x18)
	struct                                                       AmbientZoneSettings;                               // 0x420(0x24)
...
{
public:
	struct                                                       StartLocation;                                     // 0x50(0x38)
	struct                                                       AdditionalStartLocations;                          // 0x88(0x38)
...
public:
	...
	struct                                                       FractureMaterialDesc;                              // 0x2c(0x24)
...
{
public:
	struct                                                       SizeMultiplier;                                    // 0x50(0x38)
};
...
{
public:
	struct                                                       AISystemClassName;                                 // 0x28(0x10)
...
public:
	...
	struct                                                       DrawColor;                                         // 0x30(0x4)
	struct                                                       SupportedAgents;                                   // 0x34(0x4)
...
{
public:
	struct                                                       RotationOverLife;                                  // 0x50(0x38)
	bool                                                         Scale;                                             // 0x88(0x1)
};
...
public:
	...
	struct                                                       BoundingBox;                                       // 0x34(0x1c)
	bool                                                         bRelativeToInitialTransform;                       // 0x50(0x1)
	float                                                        BaseFOV;                                           // 0x54(0x4)
	struct                                                       BasePostProcessSettings;                           // 0x60(0x540)
...
public:
	...
	struct                                                       TranslucentSortAxis;                               // 0x60(0xc)
...
{
public:
	struct                                                       SourceMovementScale;                               // 0x50(0x38)
};
...
public:
	...
	struct                                                       ParticleLOD_PlayerViewpointLocation;               // 0x114(0xc)
...
public:
	...
	struct                                                       DefaultTouchInterface;                             // 0x80(0x10)
	struct                                                       ConsoleKey;                                        // 0x90(0x20)
...
public:
	...
	struct                                                       UniversalOffset;                                   // 0x54(0xc)
	...
	struct                                                       NormalToCompare;                                   // 0x84(0xc)
...
public:
	...
	struct                                                       TinyFontName;                                      // 0x38(0x10)
	class Font*                                                  SmallFont;                                         // 0x48(0x8)
	struct                                                       SmallFontName;                                     // 0x50(0x10)
	class Font*                                                  MediumFont;                                        // 0x60(0x8)
	struct                                                       MediumFontName;                                    // 0x68(0x10)
	class Font*                                                  LargeFont;                                         // 0x78(0x8)
	struct                                                       LargeFontName;                                     // 0x80(0x10)
	class Font*                                                  MonoFont;                                          // 0x90(0x8)
	struct                                                       MonoFontName;                                      // 0x98(0x10)
	class Font*                                                  SubtitleFont;                                      // 0xa8(0x8)
	struct                                                       SubtitleFontName;                                  // 0xb0(0x10)
	class Font*                                                  HugeFont;                                          // 0xc0(0x8)
	struct                                                       HugeFontName;                                      // 0xc8(0x10)
	...
	struct                                                       DebugMeshMaterialName;                             // 0x2f0(0x10)
	...
	struct                                                       RemoveSurfaceMaterialName;                         // 0x3b0(0x10)
	...
	struct                                                       ConstraintLimitMaterialName;                       // 0x470(0x10)
	class Material*                                              InvalidLightmapSettingsMaterial;                   // 0x480(0x8)
	struct                                                       InvalidLightmapSettingsMaterialName;               // 0x488(0x10)
	class Material*                                              PreviewShadowsIndicatorMaterial;                   // 0x498(0x8)
	struct                                                       PreviewShadowsIndicatorMaterialName;               // 0x4a0(0x10)
	class Material*                                              ArrowMaterial;                                     // 0x4b0(0x8)
	struct                                                       ArrowMaterialName;                                 // 0x4b8(0x10)
	struct                                                       LightingOnlyBrightness;                            // 0x4c8(0x10)
	...
	struct                                                       LightMapDensityVertexMappedColor;                  // 0x538(0x10)
	struct                                                       LightMapDensitySelectedColor;                      // 0x548(0x10)
	TArray<struct StatColorMapping>                              StatColorMappings;                                 // 0x558(0x10)
	class PhysicalMaterial*                                      DefaultPhysMaterial;                               // 0x568(0x8)
	struct                                                       DefaultPhysMaterialName;                           // 0x570(0x10)
	...
	struct                                                       PreIntegratedSkinBRDFTextureName;                  // 0x5c8(0x10)
	class Texture2D*                                             MiniFontTexture;                                   // 0x5d8(0x8)
	struct                                                       MiniFontTextureName;                               // 0x5e0(0x10)
	class Texture*                                               WeightMapPlaceholderTexture;                       // 0x5f0(0x8)
	struct                                                       WeightMapPlaceholderTextureName;                   // 0x5f8(0x10)
	class Texture2D*                                             LightMapDensityTexture;                            // 0x608(0x8)
	struct                                                       LightMapDensityTextureName;                        // 0x610(0x10)
	...
	struct                                                       SmoothedFrameRateRange;                            // 0x660(0x10)
	...
	struct                                                       C_WorldBox;                                        // 0x6d4(0x4)
	struct                                                       C_BrushWire;                                       // 0x6d8(0x4)
	struct                                                       C_AddWire;                                         // 0x6dc(0x4)
	struct                                                       C_SubtractWire;                                    // 0x6e0(0x4)
	struct                                                       C_SemiSolidWire;                                   // 0x6e4(0x4)
	struct                                                       C_NonSolidWire;                                    // 0x6e8(0x4)
	struct                                                       C_WireBackground;                                  // 0x6ec(0x4)
	struct                                                       C_ScaleBoxHi;                                      // 0x6f0(0x4)
	struct                                                       C_VolumeCollision;                                 // 0x6f4(0x4)
	struct                                                       C_BSPCollision;                                    // 0x6f8(0x4)
	struct                                                       C_OrthoBackground;                                 // 0x6fc(0x4)
	struct                                                       C_Volume;                                          // 0x700(0x4)
	struct                                                       C_BrushShape;                                      // 0x704(0x4)
	...
	struct                                                       PhysicErrorCorrection;                             // 0x768(0x1c)
	...
	struct                                                       DefaultSelectedMaterialColor;                      // 0x794(0x10)
	struct                                                       SelectedMaterialColor;                             // 0x7a4(0x10)
	struct                                                       SelectionOutlineColor;                             // 0x7b4(0x10)
	struct                                                       SubduedSelectionOutlineColor;                      // 0x7c4(0x10)
	struct                                                       SelectedMaterialColorOverride;                     // 0x7d4(0x10)
...
public:
	...
	struct                                                       Pos1;                                              // 0x40(0xc)
	struct                                                       PriAxis1;                                          // 0x4c(0xc)
	struct                                                       SecAxis1;                                          // 0x58(0xc)
	struct                                                       Pos2;                                              // 0x64(0xc)
	struct                                                       PriAxis2;                                          // 0x70(0xc)
	struct                                                       SecAxis2;                                          // 0x7c(0xc)
	...
	struct                                                       DefaultInstance;                                   // 0xe0(0x160)
};
...
public:
	struct FName                                                 SocketName;                                        // 0x28(0x8)
	struct                                                       RelativeLocation;                                  // 0x30(0xc)
	struct                                                       RelativeRotation;                                  // 0x3c(0xc)
	struct                                                       RelativeScale;                                     // 0x48(0xc)
...
public:
	...
	struct                                                       InheritVelocityScale;                              // 0x78(0xc)
...
public:
	...
	struct                                                       InheritSourceVelocityScaleDistribution;            // 0x60(0x38)
...
public:
	...
	struct                                                       StartRotation;                                     // 0x58(0x38)
	struct                                                       AdditionalStartRotation;                           // 0x90(0x38)
};
...
public:
	...
	struct                                                       InstancedNavMeshesDataAsset;                       // 0x3c0(0x10)
...
public:
	...
	struct                                                       StartRotationRate;                                 // 0x58(0x38)
	struct                                                       AdditionalStartRotationRate;                       // 0x90(0x38)
};
...
public:
	char                                                         SourceMethod;                                      // 0x50(0x1)
	struct FName                                                 SourceName;                                        // 0x54(0x8)
	struct                                                       SourceStrength;                                    // 0x60(0x38)
...
{
public:
	struct                                                       Predicate;                                         // 0x1c8(0x38)
	struct                                                       DefaultColour;                                     // 0x200(0x4)
};
...
{
public:
	struct                                                       Location;                                          // 0x50(0x38)
	struct                                                       LocationOffset;                                    // 0x88(0x38)
	struct                                                       ScaleFactor;                                       // 0xc0(0x38)
	struct                                                       Direction;                                         // 0xf8(0x38)
};
...
{
public:
	struct                                                       RandomSeedInfo;                                    // 0x178(0x20)
};
...
public:
	...
	struct                                                       LevelTransform;                                    // 0x80(0x30)
...
{
public:
	struct                                                       LightmassSettings;                                 // 0x28(0x18)
};
...
public:
	...
	struct                                                       FixedRelativeBoundingBox;                          // 0x9c(0x1c)
	bool                                                         bUseLowResTranslucencyBoundingBox;                 // 0xb8(0x1)
	struct                                                       LowResTranslucencyBoundingBox;                     // 0xbc(0x1c)
	...
	struct                                                       MacroUVPosition;                                   // 0xec(0xc)
	float                                                        MacroUVRadius;                                     // 0xf8(0x4)
	char                                                         OcclusionBoundsMethod;                             // 0xfc(0x1)
	struct                                                       CustomOcclusionBounds;                             // 0x100(0x1c)
...
{
public:
	struct                                                       StartRadius;                                       // 0x50(0x38)
	struct                                                       AdditionalStartRadiuses;                           // 0x88(0x38)
	bool                                                         StartRadiusUseGroupAForAll;                        // 0x168(0x1)
	struct                                                       AngleRanges;                                       // 0x16c(0x10)
	float                                                        FirstSliceDistributionWeight;                      // 0x18c(0x4)
	bool                                                         SurfaceOnly;                                       // 0x190(0x1)
	bool                                                         Velocity;                                          // 0x190(0x1)
	struct                                                       VelocityScale;                                     // 0x198(0x38)
	struct                                                       StartLocation;                                     // 0x1d0(0x38)
};
...
public:
	...
	struct                                                       StartColor;                                        // 0x58(0x38)
	struct                                                       AdditionalStartColor;                              // 0x90(0x38)
	bool                                                         bUseGroupAAlphaForAllGroups;                       // 0x1a8(0x1)
	struct                                                       StartAlpha;                                        // 0x1b0(0x38)
	struct                                                       AdditionalStartAlpha;                              // 0x1e8(0x38)
...
{
public:
	struct                                                       Centre;                                            // 0x50(0xc)
	float                                                        Radius;                                            // 0x5c(0x4)
	bool                                                         bUseGroupAForAll;                                  // 0x60(0x1)
	struct                                                       AdditionalParams;                                  // 0x64(0x10)
};
...
{
public:
	struct                                                       StartRotationRate;                                 // 0x50(0x38)
};
...
{
public:
	struct                                                       LifeMultiplier;                                    // 0x50(0x38)
...
public:
	...
	struct                                                       NoiseRange;                                        // 0x60(0x38)
	struct                                                       NoiseRangeScale;                                   // 0x98(0x38)
	bool                                                         bNRScaleEmitterTime;                               // 0xd0(0x1)
	struct                                                       NoiseSpeed;                                        // 0xd8(0x38)
	...
	struct                                                       NoiseTangentStrength;                              // 0x128(0x38)
...
{
public:
	struct                                                       AutomationTestmap;                                 // 0x28(0x10)
	TArray<struct EditorMapPerformanceTestDefinition>            EditorPerformanceTestMaps;                         // 0x38(0x10)
	struct                                                       BuildPromotionTest;                                // 0x48(0x210)
	struct                                                       MaterialEditorPromotionTest;                       // 0x258(0x30)
	struct                                                       ParticleEditorPromotionTest;                       // 0x288(0x10)
...
{
public:
	struct                                                       ColorScaleOverLife;                                // 0x50(0x38)
	struct                                                       AlphaScaleOverLife;                                // 0x88(0x38)
...
public:
	...
	struct                                                       ImportOptions;                                     // 0x70(0xb0)
	...
	struct                                                       CompositeFont;                                     // 0x148(0x28)
};
...
{
public:
	struct                                                       DampingFactor;                                     // 0x50(0x38)
	struct                                                       DampingFactorRotation;                             // 0x88(0x38)
	struct                                                       MaxCollisions;                                     // 0xc0(0x38)
	char                                                         CollisionCompletionOption;                         // 0xf8(0x1)
	TArray<char>                                                 CollisionTypes;                                    // 0x100(0x10)
	bool                                                         bApplyPhysics;                                     // 0x114(0x1)
	struct                                                       ParticleMass;                                      // 0x118(0x38)
...
public:
	...
	struct                                                       IncludeFlags;                                      // 0x38(0x4)
	struct                                                       ExcludeFlags;                                      // 0x3c(0x4)
};
...
{
public:
	struct                                                       AnimationTrack;                                    // 0x78(0x10)
};
...
public:
	...
	struct                                                       DefaultInstance;                                   // 0x90(0x180)
	struct                                                       WalkableSlopeOverride;                             // 0x210(0x8)
	struct                                                       BuildScale3D;                                      // 0x218(0xc)
};
...
public:
	...
	struct                                                       PositionOptions;                                   // 0x54(0x4)
	struct                                                       Position;                                          // 0x58(0x38)
	struct                                                       TangentOptions;                                    // 0x90(0x4)
	struct                                                       Tangent;                                           // 0x98(0x38)
	bool                                                         bAbsoluteTangent;                                  // 0xd0(0x1)
	struct                                                       StrengthOptions;                                   // 0xd4(0x4)
	struct                                                       Strength;                                          // 0xd8(0x38)
};
...
{
public:
	struct                                                       FFTWaterMaterialName;                              // 0x28(0x10)
	struct                                                       FFTWaterFoamTextureName;                           // 0x38(0x10)
...
public:
	...
	struct                                                       RelativeTranslation;                               // 0x58(0xc)
	struct                                                       RelativeRotation;                                  // 0x64(0xc)
	struct                                                       RelativeScale3D;                                   // 0x70(0xc)
...
{
public:
	struct                                                       FacingAxis;                                        // 0x50(0x10)
	bool                                                         bUseGroupAFacingAxisForAllGroups;                  // 0x60(0x1)
	struct                                                       AdditionalFacingAxes;                              // 0x64(0x10)
};
...
{
public:
	struct                                                       StartOffset;                                       // 0x50(0x38)
	struct                                                       Height;                                            // 0x88(0x38)
	struct                                                       Angle;                                             // 0xc0(0x38)
	struct                                                       Thickness;                                         // 0xf8(0x38)
};
...
public:
	struct FName                                                 EmitterName;                                       // 0x50(0x8)
	struct                                                       Range;                                             // 0x58(0x38)
	bool                                                         bStrengthByDistance;                               // 0x90(0x1)
	struct                                                       Strength;                                          // 0x98(0x38)
...
public:
	...
	struct                                                       VelocityScale;                                     // 0x58(0x38)
	struct                                                       StartLocation;                                     // 0x90(0x38)
};
...
{
public:
	struct                                                       DefaultSoundClassName;                             // 0x38(0x10)
	struct                                                       DefaultBaseSoundMix;                               // 0x48(0x10)
	struct                                                       VoiPSoundClass;                                    // 0x58(0x10)
...
{
public:
	struct                                                       Position;                                          // 0x50(0x38)
	struct                                                       Range;                                             // 0x88(0x38)
	struct                                                       Strength;                                          // 0xc0(0x38)
...
{
public:
	struct                                                       PrimaryActorTick;                                  // 0x28(0x50)
	...
	struct                                                       ReplicatedMovement;                                // 0x90(0x38)
	struct                                                       AttachmentReplication;                             // 0xc8(0x48)
	char                                                         Role;                                              // 0x110(0x1)
	...
	struct                                                       ParentComponentActor;                              // 0x1a0(0x8)
...
{
public:
	struct                                                       Resilience;                                        // 0x50(0x38)
	struct                                                       ResilienceScaleOverLife;                           // 0x88(0x38)
...
{
public:
	struct                                                       Location;                                          // 0x28(0xc)
	struct                                                       Rotation;                                          // 0x34(0xc)
...
{
public:
	struct                                                       ColorOverLife;                                     // 0x50(0x38)
	struct                                                       AlphaOverLife;                                     // 0x88(0x38)
...
{
public:
	struct                                                       PrimaryComponentTick;                              // 0x30(0x50)
...
public:
	...
	float                                                        Roll;                                              // 0x68(0x4)
	float                                                        Yaw;                                               // 0x6c(0x4)
	struct                                                       RollPitchYawRange;                                 // 0x70(0x38)
...
public:
	...
	struct                                                       AdjustLeftShoulder_Axis;                           // 0xe8(0xc)
	float                                                        AdjustLeftShoulder_Angle;                          // 0xf4(0x4)
	bool                                                         AdjustRightShoulder;                               // 0xf8(0x1)
	struct                                                       AdjustRightShoulder_Axis;                          // 0xfc(0xc)
	...
	struct                                                       ImportRotator;                                     // 0x128(0xc)
};
...
public:
	...
	struct                                                       DefaultCursor;                                     // 0x40(0x10)
	struct                                                       TextEditBeamCursor;                                // 0x50(0x10)
	struct                                                       CrosshairsCursor;                                  // 0x60(0x10)
	struct                                                       GrabHandCursor;                                    // 0x70(0x10)
	struct                                                       GrabHandClosedCursor;                              // 0x80(0x10)
	struct                                                       SlashedCircleCursor;                               // 0x90(0x10)
	float                                                        ApplicationScale;                                  // 0xa0(0x4)
	char                                                         UIScaleRule;                                       // 0xa4(0x1)
	struct                                                       CustomScalingRuleClass;                            // 0xa8(0x10)
	struct                                                       UIScaleCurve;                                      // 0xb8(0x80)
...
{
public:
	struct                                                       CheckBoxStyle;                                     // 0x28(0x5f0)
};
...
public:
	...
	struct                                                       RotOscillation;                                    // 0x38(0x24)
	struct                                                       LocOscillation;                                    // 0x5c(0x24)
	struct                                                       FOVOscillation;                                    // 0x80(0xc)
...
{
public:
	struct                                                       ResetLocation;                                     // 0x28(0xc)
	struct                                                       ResetRotation;                                     // 0x34(0xc)
};
...
{
public:
	struct                                                       SubImageIndex;                                     // 0x50(0x38)
...
{
public:
	struct                                                       EndPoint0;                                         // 0x50(0xc)
	struct                                                       EndPoint1;                                         // 0x5c(0xc)
	struct                                                       Range;                                             // 0x68(0x38)
	struct                                                       Strength;                                          // 0xa0(0x38)
};
...
{
public:
	struct                                                       LowerLeftCorner;                                   // 0x50(0x38)
	struct                                                       UpperRightCorner;                                  // 0x88(0x38)
...
public:
	...
	struct                                                       BlueprintGuid;                                     // 0x3c(0x10)
};
...
{
public:
	struct                                                       HapticDetails;                                     // 0x28(0x100)
};
...
public:
	...
	struct                                                       ColorScaleOverLife;                                // 0x58(0x38)
	struct                                                       BrightnessOverLife;                                // 0x90(0x38)
	struct                                                       RadiusScale;                                       // 0xc8(0x38)
	struct                                                       LightExponent;                                     // 0x100(0x38)
};
...
{
public:
	struct                                                       SupportedAgents;                                   // 0x400(0x4)
...
public:
	...
	struct                                                       LifeTime;                                          // 0x58(0x38)
	struct                                                       AdditionalLifetimes;                               // 0x90(0x38)
};
...
{
public:
	struct                                                       SpeedScale;                                        // 0x50(0x8)
	struct                                                       MaxScale;                                          // 0x58(0x8)
};
...
public:
	...
	struct                                                       PositiveBoundsExtension;                           // 0xd0(0xc)
	struct                                                       NegativeBoundsExtension;                           // 0xdc(0xc)
	struct                                                       ExtendedBounds;                                    // 0xe8(0x1c)
...
public:
	...
	struct                                                       InfluenceOnAcceleration;                           // 0x58(0x38)
	struct                                                       InfluenceOnVelocity;                               // 0x90(0x38)
};
...
{
public:
	struct                                                       StartRadius;                                       // 0xc8(0x38)
	struct                                                       AdditionalStartRadius;                             // 0x100(0x38)
	bool                                                         bUseGroupAStartRadiusForAllGroups;                 // 0x1e0(0x1)
	struct                                                       AdditionalVelocityScales;                          // 0x1e8(0x38)
	bool                                                         bUseGroupAVelocityScaleForAllGroups;               // 0x2c8(0x1)
	struct                                                       AdditionalStartLocations;                          // 0x2d0(0x38)
...
public:
	...
	struct                                                       ParentLightingGuid;                                // 0x70(0x10)
	...
	struct                                                       BasePropertyOverrides;                             // 0xc0(0x84)
};
...
{
public:
	struct                                                       DialogueWaveParameter;                             // 0x38(0x20)
...
public:
	...
	struct                                                       LastRemoteNoisePosition;                           // 0xcc(0xc)
...
{
public:
	struct                                                       PosTrack;                                          // 0x70(0x18)
	struct                                                       EulerTrack;                                        // 0x88(0x18)
	struct                                                       LookupTrack;                                       // 0xa0(0x10)
...
public:
	struct                                                       A;                                                 // 0x70(0x38)
	struct                                                       B;                                                 // 0xa8(0x38)
	struct                                                       IfTrue;                                            // 0xe0(0x38)
	struct                                                       IfFalse;                                           // 0x118(0x38)
...
{
public:
	struct                                                       LinearColorTrack;                                  // 0x70(0x18)
	float                                                        CurveTension;                                      // 0x88(0x4)
};
...
{
public:
	struct                                                       InOpacity;                                         // 0x70(0x38)
	struct                                                       FadeDistance;                                      // 0xa8(0x38)
...
{
public:
	struct                                                       ExponentIn;                                        // 0x70(0x38)
	float                                                        Exponent;                                          // 0xa8(0x4)
	struct                                                       BaseReflectFractionIn;                             // 0xb0(0x38)
	float                                                        BaseReflectFraction;                               // 0xe8(0x4)
	struct                                                       Normal;                                            // 0xf0(0x38)
};
...
{
public:
	struct                                                       Coordinate;                                        // 0x70(0x38)
	struct                                                       Time;                                              // 0xa8(0x38)
...
{
public:
	struct                                                       RandomSeedInfo;                                    // 0x88(0x20)
};
...
{
public:
	struct                                                       RandomSeedInfo;                                    // 0x1a8(0x20)
};
...
{
public:
	struct                                                       SpawnCount;                                        // 0x60(0x38)
	struct                                                       AdditionalSpawnCounts;                             // 0x98(0x38)
	...
	struct                                                       InheritVelocityScale;                              // 0x1b8(0x38)
};
...
public:
	...
	struct                                                       PostProcessSettings;                               // 0x3f0(0x540)
};
...
{
public:
	struct                                                       Default;                                           // 0x70(0x38)
	struct                                                       StaticIndirect;                                    // 0xa8(0x38)
	struct                                                       DynamicIndirect;                                   // 0xe0(0x38)
};
...
{
public:
	struct                                                       RandomSeedInfo;                                    // 0x1b0(0x20)
};
...
public:
	class PhysicalMaterial*                                      PhysMaterial;                                      // 0x58(0x8)
	struct                                                       DiffuseColor;                                      // 0x60(0x40)
	struct                                                       SpecularColor;                                     // 0xa0(0x40)
	struct                                                       BaseColor;                                         // 0xe0(0x40)
	struct                                                       Metallic;                                          // 0x120(0x40)
	struct                                                       Specular;                                          // 0x160(0x40)
	struct                                                       Roughness;                                         // 0x1a0(0x40)
	struct                                                       Normal;                                            // 0x1e0(0x48)
	struct                                                       EmissiveColor;                                     // 0x228(0x40)
	struct                                                       Opacity;                                           // 0x268(0x40)
	struct                                                       OpacityMask;                                       // 0x2a8(0x40)
	...
	struct                                                       WorldPositionOffset;                               // 0x318(0x48)
	struct                                                       WorldDisplacement;                                 // 0x360(0x48)
	struct                                                       TessellationMultiplier;                            // 0x3a8(0x40)
	struct                                                       SubsurfaceColor;                                   // 0x3e8(0x40)
	struct                                                       ClearCoat;                                         // 0x428(0x40)
	struct                                                       ClearCoatRoughness;                                // 0x468(0x40)
	struct                                                       AmbientOcclusion;                                  // 0x4a8(0x40)
	struct                                                       Refraction;                                        // 0x4e8(0x40)
	struct                                                       BillboardColor;                                    // 0x528(0x40)
	struct                                                       BillboardParams;                                   // 0x568(0x48)
	struct                                                       CustomizedUVs;                                     // 0x5b0(0x48)
	struct                                                       MaterialAttributes;                                // 0x7f0(0x38)
	struct                                                       PixelDepthOffset;                                  // 0x838(0x40)
	...
	struct                                                       TranslucentMultipleScatteringExtinction;           // 0x8d4(0x10)
...
{
public:
	struct                                                       ConstantCurve;                                     // 0x38(0x18)
};
...
public:
	struct                                                       Coordinate;                                        // 0x70(0x38)
	struct                                                       Height;                                            // 0xa8(0x38)
	struct                                                       HeightRatioInput;                                  // 0xe0(0x38)
...
public:
	struct                                                       StartRadius;                                       // 0xc8(0x38)
	struct                                                       AdditionalStartRadiuses;                           // 0x100(0x38)
	bool                                                         StartRadiusUseGroupAForAll;                        // 0x1e0(0x1)
	struct                                                       PositiveXAngleRange;                               // 0x1e4(0x8)
	struct                                                       NegativeXAngleRange;                               // 0x1ec(0x8)
	struct                                                       PositiveYAngleRange;                               // 0x1f4(0x8)
	struct                                                       NegativeYAngleRange;                               // 0x1fc(0x8)
	struct                                                       PositiveZAngleRange;                               // 0x204(0x8)
	struct                                                       NegativeZAngleRange;                               // 0x20c(0x8)
};
...
public:
	struct                                                       Input;                                             // 0x70(0x38)
	struct                                                       Min;                                               // 0xa8(0x38)
	struct                                                       Max;                                               // 0xe0(0x38)
...
public:
	...
	struct                                                       ControlInputVector;                                // 0x420(0xc)
	struct                                                       LastControlInputVector;                            // 0x42c(0xc)
};
...
{
public:
	struct                                                       BaseColor;                                         // 0x70(0x38)
	struct                                                       Metallic;                                          // 0xa8(0x38)
	struct                                                       Specular;                                          // 0xe0(0x38)
	struct                                                       Roughness;                                         // 0x118(0x38)
	struct                                                       EmissiveColor;                                     // 0x150(0x38)
	struct                                                       Opacity;                                           // 0x188(0x38)
	struct                                                       OpacityMask;                                       // 0x1c0(0x38)
	struct                                                       Normal;                                            // 0x1f8(0x38)
	struct                                                       WorldPositionOffset;                               // 0x230(0x38)
	struct                                                       WorldDisplacement;                                 // 0x268(0x38)
	struct                                                       TessellationMultiplier;                            // 0x2a0(0x38)
	struct                                                       SubsurfaceColor;                                   // 0x2d8(0x38)
	struct                                                       ClearCoat;                                         // 0x310(0x38)
	struct                                                       ClearCoatRoughness;                                // 0x348(0x38)
	struct                                                       AmbientOcclusion;                                  // 0x380(0x38)
	struct                                                       Refraction;                                        // 0x3b8(0x38)
	struct                                                       CustomizedUVs;                                     // 0x3f0(0x38)
	struct                                                       PixelDepthOffset;                                  // 0x5b0(0x38)
};
...
{
public:
	struct                                                       RandomSeedInfo;                                    // 0x138(0x20)
};
...
public:
	...
	struct                                                       NavDataConfig;                                     // 0x3d0(0x58)
...
public:
	...
	struct                                                       Input;                                             // 0x78(0x38)
	struct                                                       OffsetFraction;                                    // 0xb0(0x38)
	struct                                                       ConstInput;                                        // 0xe8(0x8)
};
...
{
public:
	struct                                                       WorldPosition;                                     // 0x70(0x38)
};
...
public:
	...
	struct                                                       EmitterOrigin;                                     // 0x70(0xc)
	bool                                                         EmitterOriginUseGroupAForAll;                      // 0x7c(0x1)
	struct                                                       AdditionalEmitterOrigins;                          // 0x80(0xc)
	struct                                                       EmitterRotation;                                   // 0xbc(0xc)
	...
	struct                                                       LoopTime;                                          // 0xf8(0x38)
	struct                                                       LoopOffset;                                        // 0x130(0x38)
	struct                                                       LoopTimeForSubUV;                                  // 0x168(0x38)
	float                                                        LoopBeginTime;                                     // 0x1a0(0x4)
	float                                                        LoopEndTime;                                       // 0x1a4(0x4)
	struct                                                       SpawnRate;                                         // 0x1a8(0x38)
...
{
public:
	struct                                                       Base;                                              // 0x70(0x38)
	struct                                                       Exponent;                                          // 0xa8(0x38)
...
{
public:
	struct                                                       RandomSeedInfo;                                    // 0x1c0(0x20)
};
...
{
public:
	struct                                                       PitchModulationParams;                             // 0x38(0x20)
	struct                                                       VolumeModulationParams;                            // 0x58(0x20)
};
...
{
public:
	struct                                                       NormalizedRotationAxis;                            // 0x70(0x38)
	struct                                                       RotationAngle;                                     // 0xa8(0x38)
	struct                                                       PivotPoint;                                        // 0xe0(0x38)
	struct                                                       Position;                                          // 0x118(0x38)
...
{
public:
	struct                                                       Struct;                                            // 0x70(0x38)
	struct                                                       MaterialAttributes;                                // 0xa8(0x38)
};
...
public:
	...
	struct                                                       ExpressionGUID;                                    // 0x78(0x10)
...
{
public:
	struct                                                       CustomWorldNormal;                                 // 0x70(0x38)
...
{
public:
	struct                                                       RandomSeedInfo;                                    // 0x308(0x20)
};
...
public:
	...
	struct                                                       StartRadius;                                       // 0xd0(0x38)
	struct                                                       AdditionalStartRadiuses;                           // 0x108(0x38)
	bool                                                         StartRadiusUseGroupAForAll;                        // 0x1e8(0x1)
	struct                                                       RadiusScale;                                       // 0x1ec(0x8)
	struct                                                       StartHeight;                                       // 0x1f8(0x38)
	bool                                                         StartHeightUseGroupAForAll;                        // 0x230(0x1)
	struct                                                       AdditionalStartHeights;                            // 0x238(0x38)
	struct                                                       AngleRange;                                        // 0x318(0x8)
	struct                                                       AdditionalAngleRanges;                             // 0x320(0x8)
...
{
public:
	struct                                                       DefaultDestructibleParameters;                     // 0x238(0x88)
...
public:
	...
	struct                                                       NavAgentProps;                                     // 0x3ec(0x30)
	struct                                                       QueryingExtent;                                    // 0x41c(0xc)
	class NavigationData*                                        MyNavData;                                         // 0x428(0x8)
	struct                                                       ProjectedLocation;                                 // 0x430(0xc)
	...
	struct                                                       TextCanvasOffset;                                  // 0x444(0x8)
...
public:
	...
	struct                                                       AttenuationOverrides;                              // 0x40(0xc0)
...
public:
	struct                                                       A;                                                 // 0x70(0x38)
	struct                                                       B;                                                 // 0xa8(0x38)
	struct                                                       AGreaterThanB;                                     // 0xe0(0x38)
	struct                                                       AEqualsB;                                          // 0x118(0x38)
	struct                                                       ALessThanB;                                        // 0x150(0x38)
...
public:
	struct                                                       Input;                                             // 0x70(0x38)
	struct                                                       Fraction;                                          // 0xa8(0x38)
	struct                                                       LuminanceFactors;                                  // 0xe0(0x10)
};
...
public:
	...
	struct                                                       ControlRotation;                                   // 0x3f8(0xc)
...
public:
	...
	struct                                                       BlendSpaceInput;                                   // 0x450(0xc)
	TArray<struct BlendSampleData>                               BlendSampleData;                                   // 0x460(0x10)
	struct                                                       BlendFilter;                                       // 0x470(0x90)
...
{
public:
	struct                                                       RandomSeedInfo;                                    // 0x90(0x20)
};
...
{
public:
	struct                                                       WhiteColor;                                        // 0x3c8(0x4)
	struct                                                       GreenColor;                                        // 0x3cc(0x4)
	struct                                                       RedColor;                                          // 0x3d0(0x4)
...
public:
	...
	struct                                                       LocationOffset;                                    // 0x40(0xc)
	struct                                                       RotationOffset;                                    // 0x4c(0xc)
...
{
public:
	struct                                                       BlendParameters;                                   // 0x50(0x20)
	struct                                                       InterpolationParam;                                // 0xb0(0x8)
...
{
public:
	struct                                                       Shadow;                                            // 0x70(0x38)
	struct                                                       NotShadow;                                         // 0xa8(0x38)
};
...
public:
	struct                                                       A;                                                 // 0x70(0x38)
	struct                                                       B;                                                 // 0xa8(0x38)
	struct                                                       Radius;                                            // 0xe0(0x38)
	struct                                                       Hardness;                                          // 0x118(0x38)
...
{
public:
	struct                                                       RandomSeedInfo;                                    // 0x68(0x20)
};
...
public:
	...
	struct                                                       AttenuationOverrides;                              // 0x68(0xc0)
};
...
public:
	class ParticleComputeShaderData*                             PositionData;                                      // 0xc8(0x8)
	struct                                                       ComputedVelocityScale;                             // 0xd0(0x38)
	float                                                        SpeedCap;                                          // 0x108(0x4)
	struct                                                       BaseVelocity;                                      // 0x110(0x38)
	struct                                                       LocationOffset;                                    // 0x148(0x38)
	struct                                                       LocationOffsetScaledDirection;                     // 0x180(0x38)
};
...
public:
	...
	struct                                                       CameraCache;                                       // 0x440(0x5b0)
	struct                                                       LastFrameCameraCache;                              // 0x9f0(0x5b0)
	struct                                                       ViewTarget;                                        // 0xfa0(0x5c0)
	struct                                                       PendingViewTarget;                                 // 0x1560(0x5c0)
	...
	struct                                                       FreeCamOffset;                                     // 0x1b74(0xc)
	struct                                                       ViewTargetOffset;                                  // 0x1b80(0xc)
...
public:
	...
	struct                                                       RelativeLocation;                                  // 0x108(0xc)
	struct                                                       RelativeRotation;                                  // 0x114(0xc)
	struct                                                       RelativeScale3D;                                   // 0x120(0xc)
	char                                                         Mobility;                                          // 0x230(0x1)
	char                                                         DetailMode;                                        // 0x231(0x1)
	struct                                                       ComponentVelocity;                                 // 0x23c(0xc)
...
{
public:
	struct                                                       Realtime;                                          // 0x70(0x38)
	struct                                                       Lightmass;                                         // 0xa8(0x38)
};
...
public:
	...
	struct                                                       VolumeCurve;                                       // 0x60(0x80)
	struct                                                       PitchCurve;                                        // 0xe0(0x80)
...
public:
	...
	struct                                                       LinkRelativeStart;                                 // 0x118(0xc)
	struct                                                       LinkRelativeEnd;                                   // 0x124(0xc)
	...
	struct                                                       ObstacleOffset;                                    // 0x138(0xc)
	struct                                                       ObstacleExtent;                                    // 0x144(0xc)
...
{
public:
	struct                                                       Acceleration;                                      // 0x58(0x38)
	struct                                                       AdditionalAcceleration;                            // 0x90(0x38)
...
public:
	...
	struct                                                       StartVelocity;                                     // 0x60(0x38)
	struct                                                       AdditionalStartVelocities;                         // 0x98(0x38)
	struct                                                       StartVelocityRadial;                               // 0x1b0(0x38)
};
...
public:
	...
	struct                                                       VelocityComponentsWeights;                         // 0x70(0xc)
	struct                                                       SpawnRateOverSpeedScale;                           // 0x80(0x38)
	struct                                                       LifetimeOverSpeedScale;                            // 0xb8(0x38)
	struct                                                       SizeOverSpeedScale;                                // 0xf0(0x38)
	struct                                                       InitialVelocityOverSpeedScale;                     // 0x128(0x38)
	struct                                                       OpacityOverSpeedScale;                             // 0x160(0x38)
};
...
public:
	...
	struct                                                       PostProcessSettings;                               // 0x300(0x540)
...
{
public:
	struct                                                       AccelerationScale;                                 // 0x58(0x38)
...
public:
	...
	struct                                                       SocketOffset;                                      // 0x2e4(0xc)
	struct                                                       TargetOffset;                                      // 0x2f0(0xc)
...
public:
	...
	struct                                                       MinInput;                                          // 0x58(0xc)
	struct                                                       MaxInput;                                          // 0x64(0xc)
	struct                                                       MinOutput;                                         // 0x70(0xc)
	struct                                                       MaxOutput;                                         // 0x7c(0xc)
...
public:
	...
	struct                                                       CompressedScaleOffsets;                            // 0xe8(0x18)
...
public:
	...
	struct                                                       FogVelocity;                                       // 0x308(0xc)
	struct                                                       NoisePrimaryScale;                                 // 0x314(0xc)
	struct                                                       NoiseSecondaryScale;                               // 0x320(0xc)
	...
	struct                                                       DensityMapScale;                                   // 0x358(0xc)
	struct                                                       DensityMapOffset;                                  // 0x364(0xc)
	struct                                                       DensityMapActiveHemisphereOrigin;                  // 0x370(0xc)
	struct                                                       DensityMapActiveHemisphereDirection;               // 0x37c(0xc)
	...
	struct                                                       MeshFogNoisePrimaryScale;                          // 0x3a8(0xc)
	struct                                                       MeshFogNoiseSecondaryScale;                        // 0x3b4(0xc)
	float                                                        MeshFogNoiseBlend;                                 // 0x3c0(0x4)
	struct                                                       MeshFogVelocity;                                   // 0x3c4(0xc)
...
public:
	...
	struct                                                       CustomPrimitiveData;                               // 0x330(0x10)
	struct                                                       BodyInstance;                                      // 0x340(0x180)
	...
	struct                                                       PostPhysicsComponentTick;                          // 0x570(0x50)
...
{
public:
	struct                                                       AccelOverLife;                                     // 0x58(0x38)
};
...
public:
	...
	struct                                                       BasedMovement;                                     // 0x458(0x38)
	struct                                                       ReplicatedBasedMovement;                           // 0x490(0x38)
	struct                                                       BaseTranslationOffset;                             // 0x4c8(0xc)
	struct                                                       BaseRotationOffset;                                // 0x4e0(0x10)
...
{
public:
	struct                                                       LightGuid;                                         // 0x2e0(0x10)
	float                                                        Brightness;                                        // 0x2f0(0x4)
	float                                                        Intensity;                                         // 0x2f4(0x4)
	struct                                                       LightColor;                                        // 0x2f8(0x4)
...
public:
	...
	struct                                                       FogInscatteringColor;                              // 0x2e4(0x10)
	struct                                                       FarFogInscatteringColor;                           // 0x2f4(0x10)
	...
	struct                                                       DirectionalInscatteringColor;                      // 0x314(0x10)
...
{
public:
	struct                                                       NavAgentProps;                                     // 0x110(0x30)
	bool                                                         bUpdateNavAgentWithOwnersCollision;                // 0x140(0x1)
	struct                                                       MovementState;                                     // 0x144(0x4)
...
public:
	...
	struct                                                       OffsetAmount;                                      // 0x60(0x38)
	struct                                                       OffsetOptions;                                     // 0x98(0x4)
	struct                                                       RotationAmount;                                    // 0xa0(0x38)
	struct                                                       RotationOptions;                                   // 0xd8(0x4)
	struct                                                       RotationRateAmount;                                // 0xe0(0x38)
	struct                                                       RotationRateOptions;                               // 0x118(0x4)
};
...
{
public:
	struct                                                       DynamicParamScaleOverCustomScale;                  // 0x68(0x38)
	struct                                                       SpawnRateOverCustomScale;                          // 0xa0(0x38)
	struct                                                       LifetimeOverCustomScale;                           // 0xd8(0x38)
	struct                                                       SizeOverCustomScale;                               // 0x110(0x38)
	struct                                                       InitialVelocityOverCustomScale;                    // 0x148(0x38)
	struct                                                       OpacityOverCustomScale;                            // 0x180(0x38)
	struct                                                       CylinderRadiusOverCustomScale;                     // 0x1b8(0x38)
};
...
public:
	...
	struct                                                       FailsafeExtent;                                    // 0x100(0xc)
};
...
public:
	...
	struct                                                       TargetViewRotation;                                // 0x46c(0xc)
	TArray<class Actor*>                                         HiddenActors;                                      // 0x488(0x10)
	float                                                        LastSpectatorStateSynchTime;                       // 0x498(0x4)
	struct                                                       LastSpectatorSyncLocation;                         // 0x49c(0xc)
	struct                                                       LastSpectatorSyncRotation;                         // 0x4a8(0xc)
	...
	struct                                                       SpawnLocation;                                     // 0x6a0(0xc)
...
public:
	...
	struct                                                       ExpressionGUID;                                    // 0x88(0x10)
...
{
public:
	struct                                                       Scale;                                             // 0x58(0x38)
	struct                                                       CustomParentScale;                                 // 0x90(0x38)
...
{
public:
	struct                                                       Coordinates;                                       // 0x80(0x38)
	struct                                                       TextureObject;                                     // 0xb8(0x38)
	struct                                                       MipValue;                                          // 0xf0(0x38)
	struct                                                       CoordinatesDX;                                     // 0x128(0x38)
	struct                                                       CoordinatesDY;                                     // 0x160(0x38)
...
{
public:
	struct                                                       RotationRate;                                      // 0x110(0xc)
	struct                                                       PivotTranslation;                                  // 0x11c(0xc)
...
public:
	...
	struct                                                       AttenuationOverrides;                              // 0x328(0xc0)
...
{
public:
	struct                                                       RandomSeedInfo;                                    // 0x218(0x20)
};
...
public:
	...
	struct                                                       PreviousHitNormal;                                 // 0x120(0xc)
...
public:
	...
	struct                                                       ReflectionTint;                                    // 0x2f0(0x10)
	struct                                                       StateId;                                           // 0x30c(0x10)
};
...
{
public:
	struct                                                       RandomSeedInfo;                                    // 0x348(0x20)
};
...
{
public:
	struct                                                       RandomSeedInfo;                                    // 0x1e8(0x20)
};
...
public:
	...
	struct                                                       TextRenderColor;                                   // 0x614(0x4)
...
public:
	...
	struct                                                       PostProcessSettings;                               // 0x360(0x540)
...
public:
	...
	struct                                                       LightFunctionScale;                                // 0x340(0xc)
...
{
public:
	struct                                                       SplineInfo;                                        // 0x5c8(0x18)
	struct                                                       SplineRotInfo;                                     // 0x5e0(0x18)
	struct                                                       SplineScaleInfo;                                   // 0x5f8(0x18)
	struct                                                       SplineReparamTable;                                // 0x610(0x18)
	...
	struct                                                       DefaultUpVector;                                   // 0x638(0xc)
};
...
public:
	...
	struct                                                       EmitterPointParameter;                             // 0x608(0x50)
	...
	struct                                                       OldPosition;                                       // 0x698(0xc)
	struct                                                       PartSysVelocity;                                   // 0x6a4(0xc)
	struct                                                       CustomInheritedVelocity;                           // 0x6c8(0xc)
	float                                                        CustomParameterDrivingCurves;                      // 0x6e8(0x4)
	struct                                                       ColourTint;                                        // 0x6ec(0x10)
...
public:
	...
	struct                                                       ExpressionGUID;                                    // 0x1b0(0x10)
...
{
public:
	struct                                                       Predicate;                                         // 0x1a8(0x38)
	struct                                                       DefaultColour;                                     // 0x1e0(0x4)
};
...
public:
	...
	struct                                                       OcclusionTint;                                     // 0x334(0x4)
...
{
public:
	struct                                                       WaterParams;                                       // 0x5d8(0x310)
...
public:
	...
	struct                                                       WireframeColorOverride;                            // 0x5f4(0x4)
...
public:
	...
	struct                                                       LightShaftOverrideDirection;                       // 0x474(0xc)
	...
	struct                                                       LightmassSettings;                                 // 0x4c8(0x10)
	bool                                                         bCastModulatedShadows;                             // 0x4d8(0x1)
	struct                                                       ModulatedShadowColor;                              // 0x4dc(0x4)
...
public:
	...
	struct                                                       WireframeColor;                                    // 0x68c(0x4)
	...
	struct                                                       CachedLocalBounds;                                 // 0x6cc(0x1c)
...
public:
	...
	struct                                                       LightmassSettings;                                 // 0x49c(0xc)
};
...
public:
	...
	struct                                                       Acceleration;                                      // 0x280(0xc)
	struct                                                       LastUpdateLocation;                                // 0x28c(0xc)
	struct                                                       PendingImpulseToApply;                             // 0x298(0xc)
	struct                                                       PendingForceToApply;                               // 0x2a4(0xc)
	...
	struct                                                       CurrentFloor;                                      // 0x308(0x8c)
	...
	struct                                                       RequestedVelocity;                                 // 0x3b8(0xc)
	int                                                          AvoidanceUID;                                      // 0x3c4(0x4)
	struct                                                       AvoidanceGroup;                                    // 0x3c8(0x4)
	struct                                                       GroupsToAvoid;                                     // 0x3cc(0x4)
	struct                                                       GroupsToIgnore;                                    // 0x3d0(0x4)
	float                                                        AvoidanceWeight;                                   // 0x3d4(0x4)
	struct                                                       PendingLaunchVelocity;                             // 0x3d8(0xc)
	...
	struct                                                       PreClothComponentTick;                             // 0x4d0(0x50)
	float                                                        MinTimeBetweenTimeStampResets;                     // 0x534(0x4)
	struct                                                       RootMotionParams;                                  // 0x540(0x40)
...
public:
	...
	struct                                                       InstanceRotation;                                  // 0x64c(0xc)
	struct                                                       InstanceRotationVariance;                          // 0x658(0xc)
	struct                                                       InstanceAttractionDirection;                       // 0x664(0xc)
...
// Size 0x80 (Full Size[0x6b0] - InheritedSize[0x630]
class MobileInstancedStaticMeshComponent: public StaticMeshComponent
{
public:
	int                                                          MaxInstances;                                      // 0x630(0x4)
	TArray<struct Transform>                                     InstanceTransforms;                                // 0x640(0x10)
	TArray<struct Matrix>                                        InstanceMatrices;                                  // 0x650(0x10)
	struct                                                       LocalBounds;                                       // 0x660(0x1c)
	bool                                                         bBoundsBuilt;                                      // 0x67c(0x1)
	class PhysicsSerializer*                                     PhysicsSerializer;                                 // 0x680(0x8)
};
...
{
public:
	struct                                                       SplineParams;                                      // 0x638(0x58)
	struct                                                       SplineUpDir;                                       // 0x690(0xc)
	...
	struct                                                       CachedMeshBodySetupGuid;                           // 0x6b8(0x10)
...
public:
	...
	struct                                                       AnimationData;                                     // 0x728(0x20)
	...
	struct                                                       RootBoneTranslation;                               // 0x7c0(0xc)
	...
	struct                                                       LineCheckBoundsScale;                              // 0x7dc(0xc)
...
public:
	...
	struct                                                       BuiltInstanceBounds;                               // 0x734(0x1c)
	struct                                                       UnbuiltInstanceBounds;                             // 0x750(0x1c)
