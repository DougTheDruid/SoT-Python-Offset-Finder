...
public:
	...
	char                                                         pad0x7_IQ1MT[0x7];                                 // 0x29(0x7)
...
public:
	...
	char                                                         pad0x4_R8KKD[0x4];                                 // 0x134(0x4)
};
...
{
public:
	char                                                         pad0x50_UOIMI[0x50];                               // 0x28(0x50)
};
...
public:
	...
	char                                                         pad0xa0_0EOOB[0xa0];                               // 0x38(0xa0)
};
...
public:
	...
	char                                                         pad0x4_HBM2M[0x4];                                 // 0x2c(0x4)
...
{
public:
	char                                                         pad0x80_HES8T[0x80];                               // 0x148(0x80)
	bool                                                         bDuplicated;                                       // 0x1c8(0x1)
	char                                                         pad0x7_3GWF7[0x7];                                 // 0x1c9(0x7)
...
public:
	...
	char                                                         pad0x4_XS3OG[0x4];                                 // 0x23c(0x4)
