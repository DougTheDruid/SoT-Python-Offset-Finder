...
public:
	...
	char                                                         pad0xa0_QR578[0xa0];                               // 0x38(0xa0)
};
...
public:
	...
	char                                                         pad0x7_PTM0R[0x7];                                 // 0x29(0x7)
...
{
public:
	char                                                         pad0x50_F4QOV[0x50];                               // 0x28(0x50)
};
...
public:
	...
	char                                                         pad0x4_YAW7B[0x4];                                 // 0x2c(0x4)
...
{
public:
	char                                                         pad0x80_01HB6[0x80];                               // 0x148(0x80)
	bool                                                         bDuplicated;                                       // 0x1c8(0x1)
	char                                                         pad0x7_WZNIN[0x7];                                 // 0x1c9(0x7)
...
public:
	...
	char                                                         pad0x4_WZ8FX[0x4];                                 // 0x134(0x4)
};
...
public:
	...
	char                                                         pad0x4_A1EB9[0x4];                                 // 0x23c(0x4)
