...
public:
	...
	char                                                         pad0x4_TGXTS[0x4];                                 // 0x2c(0x4)
...
public:
	...
	char                                                         pad0x7_XAHVI[0x7];                                 // 0x29(0x7)
...
{
public:
	char                                                         pad0xa0_PBZCJ[0xa0];                               // 0x28(0xa0)
...
public:
	...
	char                                                         pad0x4_4DSWL[0x4];                                 // 0x134(0x4)
};
...
{
public:
	char                                                         pad0x80_ZXIY9[0x80];                               // 0x140(0x80)
	bool                                                         bDuplicated;                                       // 0x1c0(0x1)
	char                                                         pad0x7_OOI0Q[0x7];                                 // 0x1c1(0x7)
...
public:
	...
	char                                                         pad0x4_HOTRG[0x4];                                 // 0x234(0x4)
