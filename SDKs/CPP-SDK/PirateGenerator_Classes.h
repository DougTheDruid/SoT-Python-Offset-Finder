...
{
public:
	char                                                         pad0x50_KMPF0[0x50];                               // 0x28(0x50)
};
...
public:
	...
	char                                                         pad0x4_ZIRO1[0x4];                                 // 0x134(0x4)
};
...
public:
	...
	char                                                         pad0x7_1PYRK[0x7];                                 // 0x29(0x7)
...
{
public:
	char                                                         pad0x80_1ULNG[0x80];                               // 0x148(0x80)
	bool                                                         bDuplicated;                                       // 0x1c8(0x1)
	char                                                         pad0x7_K1501[0x7];                                 // 0x1c9(0x7)
...
{
public:
	char                                                         pad0xa0_L39IB[0xa0];                               // 0x28(0xa0)
...
public:
	...
	char                                                         pad0x4_HR1TF[0x4];                                 // 0x2c(0x4)
...
public:
	...
	char                                                         pad0x4_W8OGG[0x4];                                 // 0x23c(0x4)
