...
{
public:
	char                                                         pad0x50_Z39K6[0x50];                               // 0x28(0x50)
};
...
public:
	...
	char                                                         pad0x4_MME8J[0x4];                                 // 0x2c(0x4)
...
{
public:
	char                                                         pad0x80_JDTXC[0x80];                               // 0x148(0x80)
	bool                                                         bDuplicated;                                       // 0x1c8(0x1)
	char                                                         pad0x7_SRR37[0x7];                                 // 0x1c9(0x7)
...
public:
	...
	char                                                         pad0x4_SIU9N[0x4];                                 // 0x134(0x4)
};
...
{
public:
	char                                                         pad0xa0_394ZT[0xa0];                               // 0x28(0xa0)
...
public:
	...
	char                                                         pad0x7_7NZDR[0x7];                                 // 0x29(0x7)
...
public:
	...
	char                                                         pad0x4_BXQAR[0x4];                                 // 0x23c(0x4)
