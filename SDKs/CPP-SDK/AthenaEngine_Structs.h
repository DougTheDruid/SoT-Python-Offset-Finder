...
{
public:
	char                                                         pad0x8_468SY[0x8];                                 // 0x0(0x8)
	class ScriptStruct*                                          Type;                                              // 0x8(0x8)
	char                                                         pad0x8_C1HDC[0x8];                                 // 0x10(0x8)
};
...
{
public:
	char                                                         pad0x18_HHTDG[0x18];                               // 0x0(0x18)
	class WwiseEvent*                                            WwiseEvent;                                        // 0x18(0x8)
	bool                                                         PlayOnTarget;                                      // 0x20(0x1)
	char                                                         pad0x7_KEACK[0x7];                                 // 0x21(0x7)
};
...
{
public:
	char                                                         pad0x18_6KOQ4[0x18];                               // 0x0(0x18)
};
...
public:
	...
	char                                                         pad0x18_6MD1T[0x18];                               // 0x8(0x18)
};
...
{
public:
	char                                                         pad0x18_CCV7F[0x18];                               // 0x0(0x18)
...
public:
	...
	char                                                         pad0x20_15HEW[0x20];                               // 0x8(0x20)
};
...
public:
	...
	char                                                         pad0x3_GD795[0x3];                                 // 0x9(0x3)
	struct FName                                                 Tag;                                               // 0xc(0x8)
	char                                                         pad0x4_9I7J8[0x4];                                 // 0x14(0x4)
};
