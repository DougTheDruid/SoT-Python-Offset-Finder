...
public:
	...
	char                                                         pad0x20_UQ15B[0x20];                               // 0x8(0x20)
};
...
{
public:
	char                                                         pad0x8_REY0T[0x8];                                 // 0x0(0x8)
	class ScriptStruct*                                          Type;                                              // 0x8(0x8)
	char                                                         pad0x8_V97IQ[0x8];                                 // 0x10(0x8)
};
...
{
public:
	char                                                         pad0x18_EIVPU[0x18];                               // 0x0(0x18)
...
{
public:
	char                                                         pad0x18_99DF8[0x18];                               // 0x0(0x18)
	class WwiseEvent*                                            WwiseEvent;                                        // 0x18(0x8)
	bool                                                         PlayOnTarget;                                      // 0x20(0x1)
	char                                                         pad0x7_NU2AB[0x7];                                 // 0x21(0x7)
};
...
public:
	...
	char                                                         pad0x18_OFF6R[0x18];                               // 0x8(0x18)
};
...
{
public:
	char                                                         pad0x18_8LOHS[0x18];                               // 0x0(0x18)
};
...
public:
	...
	char                                                         pad0x3_9I620[0x3];                                 // 0x9(0x3)
	struct FName                                                 Tag;                                               // 0xc(0x8)
	char                                                         pad0x4_1HSLT[0x4];                                 // 0x14(0x4)
};
