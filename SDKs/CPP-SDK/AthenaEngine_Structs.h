...
{
public:
	char                                                         pad0x8_L3LHG[0x8];                                 // 0x0(0x8)
	class ScriptStruct*                                          Type;                                              // 0x8(0x8)
	char                                                         pad0x8_UY5AP[0x8];                                 // 0x10(0x8)
};
...
public:
	...
	char                                                         pad0x3_S1LJX[0x3];                                 // 0x9(0x3)
	struct FName                                                 Tag;                                               // 0xc(0x8)
	char                                                         pad0x4_1I9UJ[0x4];                                 // 0x14(0x4)
};
...
{
public:
	char                                                         pad0x18_OWX7D[0x18];                               // 0x0(0x18)
...
public:
	...
	char                                                         pad0x20_Y5SRI[0x20];                               // 0x8(0x20)
};
...
{
public:
	char                                                         pad0x18_XVA3O[0x18];                               // 0x0(0x18)
	class WwiseEvent*                                            WwiseEvent;                                        // 0x18(0x8)
	bool                                                         PlayOnTarget;                                      // 0x20(0x1)
	char                                                         pad0x7_MLIAR[0x7];                                 // 0x21(0x7)
};
...
public:
	...
	char                                                         pad0x18_55JOR[0x18];                               // 0x8(0x18)
};
...
{
public:
	char                                                         pad0x18_V01ZA[0x18];                               // 0x0(0x18)
};
