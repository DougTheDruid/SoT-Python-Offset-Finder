...
{
public:
	char                                                         pad0x8_M8IKY[0x8];                                 // 0x0(0x8)
	class ScriptStruct*                                          Type;                                              // 0x8(0x8)
	char                                                         pad0x8_92G9J[0x8];                                 // 0x10(0x8)
};
...
{
public:
	char                                                         pad0x18_FT193[0x18];                               // 0x0(0x18)
};
...
{
public:
	char                                                         pad0x18_HOWUJ[0x18];                               // 0x0(0x18)
	class WwiseEvent*                                            WwiseEvent;                                        // 0x18(0x8)
	bool                                                         PlayOnTarget;                                      // 0x20(0x1)
	char                                                         pad0x7_ZMCEM[0x7];                                 // 0x21(0x7)
};
...
public:
	...
	char                                                         pad0x18_4INQX[0x18];                               // 0x8(0x18)
};
...
public:
	...
	char                                                         pad0x20_PVILJ[0x20];                               // 0x8(0x20)
};
...
{
public:
	char                                                         pad0x18_CYW3J[0x18];                               // 0x0(0x18)
...
public:
	...
	char                                                         pad0x3_OUUTA[0x3];                                 // 0x9(0x3)
	struct FName                                                 Tag;                                               // 0xc(0x8)
	char                                                         pad0x4_KTEAH[0x4];                                 // 0x14(0x4)
};
