...
public:
	...
	char                                                         pad0x20_V4O99[0x20];                               // 0x8(0x20)
};
...
{
public:
	char                                                         pad0x18_OESLI[0x18];                               // 0x0(0x18)
...
public:
	...
	char                                                         pad0x18_89X68[0x18];                               // 0x8(0x18)
};
...
public:
	...
	char                                                         pad0x3_Y99E9[0x3];                                 // 0x9(0x3)
	struct FName                                                 Tag;                                               // 0xc(0x8)
	char                                                         pad0x4_EX84C[0x4];                                 // 0x14(0x4)
};
...
{
public:
	char                                                         pad0x18_FPARI[0x18];                               // 0x0(0x18)
};
...
{
public:
	char                                                         pad0x8_GR6Y7[0x8];                                 // 0x0(0x8)
	class ScriptStruct*                                          Type;                                              // 0x8(0x8)
	char                                                         pad0x8_LYO2Q[0x8];                                 // 0x10(0x8)
};
...
{
public:
	char                                                         pad0x18_680VY[0x18];                               // 0x0(0x18)
	class WwiseEvent*                                            WwiseEvent;                                        // 0x18(0x8)
	bool                                                         PlayOnTarget;                                      // 0x20(0x1)
	char                                                         pad0x7_7X071[0x7];                                 // 0x21(0x7)
};
