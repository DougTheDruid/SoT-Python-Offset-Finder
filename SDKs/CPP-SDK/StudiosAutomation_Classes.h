...
{
public:
	char                                                         pad0x8_FYILT[0x8];                                 // 0x3d0(0x8)
	...
	char                                                         pad0x1_ZN7ML[0x1];                                 // 0x3df(0x1)
	...
	char                                                         pad0x2_RTUD8[0x2];                                 // 0x3f2(0x2)
	float                                                        TestTimeout;                                       // 0x3f4(0x4)
	float                                                        TestPausedTimeout;                                 // 0x3f8(0x4)
	char                                                         pad0x4_L2MHM[0x4];                                 // 0x3fc(0x4)
	...
	char                                                         pad0x3c_TIRI6[0x3c];                               // 0x454(0x3c)
};
...
public:
	...
	TArray<Assetclass IgnoreReferencersForClasses>               IgnoreReferencersForClasses;                       // 0x68(0x10)
};
...
{
public:
	char                                                         pad0x38_EIF1V[0x38];                               // 0x28(0x38)
};
...
{
public:
	char                                                         pad0x20_XRHK2[0x20];                               // 0xc8(0x20)
};
