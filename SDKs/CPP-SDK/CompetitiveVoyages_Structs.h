...
public:
	...
	char                                                         pad0xc_7HCEI[0xc];                                 // 0x3c(0xc)
};
...
public:
	...
	char                                                         pad0x2_J2LYN[0x2];                                 // 0x12(0x2)
};
...
public:
	...
	char                                                         pad0x3_BS1N0[0x3];                                 // 0x11(0x3)
};
...
{
public:
	char                                                         pad0x14_TDG5P[0x14];                               // 0x0(0x14)
};
...
{
public:
	char                                                         pad0x88_ZHTFQ[0x88];                               // 0x0(0x88)
};
...
public:
	...
	char                                                         pad0x4_RY9VJ[0x4];                                 // 0x1c(0x4)
	struct FString                                               GameEventType;                                     // 0x20(0x10)
};
...
public:
	...
	char                                                         pad0x4_JHLJP[0x4];                                 // 0x14(0x4)
...
{
public:
	char                                                         pad0x18_MCDBQ[0x18];                               // 0x0(0x18)
};
...
public:
	...
	char                                                         pad0x4_J4QSZ[0x4];                                 // 0x14(0x4)
};
...
public:
	...
	char                                                         pad0x3_GFCM6[0x3];                                 // 0xa1(0x3)
