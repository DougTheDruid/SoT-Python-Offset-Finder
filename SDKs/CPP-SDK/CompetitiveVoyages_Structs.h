...
public:
	...
	char                                                         pad0x3_G4L7Z[0x3];                                 // 0x11(0x3)
};
...
public:
	...
	char                                                         pad0x2_UQ3CC[0x2];                                 // 0x12(0x2)
};
...
public:
	...
	char                                                         pad0xc_4KNS6[0xc];                                 // 0x3c(0xc)
};
...
{
public:
	char                                                         pad0x18_0SAZU[0x18];                               // 0x0(0x18)
};
...
{
public:
	char                                                         pad0x88_RNJQ7[0x88];                               // 0x0(0x88)
};
...
public:
	...
	char                                                         pad0x4_MU09J[0x4];                                 // 0x14(0x4)
...
{
public:
	char                                                         pad0x14_OFE3Z[0x14];                               // 0x0(0x14)
};
...
public:
	...
	char                                                         pad0x4_E99JQ[0x4];                                 // 0x1c(0x4)
	struct FString                                               GameEventType;                                     // 0x20(0x10)
};
...
public:
	...
	char                                                         pad0x4_L090K[0x4];                                 // 0x14(0x4)
};
...
public:
	...
	char                                                         pad0x3_CVC1V[0x3];                                 // 0xa1(0x3)
