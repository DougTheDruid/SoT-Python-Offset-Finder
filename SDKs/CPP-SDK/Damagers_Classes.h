...
{
public:
	char                                                         pad0x8_5FONO[0x8];                                 // 0xc8(0x8)
	...
	char                                                         pad0xcb_NDDCS[0xcb];                               // 0x155(0xcb)
};
...
public:
	...
	char                                                         pad0x3_6FLKP[0x3];                                 // 0x131(0x3)
	...
	char                                                         pad0x3_2LNUV[0x3];                                 // 0x13d(0x3)
	float                                                        NearbyEncounterDistanceInMetres;                   // 0x140(0x4)
	char                                                         pad0x4_K8U1D[0x4];                                 // 0x144(0x4)
	...
	char                                                         pad0x48_RW4ZB[0x48];                               // 0x188(0x48)
};
