...
public:
	...
	char                                                         pad0x8_P9WJN[0x8];                                 // 0xd8(0x8)
	class                                                        DamagerType;                                       // 0xe0(0x8)
	byte                                                         HealthChangedReason;                               // 0xe8(0x1)
	char                                                         pad0x3_EFZU1[0x3];                                 // 0xe9(0x3)
	Struct Vector                                                LocalOffset;                                       // 0xec(0xc)
	char                                                         pad0x28_9U3OC[0x28];                               // 0xf8(0x28)
};
...
public:
	...
	char                                                         pad0x3_O6ROC[0x3];                                 // 0x13d(0x3)
	float                                                        NearbyEncounterDistanceInMetres;                   // 0x140(0x4)
	char                                                         pad0x4_VZQ09[0x4];                                 // 0x144(0x4)
	...
	char                                                         pad0x48_ZRC5U[0x48];                               // 0x188(0x48)
};
...
{
public:
	char                                                         pad0x8_0DZAG[0x8];                                 // 0xc8(0x8)
	...
	char                                                         pad0xcb_Q6L4D[0xcb];                               // 0x155(0xcb)
};
