...
public:
	...
	char                                                         pad0x8_6HWKS[0x8];                                 // 0xd8(0x8)
	class                                                        DamagerType;                                       // 0xe0(0x8)
	byte                                                         HealthChangedReason;                               // 0xe8(0x1)
	char                                                         pad0x3_5A4AR[0x3];                                 // 0xe9(0x3)
	Struct Vector                                                LocalOffset;                                       // 0xec(0xc)
	char                                                         pad0x28_WKWYR[0x28];                               // 0xf8(0x28)
};
...
public:
	...
	char                                                         pad0x3_U93M3[0x3];                                 // 0x131(0x3)
	...
	char                                                         pad0x3_ZKVX2[0x3];                                 // 0x13d(0x3)
	float                                                        NearbyEncounterDistanceInMetres;                   // 0x140(0x4)
	char                                                         pad0x4_NVECJ[0x4];                                 // 0x144(0x4)
	...
	char                                                         pad0x48_UXI4E[0x48];                               // 0x188(0x48)
};
...
{
public:
	char                                                         pad0x8_47FBB[0x8];                                 // 0xc8(0x8)
	...
	char                                                         pad0xcb_QYI6V[0xcb];                               // 0x155(0xcb)
};
