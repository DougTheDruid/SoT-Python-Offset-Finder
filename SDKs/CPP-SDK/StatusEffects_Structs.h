...
{
public:
	char                                                         pad0x18_HZZ8P[0x18];                               // 0x0(0x18)
};
...
public:
	...
	char                                                         pad0x3_THS1T[0x3];                                 // 0x29(0x3)
...
public:
	...
	char                                                         pad0x4_X721A[0x4];                                 // 0x14(0x4)
};
...
// Size 0x8
struct ActorCreatedOnExplodeEvent
{
public:
	char                                                         pad0x8_FZHG0[0x8];                                 // 0x0(0x8)
};
...
{
public:
	char                                                         pad0x10_JDC03[0x10];                               // 0x0(0x10)
};
...
public:
	...
	char                                                         pad0xc_H3NT5[0xc];                                 // 0x14(0xc)
};
...
public:
	...
	struct StatusDescriptor                                      Descriptor;                                        // 0x10(0x4)
	char                                                         pad0x4_WTIXX[0x4];                                 // 0x14(0x4)
	...
	char                                                         pad0x17_KMSH7[0x17];                               // 0x39(0x17)
};
...
public:
	...
	char                                                         pad0x4_WP7LL[0x4];                                 // 0x24(0x4)
};
