...
{
public:
	char                                                         pad0x18_DZMGF[0x18];                               // 0x0(0x18)
};
...
{
public:
	char                                                         pad0x10_0UMBI[0x10];                               // 0x0(0x10)
};
...
public:
	...
	char                                                         pad0xc_AVLZX[0xc];                                 // 0x14(0xc)
};
...
public:
	...
	struct StatusDescriptor                                      Descriptor;                                        // 0x10(0x4)
	char                                                         pad0x4_MW722[0x4];                                 // 0x14(0x4)
	...
	char                                                         pad0x17_MK96C[0x17];                               // 0x39(0x17)
};
...
public:
	...
	char                                                         pad0x4_IL8KK[0x4];                                 // 0x24(0x4)
};
