...
public:
	...
	char                                                         pad0x8_NB2XA[0x8];                                 // 0x30(0x8)
};
...
{
public:
	char                                                         pad0x80_0L4XP[0x80];                               // 0x28(0x80)
	...
	char                                                         pad0x2_27WLD[0x2];                                 // 0xc2(0x2)
	bool                                                         Shuffle;                                           // 0xc4(0x1)
	bool                                                         Loop;                                              // 0xc4(0x1)
	char                                                         pad0x3_33RNS[0x3];                                 // 0xc5(0x3)
	class MediaPlaylist*                                         Playlist;                                          // 0xc8(0x8)
	int                                                          PlaylistIndex;                                     // 0xd0(0x4)
	char                                                         pad0x4_SVBJ0[0x4];                                 // 0xd4(0x4)
	...
	char                                                         pad0x64_AFPN1[0x64];                               // 0xf4(0x64)
	struct Guid                                                  PlayerGuid;                                        // 0x158(0x10)
	char                                                         pad0x8_2F2CM[0x8];                                 // 0x168(0x8)
};
...
{
public:
	char                                                         pad0x58_P54IF[0x58];                               // 0x28(0x58)
};
...
public:
	...
	char                                                         pad0x17_SXNFS[0x17];                               // 0x99(0x17)
};
...
public:
	...
	char                                                         pad0x3_RXK6S[0x3];                                 // 0x89(0x3)
...
public:
	...
	char                                                         pad0x1_O95L1[0x1];                                 // 0x13b(0x1)
	...
	char                                                         pad0x3_43FSX[0x3];                                 // 0x155(0x3)
	class MediaPlayer*                                           MediaPlayer;                                       // 0x158(0x8)
	char                                                         pad0xc8_MOQKV[0xc8];                               // 0x160(0xc8)
};
