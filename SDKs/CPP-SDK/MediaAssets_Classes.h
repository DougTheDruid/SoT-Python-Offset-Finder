...
{
public:
	char                                                         pad0x58_8ZDH3[0x58];                               // 0x28(0x58)
};
...
{
public:
	char                                                         pad0x80_X31L8[0x80];                               // 0x28(0x80)
	...
	char                                                         pad0x2_8XDDI[0x2];                                 // 0xc2(0x2)
	bool                                                         Shuffle;                                           // 0xc4(0x1)
	bool                                                         Loop;                                              // 0xc4(0x1)
	char                                                         pad0x3_8NIAW[0x3];                                 // 0xc5(0x3)
	class MediaPlaylist*                                         Playlist;                                          // 0xc8(0x8)
	int                                                          PlaylistIndex;                                     // 0xd0(0x4)
	char                                                         pad0x4_465IQ[0x4];                                 // 0xd4(0x4)
	...
	char                                                         pad0x64_6D6LY[0x64];                               // 0xf4(0x64)
	struct Guid                                                  PlayerGuid;                                        // 0x158(0x10)
	char                                                         pad0x8_621MT[0x8];                                 // 0x168(0x8)
};
...
public:
	...
	char                                                         pad0x8_84XKL[0x8];                                 // 0x30(0x8)
};
...
public:
	...
	char                                                         pad0x1_F151N[0x1];                                 // 0x143(0x1)
	...
	char                                                         pad0x3_EBV67[0x3];                                 // 0x15d(0x3)
	class MediaPlayer*                                           MediaPlayer;                                       // 0x160(0x8)
	char                                                         pad0xc8_N4OT6[0xc8];                               // 0x168(0xc8)
};
...
public:
	...
	char                                                         pad0x17_5WWLI[0x17];                               // 0x99(0x17)
};
...
public:
	...
	char                                                         pad0x3_AQ25Y[0x3];                                 // 0x89(0x3)
