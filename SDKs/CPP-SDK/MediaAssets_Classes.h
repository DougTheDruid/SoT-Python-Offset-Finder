...
public:
	...
	struct                                                       CacheAhead;                                        // 0xa8(0x8)
	struct                                                       CacheBehind;                                       // 0xb0(0x8)
	struct                                                       CacheBehindGame;                                   // 0xb8(0x8)
	...
	struct                                                       TimeDelay;                                         // 0xd8(0x8)
	float                                                        HorizontalFieldOfView;                             // 0xe0(0x4)
	float                                                        VerticalFieldOfView;                               // 0xe4(0x4)
	struct                                                       ViewRotation;                                      // 0xe8(0xc)
	struct                                                       PlayerGuid;                                        // 0x158(0x10)
};
