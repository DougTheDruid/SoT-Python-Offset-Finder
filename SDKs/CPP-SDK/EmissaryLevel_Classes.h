...
public:
	...
	char                                                         pad0x8_K9557[0x8];                                 // 0x60(0x8)
};
...
{
public:
	char                                                         pad0x8_76JHM[0x8];                                 // 0x728(0x8)
	...
	char                                                         pad0x7_VYLJT[0x7];                                 // 0x769(0x7)
};
...
{
public:
	char                                                         pad0xa8_83PVO[0xa8];                               // 0x440(0xa8)
	Struct Vector                                                GuildSessionEndedFlotsamOffset;                    // 0x4e8(0xc)
	char                                                         pad0x3c_BO9RP[0x3c];                               // 0x4f4(0x3c)
};
...
public:
	...
	char                                                         pad0x7_N07YO[0x7];                                 // 0xd1(0x7)
...
{
public:
	char                                                         pad0x8_G2BEN[0x8];                                 // 0xc8(0x8)
	bool                                                         IsAtMaxRank;                                       // 0xd0(0x1)
	char                                                         pad0x7_300RJ[0x7];                                 // 0xd1(0x7)
	TArray<struct NoteCompletionIdents>                          NoteCompletionIdents;                              // 0xd8(0x10)
	char                                                         pad0x10_1X7A5[0x10];                               // 0xe8(0x10)
	...
	char                                                         pad0x3_H7ECA[0x3];                                 // 0x109(0x3)
	struct FName                                                 VotedCompany;                                      // 0x10c(0x8)
	char                                                         pad0x4_LCCTC[0x4];                                 // 0x114(0x4)
};
...
public:
	...
	char                                                         pad0x4_T9YD9[0x4];                                 // 0x3c(0x4)
...
public:
	...
	char                                                         pad0x1c_6OM6A[0x1c];                               // 0x334(0x1c)
};
...
public:
	...
	char                                                         pad0x18_SKVBK[0x18];                               // 0x2e8(0x18)
};
...
public:
	...
	char                                                         pad0x18_6DA0Z[0x18];                               // 0x370(0x18)
};
...
public:
	...
	char                                                         pad0x18_HNXOJ[0x18];                               // 0x278(0x18)
};
...
public:
	...
	char                                                         pad0x7_E4NMM[0x7];                                 // 0x31(0x7)
};
