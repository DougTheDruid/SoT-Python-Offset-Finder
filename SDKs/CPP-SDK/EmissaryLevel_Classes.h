...
public:
	...
	char                                                         pad0x8_ZPZ5H[0x8];                                 // 0x60(0x8)
};
...
{
public:
	char                                                         pad0x8_JPDJK[0x8];                                 // 0x728(0x8)
	...
	char                                                         pad0x7_UW6O3[0x7];                                 // 0x769(0x7)
};
...
{
public:
	char                                                         pad0xa8_VCWG6[0xa8];                               // 0x440(0xa8)
	Struct Vector                                                GuildSessionEndedFlotsamOffset;                    // 0x4e8(0xc)
	char                                                         pad0x3c_GNTG1[0x3c];                               // 0x4f4(0x3c)
};
...
{
public:
	char                                                         pad0xb8_A22S8[0xb8];                               // 0x3c8(0xb8)
	...
	char                                                         pad0x288_X8T0U[0x288];                             // 0x498(0x288)
};
...
public:
	...
	char                                                         pad0x7_UBVFF[0x7];                                 // 0xd1(0x7)
...
{
public:
	char                                                         pad0x8_5AAH5[0x8];                                 // 0xc8(0x8)
	bool                                                         IsAtMaxRank;                                       // 0xd0(0x1)
	char                                                         pad0x7_81LNP[0x7];                                 // 0xd1(0x7)
	TArray<struct NoteCompletionIdents>                          NoteCompletionIdents;                              // 0xd8(0x10)
	char                                                         pad0x10_ZF5UH[0x10];                               // 0xe8(0x10)
	...
	char                                                         pad0x3_0PFTM[0x3];                                 // 0x109(0x3)
	struct FName                                                 VotedCompany;                                      // 0x10c(0x8)
	char                                                         pad0x4_JZQ5R[0x4];                                 // 0x114(0x4)
};
...
public:
	...
	char                                                         pad0x4_IGJYC[0x4];                                 // 0x3c(0x4)
...
public:
	...
	char                                                         pad0x1c_AYQSQ[0x1c];                               // 0x334(0x1c)
};
...
public:
	...
	char                                                         pad0x18_TO24A[0x18];                               // 0x2e8(0x18)
};
...
public:
	...
	char                                                         pad0x18_X4SJC[0x18];                               // 0x370(0x18)
};
...
public:
	...
	char                                                         pad0x18_I3P24[0x18];                               // 0x278(0x18)
};
...
public:
	...
	char                                                         pad0x7_A1JDC[0x7];                                 // 0x31(0x7)
};
