...
{
public:
	char                                                         pad0x10_X3T0P[0x10];                               // 0xc8(0x10)
};
...
public:
	...
	char                                                         pad0x8_GHBN5[0x8];                                 // 0x60(0x8)
};
...
{
public:
	char                                                         pad0x8_XB6QM[0x8];                                 // 0x748(0x8)
	...
	char                                                         pad0x7_WUW1E[0x7];                                 // 0x789(0x7)
};
...
{
public:
	char                                                         pad0xa8_WM9DW[0xa8];                               // 0x470(0xa8)
	struct Vector                                                GuildSessionEndedFlotsamOffset;                    // 0x518(0xc)
	char                                                         pad0x3c_TJRNZ[0x3c];                               // 0x524(0x3c)
};
...
{
public:
	char                                                         pad0xb8_IA31K[0xb8];                               // 0x3c8(0xb8)
	...
	char                                                         pad0x288_CMSZ3[0x288];                             // 0x498(0x288)
};
...
public:
	...
	char                                                         pad0x7_B1F80[0x7];                                 // 0xd1(0x7)
...
public:
	...
	char                                                         pad0x3_4F5F9[0x3];                                 // 0x109(0x3)
	struct FName                                                 VotedCompany;                                      // 0x10c(0x8)
	char                                                         pad0x4_W7M5Q[0x4];                                 // 0x114(0x4)
};
...
public:
	...
	char                                                         pad0x4_RLGF8[0x4];                                 // 0x3c(0x4)
...
public:
	...
	char                                                         pad0x1c_E18F6[0x1c];                               // 0x334(0x1c)
};
...
public:
	...
	char                                                         pad0x18_Q98MA[0x18];                               // 0x318(0x18)
};
...
public:
	...
	char                                                         pad0x30_RUPPO[0x30];                               // 0x3a0(0x30)
};
...
public:
	...
	char                                                         pad0x18_3B2LR[0x18];                               // 0x2e0(0x18)
};
...
{
public:
	char                                                         pad0x30_WEJV3[0x30];                               // 0x2f8(0x30)
};
...
public:
	...
	char                                                         pad0x7_YSE6M[0x7];                                 // 0x31(0x7)
};
