...
{
public:
	struct                                                       GuildSessionEndedFlotsamOffset;                    // 0x528(0xc)
};
...
public:
	...
	struct                                                       BoostMultiplers;                                   // 0x38(0x8)
	struct                                                       DefaultEmissaryFlagAssetReferences;                // 0x40(0x20)
...
{
public:
	struct                                                       HandInOwnFlotsamReward;                            // 0x758(0x18)
	struct                                                       AlternateHandInOwnFlotsamReward;                   // 0x770(0x18)
