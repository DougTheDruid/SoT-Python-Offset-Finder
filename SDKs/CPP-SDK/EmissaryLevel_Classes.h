...
{
public:
	char                                                         pad0xa8_XKCL9[0xa8];                               // 0x470(0xa8)
	struct Vector                                                GuildSessionEndedFlotsamOffset;                    // 0x518(0xc)
	char                                                         pad0x3c_E2FES[0x3c];                               // 0x524(0x3c)
};
...
public:
	...
	char                                                         pad0x7_IUTTA[0x7];                                 // 0x31(0x7)
};
...
{
public:
	char                                                         pad0xb8_PZP8Y[0xb8];                               // 0x3c8(0xb8)
	...
	char                                                         pad0x288_997S6[0x288];                             // 0x498(0x288)
};
...
{
public:
	char                                                         pad0x10_NGRN7[0x10];                               // 0xc8(0x10)
};
...
public:
	...
	char                                                         pad0x8_GS74R[0x8];                                 // 0x60(0x8)
};
...
{
public:
	char                                                         pad0x8_QFCN8[0x8];                                 // 0x748(0x8)
	...
	char                                                         pad0x7_TI9MN[0x7];                                 // 0x789(0x7)
};
...
public:
	...
	char                                                         pad0x7_VO1EK[0x7];                                 // 0xd1(0x7)
...
public:
	...
	char                                                         pad0x4_8Q40W[0x4];                                 // 0x3c(0x4)
...
public:
	...
	char                                                         pad0x1c_87GDF[0x1c];                               // 0x334(0x1c)
};
...
public:
	...
	char                                                         pad0x3_I868E[0x3];                                 // 0x109(0x3)
	struct FName                                                 VotedCompany;                                      // 0x10c(0x8)
	char                                                         pad0x4_HQHRH[0x4];                                 // 0x114(0x4)
};
...
public:
	...
	char                                                         pad0x18_7CP24[0x18];                               // 0x318(0x18)
};
...
public:
	...
	char                                                         pad0x18_Z4SVG[0x18];                               // 0x2e0(0x18)
};
...
{
public:
	char                                                         pad0x30_TGI27[0x30];                               // 0x2f8(0x30)
};
...
public:
	...
	char                                                         pad0x30_21IOO[0x30];                               // 0x3a0(0x30)
};
