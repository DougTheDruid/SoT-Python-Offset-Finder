...
public:
	...
	char                                                         CreatureType;                                      // 0x428(0x1)
	char                                                         NumOfCreatures;                                    // 0x429(0x1)
	char                                                         pad0x2_K4OUY[0x2];                                 // 0x42a(0x2)
	...
	char                                                         CirclingDirection;                                 // 0x45c(0x1)
	char                                                         pad0x3_S5O1O[0x3];                                 // 0x45d(0x3)
	...
	char                                                         pad0x4_SNEEZ[0x4];                                 // 0x49c(0x4)
	TArray<Class>                                                SelectedCreatureType;                              // 0x4a0(0x10)
	TArray<Class>                                                Seagull;                                           // 0x4b0(0x10)
	float                                                        Size;                                              // 0x4c0(0x4)
	float                                                        SizeVariance;                                      // 0x4c4(0x4)
	float                                                        SimSpeed;                                          // 0x4c8(0x4)
	struct Vector                                                BBox;                                              // 0x4cc(0xc)
	TArray<Class>                                                Skellygull_01;                                     // 0x4d8(0x10)
	TArray<Class>                                                Bats_01;                                           // 0x4e8(0x10)
	TArray<Class>                                                Parrot_01;                                         // 0x4f8(0x10)
	bool                                                         ScaleInDistance;                                   // 0x508(0x1)
	char                                                         pad0x3_PKX9Y[0x3];                                 // 0x509(0x3)
	...
	char                                                         pad0x3_1DJAT[0x3];                                 // 0x51d(0x3)
