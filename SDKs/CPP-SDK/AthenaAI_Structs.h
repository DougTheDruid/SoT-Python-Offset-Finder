...
public:
	...
	float                                                        SightRadiusForCrouching;                           // 0x14(0x4)
	float                                                        LoseSightRadiusForCrouching;                       // 0x18(0x4)
	float                                                        PeripheralVisionAngleDegreesForCrouching;          // 0x1c(0x4)
};
...
public:
	class UClass*                                                AIStrategy;                                        // 0x0(0x8)
	struct AthenaAIControllerSenseSettings                       SenseSettings;                                     // 0x8(0x20)
	bool                                                         ClearPerceivedData;                                // 0x28(0x1)
};
