...
{
public:
	struct                                                       TargetParticles;                                   // 0x0(0x10)
...
{
public:
	struct                                                       SessionId;                                         // 0x0(0x10)
	struct                                                       GuildId;                                           // 0x10(0x10)
	struct FName                                                 Company;                                           // 0x20(0x8)
	struct                                                       AssociatedCrew;                                    // 0x28(0x10)
...
public:
	...
	struct                                                       ActionRewardData;                                  // 0x8(0x88)
};
...
public:
	...
	struct                                                       AssociatedCrew;                                    // 0x18(0x10)
};
...
public:
	...
	struct                                                       EmissaryFlagMeshAssetReferences;                   // 0x8(0x20)
	assetobject                                                  EmissaryFlotsamSpawnDataAsset;                     // 0x28(0x20)
	assetobject                                                  WonInBattleEmissaryFlotsamSpawnDataAsset;          // 0x48(0x20)
	class EmissaryColourSwatchSettingsAsset*                     CustomisedFlagSettings;                            // 0x68(0x8)
	struct                                                       EmissaryDeactivationReward;                        // 0x70(0x8)
	...
	struct                                                       TreasureSoldNotificationFlag;                      // 0xb8(0x10)
	struct                                                       EmissaryFlagTextureReference;                      // 0xc8(0x10)
};
...
{
public:
	struct                                                       BackOfShipEmissaryFlagMeshAssetReference;          // 0x0(0x10)
	struct                                                       MastEmissaryFlagMeshAssetReference;                // 0x10(0x10)
};
...
public:
	...
	struct                                                       AssociatedCrew;                                    // 0x4(0x10)
};
...
public:
	...
	struct                                                       EmissaryFlagMeshAssetReferences;                   // 0x10(0x20)
	assetobject                                                  EmissaryFlotsamSpawnDataAsset;                     // 0x30(0x20)
	struct                                                       EmissaryFlagTextureReference;                      // 0x50(0x10)
};
...
public:
	...
	struct                                                       AssociatedCrew;                                    // 0xc(0x10)
};
...
public:
	class UClass*                                                FinishedEventType;                                 // 0x0(0x8)
	struct                                                       AssociatedCrew;                                    // 0x8(0x10)
};
...
public:
	...
	struct                                                       KillPlayerReward;                                  // 0x20(0x28)
...
public:
	...
	struct                                                       CompanyCosmetics;                                  // 0x30(0x20)
	struct                                                       TimeSpentAtMaxRankStat;                            // 0x50(0x4)
