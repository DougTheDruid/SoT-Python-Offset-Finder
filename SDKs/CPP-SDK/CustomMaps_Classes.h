...
public:
	...
	char                                                         pad0x3_RXYYZ[0x3];                                 // 0x29(0x3)
	struct Guid                                                  Guid;                                              // 0x2c(0x10)
	char                                                         pad0x4_B065S[0x4];                                 // 0x3c(0x4)
};
...
public:
	bool                                                         Visible;                                           // 0x28(0x1)
	char                                                         pad0x3_43XC9[0x3];                                 // 0x29(0x3)
	struct Guid                                                  Guid;                                              // 0x2c(0x10)
	char                                                         pad0x4_PK9W0[0x4];                                 // 0x3c(0x4)
};
...
public:
	...
	char                                                         pad0x4_E7K2L[0x4];                                 // 0x4c(0x4)
};
...
public:
	struct Vector2D                                              Position;                                          // 0x40(0x8)
	float                                                        Orientation;                                       // 0x48(0x4)
	char                                                         pad0x4_MSH9N[0x4];                                 // 0x4c(0x4)
};
...
public:
	...
	char                                                         pad0x3_LTYU9[0x3];                                 // 0x91(0x3)
	...
	char                                                         pad0x50_F2N2J[0x50];                               // 0xb8(0x50)
};
...
public:
	...
	float                                                        FontScale;                                         // 0x8c(0x4)
	bool                                                         StrikeThrough;                                     // 0x90(0x1)
	char                                                         pad0x3_DU7FL[0x3];                                 // 0x91(0x3)
	float                                                        StrikethroughThickness;                            // 0x94(0x4)
	struct LinearColor                                           TextColour;                                        // 0x98(0x10)
};
