...
public:
	...
	char                                                         pad0x3_GNZAQ[0x3];                                 // 0x29(0x3)
	struct Guid                                                  Guid;                                              // 0x2c(0x10)
	char                                                         pad0x4_FV3T3[0x4];                                 // 0x3c(0x4)
};
...
public:
	bool                                                         Visible;                                           // 0x28(0x1)
	char                                                         pad0x3_SLVNV[0x3];                                 // 0x29(0x3)
	struct Guid                                                  Guid;                                              // 0x2c(0x10)
	char                                                         pad0x4_32G0S[0x4];                                 // 0x3c(0x4)
};
...
public:
	...
	char                                                         pad0x4_Y2CL6[0x4];                                 // 0x4c(0x4)
};
...
public:
	struct Vector2D                                              Position;                                          // 0x40(0x8)
	float                                                        Orientation;                                       // 0x48(0x4)
	char                                                         pad0x4_GDWTF[0x4];                                 // 0x4c(0x4)
};
...
public:
	...
	char                                                         pad0x3_QE75D[0x3];                                 // 0x91(0x3)
	...
	char                                                         pad0x50_PYC3F[0x50];                               // 0xb8(0x50)
};
...
public:
	...
	float                                                        FontScale;                                         // 0x8c(0x4)
	bool                                                         StrikeThrough;                                     // 0x90(0x1)
	char                                                         pad0x3_HG6KU[0x3];                                 // 0x91(0x3)
	float                                                        StrikethroughThickness;                            // 0x94(0x4)
	struct LinearColor                                           TextColour;                                        // 0x98(0x10)
};
