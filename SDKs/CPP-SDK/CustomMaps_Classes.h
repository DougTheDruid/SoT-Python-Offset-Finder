...
public:
	...
	char                                                         pad0x4_Y890B[0x4];                                 // 0x44(0x4)
};
...
public:
	Struct Vector2D                                              Position;                                          // 0x38(0x8)
	float                                                        Orientation;                                       // 0x40(0x4)
	char                                                         pad0x4_CD2T1[0x4];                                 // 0x44(0x4)
};
...
public:
	...
	char                                                         pad0x3_NXWFT[0x3];                                 // 0x85(0x3)
	float                                                        StrikethroughThickness;                            // 0x88(0x4)
	char                                                         pad0x4c_GU9O6[0x4c];                               // 0x8c(0x4c)
};
...
public:
	...
	float                                                        FontScale;                                         // 0x80(0x4)
	bool                                                         StrikeThrough;                                     // 0x84(0x1)
	char                                                         pad0x3_S6GNL[0x3];                                 // 0x85(0x3)
	float                                                        StrikethroughThickness;                            // 0x88(0x4)
	char                                                         pad0x4_VRRGG[0x4];                                 // 0x8c(0x4)
};
