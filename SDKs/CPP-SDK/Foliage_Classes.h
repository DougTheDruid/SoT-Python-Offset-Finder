...
{
public:
	char                                                         pad0x20_M5R0P[0x20];                               // 0x7a0(0x20)
};
...
public:
	...
	char                                                         pad0x3_OQGTJ[0x3];                                 // 0x45(0x3)
	...
	char                                                         pad0x3_9YVFZ[0x3];                                 // 0xed(0x3)
	...
	char                                                         pad0x2_STDN0[0x2];                                 // 0x2c2(0x2)
	...
	char                                                         pad0x2_DA53B[0x2];                                 // 0x35e(0x2)
};
...
{
public:
	char                                                         pad0x50_88AFX[0x50];                               // 0x3c8(0x50)
};
...
public:
	...
	char                                                         pad0x4_8C2T0[0x4];                                 // 0x434(0x4)
};
...
{
public:
	char                                                         pad0x10_HXSLP[0x10];                               // 0x620(0x10)
};
...
public:
	...
	char                                                         pad0x4_0FPRB[0x4];                                 // 0xd4(0x4)
...
public:
	...
	char                                                         pad0xa0_9D7RF[0xa0];                               // 0x30(0xa0)
	TArray<struct ProceduralFoliageInstance>                     InstancesArray;                                    // 0xd0(0x10)
	char                                                         pad0x70_YMXBH[0x70];                               // 0xe0(0x70)
};
