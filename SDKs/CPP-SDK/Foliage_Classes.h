...
{
public:
	char                                                         pad0x20_1H98G[0x20];                               // 0x7a0(0x20)
};
...
public:
	...
	char                                                         pad0x3_RAHY4[0x3];                                 // 0x45(0x3)
	...
	char                                                         pad0x3_YGA40[0x3];                                 // 0xed(0x3)
	...
	char                                                         pad0x2_DIOBJ[0x2];                                 // 0x2c2(0x2)
	...
	char                                                         pad0x2_E3Q49[0x2];                                 // 0x35e(0x2)
};
...
{
public:
	char                                                         pad0x50_WQH71[0x50];                               // 0x3c8(0x50)
};
...
public:
	...
	char                                                         pad0x4_AWPTZ[0x4];                                 // 0x434(0x4)
};
...
{
public:
	char                                                         pad0x10_43LMB[0x10];                               // 0x620(0x10)
};
...
public:
	...
	char                                                         pad0x4_WEQ04[0x4];                                 // 0xd4(0x4)
...
public:
	...
	char                                                         pad0xa0_WE0A3[0xa0];                               // 0x30(0xa0)
	TArray<struct ProceduralFoliageInstance>                     InstancesArray;                                    // 0xd0(0x10)
	char                                                         pad0x70_8LELC[0x70];                               // 0xe0(0x70)
};
