...
public:
	...
	char                                                         pad0x4_ASQQV[0x4];                                 // 0x434(0x4)
};
...
public:
	...
	char                                                         pad0x4_TZT9N[0x4];                                 // 0xd4(0x4)
...
{
public:
	char                                                         pad0x10_5PUMR[0x10];                               // 0x620(0x10)
};
...
public:
	...
	char                                                         pad0xa0_3A972[0xa0];                               // 0x30(0xa0)
	TArray<struct ProceduralFoliageInstance>                     InstancesArray;                                    // 0xd0(0x10)
	char                                                         pad0x70_5BFRO[0x70];                               // 0xe0(0x70)
};
...
{
public:
	char                                                         pad0x20_95J2T[0x20];                               // 0x7a0(0x20)
};
...
{
public:
	char                                                         pad0x50_O4ID9[0x50];                               // 0x3c8(0x50)
};
...
public:
	...
	char                                                         pad0x3_4T5NG[0x3];                                 // 0x45(0x3)
	...
	char                                                         pad0x3_RHS5X[0x3];                                 // 0xed(0x3)
	...
	char                                                         pad0x2_K71DO[0x2];                                 // 0x2c2(0x2)
	...
	char                                                         pad0x2_BI8V8[0x2];                                 // 0x35e(0x2)
};
