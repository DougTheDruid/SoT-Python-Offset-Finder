...
public:
	...
	char                                                         pad0x3_9RKKS[0x3];                                 // 0x45(0x3)
	...
	char                                                         pad0x3_NT74P[0x3];                                 // 0xed(0x3)
	...
	char                                                         pad0x2_JOY8D[0x2];                                 // 0x2c2(0x2)
	...
	char                                                         pad0x2_KCEPT[0x2];                                 // 0x35e(0x2)
};
...
public:
	...
	char                                                         pad0x4_C3CG8[0x4];                                 // 0x434(0x4)
};
...
public:
	...
	char                                                         pad0x4_Y7R8L[0x4];                                 // 0xd4(0x4)
...
public:
	...
	char                                                         pad0x4_A2IJK[0x4];                                 // 0x34(0x4)
	TArray<struct FoliageTypes>                                  FoliageTypes;                                      // 0x38(0x10)
	bool                                                         bNeedsSimulation;                                  // 0x48(0x1)
	char                                                         pad0x1f_7YCVC[0x1f];                               // 0x49(0x1f)
};
...
public:
	...
	char                                                         pad0xa0_D6XWC[0xa0];                               // 0x30(0xa0)
	TArray<struct InstancesArray>                                InstancesArray;                                    // 0xd0(0x10)
	char                                                         pad0x70_D5U4P[0x70];                               // 0xe0(0x70)
};
