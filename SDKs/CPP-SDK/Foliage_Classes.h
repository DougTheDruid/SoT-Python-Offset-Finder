...
{
public:
	char                                                         pad0x50_IFPI7[0x50];                               // 0x3a0(0x50)
};
...
public:
	...
	char                                                         pad0x3_7L40B[0x3];                                 // 0x45(0x3)
	...
	char                                                         pad0x3_Q0DML[0x3];                                 // 0xed(0x3)
	...
	char                                                         pad0x2_IB0LL[0x2];                                 // 0x2c2(0x2)
	...
	char                                                         pad0x2_SMQSU[0x2];                                 // 0x35e(0x2)
};
...
public:
	...
	char                                                         pad0x4_37OZ1[0x4];                                 // 0xc4(0x4)
...
{
public:
	char                                                         pad0x20_YQX7W[0x20];                               // 0x780(0x20)
};
...
public:
	...
	char                                                         pad0xa0_2TLM1[0xa0];                               // 0x30(0xa0)
	TArray<struct ProceduralFoliageInstance>                     InstancesArray;                                    // 0xd0(0x10)
	char                                                         pad0x70_E6ZHH[0x70];                               // 0xe0(0x70)
};
...
public:
	...
	char                                                         pad0x4_XBPXD[0x4];                                 // 0x40c(0x4)
};
...
{
public:
	char                                                         pad0x10_YNJMI[0x10];                               // 0x600(0x10)
};
