...
{
public:
	char                                                         pad0x20_RICUM[0x20];                               // 0x7a0(0x20)
};
...
public:
	...
	char                                                         pad0x3_K3SEK[0x3];                                 // 0x45(0x3)
	...
	char                                                         pad0x3_FMX41[0x3];                                 // 0xed(0x3)
	...
	char                                                         pad0x2_6P907[0x2];                                 // 0x2c2(0x2)
	...
	char                                                         pad0x2_TR2IA[0x2];                                 // 0x35e(0x2)
};
...
{
public:
	char                                                         pad0x50_41QUF[0x50];                               // 0x3c8(0x50)
};
...
public:
	...
	char                                                         pad0x4_8LQCD[0x4];                                 // 0x434(0x4)
};
...
{
public:
	char                                                         pad0x10_SDS96[0x10];                               // 0x620(0x10)
};
...
public:
	...
	char                                                         pad0x4_UYPSB[0x4];                                 // 0xd4(0x4)
...
public:
	...
	char                                                         pad0xa0_HEK81[0xa0];                               // 0x30(0xa0)
	TArray<struct ProceduralFoliageInstance>                     InstancesArray;                                    // 0xd0(0x10)
	char                                                         pad0x70_NG8HT[0x70];                               // 0xe0(0x70)
};
