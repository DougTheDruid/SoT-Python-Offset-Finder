...
public:
	...
	char                                                         pad0x3_I55WL[0x3];                                 // 0x45(0x3)
	...
	char                                                         pad0x3_6FNFD[0x3];                                 // 0xed(0x3)
	...
	char                                                         pad0x2_SHAUF[0x2];                                 // 0x2c2(0x2)
	...
	char                                                         pad0x4_J5HEN[0x4];                                 // 0x35c(0x4)
};
...
public:
	...
	char                                                         pad0xc_4IVL4[0xc];                                 // 0x432(0xc)
};
...
public:
	...
	char                                                         pad0x4_VB6I9[0x4];                                 // 0xd4(0x4)
...
public:
	...
	char                                                         pad0xa0_1IPXY[0xa0];                               // 0x30(0xa0)
	TArray<struct InstancesArray>                                InstancesArray;                                    // 0xd0(0x10)
	char                                                         pad0x90_JSRID[0x90];                               // 0xde(0x90)
};
