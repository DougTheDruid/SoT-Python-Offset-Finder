...
public:
	...
	char                                                         pad0x4_3OFEM[0x4];                                 // 0xc4(0x4)
...
public:
	...
	char                                                         pad0x4_MLX48[0x4];                                 // 0x40c(0x4)
};
...
{
public:
	char                                                         pad0x10_Y6KIJ[0x10];                               // 0x620(0x10)
};
...
public:
	...
	char                                                         pad0xa0_QEYCD[0xa0];                               // 0x30(0xa0)
	TArray<struct ProceduralFoliageInstance>                     InstancesArray;                                    // 0xd0(0x10)
	char                                                         pad0x70_N666I[0x70];                               // 0xe0(0x70)
};
...
{
public:
	char                                                         pad0x50_JJ5XZ[0x50];                               // 0x3a0(0x50)
};
...
public:
	...
	char                                                         pad0x3_2FAMF[0x3];                                 // 0x45(0x3)
	...
	char                                                         pad0x3_QYSNL[0x3];                                 // 0xed(0x3)
	...
	char                                                         pad0x2_Q86DS[0x2];                                 // 0x2c2(0x2)
	...
	char                                                         pad0x2_ZW20N[0x2];                                 // 0x35e(0x2)
};
...
{
public:
	char                                                         pad0x20_CDCSC[0x20];                               // 0x7a0(0x20)
};
