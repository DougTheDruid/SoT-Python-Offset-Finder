...
public:
	...
	char                                                         pad0x7_XKDN0[0x7];                                 // 0x41(0x7)
};
...
public:
	...
	char                                                         pad0x80_0XZ0T[0x80];                               // 0x748(0x80)
};
...
{
public:
	char                                                         pad0x8_RIQ26[0x8];                                 // 0xb8(0x8)
	struct Guid                                                  OwningCrewID;                                      // 0xc0(0x10)
	char                                                         pad0x58_DUN2K[0x58];                               // 0xd0(0x58)
};
...
{
public:
	char                                                         pad0x398_DAOP5[0x398];                             // 0x3a0(0x398)
	class BoneCallerServiceParams*                               ServiceParams;                                     // 0x738(0x8)
	char                                                         pad0x70_R1GEZ[0x70];                               // 0x740(0x70)
};
