...
public:
	...
	char                                                         pad0x20_3XD9I[0x20];                               // 0x8(0x20)
};
...
public:
	...
	char                                                         pad0x20_V7QZ5[0x20];                               // 0x10(0x20)
};
...
{
public:
	char                                                         pad0x28_LCUKM[0x28];                               // 0x0(0x28)
	TArray<struct StoryFlag>                                     StoryFlags;                                        // 0x28(0x10)
	char                                                         pad0x10_3ETBC[0x10];                               // 0x38(0x10)
};
...
{
public:
	char                                                         pad0x48_5HQW1[0x48];                               // 0x0(0x48)
};
...
{
public:
	char                                                         pad0x48_0HO99[0x48];                               // 0x0(0x48)
};
...
public:
	...
	char                                                         pad0x10_COVVF[0x10];                               // 0x8(0x10)
};
...
public:
	...
	char                                                         pad0x6_H0UYN[0x6];                                 // 0x22(0x6)
};
