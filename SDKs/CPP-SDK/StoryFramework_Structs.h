...
{
public:
	char                                                         pad0x48_OCH0I[0x48];                               // 0x0(0x48)
};
...
{
public:
	char                                                         pad0x48_7CZIL[0x48];                               // 0x0(0x48)
};
...
public:
	...
	char                                                         pad0x10_RZMA5[0x10];                               // 0x8(0x10)
};
...
public:
	...
	char                                                         pad0x6_RCOSH[0x6];                                 // 0x22(0x6)
};
...
public:
	...
	char                                                         pad0x7_UX4RW[0x7];                                 // 0x29(0x7)
};
...
public:
	...
	char                                                         pad0x7_H549X[0x7];                                 // 0x31(0x7)
};
...
{
public:
	char                                                         pad0x28_LYQDR[0x28];                               // 0x0(0x28)
	TArray<struct StoryFlag>                                     StoryFlags;                                        // 0x28(0x10)
	char                                                         pad0x10_4LS5T[0x10];                               // 0x38(0x10)
};
...
public:
	...
	char                                                         pad0x7_A4H7P[0x7];                                 // 0x11(0x7)
};
