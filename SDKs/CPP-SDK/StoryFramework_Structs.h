...
{
public:
	char                                                         pad0x48_UALGS[0x48];                               // 0x0(0x48)
};
...
public:
	...
	char                                                         pad0x10_ORVV0[0x10];                               // 0x8(0x10)
};
...
public:
	...
	char                                                         pad0x6_76F8L[0x6];                                 // 0x22(0x6)
};
...
{
public:
	char                                                         pad0x48_XJB0S[0x48];                               // 0x0(0x48)
};
...
public:
	...
	char                                                         pad0x7_1GGL0[0x7];                                 // 0x31(0x7)
};
...
public:
	...
	char                                                         pad0x7_KJOW2[0x7];                                 // 0x29(0x7)
};
...
{
public:
	char                                                         pad0x28_FKRTS[0x28];                               // 0x0(0x28)
	TArray<struct StoryFlag>                                     StoryFlags;                                        // 0x28(0x10)
	char                                                         pad0x10_MVOA9[0x10];                               // 0x38(0x10)
};
...
public:
	...
	char                                                         pad0x7_HVNS4[0x7];                                 // 0x11(0x7)
};
