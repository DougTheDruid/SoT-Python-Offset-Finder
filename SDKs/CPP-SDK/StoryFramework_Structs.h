...
public:
	...
	char                                                         pad0x7_PCONQ[0x7];                                 // 0x31(0x7)
};
...
{
public:
	char                                                         pad0x48_33TLE[0x48];                               // 0x0(0x48)
};
...
public:
	...
	char                                                         pad0x7_TVQ48[0x7];                                 // 0x29(0x7)
};
...
public:
	...
	char                                                         pad0x6_VCRV3[0x6];                                 // 0x22(0x6)
};
...
{
public:
	char                                                         pad0x48_P00JG[0x48];                               // 0x0(0x48)
};
...
public:
	...
	char                                                         pad0x10_P8L5O[0x10];                               // 0x8(0x10)
};
...
{
public:
	char                                                         pad0x28_MISU5[0x28];                               // 0x0(0x28)
	TArray<struct StoryFlag>                                     StoryFlags;                                        // 0x28(0x10)
	char                                                         pad0x10_XYLUM[0x10];                               // 0x38(0x10)
};
...
public:
	...
	char                                                         pad0x7_7P77W[0x7];                                 // 0x11(0x7)
};
