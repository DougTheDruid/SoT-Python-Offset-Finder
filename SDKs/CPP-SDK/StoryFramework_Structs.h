...
public:
	...
	char                                                         pad0x7_9GV5B[0x7];                                 // 0x31(0x7)
};
...
{
public:
	char                                                         pad0x48_PDAMS[0x48];                               // 0x0(0x48)
};
...
public:
	...
	char                                                         pad0x7_XL5VO[0x7];                                 // 0x29(0x7)
};
...
public:
	...
	char                                                         pad0x10_TSLFP[0x10];                               // 0x8(0x10)
};
...
{
public:
	char                                                         pad0x48_LC1OP[0x48];                               // 0x0(0x48)
};
...
public:
	...
	char                                                         pad0x6_UXZXI[0x6];                                 // 0x22(0x6)
};
...
{
public:
	char                                                         pad0x28_GKCXT[0x28];                               // 0x0(0x28)
	TArray<struct StoryFlag>                                     StoryFlags;                                        // 0x28(0x10)
	char                                                         pad0x10_73JJV[0x10];                               // 0x38(0x10)
};
...
public:
	...
	char                                                         pad0x7_GASYK[0x7];                                 // 0x11(0x7)
};
