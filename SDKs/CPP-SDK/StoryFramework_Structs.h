...
public:
	...
	char                                                         pad0x10_KJRXH[0x10];                               // 0x8(0x10)
};
...
public:
	...
	char                                                         pad0x6_M4HMK[0x6];                                 // 0x22(0x6)
};
...
public:
	...
	char                                                         pad0x7_YLDDT[0x7];                                 // 0x29(0x7)
};
...
{
public:
	char                                                         pad0x48_Y4CEX[0x48];                               // 0x0(0x48)
};
...
public:
	...
	char                                                         pad0x7_MYJ9D[0x7];                                 // 0x31(0x7)
};
...
{
public:
	char                                                         pad0x48_FR3IB[0x48];                               // 0x0(0x48)
};
...
public:
	...
	char                                                         pad0x7_AUOUV[0x7];                                 // 0x11(0x7)
};
...
{
public:
	char                                                         pad0x28_258MC[0x28];                               // 0x0(0x28)
	TArray<struct StoryFlag>                                     StoryFlags;                                        // 0x28(0x10)
	char                                                         pad0x10_H268X[0x10];                               // 0x38(0x10)
};
