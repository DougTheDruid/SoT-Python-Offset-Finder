...
public:
	...
	char                                                         pad0x10_EGETH[0x10];                               // 0x8(0x10)
};
...
public:
	...
	char                                                         pad0x7_82GR3[0x7];                                 // 0x31(0x7)
};
...
public:
	...
	char                                                         pad0x6_3M99S[0x6];                                 // 0x22(0x6)
};
...
public:
	...
	char                                                         pad0x7_NP9K6[0x7];                                 // 0x29(0x7)
};
...
{
public:
	char                                                         pad0x48_I9821[0x48];                               // 0x0(0x48)
};
...
{
public:
	char                                                         pad0x48_ACB5L[0x48];                               // 0x0(0x48)
};
...
public:
	...
	char                                                         pad0x7_M6LGE[0x7];                                 // 0x11(0x7)
};
...
{
public:
	char                                                         pad0x28_7PD7S[0x28];                               // 0x0(0x28)
	TArray<struct StoryFlag>                                     StoryFlags;                                        // 0x28(0x10)
	char                                                         pad0x10_IP8KH[0x10];                               // 0x38(0x10)
};
