...
{
public:
	char                                                         pad0x48_V1VVV[0x48];                               // 0x0(0x48)
};
...
public:
	...
	char                                                         pad0x6_EU8JD[0x6];                                 // 0x22(0x6)
};
...
{
public:
	char                                                         pad0x48_2RUIH[0x48];                               // 0x0(0x48)
};
...
public:
	...
	char                                                         pad0x10_OYSUS[0x10];                               // 0x8(0x10)
};
...
public:
	...
	char                                                         pad0x7_S132G[0x7];                                 // 0x31(0x7)
};
...
public:
	...
	char                                                         pad0x7_PTSW5[0x7];                                 // 0x29(0x7)
};
...
public:
	...
	char                                                         pad0x7_3PB2W[0x7];                                 // 0x11(0x7)
};
...
{
public:
	char                                                         pad0x28_YYNRV[0x28];                               // 0x0(0x28)
	TArray<struct StoryFlag>                                     StoryFlags;                                        // 0x28(0x10)
	char                                                         pad0x10_2DLUE[0x10];                               // 0x38(0x10)
};
