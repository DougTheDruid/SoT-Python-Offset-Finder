...
{
public:
	char                                                         pad0x48_YTAO2[0x48];                               // 0x0(0x48)
};
...
{
public:
	char                                                         pad0x48_IVPUG[0x48];                               // 0x0(0x48)
};
...
public:
	...
	char                                                         pad0x4_IY3R4[0x4];                                 // 0x2c(0x4)
...
public:
	...
	char                                                         pad0x18_DT8WW[0x18];                               // 0x8(0x18)
};
...
public:
	...
	char                                                         pad0x7_1Q1TK[0x7];                                 // 0x31(0x7)
...
{
public:
	char                                                         pad0x48_1FLV6[0x48];                               // 0x0(0x48)
	...
	char                                                         pad0x6_9E0AK[0x6];                                 // 0x82(0x6)
};
...
{
public:
	char                                                         pad0x48_F0OHU[0x48];                               // 0x0(0x48)
