...
{
public:
	char                                                         pad0x30_2PMU0[0x30];                               // 0x0(0x30)
	...
	char                                                         pad0x6_A8MPO[0x6];                                 // 0x6a(0x6)
};
...
public:
	...
	char                                                         pad0x18_T1PNM[0x18];                               // 0x8(0x18)
};
...
{
public:
	char                                                         pad0x30_J6LLT[0x30];                               // 0x0(0x30)
};
...
{
public:
	char                                                         pad0x30_BXSA0[0x30];                               // 0x0(0x30)
};
...
public:
	...
	char                                                         pad0x7_XN9SB[0x7];                                 // 0x31(0x7)
...
public:
	...
	char                                                         pad0x4_6BSYG[0x4];                                 // 0x2c(0x4)
...
{
public:
	char                                                         pad0x30_BZYF4[0x30];                               // 0x0(0x30)
