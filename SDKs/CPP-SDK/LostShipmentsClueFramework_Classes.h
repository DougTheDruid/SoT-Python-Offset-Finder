...
public:
	...
	char                                                         pad0xf_6JSD9[0xf];                                 // 0x29(0xf)
};
...
public:
	...
	char                                                         pad0x4_7CTZF[0x4];                                 // 0x2c(0x4)
};
...
public:
	...
	char                                                         pad0x50_MWDU6[0x50];                               // 0x40(0x50)
};
...
public:
	...
	char                                                         pad0x8_JRP36[0x8];                                 // 0x190(0x8)
};
...
{
public:
	char                                                         pad0x8_ZUT6Y[0x8];                                 // 0xc8(0x8)
...
{
public:
	char                                                         pad0x18_SW6PU[0x18];                               // 0x98(0x18)
	Class SeaClueSiteTypesDataAsset*                             SeaClueSiteTypes;                                  // 0xb0(0x8)
	char                                                         pad0xe0_UEF2C[0xe0];                               // 0xb8(0xe0)
};
...
public:
	...
	char                                                         pad0x4_BVGQL[0x4];                                 // 0x9c(0x4)
...
public:
	...
	char                                                         pad0x60_1GSRQ[0x60];                               // 0xa0(0x60)
};
...
public:
	...
	char                                                         pad0x7_3FIGM[0x7];                                 // 0x91(0x7)
...
public:
	...
	char                                                         pad0x7_NOP9H[0x7];                                 // 0x111(0x7)
};
...
public:
	...
	char                                                         pad0x7_HX5TH[0x7];                                 // 0xb1(0x7)
};
