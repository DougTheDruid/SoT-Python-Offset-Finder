...
{
public:
	char                                                         pad0x8_D03XY[0x8];                                 // 0xc8(0x8)
	...
	char                                                         pad0x18_OUZG7[0x18];                               // 0x108(0x18)
};
...
{
public:
	char                                                         pad0x68_OCQC4[0x68];                               // 0x28(0x68)
};
...
{
public:
	char                                                         pad0x8_PCD5U[0x8];                                 // 0xc8(0x8)
...
{
public:
	char                                                         pad0x8_CUL3L[0x8];                                 // 0xc8(0x8)
	bool                                                         KeepOwnerRotationWhileDocked;                      // 0xd0(0x1)
	char                                                         pad0x7_8HFWZ[0x7];                                 // 0xd1(0x7)
};
