...
{
public:
	char                                                         pad0x8_BFF92[0x8];                                 // 0xb8(0x8)
	bool                                                         KeepOwnerRotationWhileDocked;                      // 0xc0(0x1)
	char                                                         pad0x7_CYTF7[0x7];                                 // 0xc1(0x7)
};
...
{
public:
	char                                                         pad0x8_IR3ZT[0x8];                                 // 0xb8(0x8)
	...
	char                                                         pad0x18_3WAAT[0x18];                               // 0xf8(0x18)
};
...
{
public:
	char                                                         pad0x8_F9SPC[0x8];                                 // 0xb8(0x8)
...
{
public:
	char                                                         pad0x68_WXDQO[0x68];                               // 0x28(0x68)
};
