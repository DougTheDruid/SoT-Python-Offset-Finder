...
{
public:
	char                                                         pad0x8_R7HTL[0x8];                                 // 0x3a0(0x8)
	...
	char                                                         pad0x9f_68C7X[0x9f];                               // 0x439(0x9f)
};
...
{
public:
	char                                                         pad0x8_YSXM9[0x8];                                 // 0x28(0x8)
...
{
public:
	char                                                         pad0x80_39MJM[0x80];                               // 0xb8(0x80)
};
...
public:
	...
	char                                                         pad0xc_EXN3J[0xc];                                 // 0x3bc(0xc)
};
