...
public:
	...
	char                                                         pad0xc_39DFZ[0xc];                                 // 0x3bc(0xc)
};
...
{
public:
	char                                                         pad0x8_VYPLH[0x8];                                 // 0x3a0(0x8)
	...
	char                                                         pad0x9f_XWKIP[0x9f];                               // 0x439(0x9f)
};
...
{
public:
	char                                                         pad0x80_05OYU[0x80];                               // 0xb8(0x80)
};
...
{
public:
	char                                                         pad0x8_EKKA0[0x8];                                 // 0x28(0x8)
