...
public:
	...
	char                                                         pad0xc_HITJX[0xc];                                 // 0x3bc(0xc)
};
...
{
public:
	char                                                         pad0x80_L5WYY[0x80];                               // 0xb8(0x80)
};
...
{
public:
	char                                                         pad0x8_PTNMJ[0x8];                                 // 0x3a0(0x8)
	...
	char                                                         pad0x9f_AEUO0[0x9f];                               // 0x439(0x9f)
};
...
{
public:
	char                                                         pad0x8_4MQJR[0x8];                                 // 0x28(0x8)
