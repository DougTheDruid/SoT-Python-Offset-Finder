...
{
public:
	char                                                         pad0x10_0YT2O[0x10];                               // 0xb8(0x10)
	...
	char                                                         pad0x3_GYLPL[0x3];                                 // 0xf1(0x3)
	...
	char                                                         pad0x58_Q4HAZ[0x58];                               // 0x210(0x58)
};
...
{
public:
	char                                                         pad0x18_XWZK5[0x18];                               // 0xb8(0x18)
	...
	char                                                         pad0x5_SZRPK[0x5];                                 // 0x123(0x5)
	...
	char                                                         pad0x30_AXAJ9[0x30];                               // 0x398(0x30)
	bool                                                         IsInExclusionZone;                                 // 0x3c8(0x1)
	char                                                         pad0x7_3HIAG[0x7];                                 // 0x3c9(0x7)
	...
	char                                                         pad0x1_O3FOA[0x1];                                 // 0x3f2(0x1)
	...
	char                                                         pad0x2_SH63T[0x2];                                 // 0x3fa(0x2)
	float                                                        FailedDeploymentDelay;                             // 0x3fc(0x4)
	char                                                         pad0x8_HNTKH[0x8];                                 // 0x400(0x8)
	...
	char                                                         pad0x6_AQ3D3[0x6];                                 // 0x412(0x6)
	...
	char                                                         pad0x28_FQUMM[0x28];                               // 0x430(0x28)
	class StaticMeshComponent*                                   FuseStaticMeshComponent;                           // 0x458(0x8)
	char                                                         pad0x78_4VHHE[0x78];                               // 0x460(0x78)
};
