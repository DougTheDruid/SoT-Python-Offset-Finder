...
public:
	...
	char                                                         pad0x10_4EFPW[0x10];                               // 0x35c(0x10)
	...
	char                                                         pad0x4_MHZN3[0x4];                                 // 0x3b4(0x4)
	class MaterialInstanceDynamic*                               DynamicMaterial;                                   // 0x3b8(0x8)
	char                                                         pad0x20_QLR1Z[0x20];                               // 0x3c0(0x20)
};
