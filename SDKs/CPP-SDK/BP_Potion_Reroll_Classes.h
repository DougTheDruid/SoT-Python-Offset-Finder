...
public:
	...
	Class StaticMeshComponent*                                   vfx_Tendrils;                                      // 0x508(0x8)
	Class ParticleSystemComponent*                               vfx_rerollBottle;                                  // 0x510(0x8)
	Class StaticMeshComponent*                                   Potion_Reroll;                                     // 0x518(0x8)
