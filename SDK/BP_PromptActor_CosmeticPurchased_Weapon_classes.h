...
class ABP_PromptActor_CosmeticPurchased_Weapon_C : public ABP_PromptActorBase_C
{
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass BP_PromptActor_CosmeticPurchased_Weapon.BP_PromptActor_CosmeticPurchased_Weapon_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_PromptActor_CosmeticPurchased_Weapon(int EntryPoint);
	void AfterRead();
	void BeforeDelete();
