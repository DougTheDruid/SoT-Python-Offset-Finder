...
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass Title_AF_Rank3_001_EmissaryOfFortuneVoyagers.Title_AF_Rank3_001_EmissaryOfFortuneVoyagers_C");
		return ptr;
	}
