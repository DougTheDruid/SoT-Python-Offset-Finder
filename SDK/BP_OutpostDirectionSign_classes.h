...
// BlueprintGeneratedClass BP_OutpostDirectionSign.BP_OutpostDirectionSign_C
// 0x0018 (FullSize[0x04B0] - InheritedSize[0x0498])
class ABP_OutpostDirectionSign_C : public AModalInteractionProxy
{
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass BP_OutpostDirectionSign.BP_OutpostDirectionSign_C");
		return ptr;
	}
