...
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass Proposal_DoubloonMercenaryVoyages_OnDemandRitualSkull.Proposal_DoubloonMercenaryVoyages_OnDemandRitualSkull_C");
		return ptr;
	}
