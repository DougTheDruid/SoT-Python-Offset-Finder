...
public:
	...
	class UStaticMeshComponent*                        tls_linstock_01_a;                                         // 0x03E0(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData, NonTransactional, NoDestructor)
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass wsp_Pole_Orb_Light_d.wsp_Pole_Orb_Light_d_C");
		return ptr;
	}
