...
void ABP_SKD_ShrineShimmer_C::AfterRead()
{
	AShimmerActor::AfterRead();

	READ_PTR_FULL(surface_bio_lum, UStaticMeshComponent);
	READ_PTR_FULL(volume_glow, UStaticMeshComponent);
	READ_PTR_FULL(shimmer_water_00, UStaticMeshComponent);
	READ_PTR_FULL(shimmer_air_01, UStaticMeshComponent);
	READ_PTR_FULL(shimmer_air_00, UStaticMeshComponent);
	READ_PTR_FULL(SharedRoot, USceneComponent);
	READ_PTR_FULL(FadeCurve, UTimelineComponent);
}

void ABP_SKD_ShrineShimmer_C::BeforeDelete()
{
	AShimmerActor::BeforeDelete();

	DELE_PTR_FULL(surface_bio_lum);
	DELE_PTR_FULL(volume_glow);
	DELE_PTR_FULL(shimmer_water_00);
	DELE_PTR_FULL(shimmer_air_01);
	DELE_PTR_FULL(shimmer_air_00);
	DELE_PTR_FULL(SharedRoot);
	DELE_PTR_FULL(FadeCurve);
}
