...
{
public:
	unsigned char                                      UnknownData_J91I[0x10];                                    // 0x03D0(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_DQY1[0x4];                                     // 0x0034(0x0004) MISSED OFFSET (PADDING)
