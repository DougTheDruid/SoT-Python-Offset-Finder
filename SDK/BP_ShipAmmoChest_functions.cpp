...
// Function:
//		Offset -> 0x016629C0
//		Name   -> Function BP_ShipAmmoChest.BP_ShipAmmoChest_C.UserConstructionScript
//		Flags  -> (Event, Public, BlueprintCallable, BlueprintEvent)
void ABP_ShipAmmoChest_C::UserConstructionScript()
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function BP_ShipAmmoChest.BP_ShipAmmoChest_C.UserConstructionScript");
...
void ABP_ShipAmmoChest_C::AfterRead()
{
	ABP_AmmoChest_C::AfterRead();
...
void ABP_ShipAmmoChest_C::BeforeDelete()
{
	ABP_AmmoChest_C::BeforeDelete();
