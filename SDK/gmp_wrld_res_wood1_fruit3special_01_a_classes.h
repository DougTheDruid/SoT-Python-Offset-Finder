...
public:
	...
	class UClusterStaticMeshComponent*                 COCONUT;                                                   // 0x0410(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData, NonTransactional, NoDestructor)
	class UClusterStaticMeshComponent*                 PINEAPPLE;                                                 // 0x0418(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData, NonTransactional, NoDestructor)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass gmp_wrld_res_wood1_fruit3special_01_a.gmp_wrld_res_wood1_fruit3special_01_a_C");
		return ptr;
	}
