...
{
	unsigned char                                      UnknownData_T6AJ[0x18];                                    // 0x0000(0x0018) MISSED OFFSET (PADDING)
...
struct FCommodityRedemptionTrackingModel
{
	...
	unsigned char                                      UnknownData_RTW0[0x5];                                     // 0x0003(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FCommodityTrackingModel
{
	...
	unsigned char                                      UnknownData_IZ8E[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
