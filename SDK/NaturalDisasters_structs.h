...
struct FVolcanoSetupDataEmbersEntry
{
	...
	unsigned char                                      UnknownData_KQMO[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FWeightedVolcanoProjectile
{
	...
	unsigned char                                      UnknownData_EVX3[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_TT07[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FVolcanoTargetChances
{
	...
	unsigned char                                      UnknownData_E8U8[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_A4QS[0x4];                                     // 0x0054(0x0004) MISSED OFFSET (PADDING)
...
struct FVolcanoStateData
{
	...
	unsigned char                                      UnknownData_L7CO[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FVolcanoTarget
{
	...
	unsigned char                                      UnknownData_EFO8[0x6];                                     // 0x0002(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_5VZC[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (PADDING)
...
struct FVolcanoTargetCoolDown
{
	...
	unsigned char                                      UnknownData_TQVQ[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (PADDING)
