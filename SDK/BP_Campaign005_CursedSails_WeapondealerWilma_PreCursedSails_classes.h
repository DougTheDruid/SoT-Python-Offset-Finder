...
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass BP_Campaign005_CursedSails_WeapondealerWilma_PreCursedSails.BP_Campaign005_CursedSails_WeapondealerWilma_PreCursedSails_C");
		return ptr;
	}
