...
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass BP_TaleBook_Shroudbreaker_AncientSpireOutpost_AdditionalPuzzles.BP_TaleBook_Shroudbreaker_AncientSpireOutpost_AdditionalPuzzles_C");
		return ptr;
	}
