...
// BlueprintGeneratedClass BP_Campaign037_FeastOfBounty_BilgeRats_NPC.BP_Campaign037_FeastOfBounty_BilgeRats_NPC_C
// 0x0030 (FullSize[0x0638] - InheritedSize[0x0608])
class ABP_Campaign037_FeastOfBounty_BilgeRats_NPC_C : public ACompanyShopkeeper
{
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass BP_Campaign037_FeastOfBounty_BilgeRats_NPC.BP_Campaign037_FeastOfBounty_BilgeRats_NPC_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_Campaign037_FeastOfBounty_BilgeRats_NPC(int EntryPoint);
	void AfterRead();
	void BeforeDelete();
