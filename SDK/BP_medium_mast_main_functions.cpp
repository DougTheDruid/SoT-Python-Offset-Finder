...
// Function:
//		Offset -> 0x01637030
//		Name   -> Function BP_medium_mast_main.BP_medium_mast_main_C.UserConstructionScript
...
// Function:
//		Offset -> 0x01637030
//		Name   -> Function BP_medium_mast_main.BP_medium_mast_main_C.OnMastDescLoaded
...
// Function:
//		Offset -> 0x01637030
//		Name   -> Function BP_medium_mast_main.BP_medium_mast_main_C.ExecuteUbergraph_BP_medium_mast_main
//		Flags  -> ()
// Parameters:
...
void ABP_medium_mast_main_C::AfterRead()
{
	...
	READ_PTR_FULL(BP_BellLower, UChildActorComponent);
	READ_PTR_FULL(BellSupportLower, UStaticMeshComponent);
}

void ABP_medium_mast_main_C::BeforeDelete()
{
	...
	DELE_PTR_FULL(BP_BellLower);
	DELE_PTR_FULL(BellSupportLower);
}
