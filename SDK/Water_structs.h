...
struct FWaterInformation
{
	...
	unsigned char                                      UnknownData_MCOA[0x7];                                     // 0x0009(0x0007) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_3D34[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_NKYI[0x2];                                     // 0x004A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	float                                              StaticWaterHeightValue;                                    // 0x004C(0x0004) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_DPFR[0x88];                                    // 0x0050(0x0088) MISSED OFFSET (PADDING)
...
struct FSplashProbe
{
	unsigned char                                      UnknownData_VQCJ[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_P6A1[0x1];                                     // 0x00F3(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_0R7O[0x7];                                     // 0x0101(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_VJ4Q[0x18];                                    // 0x0110(0x0018) MISSED OFFSET (PADDING)
...
struct FBuoyancyVolumeSample
{
	...
	unsigned char                                      UnknownData_W0C9[0x2];                                     // 0x0012(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_SXCI[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_JYY1[0x10];                                    // 0x0048(0x0010) MISSED OFFSET (PADDING)
...
struct FBuoyancyDragSample
{
	...
	unsigned char                                      UnknownData_DKSG[0x63];                                    // 0x002D(0x0063) MISSED OFFSET (PADDING)
...
struct FWaterBuoyancy
{
	...
	unsigned char                                      UnknownData_F84E[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_FBQD[0xEC];                                    // 0x0044(0x00EC) MISSED OFFSET (PADDING)
...
struct FBuoyancySampleMovementConfigurationEntry
{
	...
	unsigned char                                      UnknownData_4A3P[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FBuoyancySampleMovementConfiguration
{
	...
	unsigned char                                      UnknownData_J0IY[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_9WIV[0x4];                                     // 0x0034(0x0004) MISSED OFFSET (PADDING)
...
struct FBuoyancySampleMovement
{
	...
	unsigned char                                      UnknownData_WPKV[0x40];                                    // 0x0010(0x0040) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_R59L[0x8];                                     // 0x0060(0x0008) MISSED OFFSET (PADDING)
...
struct FWaterSpout
{
	...
	unsigned char                                      UnknownData_8C7Q[0x30];                                    // 0x0040(0x0030) MISSED OFFSET (PADDING)
...
struct FWaterSplashProbesContainer
{
	...
	unsigned char                                      UnknownData_U5FW[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_ZT45[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_LXFO[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FFFTWaterQueryResult
{
	...
	unsigned char                                      UnknownData_8JOL[0x3];                                     // 0x0019(0x0003) MISSED OFFSET (PADDING)
