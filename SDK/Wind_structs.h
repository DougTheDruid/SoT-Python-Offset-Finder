...
struct FWindZoneParams
{
	...
	unsigned char                                      UnknownData_WK3G[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_GOLY[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_Z6NB[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
