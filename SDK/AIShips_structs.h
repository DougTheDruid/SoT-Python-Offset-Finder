...
struct FAIShipBattleParams
{
	...
	unsigned char                                      UnknownData_8Z8E[0x20];                                    // 0x0000(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData_IEZ3[0x4];                                     // 0x0044(0x0004) MISSED OFFSET (PADDING)
...
struct FTrackingNoiseGenerator
{
	...
	unsigned char                                      UnknownData_UE58[0xC];                                     // 0x000C(0x000C) MISSED OFFSET (PADDING)
...
struct FAIShipEncounterParamsSpawnerData
{
	...
	unsigned char                                      UnknownData_RVIZ[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAIShipContextDescDamageParams
{
	...
	unsigned char                                      UnknownData_0ARK[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_4WH6[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAIShipCrewAmmoType
{
	...
	unsigned char                                      UnknownData_Q38J[0x6];                                     // 0x0002(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAIShipCrewFormType
{
	...
	unsigned char                                      UnknownData_XX60[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_C5CN[0x6];                                     // 0x000A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FWeightedSpawnOffset
{
	...
	unsigned char                                      UnknownData_0WX3[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FWeightedSpawnDirection
{
	...
	float                                              Weight;                                                    // 0x0008(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_SVXI[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TArray<struct FWeightedSpawnOffset>                SpawnOffsets;                                              // 0x0010(0x0010) (Edit, ZeroConstructor, DisableEditOnInstance)
	unsigned char                                      UnknownData_Q9ST[0x90];                                    // 0x0020(0x0090) MISSED OFFSET (PADDING)
...
struct FRelativeSpawnLocationGeneratorParams
{
	...
	unsigned char                                      UnknownData_02QJ[0x90];                                    // 0x0010(0x0090) MISSED OFFSET (PADDING)
...
struct FAIShipSizeLimit
{
	...
	unsigned char                                      UnknownData_3TL2[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (PADDING)
...
struct FAIShipWeightedSize
{
	...
	unsigned char                                      UnknownData_37V1[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAIShipEncounterBattleGenerationParams
{
	...
	unsigned char                                      UnknownData_RQB9[0x4];                                     // 0x003C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FFeatureLockedAIShipEncounterBattleGenerationParams
{
	...
	unsigned char                                      UnknownData_CHDQ[0x10];                                    // 0x0068(0x0010) MISSED OFFSET (PADDING)
...
struct FAIShipBattleEncounterDescGenerationParams
{
	...
	unsigned char                                      UnknownData_YG5W[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FWeightedAIShipCrewAmmoType
{
	...
	unsigned char                                      UnknownData_Y891[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAIShipGenerationParams
{
	...
	unsigned char                                      UnknownData_TPJW[0x6];                                     // 0x0002(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_Q82H[0x4];                                     // 0x0044(0x0004) MISSED OFFSET (PADDING)
...
{
	int                                                Weight;                                                    // 0x0000(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_KCOQ[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAIShipEncounterParams
{
	...
	unsigned char                                      UnknownData_XADY[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	struct FText                                       Name;                                                      // 0x0000(0x0018) ELEMENT_SIZE_MISMATCH (Edit, DisableEditOnInstance)
	unsigned char                                      UnknownData_H8KB[0x20];                                    // 0x0000(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FText                                       SkellyCrewName;                                            // 0x0038(0x0018) ELEMENT_SIZE_MISMATCH (Edit, DisableEditOnInstance)
	unsigned char                                      UnknownData_UWVS[0x20];                                    // 0x0038(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData_RWA8[0x6];                                     // 0x0072(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAIShipDespawnedEvent
{
	...
	unsigned char                                      UnknownData_LTUE[0x7];                                     // 0x0009(0x0007) MISSED OFFSET (PADDING)
...
struct FAIShipSpawnedEvent
{
	...
	unsigned char                                      UnknownData_FA21[0x4];                                     // 0x003C(0x0004) MISSED OFFSET (PADDING)
...
struct FAIShipEncounterCompleteNetEvent : public FBoxedRpc
{
	...
	unsigned char                                      UnknownData_K065[0x2];                                     // 0x0016(0x0002) MISSED OFFSET (PADDING)
...
struct FAIShipEncounterRevealNetEvent : public FBoxedRpc
{
	...
	unsigned char                                      UnknownData_C3FK[0x6];                                     // 0x001A(0x0006) MISSED OFFSET (PADDING)
...
struct FAIShipEncounterNotification
{
	...
	unsigned char                                      UnknownData_ZZMN[0x20];                                    // 0x0000(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData_75NW[0x20];                                    // 0x0040(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData_UK5L[0x6];                                     // 0x007A(0x0006) MISSED OFFSET (PADDING)
...
struct FAIShipEncounterZoneEnteredNetworkEvent : public FNetworkEventStruct
{
	...
	unsigned char                                      UnknownData_N4IN[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (PADDING)
...
struct FAIShipDamagedTelemetryEvent
{
	...
	unsigned char                                      UnknownData_LPUM[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_YAI9[0x4];                                     // 0x0044(0x0004) MISSED OFFSET (PADDING)
...
struct FAIShipDespawnTelemetryEvent
{
	...
	unsigned char                                      UnknownData_P00B[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (PADDING)
...
struct FAIShipSpawnTelemetryEvent
{
	...
	unsigned char                                      UnknownData_Y839[0x4];                                     // 0x0064(0x0004) MISSED OFFSET (PADDING)
