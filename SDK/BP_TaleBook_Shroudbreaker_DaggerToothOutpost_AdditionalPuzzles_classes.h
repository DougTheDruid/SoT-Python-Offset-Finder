...
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass BP_TaleBook_Shroudbreaker_DaggerToothOutpost_AdditionalPuzzles.BP_TaleBook_Shroudbreaker_DaggerToothOutpost_AdditionalPuzzles_C");
		return ptr;
	}
