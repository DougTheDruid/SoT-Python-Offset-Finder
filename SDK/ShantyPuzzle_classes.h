...
{
public:
	unsigned char                                      UnknownData_25QV[0x8];                                     // 0x02B0(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_B0PX[0x6];                                     // 0x02D2(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_Z60L[0xC0];                                    // 0x0300(0x00C0) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_TA78[0x20];                                    // 0x05B0(0x0020) MISSED OFFSET (PADDING)
