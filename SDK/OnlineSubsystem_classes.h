...
public:
	...
	unsigned char                                      UnknownData_3B7Y[0x4];                                     // 0x003C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_QSR8[0x18];                                    // 0x0048(0x0018) MISSED OFFSET (PADDING)
