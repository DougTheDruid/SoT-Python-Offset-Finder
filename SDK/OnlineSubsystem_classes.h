...
public:
	...
	unsigned char                                      UnknownData_WSKP[0x4];                                     // 0x003C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_J3SD[0x18];                                    // 0x0048(0x0018) MISSED OFFSET (PADDING)
