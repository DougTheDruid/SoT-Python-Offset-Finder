...
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass Title_RB_Rank3_001_EmissaryOfEternalServants.Title_RB_Rank3_001_EmissaryOfEternalServants_C");
		return ptr;
	}
