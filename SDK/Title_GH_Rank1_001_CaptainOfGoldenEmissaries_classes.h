...
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass Title_GH_Rank1_001_CaptainOfGoldenEmissaries.Title_GH_Rank1_001_CaptainOfGoldenEmissaries_C");
		return ptr;
	}
