...
{
public:
	class UClusterStaticMeshComponent*                 ClusterStaticMeshBanana2;                                  // 0x03F8(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData, NonTransactional, NoDestructor)
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass gmp_wrld_res_wood1_fruit2_01_a.gmp_wrld_res_wood1_fruit2_01_a_C");
		return ptr;
	}
