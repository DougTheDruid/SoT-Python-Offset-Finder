...
struct FSeasonGoalPopupAsset
{
	...
	unsigned char                                      UnknownData_TJ0B[0x4];                                     // 0x007C(0x0004) MISSED OFFSET (PADDING)
...
struct FSeasonIconPopupAsset
{
	...
	unsigned char                                      UnknownData_BP5X[0x4];                                     // 0x0064(0x0004) MISSED OFFSET (PADDING)
...
struct FSeasonProgressionUIEventTypeTelemetryFragment
{
	...
	unsigned char                                      UnknownData_D4OM[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (PADDING)
...
struct FSeasonProgressionUITelemetryFragment
{
	...
	unsigned char                                      UnknownData_R3ZV[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (PADDING)
...
struct FNavigationDesc
{
	...
	unsigned char                                      UnknownData_45YJ[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FEnableMoreButtonEvent
{
	...
	unsigned char                                      UnknownData_I520[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FSeasonNotificationContent
{
	...
	unsigned char                                      UnknownData_HZ9B[0x4];                                     // 0x0064(0x0004) MISSED OFFSET (PADDING)
...
struct FDeedProgressDesc
{
	...
	unsigned char                                      UnknownData_3IN5[0x4];                                     // 0x003C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FOpenSeasonsMenuEvent
{
	...
	unsigned char                                      UnknownData_96O1[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FGuid                                       Id;                                                        // 0x0004(0x0010) (ZeroConstructor, IsPlainOldData, NoDestructor)
...
struct FSeasonsPopupEvent
{
	...
	unsigned char                                      UnknownData_6ZP7[0x4];                                     // 0x009C(0x0004) MISSED OFFSET (PADDING)
