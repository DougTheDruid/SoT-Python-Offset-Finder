...
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass BP_FortIslandWashedUpMessageInABottleSpawner.BP_FortIslandWashedUpMessageInABottleSpawner_C");
		return ptr;
	}
