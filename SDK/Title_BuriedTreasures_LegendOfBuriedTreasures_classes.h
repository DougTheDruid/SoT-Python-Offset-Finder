...
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass Title_BuriedTreasures_LegendOfBuriedTreasures.Title_BuriedTreasures_LegendOfBuriedTreasures_C");
		return ptr;
	}
