...
// BlueprintGeneratedClass BP_PromptActor_VisitCompanyShop_MA.BP_PromptActor_VisitCompanyShop_MA_C
// 0x0090 (FullSize[0x0498] - InheritedSize[0x0408])
class ABP_PromptActor_VisitCompanyShop_MA_C : public ABP_PromptActorBase_C
{
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass BP_PromptActor_VisitCompanyShop_MA.BP_PromptActor_VisitCompanyShop_MA_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_PromptActor_VisitCompanyShop_MA(int EntryPoint);
	void AfterRead();
	void BeforeDelete();
