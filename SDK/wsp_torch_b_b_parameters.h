...
struct Awsp_torch_b_b_C_UserConstructionScript_Params
{
};

// Function wsp_torch_b_b.wsp_torch_b_b_C.ReceiveBeginPlay
struct Awsp_torch_b_b_C_ReceiveBeginPlay_Params
{
};

// Function wsp_torch_b_b.wsp_torch_b_b_C.ExecuteUbergraph_wsp_torch_b_b
struct Awsp_torch_b_b_C_ExecuteUbergraph_wsp_torch_b_b_Params
{
