...
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass BP_FeatureIslandWashedUpCollectorsChestSpawner.BP_FeatureIslandWashedUpCollectorsChestSpawner_C");
		return ptr;
	}
