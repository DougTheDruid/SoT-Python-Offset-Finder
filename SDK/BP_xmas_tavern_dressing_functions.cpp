...
// Function:
//		Offset -> 0x016629C0
//		Name   -> Function BP_xmas_tavern_dressing.BP_xmas_tavern_dressing_C.UserConstructionScript
//		Flags  -> (Event, Public, BlueprintCallable, BlueprintEvent)
void ABP_xmas_tavern_dressing_C::UserConstructionScript()
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function BP_xmas_tavern_dressing.BP_xmas_tavern_dressing_C.UserConstructionScript");
...
void ABP_xmas_tavern_dressing_C::AfterRead()
{
	AActor::AfterRead();

	READ_PTR_FULL(ChildActor, UChildActorComponent);
	READ_PTR_FULL(cmn_candle_group_02, UChildActorComponent);
...
void ABP_xmas_tavern_dressing_C::BeforeDelete()
{
	AActor::BeforeDelete();

	DELE_PTR_FULL(ChildActor);
	DELE_PTR_FULL(cmn_candle_group_02);
