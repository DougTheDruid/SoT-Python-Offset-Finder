...
{
public:
	unsigned char                                      UnknownData_HSVK[0x18];                                    // 0x03D0(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_ND6W[0x18];                                    // 0x03D0(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_BA7M[0x4];                                     // 0x0408(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
