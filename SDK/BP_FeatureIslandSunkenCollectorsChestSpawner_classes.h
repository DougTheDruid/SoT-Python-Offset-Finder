...
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass BP_FeatureIslandSunkenCollectorsChestSpawner.BP_FeatureIslandSunkenCollectorsChestSpawner_C");
		return ptr;
	}
