...
{
public:
	unsigned char                                      UnknownData_RWD3[0x10];                                    // 0x0028(0x0010) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_LJM9[0xB0];                                    // 0x0028(0x00B0) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_VO5Z[0x10];                                    // 0x0028(0x0010) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_RETS[0x58];                                    // 0x0030(0x0058) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_1IJM[0x50];                                    // 0x0028(0x0050) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_15EV[0x8];                                     // 0x00D8(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_H9LR[0x8];                                     // 0x05D8(0x0008) Fix Super Size
...
{
public:
	unsigned char                                      UnknownData_KNB1[0x8];                                     // 0x00C8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
