...
struct FCleanlinessInfo
{
	...
	unsigned char                                      UnknownData_409A[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_Q9SD[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
