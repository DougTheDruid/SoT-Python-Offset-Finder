...
public:
	...
	unsigned char                                      UnknownData_9JNF[0x3];                                     // 0x0069(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_M9NK[0x3];                                     // 0x006D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_VRMP[0x1E];                                    // 0x0072(0x001E) MISSED OFFSET (PADDING)
