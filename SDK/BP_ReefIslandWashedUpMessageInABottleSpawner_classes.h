...
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass BP_ReefIslandWashedUpMessageInABottleSpawner.BP_ReefIslandWashedUpMessageInABottleSpawner_C");
		return ptr;
	}
