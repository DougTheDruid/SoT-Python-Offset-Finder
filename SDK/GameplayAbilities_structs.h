...
{
	unsigned char                                      UnknownData_UCNH[0x20];                                    // 0x0000(0x0020) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_GI90[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_6XI4[0x20];                                    // 0x0000(0x0020) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_EMJD[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_EWGG[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_0OFN[0x7];                                     // 0x0021(0x0007) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_2T8O[0x18];                                    // 0x0000(0x0018) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_7E1D[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_FG28[0xF];                                     // 0x0011(0x000F) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FGameplayEventData
{
	...
	unsigned char                                      UnknownData_3MLY[0x4];                                     // 0x009C(0x0004) MISSED OFFSET (PADDING)
...
struct FGameplayAbilitySpecDef
{
	...
	unsigned char                                      UnknownData_THO3[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_3X89[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (PADDING)
...
struct FGameplayEffectAttributeCaptureDefinition
{
	...
	unsigned char                                      UnknownData_L15O[0x6];                                     // 0x000A(0x0006) MISSED OFFSET (PADDING)
...
struct FScalableFloat
{
	...
	unsigned char                                      UnknownData_139P[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FCurveTableRowHandle                        Curve;                                                     // 0x0008(0x0010) (Edit, DisableEditOnInstance)
	unsigned char                                      UnknownData_X3XU[0x8];                                     // 0x0018(0x0008) MISSED OFFSET (PADDING)
...
struct FAttributeBasedFloat
{
	...
	unsigned char                                      UnknownData_OGPL[0x7];                                     // 0x0081(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FGameplayEffectModifierMagnitude
{
	...
	unsigned char                                      UnknownData_AKN2[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FGameplayEffectExecutionScopedModifierInfo
{
	...
	unsigned char                                      UnknownData_E0L3[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FGameplayModifierInfo
{
	...
	unsigned char                                      UnknownData_0MX6[0x7];                                     // 0x0009(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FPredictionKey
{
	...
	unsigned char                                      UnknownData_0SR2[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_510R[0x6];                                     // 0x0012(0x0006) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_SMQE[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAbilityTriggerData
{
	...
	unsigned char                                      UnknownData_TGO2[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (PADDING)
...
struct FGameplayAbilityActivationInfo
{
	...
	unsigned char                                      UnknownData_YZ1W[0x6];                                     // 0x0002(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FGameplayEffectModifiedAttribute
{
	...
	unsigned char                                      UnknownData_CYEE[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (PADDING)
...
struct FGameplayEffectSpecForRPC
{
	...
	unsigned char                                      UnknownData_1YM4[0x4];                                     // 0x008C(0x0004) MISSED OFFSET (PADDING)
...
struct FActiveGameplayCue : public FFastArraySerializerItem
{
	...
	unsigned char                                      UnknownData_TLZ2[0x7];                                     // 0x0029(0x0007) MISSED OFFSET (PADDING)
...
struct FTagContainerAggregator
{
	...
	unsigned char                                      UnknownData_88TJ[0x30];                                    // 0x0078(0x0030) MISSED OFFSET (PADDING)
...
struct FGameplayEffectAttributeCaptureSpec
{
	...
	unsigned char                                      UnknownData_1KD7[0x18];                                    // 0x0010(0x0018) MISSED OFFSET (PADDING)
...
struct FGameplayEffectAttributeCaptureSpecContainer
{
	...
	unsigned char                                      UnknownData_2HCH[0x7];                                     // 0x0021(0x0007) MISSED OFFSET (PADDING)
...
struct FGameplayEffectSpec
{
	...
	unsigned char                                      UnknownData_0VJL[0x10];                                    // 0x0040(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_V56D[0x4];                                     // 0x005C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_73RR[0x3];                                     // 0x0215(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TArray<struct FGameplayAbilitySpecDef>             GrantedAbilitySpecs;                                       // 0x0218(0x0010) (ZeroConstructor)
	unsigned char                                      UnknownData_I6KO[0x50];                                    // 0x0228(0x0050) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_GEM0[0x4];                                     // 0x029C(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_6MH8[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_M7CA[0x2B];                                    // 0x02D5(0x002B) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_19DZ[0x20];                                    // 0x00A8(0x0020) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TArray<struct FActiveGameplayEffect>               GameplayEffects_Internal;                                  // 0x00C8(0x0010) (ZeroConstructor)
	unsigned char                                      UnknownData_OPF7[0x290];                                   // 0x00D8(0x0290) MISSED OFFSET (PADDING)
...
struct FGameplayAbilityLocalAnimMontage
{
	...
	unsigned char                                      UnknownData_9T9Z[0x7];                                     // 0x0009(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FPredictionKey                              PredictionKey;                                             // 0x0010(0x0018)
...
struct FGameplayAbilityRepAnimMontage
{
	...
	unsigned char                                      UnknownData_0QZI[0x2];                                     // 0x0016(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FGameplayAbilitySpec : public FFastArraySerializerItem
{
	...
	unsigned char                                      UnknownData_2U91[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_9OO6[0x5];                                     // 0x002B(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_C712[0x3];                                     // 0x0075(0x0003) MISSED OFFSET (PADDING)
...
struct FGameplayAbilitySpecContainer : public FFastArraySerializer
{
	...
	unsigned char                                      UnknownData_RTS2[0x8];                                     // 0x00B8(0x0008) MISSED OFFSET (PADDING)
...
struct FGameplayAbilityBindInfo
{
	...
	unsigned char                                      UnknownData_PUPW[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FGameplayCuePendingExecute
{
	...
	unsigned char                                      UnknownData_HYSU[0x7];                                     // 0x0021(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FGameplayCueNotifyData
{
	...
	unsigned char                                      UnknownData_UY4K[0x8];                                     // 0x0020(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_KNZ7[0x88];                                    // 0x0000(0x0088) MISSED OFFSET (PADDING)
...
struct FGameplayModifierEvaluatedData
{
	...
	unsigned char                                      UnknownData_S1OY[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_PFXP[0x3];                                     // 0x0015(0x0003) MISSED OFFSET (PADDING)
...
struct FGameplayEffectCustomExecutionOutput
{
	...
	unsigned char                                      UnknownData_8T11[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (PADDING)
...
struct FAttributeMetaData : public FTableRowBase
{
	...
	unsigned char                                      UnknownData_GSM6[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_312E[0x7];                                     // 0x0021(0x0007) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_9XLG[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_AJU8[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_K3RT[0x18];                                    // 0x0038(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_6IVH[0x3];                                     // 0x005D(0x0003) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_YCOD[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_J2KS[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_DIFW[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FGameplayAbilityTargetingLocationInfo       SourceLocation;                                            // 0x0010(0x0070) (Edit, BlueprintVisible, ContainsInstancedReference)
...
{
	unsigned char                                      UnknownData_XXIC[0x50];                                    // 0x0000(0x0050) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_4J09[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_BPV0[0x10];                                    // 0x00C0(0x0010) MISSED OFFSET (PADDING)
