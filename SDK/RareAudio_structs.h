...
{
	unsigned char                                      UnknownData_PHP9[0x20];                                    // 0x0000(0x0020) MISSED OFFSET (PADDING)
...
{
	struct FName                                       RTPCName;                                                  // 0x0000(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
{
	struct FName                                       SwitchGroup;                                               // 0x0000(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FName                                       SwitchValue;                                               // 0x0008(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
struct FStaticMeshWwiseEmitterData
{
	...
	unsigned char                                      UnknownData_TU3E[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FStaticMeshComponentAudioAssociation
{
	...
	unsigned char                                      UnknownData_SYO8[0x24];                                    // 0x0044(0x0024) MISSED OFFSET (PADDING)
