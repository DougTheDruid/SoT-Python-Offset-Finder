...
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass BP_ResourceIslandWashedUpResourceMerchantCratesSpawner.BP_ResourceIslandWashedUpResourceMerchantCratesSpawner_C");
		return ptr;
	}
