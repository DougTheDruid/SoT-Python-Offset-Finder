...
{
	class UMaterialInstance*                           Seagull_Material;                                          // 0x0000(0x0008)  (Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
	class UMaterialInstance*                           Seagull_MT_LOD;                                            // 0x0008(0x0008)  (Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
};
