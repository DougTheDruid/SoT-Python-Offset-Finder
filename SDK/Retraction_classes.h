...
{
public:
	unsigned char                                      UnknownData_XXE5[0x28];                                    // 0x00C8(0x0028) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_4L9W[0x1];                                     // 0x00FF(0x0001) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_B0JH[0x8];                                     // 0x00C8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_VI5K[0x30];                                    // 0x00E0(0x0030) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_KYAK[0x8];                                     // 0x0120(0x0008) MISSED OFFSET (PADDING)
