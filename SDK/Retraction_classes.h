...
{
public:
	unsigned char                                      UnknownData_MWF5[0x28];                                    // 0x00C8(0x0028) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_DR51[0x1];                                     // 0x00FF(0x0001) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_X7MD[0x8];                                     // 0x00C8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_TVV3[0x30];                                    // 0x00E0(0x0030) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_J8QE[0x8];                                     // 0x0120(0x0008) MISSED OFFSET (PADDING)
