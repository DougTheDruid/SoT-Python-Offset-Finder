...
struct FScrapeableDamageSpeedEntry
{
	...
	unsigned char                                      UnknownData_TRYP[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (PADDING)
...
struct FWatercraftRolloverCorrector
{
	...
	unsigned char                                      UnknownData_BRXN[0x4];                                     // 0x0008(0x0004) MISSED OFFSET (PADDING)
...
struct FRowboatDamageEffectData
{
	...
	unsigned char                                      UnknownData_2EFB[0xC];                                     // 0x000C(0x000C) MISSED OFFSET (PADDING)
...
struct FOar
{
	...
	unsigned char                                      UnknownData_FHZ2[0x28];                                    // 0x0038(0x0028) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_PQ8C[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_R0XV[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_WL0Z[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FRowboatMountStateTelemetryEvent
{
	...
	unsigned char                                      UnknownData_B5IH[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (PADDING)
...
struct FWatercraftDespawnTelemetryEvent
{
	...
	unsigned char                                      UnknownData_SE7R[0x3];                                     // 0x001D(0x0003) MISSED OFFSET (PADDING)
