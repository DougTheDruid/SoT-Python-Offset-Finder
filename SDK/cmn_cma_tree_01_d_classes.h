...
public:
	...
	class UStaticMeshComponent*                        wsp_trunk_01_a;                                            // 0x03F8(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData, NonTransactional, NoDestructor)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass cmn_cma_tree_01_d.cmn_cma_tree_01_d_C");
		return ptr;
	}
