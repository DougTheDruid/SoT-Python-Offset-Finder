...
struct FFinaleReplicationState
{
	...
	unsigned char                                      UnknownData_IZ8F[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FChangeGlitterBeardVFXStateEvent
{
	...
	unsigned char                                      UnknownData_7P98[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_1LM9[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_WACG[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_4HBG[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_B9V2[0x20];                                    // 0x0000(0x0020) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_NNRM[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_JF6U[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (PADDING)
