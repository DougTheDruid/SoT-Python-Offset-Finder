...
// BlueprintGeneratedClass BP_LotS_reward024.BP_LotS_reward024_C
// 0x0018 (FullSize[0x04B0] - InheritedSize[0x0498])
class ABP_LotS_reward024_C : public AModalInteractionProxy
{
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass BP_LotS_reward024.BP_LotS_reward024_C");
		return ptr;
	}
