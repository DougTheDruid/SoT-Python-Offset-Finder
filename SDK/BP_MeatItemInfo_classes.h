...
{
public:
	class UDeliverableRedirectionComponent*            DeliverableRedirection;                                    // 0x0558(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData, NonTransactional, NoDestructor)
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass BP_MeatItemInfo.BP_MeatItemInfo_C");
		return ptr;
	}
