...
{
public:
	unsigned char                                      UnknownData_UKSZ[0x8];                                     // 0x05F0(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_O71R[0x1C];                                    // 0x060C(0x001C) Fix Super Size
...
{
public:
	unsigned char                                      UnknownData_IFJC[0x8];                                     // 0x0628(0x0008) Fix Super Size
	...
	unsigned char                                      UnknownData_DIBZ[0x50];                                    // 0x0640(0x0050) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_W8PK[0xC];                                     // 0x0644(0x000C) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_WPEE[0x70];                                    // 0x00C8(0x0070) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_NBZ8[0x5];                                     // 0x014B(0x0005) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_Z9MB[0xF8];                                    // 0x03D0(0x00F8) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_80Q7[0x8];                                     // 0x0500(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_GFMX[0x3];                                     // 0x050D(0x0003) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_5P7M[0x8];                                     // 0x00C8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_L2PN[0x48];                                    // 0x00D8(0x0048) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_WPLJ[0x2];                                     // 0x0126(0x0002) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_RPXF[0x8];                                     // 0x00C8(0x0008) MISSED OFFSET (PADDING)
