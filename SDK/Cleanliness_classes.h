...
{
public:
	unsigned char                                      UnknownData_GD62[0x10];                                    // 0x00C8(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_V994[0x54];                                    // 0x00F4(0x0054) MISSED OFFSET (PADDING)
