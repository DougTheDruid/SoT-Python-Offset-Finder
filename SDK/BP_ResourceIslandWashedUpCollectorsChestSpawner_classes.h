...
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass BP_ResourceIslandWashedUpCollectorsChestSpawner.BP_ResourceIslandWashedUpCollectorsChestSpawner_C");
		return ptr;
	}
