...
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass BP_ResourceIslandWashedUpResourceMerchantCratesSpawner_DVR.BP_ResourceIslandWashedUpResourceMerchantCratesSpawner_DVR_C");
		return ptr;
	}
