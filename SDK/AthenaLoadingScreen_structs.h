...
{
	unsigned char                                      UnknownData_YDSZ[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_HNHJ[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_YG1N[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
