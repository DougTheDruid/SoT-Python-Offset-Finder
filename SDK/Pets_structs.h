...
struct FHangoutSpotParams
{
	...
	unsigned char                                      UnknownData_9V0K[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FPetDangerHearingThreat
{
	...
	unsigned char                                      UnknownData_NI3R[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FPetFeedingAnimationData
{
	...
	unsigned char                                      UnknownData_EMM7[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FHangoutSpotPosition
{
	...
	unsigned char                                      UnknownData_8FPW[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_KNBC[0x6];                                     // 0x0042(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	class APawn*                                       Occupier;                                                  // 0x0048(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_YX6H[0x10];                                    // 0x0050(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_YCJM[0x2];                                     // 0x0062(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_AL96[0xE];                                     // 0x0072(0x000E) MISSED OFFSET (PADDING)
...
struct FPetRelationship
{
	...
	unsigned char                                      UnknownData_4BD9[0x18];                                    // 0x0008(0x0018) MISSED OFFSET (PADDING)
...
struct FReactStateMapping
{
	...
	unsigned char                                      UnknownData_5GQN[0x4];                                     // 0x00C4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FWieldablePetDropTimeout
{
	...
	unsigned char                                      UnknownData_S0LS[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FWieldablePetFoodSourceEntry
{
	...
	unsigned char                                      UnknownData_4AJI[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (PADDING)
...
struct FWieldablePetHungerAnimationData
{
	...
	unsigned char                                      UnknownData_9444[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FPetTurnToFaceData
{
	...
	unsigned char                                      UnknownData_7Q62[0xC];                                     // 0x0014(0x000C) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_7XEF[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_B50R[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FEventPetReactedToFood : public FEventPetFoodBase
{
	...
	unsigned char                                      UnknownData_FASB[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_Z5NV[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_WMPL[0x2];                                     // 0x0000(0x0002) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_MLTZ[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_JX32[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_ZOC4[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_XTDL[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (PADDING)
...
struct FEventWieldablePetPutOnPerch
{
	...
	unsigned char                                      UnknownData_P3QT[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_EYHK[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FEventPetReactBegun
{
	...
	unsigned char                                      UnknownData_LMLB[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (PADDING)
...
struct FPetBaseTelemetryFragment
{
	...
	unsigned char                                      UnknownData_WVWD[0x3];                                     // 0x0021(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FWieldablePetPutOnPerchTelemetryEvent
{
	...
	uint32_t                                           HangoutSpotIndex;                                          // 0x0010(0x0004) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_6R1P[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_TDWY[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FPetReactedToFoodTelemetryEvent
{
	...
	unsigned char                                      UnknownData_PH6M[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (PADDING)
...
struct FPetReactedTelemetryEvent
{
	...
	unsigned char                                      UnknownData_WQ6E[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_5JX7[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_RRQ3[0xC];                                     // 0x0000(0x000C) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_A36Q[0x50];                                    // 0x0000(0x0050) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_LSNC[0x50];                                    // 0x0000(0x0050) MISSED OFFSET (PADDING)
...
struct FPetDespawnActionStateParams
{
	...
	unsigned char                                      UnknownData_ZLR3[0x4];                                     // 0x003C(0x0004) MISSED OFFSET (PADDING)
...
struct FPetSpawnActionStateParams
{
	...
	unsigned char                                      UnknownData_GUM2[0x4];                                     // 0x003C(0x0004) MISSED OFFSET (PADDING)
