...
class ABP_SunkenKingdomDeepSeaRegion_Treasury_1C_C : public ADeepSeaRegion
{
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass BP_SunkenKingdomDeepSeaRegion_Treasury_1C.BP_SunkenKingdomDeepSeaRegion_Treasury_1C_C");
		return ptr;
	}
