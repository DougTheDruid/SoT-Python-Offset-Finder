...
{
public:
	unsigned char                                      UnknownData_UXB4[0x8];                                     // 0x00C8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_DL3T[0x3];                                     // 0x00FD(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_9BA4[0x1];                                     // 0x0103(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_NZDN[0x7];                                     // 0x0111(0x0007) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_VANT[0x8];                                     // 0x05B8(0x0008) Fix Super Size
	...
	unsigned char                                      UnknownData_ZLO8[0xB8];                                    // 0x05C8(0x00B8) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_ARF5[0x4];                                     // 0x004C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_2UZL[0x10];                                    // 0x0028(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TArray<class UInteractableArea*>                   InteractableAreas;                                         // 0x0038(0x0010) (ZeroConstructor, Transient)
	unsigned char                                      UnknownData_JNAQ[0x28];                                    // 0x0048(0x0028) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_G3I8[0x8];                                     // 0x05D8(0x0008) Fix Super Size
	unsigned char                                      UnknownData_JBP6[0x8];                                     // 0x05E0(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ONY4[0xA0];                                    // 0x05F0(0x00A0) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_RQ6N[0x18];                                    // 0x0028(0x0018) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_4I8Q[0x8];                                     // 0x03D0(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	TArray<class UClass*>                              ValidInteractNotificationIds;                              // 0x03F0(0x0010) (ZeroConstructor, UObjectWrapper)
