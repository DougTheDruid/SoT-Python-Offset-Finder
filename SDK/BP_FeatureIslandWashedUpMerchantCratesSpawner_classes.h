...
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass BP_FeatureIslandWashedUpMerchantCratesSpawner.BP_FeatureIslandWashedUpMerchantCratesSpawner_C");
		return ptr;
	}
